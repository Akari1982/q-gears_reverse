...
int func39c38()
{
    ...
    switch (A3)
    {
        ...
        case 0x10:
        {
            ...
            entity_struct = system_get_entity_script_data_pointer_from_script();
        ...
        case 0x14:
        {
            ...
            {
                system_event_script_run(entity_struct, priority, script_id, 0x1); // pause current
        ...
        case 0x4b:
        {
            ...
            if (bu[V0 + 0x5] == 0x4)
            {
                ...
                if (w[0x8007b708] == 0x1) // if field
                {
                    V1 = hu[S4 + 0x34];
                    if (V1 != 0xffff)
                    {
                        funcc7570(bu[S4 + 0x3b], (S2 << 0x2) & 0xfffc);
                    }
                }
        ...
        case 0xbf:
        {
            S4 = system_get_entity_script_data_pointer_from_script();
        }
        ...
        case 0x1d:
        {
            ...
            if (w[0x8007b708] == 0x1) // if this is field
            {
                V0 = hu[S4 + 0x34] ^ 0xffff;
                S5 = S5 < V0;
            }
            ...
            if (S5 != 0)
            {
                funcc3e18(bu[S4 + 0x3b], 0x1);
            }

            if (bu[S4 + 0x5] == 0x4)
            {
                [S4 + 0x78] = w(0x7fffffff);
                [S4 + 0x30] = h(0);
                [S4 + 0x50] = h(hu[S4 + 0x50] & 0xffcf);
            }
        ...
        case 0xbb:
        {
            S0 = system_get_entity_script_data_pointer_from_script();
        }
        ...
        case 0x56:
        {
            ...
            {
                func52da0();
                A3 = system_read_from_stack_command_not_from_script();
            }
            else
            {
                V1 = w[0x8007b70c];
        ...
        case 0xa7:
        {
            ...
            func398d0(S0, A1 << 0x4, 0x1, bu[S0 + 0x73]);
        ...
        case 0x9b:
        {
            ...
            if (V0 != 0)
            {
                func398d0(S0, system_get_rotation_by_vector_x_y(S2, S3), 0x1, bu[S0 + 0x73]);
            }
            return 0;
        }
        ...
        case 0x51:
        {
            8003B658	jal    system_get_entity_script_data_pointer_from_script [$80038150]
            8003B65C	nop
            V1 = w[0x8007b6f4];
            8003B668	nop
            V1 = V1 & 0001;
            ...
            if (S1 != 0)
            {
                func398d0(S0, system_get_rotation_by_vector_x_y(w[S1 + 0x14] - w[S0 + 0x14], w[S1 + 0x1c] - w[S0 + 0x1c]), 0x1, S2);
            }
        ...
        case 0x1f:
        {
            ...
            A2 = bu[current_script_data + 0x10];
            if ((S5 & 0xa0) == 0x80)
            {
                if (bu[current_script_data + 0x5] == 0x4)
                {
                    V0 = w[0x8007aecc];
                    A0 = w[V0 + 0x16d8];
                    while (A0 != 0)
            ...
            {
                func52da0();
                text_id = system_read_from_stack_command_not_from_script();
            }
            else
            {
                A0 = w[0x8007b70c];
            ...
            func4dcec(text_id, bu[current_script_data + 0x10], func39660(current_script_data, text_id, S5), S5);

            [current_script_data + 0xd] = b(0xfe);
        ...
        case 0x20:
        {
            ...
            A2 = bu[current_script_data + 0x10];
            // if normal model dialog
            if (((S5 & 0xa0) == 0x80) && (bu[current_script_data + 0x5] == 0x4))
            {
        ...
        case 0x23:
        {
            ...
            if (func38990(S2, 0, A2, 0) != 0)
            {
                [0x8007b6f8] = w(0x1);
                A0 = w[0x8007b70c];
                [A0 + 0x0] = w(w[0x8007aea0]); // restore script position before this opcode
            }
        ...
        case 0x9d:
        {
            func1e350(bu[S0 + 0x3b]);

            [V0 + 0x0] = w(w[V0 + 0x0] & 0xffffffef);
            [S0 + 0x60] = b(bu[S0 + 0x91] + 0x1);
            [S0 + 0x61] = b(0xff);
            [S0 + 0x62] = b(0);
            ...
            [S0 + 0x36] = h(hu[S0 + 0x76]);
            [S0 + 0x3a] = b(bu[S0 + 0x60]);
            [S0 + 0x62] = b(bu[S0 + 0x62] & 0xb9);
            [S0 + 0x62] = b(bu[S0 + 0x62] | ((bu[S0 + 0x61] < bu[S0 + 0x60]) ? 0xc0 : 0x80));
            [S0 + 0x38] = b(system_get_number_of_frames_in_animation(hu[S0 + 0x34], hu[S0 + 0x76]));
            [S0 + 0x5d] = b(bu[S0 + 0x69]);
            [S0 + 0x64] = b(0);

            V0 = w[0x8007aecc];

            if (bu[S0 + 0x7] == bu[V0 + 0x16ed])
            {
                [0x8007b710] = w(w[0x8007b710] + 0x1);
            }
        ...
        case 0x29:
        {
            ...
            if (A0 != 0)
            {
                ...
                loop3d2ac:	; 8003D2AC
                    ...
                    S0 = S0 - 0x1;
                    S1 = S1 + 0x4;
                8003D39C	bne    s0, -0x1, loop3d2ac [$8003d2ac]
            }
        ...
        case 0x9f:
        {
            ...
            if ((S4 != 0) && (hu[S4 + 0x34] != 0xffff))
            {
                V0 = func1e350(bu[S4 + 0x3b]);
            ...
            if (S0 != 0)
            {
                [S0 + 0x54] = h((S2 << 0x18) >> 0x12);
                [S0 + 0x56] = h((S3 << 0x18) >> 0x12);
                [S0 + 0x58] = h((S5 << 0x18) >> 0x12);
                [S0 + 0x0] = h(hu[S0 + 0x0] | 0x2);
            }
        ...
        case 0xb5:
        {
            S1 = system_get_entity_script_data_pointer_from_script();
        ...
        case 0x43:
        {
            ...
            V0 = func367d0(A0, S2, 0x14, 0); // init entity
        ...
        case 0x8f:
        {
            80042950	jal    system_get_entity_script_data_pointer_from_script [$80038150]
            80042954	nop
            V1 = w[0x8007b6f4];
            80042960	nop
            V1 = V1 & 0001;
        ...
        case 0x3a:
        {
            80042CB4	jal    system_get_entity_script_data_pointer_from_script [$80038150]
            80042CB8	nop
            A0 = V0;
        ...
        case 0xb3:
        {
            ...
            {
                func52da0();
                T2 = system_read_from_stack_command_not_from_script();
            }
            else
            {
                A0 = w[0x8007b70c];
        ...
        case 0xaa:
        {
            [0x80073998] = w(w[0x80073998] & 0xfffbffff);
        ...
        case 0xab:
        {
            [0x80073998] = w(w[0x80073998] | 0x40000);
        ...
        case 0xce:
        {
            ...
            A3 = w[0x8006794c];
            A1 = w[A3 + 0x1c];
            [A1 + 0x560] = w(w[A1 + 0x560] + A2);
            if (w[A1 + 0x560] > 0x98967f) [A1 + 0x560] = w(0x98967f);
        ...
        case 0xcf:
        {
            ...
            T0 = w[0x8006794c];
            A2 = w[T0 + 0x1c];
            [A2 + 0x560] = w(w[A2 + 0x560] - A3);

            if (w[A2 + 0x560] > 0x98967f)
            {
                [A2 + 0x560] = w(0);
            }
        ...
        case 0xd9:
        {
            ...
            V0 = w[0x8006794c];
            func53960(w[V0 + 0x1c] + S2 * 0x90 + 0x3c);
        ...
        case 0xa9:
        {
            ...
            if (S1 != 0)
            {
                [SP + 0x20] = h(hu[S1 + 0x14]); // x
                [SP + 0x22] = h(hu[S1 + 0x18]); // y
                [SP + 0x24] = h(hu[S1 + 0x1c]); // z

                // 8007ae2c store screen X here
                // 8007ae30 store screen Y here
                system_get_screen_coords_by_vector(SP + 0x20, 0x8007ae2c, 0x8007ae30);
            }
