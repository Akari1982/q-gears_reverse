...
[S0 + b300] = w(V0);
800A7164	jal    $system_psyq_vsync
A0 = 0;
...
[S0 + b300] = w(V0);
800A71EC	jal    $system_psyq_vsync
A0 = 0;
...
[SP + 0018] = w(RA);
[SP + 0014] = w(S1);
800A7828	jal    $func1c7fc
[SP + 0010] = w(S0);
S1 = V0;
A0 = 0005;
A1 = 7003a;
800A7840	jal    $func1c7fc
A2 = 0;
V1 = w[8006794c];
800A7850	nop
V1 = w[V1 + 001c];
...
A0 = 0004;
A1 = 90122;
800A7874	jal    $func1c7fc
A2 = 0;
S1 = V0;
A0 = 0005;
A1 = 90122;
800A788C	jal    $func1c7fc
A2 = 0;
