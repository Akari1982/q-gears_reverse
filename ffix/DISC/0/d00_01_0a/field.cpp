...
A0 = 2714;
[SP + 0024] = w(RA);
800A8488	jal    $800220e8
[SP + 0020] = w(S0);
800A8490	beq    v0, zero, la84d0 [$800a84d0]
A0 = 0001;
800A8498	jal    $80021e5c
A0 = 2714;
A0 = w[80067948];
A1 = w[V0 + 0008];
A2 = w[V0 + 000c];
...
V0 = V1 + V0;
A0 = w[V0 + 0010];
800AE910	jal    $80013590
A1 = 1000;

lae918:	; 800ae918
800AE918	jal    $8004c204
800AE91C	nop
RA = w[SP + 0014];
S0 = w[SP + 0010];
800AE928	jr     ra 
...
800AEA04	nop
A0 = bu[V0 + 0009];
800AEA0C	jal    $80015c58
800AEA10	lui    s0, $800d
800AEA14	jal    $80012d28
A0 = 0001;
V0 = hu[S0 + 9d44];
800AEA20	nop
V0 = V0 & 0008;
...
A2 = hu[V1 + 0006];
V0 = 00e0;
800B4AE0	jal    $8001d8a8
[V1 + 0002] = h(V0);
800B4AE8	jal    $800130a4
A0 = 0;
V0 = w[8006794c];
800B4AF8	nop
V0 = w[V0 + 001c];
...
800B4EB4	nop
A0 = bu[V0 + 0009];
800B4EBC	jal    $80015c58
800B4EC0	nop
800B4EC4	jal    $80012d28
A0 = 0001;
V1 = w[S5 + 794c];
800B4ED0	nop
V0 = w[V1 + 001c];
...
800B5350	nop
800B5354	jal    $800130a4
A0 = 0;
800B535C	jal    $80015c58
A0 = 0;
800B5364	jal    $80012d28
A0 = 0001;
V1 = w[S0 + 794c];
800B5370	nop
V0 = w[V1 + 001c];
...
A1 = S0;
800C8738	jal    $800130a4
A0 = 0;
A0 = S2;
A1 = 03c0;
800C8748	jal    $80013410
A2 = 01b0;
800C8750	jal    $800130a4
A0 = 0;
A0 = S3;
A1 = 03d0;
800C8760	jal    $80013410
A2 = 01b0;
800C8768	jal    $800130a4
A0 = 0;
A1 = h[SP + 0010];
A2 = h[SP + 0012];
800C8778	jal    $80013410
A0 = S1;
800C8780	jal    $800130a4
A0 = 0;
A1 = h[SP + 0018];
A2 = h[SP + 001a];
800C8790	jal    $80013410
A0 = S4;
800C8798	jal    $800130a4
A0 = 0;
A1 = h[SP + 0020];
A2 = h[SP + 0022];
800C87A8	jal    $80013410
A0 = S5;
800C87B0	jal    $800130a4
A0 = 0;
A0 = S1;
A1 = S0;
V0 = 03c0;
...
[SP + 0022] = h(V1);
800C87E0	jal    $800130a4
A0 = 0;
A1 = h[SP + 0030];
A2 = h[SP + 0032];
800C87F0	jal    $80013410
A0 = S2;
800C87F8	jal    $800130a4
A0 = 0;
A1 = h[SP + 0038];
A2 = h[SP + 003a];
800C8808	jal    $80013410
A0 = S3;
800C8810	jal    $800130a4
A0 = 0;
RA = w[SP + 0058];
S5 = w[SP + 0054];
S4 = w[SP + 0050];
