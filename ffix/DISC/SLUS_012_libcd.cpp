...
8001FE78	jal    system_interrupts_timer_dma_initialize [$80015ea8]
[AT + 825c] = w(0);
A1 = 800201f4;
8001FE88	jal    system_int_set_interrupt_callback [$80015ed8]
A0 = 0002;
RA = w[SP + 0010];
SP = SP + 0018;
8001FE98	jr     ra 
...
[80068250] = w(0);
[80068260] = w(0);
8001FEF4	lui    at, $8007
8001FEF8	jal    system_interrupts_timer_dma_initialize [$80015ea8]
[AT + 825c] = w(0);
A1 = 800201f4;
8001FF08	jal    system_int_set_interrupt_callback [$80015ed8]
A0 = 0002;
V1 = w[80068514];
V0 = 0001;
[V1 + 0000] = b(V0);
...
V1 = w[8006851c];
V0 = 1325;
8001FFE4	jal    func1f7fc [$8001f7fc]
[V1 + 0000] = w(V0);
V0 = w[8006825c];
8001FFF4	nop
V0 = V0 & 0010;
...
A1 = 0;
A2 = 0;
8002000C	jal    func1f7fc [$8001f7fc]
A3 = 0;
...
A1 = 0;
A2 = 0;
80020020	jal    func1f7fc [$8001f7fc]
A3 = 0;
...
A1 = 0;
A2 = 0;
8002003C	jal    func1f7fc [$8001f7fc]
A3 = 0;
...
A1 = 0;
A2 = 0;
80020474	jal    func1f7fc [$8001f7fc]
A3 = 0;
...
A1 = S1;
A2 = S2;
8002049C	jal    func1f7fc [$8001f7fc]
A3 = 0;
...
A1 = S1;
A2 = S2;
800204C0	jal    func1f7fc [$8001f7fc]
A3 = 0;
...
A1 = 0;
A2 = 0;
800205A8	jal    func1f7fc [$8001f7fc]
A3 = 0;
...
A1 = S1;
A2 = 0;
800205D0	jal    func1f7fc [$8001f7fc]
A3 = 0;
...
A1 = S1;
A2 = 0;
800205F4	jal    func1f7fc [$8001f7fc]
A3 = 0001;
...
A1 = 0;
A2 = 0;
800206DC	jal    func1f7fc [$8001f7fc]
A3 = 0;
...
A1 = S1;
A2 = S2;
80020704	jal    func1f7fc [$8001f7fc]
A3 = 0;
...
A1 = S1;
A2 = S2;
80020728	jal    func1f7fc [$8001f7fc]
A3 = 0;
...
[SP + 0014] = w(RA);
A0 = w[S0 + 0000];
800207B8	jal    func21380 [$80021380]
...
L209bc:	; 800209BC
A0 = w[S0 + 002c];
800209C0	jal    func213a0 [$800213a0]
800209C4	nop
V0 = w[8006861c];
800209D0	nop
V0 = V0 & 0001;
...
800209F0	jal    func21380 [$80021380]
A0 = A0 + 07a0;
A0 = 0009;
...
80020A9C	nop
A0 = w[S0 + 002c];
80020AA4	jal    func213a0 [$800213a0]
80020AA8	nop
V0 = w[8006861c];
80020AB4	nop
V0 = V0 & 0001;
...
80020AD4	jal    func21380 [$80021380]
A0 = A0 + 07a0;
A0 = 0009;
...
[SP + 0024] = w(RA);
[SP + 001c] = w(S1);
80020B30	jal    func21380 [$80021380]
[SP + 0018] = w(S0);
80020B38	jal    func213a0 [$800213a0]
A0 = 0;
V0 = w[8006861c];
80020B48	nop
V0 = V0 & 0001;
...
80020C90	jal    func213a0 [$800213a0]
[S0 + 0020] = w(V0);
V0 = w[8006861c];
80020CA0	nop
V0 = V0 & 0001;
...
A0 = w[S0 + 0000];
80020D58	jal    func21380 [$80021380]
...
A0 = w[S0 + 0000];
80020D78	jal    func21380 [$80021380]
...
A0 = w[S1 + 0000];
80020DE8	jal    func213a0 [$800213a0]
80020DEC	nop
V0 = w[8006861c];
80020DF8	nop
V0 = V0 & 0001;
...
80020E18	jal    func21380 [$80021380]
A0 = A0 + 07a0;
A0 = 0009;
...
A0 = w[S0 + 0000];
80020F58	jal    func21380 [$80021380]
...
[S0 + 000c] = w(V0);
[S0 + 0004] = w(S3);
80020FAC	jal    func21380 [$80021380]
[S0 + 0000] = w(S4);
A0 = 0;
80020FB8	jal    func213a0 [$800213a0]
[S0 + 0028] = w(V0);
V1 = w[8006861c];
[S0 + 002c] = w(V0);
V1 = V1 & 0001;
...
V0 = V0 + 07ff;
V0 = V0 >> 0b;
80022720	jal    func213a0 [$800213a0]
[S0 + 0004] = w(V0);
A0 = w[S2 + 0010];
8002272C	jal    func21380 [$80021380]
80022730	nop
V0 = bu[S2 + 0000];
80022738	nop
V0 = V0 & 0001;
...
L22898:	; 80022898
80022898	jal    func213a0 [$800213a0]
A0 = 0;
V0 = 0004;
[S2 + 61d0] = b(V0);
A0 = 0009;
...
L228cc:	; 800228CC
800228CC	jal    func213a0 [$800213a0]
A0 = 0;
A0 = 0009;
A1 = 0;
...
////////////////////////////////
// func22a80
80022A80	addiu  sp, sp, $ffe8 (=-$18)
[SP + 0010] = w(RA);
80022A88	jal    func23634 [$80023634]
A0 = 0001;
80022A90	jal    func21380 [$80021380]
A0 = 0;
80022A98	jal    func213a0 [$800213a0]
A0 = 0;
A0 = 800761d0;
A1 = 0;
80022AAC	jal    func1d898 [$8001d898]
A2 = 098c;
RA = w[SP + 0010];
80022AB8	nop
80022ABC	jr     ra 
