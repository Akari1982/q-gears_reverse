...
A0 = w[SP + 0018];
8001EB2C	jal    func202d0 [$800202d0]
A1 = S4;
V0 = S5 + 0004;
V0 = S1 + V0;
...
[SP + 0018] = w(S0);
[SP + 0020] = w(RA);
8001ECD8	jal    func202d0 [$800202d0]
S0 = A2;
A0 = 0002;
A1 = SP + 0010;
...
[SP + 0018] = w(S2);
S2 = S3 & 00ff;
80020548	lui    v1, $8007
8002054C	addiu  v1, v1, $8558 (=-$7aa8)
[SP + 0020] = w(S4);
S4 = w[80068250];
V0 = S2 << 02;
[SP + 0024] = w(S5);
...
S6 = 0;
[SP + 002c] = w(S7);
80020574	addiu  s7, zero, $ffff (=-$1)
[SP + 0034] = w(RA);

loop2057c:	; 8002057C
8002057C	lui    at, $8007
80020580	beq    s2, fp, L205b0 [$800205b0]
[AT + 8250] = w(0);
V0 = bu[8006825c];
80020590	nop
V0 = V0 & 0010;
80020598	beq    v0, zero, L205b0 [$800205b0]
A0 = 0001;
A1 = 0;
A2 = 0;
800205A8	jal    system_cdrom_cdl_command_exec [$8001f7fc]
A3 = 0;

L205b0:	; 800205B0
800205B0	beq    s1, zero, L205e0 [$800205e0]
800205B4	nop
V0 = w[S5 + 0000];
800205BC	nop
800205C0	beq    v0, zero, L205e0 [$800205e0]
A0 = 0002;
A1 = S1;
A2 = 0;
800205D0	jal    system_cdrom_cdl_command_exec [$8001f7fc]
A3 = 0;
800205D8	bne    v0, zero, L20604 [$80020604]
800205DC	nop
...
A1 = S1;
A2 = 0;
800205F4	jal    system_cdrom_cdl_command_exec [$8001f7fc]
A3 = 0001;
800205FC	beq    v0, zero, L20620 [$80020620]
V0 = S6 + 0001;

L20604:	; 80020604
80020604	addiu  s0, s0, $ffff (=-$1)
80020608	bne    s0, s7, loop2057c [$8002057c]
8002060C	nop
[80068250] = w(S4);
80020618	addiu  s6, zero, $ffff (=-$1)
V0 = S6 + 0001;
...
[SP + 0014] = w(RA);
A0 = w[S0 + 0000];
800207B8	jal    system_cdrom_set_sync_callback [$80021380]
...
L20874:	; 80020874
80020874	jal    func21290 [$80021290]
A0 = SP + 0010;
...
L209bc:	; 800209BC
A0 = w[S0 + 002c];
800209C0	jal    system_cdrom_set_ready_callback [$800213a0]
800209C4	nop
V0 = w[8006861c];
800209D0	nop
V0 = V0 & 0001;
...
800209F0	jal    system_cdrom_set_sync_callback [$80021380]
A0 = A0 + 07a0;
A0 = 0009;
800209FC	jal    func2051c [$8002051c]
A1 = 0;
V1 = w[80068618];
V0 = 0001;
...
80020A9C	nop
A0 = w[S0 + 002c];
80020AA4	jal    system_cdrom_set_ready_callback [$800213a0]
80020AA8	nop
V0 = w[8006861c];
80020AB4	nop
V0 = V0 & 0001;
...
80020AD4	jal    system_cdrom_set_sync_callback [$80021380]
A0 = A0 + 07a0;
A0 = 0009;
80020AE0	jal    func2051c [$8002051c]
A1 = 0;
V1 = w[80068618];
V0 = 0001;
...
[SP + 0024] = w(RA);
[SP + 001c] = w(S1);
80020B30	jal    system_cdrom_set_sync_callback [$80021380]
[SP + 0018] = w(S0);
80020B38	jal    system_cdrom_set_ready_callback [$800213a0]
A0 = 0;
V0 = w[8006861c];
80020B48	nop
V0 = V0 & 0001;
...
L20b98:	; 80020B98
80020B98	jal    func2051c [$8002051c]
A1 = 0;
...
80020C74	nop
80020C78	jal    func21290 [$80021290]
A0 = V0;
A0 = 800207d4;
80020C88	lui    s0, $8007
80020C8C	addiu  s0, s0, $85d8 (=-$7a28)
80020C90	jal    system_cdrom_set_ready_callback [$800213a0]
[S0 + 0020] = w(V0);
V0 = w[8006861c];
80020CA0	nop
V0 = V0 & 0001;
...
V0 = w[S0 + 0004];
A1 = 0;
80020CC8	jal    func2051c [$8002051c]
[S0 + 0008] = w(V0);
V0 = w[S0 + 0000];
...
A0 = w[S0 + 0000];
80020D58	jal    system_cdrom_set_sync_callback [$80021380]
...
A0 = w[S0 + 0000];
80020D78	jal    system_cdrom_set_sync_callback [$80021380]
...
A0 = w[S1 + 0000];
80020DE8	jal    system_cdrom_set_ready_callback [$800213a0]
80020DEC	nop
V0 = w[8006861c];
80020DF8	nop
V0 = V0 & 0001;
...
80020E18	jal    system_cdrom_set_sync_callback [$80021380]
A0 = A0 + 07a0;
A0 = 0009;
80020E24	jal    func2051c [$8002051c]
A1 = 0;
...
A0 = w[S0 + 0000];
80020F58	jal    system_cdrom_set_sync_callback [$80021380]
...
[S0 + 000c] = w(V0);
[S0 + 0004] = w(S3);
80020FAC	jal    system_cdrom_set_sync_callback [$80021380]
[S0 + 0000] = w(S4);
A0 = 0;
80020FB8	jal    system_cdrom_set_ready_callback [$800213a0]
[S0 + 0028] = w(V0);
V1 = w[8006861c];
[S0 + 002c] = w(V0);
V1 = V1 & 0001;
...
[A2 + 000c] = w(T2);
A1 = A1 + 0010;
800226E0	bne    a1, a0, loop226bc [$800226bc]
A2 = A2 + 0010;
A0 = 0;
800226EC	lui    s1, $8007
S3 = 0001;
A3 = w[A1 + 0000];
800226F8	nop
[A2 + 0000] = w(A3);
...
V0 = V0 + 07ff;
V0 = V0 >> 0b;
80022720	jal    system_cdrom_set_ready_callback [$800213a0]
[S0 + 0004] = w(V0);
A0 = w[S2 + 0010];
8002272C	jal    system_cdrom_set_sync_callback [$80021380]
80022730	nop
V0 = bu[S2 + 0000];
80022738	nop
V0 = V0 & 0001;
80022740	beq    v0, zero, L22770 [$80022770]
80022744	nop
S0 = S0 + 0008;
[S1 + 61d0] = b(S3);
A0 = w[S2 + 0004];
80022754	jal    func202d0 [$800202d0]
A1 = S0;
A0 = 0002;
80022760	jal    func23580 [$80023580]
A1 = S0;
80022768	j      L227ac [$800227ac]
8002276C	nop

L22770:	; 80022770
V0 = w[SP + 0010];
V1 = 0004;
80022778	beq    v0, v1, L22794 [$80022794]
A0 = 0009;
[S1 + 61d0] = b(V1);
80022784	jal    func23580 [$80023580]
A1 = 0;
8002278C	j      L227ac [$800227ac]
80022790	nop

L22794:	; 80022794
V0 = w[S0 + 095c];
80022798	nop
8002279C	beq    v0, zero, L227ac [$800227ac]
[S1 + 61d0] = b(0);
800227A4	jalr   v0 ra
A0 = S0;
...
A1 = 0003;
80022824	jal    func21290 [$80021290]
A0 = SP + 0010;
V1 = 800761d0;
A0 = w[V1 + 0018];
80022838	nop
...
L22898:	; 80022898
80022898	jal    system_cdrom_set_ready_callback [$800213a0]
A0 = 0;
V0 = 0004;
[S2 + 61d0] = b(V0);
A0 = 0009;
800228AC	jal    func23580 [$80023580]
A1 = 0;
...
L228cc:	; 800228CC
800228CC	jal    system_cdrom_set_ready_callback [$800213a0]
A0 = 0;
A0 = 0009;
A1 = 0;
...
[A2 + 0003] = b(V1);
V0 = V0 + 0001;
800228FC	jal    func23580 [$80023580]
[A2 + 0001] = b(V0);
...
////////////////////////////////
// func22ac4
80022AC4	addiu  sp, sp, $ffd0 (=-$30)
[SP + 0028] = w(S0);
S0 = A0;
A0 = SP + 0010;
[SP + 002c] = w(RA);
80022AD8	jal    func1e3c0 [$8001e3c0]
A1 = S0;
80022AE0	beq    v0, zero, L22af8 [$80022af8]

80022AE8	jal    func21290 [$80021290]
A0 = SP + 0010;
80022AF0	j      L22b08 [$80022b08]
80022AF4	nop
...
[SP + 0024] = w(RA);
80022B4C	jal    system_cdrom_set_ready_callback [$800213a0]
A0 = 0;
80022B54	jal    system_cdrom_set_sync_callback [$80021380]
A0 = 0;
[S2 + 0002] = b(0);
[S2 + 0003] = b(0);
[S0 + 61d0] = b(0);
...
////////////////////////////////
// func22c60
80022C60	addiu  sp, sp, $ffe8 (=-$18)
80022C64	lui    v1, $8007
V0 = 0003;
[V1 + 6148] = b(V0);
V1 = V1 + 6148;
80022C74	addiu  v0, zero, $ffff (=-$1)
[SP + 0010] = w(RA);
[V1 + 000c] = w(V0);
V0 = 800231a0;
[V1 + 0010] = w(V0);
...
[V1 + 0020] = w(A2);
[V1 + 0014] = w(V0);
80022CAC	jal    func230b8 [$800230b8]
[V1 + 0018] = w(A3);
RA = w[SP + 0010];
V0 = V0 & 00ff;
80022CBC	jr     ra 
...
[SP + 001c] = w(0);
[SP + 0024] = w(V0);
80022DBC	jal    func230b8 [$800230b8]
[SP + 0028] = w(0);
V0 = V0 & 00ff;
80022DC8	beq    v0, zero, L22de0 [$80022de0]
V0 = 0;

loop22dd0:	; 80022DD0
80022DD0	jal    func22b18 [$80022b18]
80022DD4	nop
80022DD8	bne    v0, zero, loop22dd0 [$80022dd0]
V0 = 0001;
...
80022DF4	lui    v1, $8007
V0 = 0003;
[V1 + 6148] = b(V0);
V1 = V1 + 6148;
80022E04	addiu  v0, zero, $ffff (=-$1)
...
[V1 + 0020] = w(A2);
[V1 + 0014] = w(V0);
80022E3C	jal    func230b8 [$800230b8]
[V1 + 0018] = w(0);
V0 = V0 & 00ff;
if( V0 == 0 ) return 0;
...
loop22e50:	; 80022E50
    func22b18();
80022E58	bne    v0, zero, loop22e50 [$80022e50]
...
[SP + 0020] = w(RA);
80022F94	jal    system_cdrom_set_ready_callback [$800213a0]
A0 = 0;
A0 = 0009;
A1 = 0;
[S2 + 0948] = w(S3);
80022FA8	jal    func23580 [$80023580]
[S0 + 61d0] = b(S1);
...
A0 = 0;
[V1 + 0002] = b(0);
8002303C	jal    system_cdrom_set_ready_callback [$800213a0]
[V1 + 0003] = b(0);
A0 = 0009;
V0 = 0004;
A1 = 0;
80023050	jal    func23580 [$80023580]
[S0 + 61d0] = b(V0);
...
A0 = V0 + 61d0;
[SP + 0018] = w(RA);
800230D8	bne    v1, zero, L23114 [$80023114]
[A0 + 0001] = b(0);
V0 = bu[A1 + 0000];
800230E4	nop
V0 = V0 & 0004;
800230EC	beq    v0, zero, L2317c [$8002317c]
800230F0	nop
V0 = w[A1 + 0018];
800230F8	nop
800230FC	beq    v0, zero, L23184 [$80023184]
80023100	nop
80023104	jalr   v0 ra
80023108	nop
8002310C	j      L23190 [$80023190]
V0 = 0001;

L23114:	; 80023114
V0 = bu[A0 + 0002];
80023118	nop
8002311C	bne    v0, zero, L2318c [$8002318c]
V0 = A0 + 0968;
V1 = A1;
A0 = A1 + 0020;
...
[V0 + 000c] = w(T1);
V1 = V1 + 0010;
80023150	bne    v1, a0, loop2312c [$8002312c]
V0 = V0 + 0010;
A2 = w[V1 + 0000];
8002315C	nop
[V0 + 0000] = w(A2);
...
A0 = bu[V0 + 61d0];
V0 = 0001;
80023174	bne    a0, zero, L23184 [$80023184]
[V1 + 0002] = b(V0);

L2317c:	; 8002317C
8002317C	jal    func2267c [$8002267c]
A0 = A1;

L23184:	; 80023184
80023184	j      L23190 [$80023190]
V0 = 0001;
...
////////////////////////////////
// func231a0
800231A0	addiu  sp, sp, $ffe8 (=-$18)
800231A4	beq    a1, zero, L231d4 [$800231d4]
[SP + 0010] = w(RA);
T1 = 80076b0c;
800231B4	lwl    a2, $0003(a1)
800231B8	lwr    a2, $0000(a1)
800231BC	lwl    a3, $0007(a1)
800231C0	lwr    a3, $0004(a1)
800231C4	swl    a2, $0003(t1)
800231C8	swr    a2, $0000(t1)
800231CC	swl    a3, $0007(t1)
800231D0	swr    a3, $0004(t1)

L231d4:	; 800231D4
V0 = 800761d0;
V0 = bu[V0 + 0002];
800231E0	nop
800231E4	beq    v0, zero, L231fc [$800231fc]
V0 = 0005;
800231EC	jal    func2325c [$8002325c]
A0 = A0 & 00ff;
800231F4	j      L2324c [$8002324c]
800231F8	nop

L231fc:	; 800231FC
A0 = A0 & 00ff;
80023200	bne    a0, v0, L23218 [$80023218]
80023204	nop
80023208	jal    func23304 [$80023304]
A0 = V0;
80023210	j      L2324c [$8002324c]
80023214	nop

L23218:	; 80023218
V0 = 0002;
8002321C	bne    a0, v0, L2324c [$8002324c]
80023220	lui    v1, $8007
V0 = bu[A1 + 61d0];
80023228	addiu  v1, v1, $8668 (=-$7998)
V0 = V0 << 02;
V0 = V0 + V1;
V0 = w[V0 + 0000];
80023238	nop
8002323C	beq    v0, zero, L2324c [$8002324c]
80023240	nop
80023244	jalr   v0 ra
A0 = 0002;
...
800232D0	nop
800232D4	jal    system_cdrom_set_ready_callback [$800213a0]
A0 = 0;
V0 = 0004;
[S1 + 61d0] = b(V0);
A0 = 0009;
800232E8	jal    func23580 [$80023580]
A1 = 0;
...
[A1 + 0003] = b(V1);
V0 = V0 + 0001;
80023348	jal    system_cdrom_set_ready_callback [$800213a0]
[A1 + 0001] = b(V0);
A0 = 0009;
80023354	jal    func23580 [$80023580]
A1 = 0;
...
A1 = SP + 0010;
[SP + 0010] = b(S1);
800233A0	jal    func23580 [$80023580]
[V0 + 61d0] = b(V1);
...
80023408	jal    system_cdrom_set_ready_callback [$800213a0]
A0 = A0 + 35a0;
...
L23418:	; 80023418
A0 = w[A0 + 0958];
8002341C	jal    system_cdrom_set_ready_callback [$800213a0]
80023420	nop
...
L23444:	; 80023444
80023444	jal    func23580 [$80023580]
A1 = 0;
RA = w[SP + 0010];
80023450	nop
80023454	jr     ra 
...
[SP + 0010] = w(RA);
80023464	jal    system_cdrom_set_ready_callback [$800213a0]
A0 = 0;
8002346C	jal    system_cdrom_set_sync_callback [$80021380]
A0 = 0;
A0 = 800761d0;
V0 = bu[A0 + 0003];
80023480	nop
...
////////////////////////////////
// func23580
80023580	addiu  sp, sp, $ffe8 (=-$18)
[SP + 0010] = w(RA);
80023588	jal    func2051c [$8002051c]
A0 = A0 & 00ff;
RA = w[SP + 0010];
80023594	nop
80023598	jr     ra 
...
800235EC	nop
800235F0	jal    system_cdrom_set_ready_callback [$800213a0]
A0 = 0;
V0 = 0004;
[S0 + 61d0] = b(V0);
A0 = 0009;
80023604	jal    func23580 [$80023580]
A1 = 0;
