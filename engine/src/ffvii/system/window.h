#ifndef FFVII_WINDOW_H
#define FFVII_WINDOW_H
...
void FFVII_System_UIWindowAddToRender( const PSX_RECT& w_rect ); // system_menu_add_window_to_render
...
void FFVII_System_UICreateAddTextureSettings( u32 draw_allow, u32 dithering, u16 settings, const PSX_RECT& w_rect ); // system_menu_create_and_add_texture_setting_packet
void FFVII_System_UIDialogAddToRender(); // system_menu_add_dialog_to_render

int FFVII_System_GetCharacterName( u8 character_id ); // system_get_character_name_offset
