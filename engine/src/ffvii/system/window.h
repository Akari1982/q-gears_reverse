...
void FFVII_System_UIWindowAddToRender();    // system_menu_add_window_to_render
...
void FFVII_System_UICreateAddTextureSettings( const u32 draw_allow, const u32 dithering, const u16 settings, const struct FFVII_Rect w_rect ); // system_menu_create_and_add_texture_setting_packet
void FFVII_System_UICreateAddTextureSettings_(); // system_menu_create_and_add_texture_setting_packet
