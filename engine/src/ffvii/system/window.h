...
void FFVII_System_UICreateAddTextureSettings( const u32 draw_allow, const u32 dithering, const u16 settings, struct PSX_RECT w_rect ); // system_menu_create_and_add_texture_setting_packet
