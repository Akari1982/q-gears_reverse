...
void
PSX_SetTransMatrix( PSX_MATRIX* m )
{
...
void
System_GTERotateAndTranslateVector( PSX_SVECTOR* v0, PSX_VECTOR* v1, long* flag )
{
    psxRegs.CP2D.n.v0.x = v->vx;
    psxRegs.CP2D.n.v0.y = v->vy;
    psxRegs.CP2D.n.v0.z = v->vz;
