...
const u16 System_RenderPacketCreateCLUT( const u32 x, const u32 y );                                                 // system_create_clut_for_packet
...
const u32 System_RenderTextureWindowSettings( struct PSX_RECT rect ); // system_gpu_get_texture_window_setting_command
