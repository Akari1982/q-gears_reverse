...
8007AA90	sw     s1, $0044(sp)
8007AA94	addu   s1, a0, zero
8007AA98	sw     s0, $0040(sp)
8007AA9C	addu   s0, a1, zero
8007AAA0	sw     s3, $004c(sp)
8007AAA4	addu   s3, a2, zero
8007AAA8	sw     s2, $0048(sp)
8007AAAC	addu   s2, a3, zero
8007AAB0	addiu  a0, sp, $0010
8007AAB4	sw     ra, $0058(sp)
8007AAB8	sw     s5, $0054(sp)
8007AABC	sw     s4, $0050(sp)
8007AAC0	lh     v0, $0000(s0)
8007AAC4	lh     v1, $0000(s1)
8007AAC8	addiu  s5, sp, $0020
8007AACC	sw     zero, $0014(sp)
8007AAD0	subu   v0, v0, v1
8007AAD4	sw     v0, $0010(sp)
8007AAD8	lh     v0, $0004(s0)
8007AADC	lh     v1, $0004(s1)
8007AAE0	addu   a1, s5, zero
8007AAE4	subu   v0, v0, v1
8007AAE8	sw     v0, $0018(sp)
8007AAEC	lh     v0, $0000(s2)
8007AAF0	lh     v1, $0000(s1)
8007AAF4	addiu  s4, sp, $0030
8007AAF8	sw     zero, $0024(sp)
8007AAFC	subu   v0, v0, v1
8007AB00	sw     v0, $0020(sp)
8007AB04	lh     v0, $0004(s2)
8007AB08	lh     v1, $0004(s1)
8007AB0C	addu   a2, s4, zero
8007AB10	subu   v0, v0, v1
8007AB14	jal    $8004a380
8007AB18	sw     v0, $0028(sp)
8007AB1C	lw     v0, $0034(sp)
8007AB20	nop
8007AB24	bltz   v0, L7ab94 [$8007ab94]
8007AB28	addiu  a0, sp, $0010
8007AB2C	lh     v0, $0000(s3)
8007AB30	lh     v1, $0000(s0)
8007AB34	sw     zero, $0014(sp)
8007AB38	subu   v0, v0, v1
8007AB3C	sw     v0, $0010(sp)
8007AB40	lh     v0, $0004(s3)
8007AB44	lh     v1, $0004(s0)
8007AB48	nop
8007AB4C	subu   v0, v0, v1
8007AB50	sw     v0, $0018(sp)
8007AB54	lh     v0, $0000(s2)
8007AB58	lh     v1, $0000(s0)
8007AB5C	addu   a1, s5, zero
8007AB60	sw     zero, $0024(sp)
8007AB64	subu   v0, v0, v1
8007AB68	sw     v0, $0020(sp)
8007AB6C	lh     v0, $0004(s2)
8007AB70	lh     v1, $0004(s0)
8007AB74	addu   a2, s4, zero
8007AB78	subu   v0, v0, v1
8007AB7C	jal    $8004a380
8007AB80	sw     v0, $0028(sp)
8007AB84	lw     v0, $0034(sp)
8007AB88	nop
8007AB8C	bgez   v0, L7ab9c [$8007ab9c]
8007AB90	addiu  a0, sp, $0010
...
L7ab9c:	; 8007AB9C
8007AB9C	lh     v0, $0000(s1)
8007ABA0	lh     v1, $0000(s3)
8007ABA4	sw     zero, $0014(sp)
8007ABA8	subu   v0, v0, v1
8007ABAC	sw     v0, $0010(sp)
8007ABB0	lh     v0, $0004(s1)
8007ABB4	lh     v1, $0004(s3)
8007ABB8	nop
8007ABBC	subu   v0, v0, v1
8007ABC0	sw     v0, $0018(sp)
8007ABC4	lh     v0, $0000(s2)
8007ABC8	lh     v1, $0000(s3)
8007ABCC	addu   a1, s5, zero
8007ABD0	sw     zero, $0024(sp)
8007ABD4	subu   v0, v0, v1
8007ABD8	sw     v0, $0020(sp)
8007ABDC	lh     v0, $0004(s2)
8007ABE0	lh     v1, $0004(s3)
8007ABE4	addu   a2, s4, zero
8007ABE8	subu   v0, v0, v1
8007ABEC	jal    $8004a380
8007ABF0	sw     v0, $0028(sp)
8007ABF4	lw     v0, $0034(sp)
8007ABF8	nop
8007ABFC	sra    v0, v0, $1f

L7ac00:	; 8007AC00
8007AC00	lw     ra, $0058(sp)
8007AC04	lw     s5, $0054(sp)
8007AC08	lw     s4, $0050(sp)
8007AC0C	lw     s3, $004c(sp)
8007AC10	lw     s2, $0048(sp)
8007AC14	lw     s1, $0044(sp)
8007AC18	lw     s0, $0040(sp)
8007AC1C	addiu  sp, sp, $0060
8007AC20	jr     ra 
8007AC24	nop
////////////////////////////////
