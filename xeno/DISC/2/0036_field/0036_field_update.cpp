...
80074B38	nop
80074B3C	lui    a3, $800b
80074B40	addiu  a3, a3, $ed54 (=-$12ac)
V0 = h[A3 + 0002];
V1 = h[800aed5a];
A0 = h[800aed5e];
A1 = h[800aed66];
...
////////////////////////////////
// func74fa0
80074FA0	addiu  sp, sp, $ffe0 (=-$20)
[SP + 0018] = w(RA);
80074FA8	jal    func73d90 [$80073d90]
80074FAC	nop
80074FB0	jal    call_run_script_8 [$800a15c0]
80074FB4	nop
...
V0 = w[800c3740];
A1 = w[800acfe0];
80074FD4	jal    func7f660 [$8007f660]
A0 = V0 + A0;
80074FDC	jal    $80044448
A0 = 0;
80074FE4	jal    $8004b3f4
A0 = 0;
A0 = SP + 0010;
A1 = 0;
V0 = 0140;
...
V0 = V0 << 08;
A2 = A2 << 08;
80075028	jal    $800447d4
[SP + 0012] = h(V0);
A0 = w[800c3740];
80075038	jal    $80044d14
A0 = A0 + 00b8;
A0 = w[800c3740];
80075048	jal    $80044abc
8007504C	nop
V0 = w[800c3740];
A0 = 80f0;
8007505C	jal    $80044a48
A0 = V0 + A0;
RA = w[SP + 0018];
SP = SP + 0020;
8007506C	jr     ra 
...
S2 = A0;
S3 = A1;
80075098	lui    a1, $8007
8007509C	addiu  a1, a1, $f200 (=-$e00)
V0 = w[A1 + 0000];
V1 = w[A1 + 0004];
A0 = w[A1 + 0008];
[SP + 0010] = w(V0);
...
////////////////////////////////
// func76c50
80076C50	addiu  sp, sp, $ffe8 (=-$18)
[SP + 0010] = w(RA);
A0 = 0008;
80076C5C	jal    $800322bc
A1 = 0;
A0 = 0004;
80076C68	jal    $80028280
A1 = 0;
80076C70	jal    func71578 [$80071578]
80076C74	nop
RA = w[SP + 0010];
SP = SP + 0018;
80076C80	jr     ra 
