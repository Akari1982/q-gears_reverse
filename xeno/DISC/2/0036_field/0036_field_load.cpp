...
[SP + 0040] = w(S6);
[SP + 0038] = w(S4);
8006FA10	jal    $8004702c
[SP + 0030] = w(S2);
A0 = SP + 0010;
S2 = S0;
S4 = S1;
8006FA24	jal    $8004703c
S6 = S3;
8006FA2C	beq    v0, zero, L6fae4 [$8006fae4]
8006FA30	nop
V0 = w[SP + 0018];
8006FA38	nop
8006FA3C	beq    v0, zero, L6faac [$8006faac]
V0 = S0 << 10;
V0 = V0 >> 10;
8006FA48	addiu  v1, zero, $ffff (=-$1)
8006FA4C	beq    v0, v1, L6fa70 [$8006fa70]
V0 = S1 << 10;
V0 = w[SP + 0014];
8006FA58	nop
[V0 + 0000] = h(S5);
...
L6fa70:	; 8006FA70
8006FA70	beq    v0, zero, L6fa88 [$8006fa88]
V0 = S3 << 10;
V0 = w[SP + 0014];
8006FA7C	nop
[V0 + 0004] = h(S4);
...
L6fa88:	; 8006FA88
8006FA88	beq    v0, zero, L6fa9c [$8006fa9c]
8006FA8C	nop
V0 = w[SP + 0014];
8006FA94	nop
[V0 + 0006] = h(S6);
...
A0 = w[SP + 0014];
A1 = w[SP + 0018];
8006FAA4	jal    $8004470c
8006FAA8	nop

L6faac:	; 8006FAAC
V0 = w[SP + 0020];
8006FAB0	nop
8006FAB4	beq    v0, zero, L6fac8 [$8006fac8]
8006FAB8	nop
V0 = w[SP + 001c];
8006FAC0	nop
[V0 + 0000] = h(S7);
...
////////////////////////////////
// func71578
80071578	addiu  sp, sp, $ffe8 (=-$18)
[SP + 0010] = w(RA);
80071580	lui    a0, $8006
A0 = A0 + 1c8c;
