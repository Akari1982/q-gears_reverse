...
0x04dd    op02_JumpToConditional( val1=(s)mem[0x12a], val2=1, condition="val1 == val2", address_if_false=0x4eb )
...
0x0b90    -- 0x1F( ???=0x70 )
0x0b92    -- 0x18()
0x0b97    op02_JumpToConditional( val1=(s)mem[0x102], val2=7, condition="val1 == val2", address_if_false=0xbac )
0x0b9f    -- 0x1A()
0x0ba1    -- 0x19_ActorSetPosition( x=(vf80)0x0000, z=(vf40)0xfb1e, flag=(flag)0xc0 )
0x0ba7    -- 0x5F( ???=0x0 )
0x0ba9    op01_JumpTo( address=0xc9e )
0x0bac    op02_JumpToConditional( val1=(s)mem[0x102], val2=8, condition="val1 == val2", address_if_false=0xbc4 )
0x0bb4    -- 0x1A()
...
0x0bc4    op02_JumpToConditional( val1=(s)mem[0x102], val2=7, condition="val1 > val2", address_if_false=0xbdf )
0x0bcc    op02_JumpToConditional( val1=(s)mem[0x102], val2=11, condition="val1 < val2", address_if_false=0xbdf )
0x0bd4    -- 0x1A()
0x0bd6    -- 0x19_ActorSetPosition( x=(vf80)0x025d, z=(vf40)0x0043, flag=(flag)0xc0 )
0x0bdc    op01_JumpTo( address=0xc9e )
0x0bdf    op02_JumpToConditional( val1=(s)mem[0x102], val2=11, condition="val1 == val2", address_if_false=0xbf7 )
0x0be7    -- 0x1A()
...
0x0bf7    op02_JumpToConditional( val1=(s)mem[0x102], val2=12, condition="val1 == val2", address_if_false=0xc0f )
0x0bff    -- 0x1A()
...
0x0c0f    op02_JumpToConditional( val1=(s)mem[0x102], val2=15, condition="val1 == val2", address_if_false=0xc27 )
0x0c17    -- 0x1A()
...
0x0c27    op02_JumpToConditional( val1=(s)mem[0x102], val2=18, condition="val1 < val2", address_if_false=0xc3f )
0x0c2f    -- 0x1A()
...
Actor_0x0e:on_talk:
0x0cd4    op02_JumpToConditional( val1=(s)mem[0x102], val2=8, condition="val1 == val2", address_if_false=0xcf7 )
...
0x0cf7    op02_JumpToConditional( val1=(s)mem[0x102], val2=9, condition="val1 == val2", address_if_false=0xd0f )
0x0cff    op26_Wait( time=10 )
0x0d02    -- 0x5F( ???=0x3 )
0x0d04    op26_Wait( time=10 )
0x0d07    -- 0x98_MapLoad( field_id=99, value=0 )
0x0d0c    op01_JumpTo( address=0xd58 )
0x0d0f    op02_JumpToConditional( val1=(s)mem[0x102], val2=12, condition="val1 == val2", address_if_false=0xd3a )
...
0x0d3a    op02_JumpToConditional( val1=(s)mem[0x102], val2=18, condition="val1 < val2", address_if_false=0xd58 )
...
0x0def    -- 0x1F( ???=0x30 )
0x0df1    op02_JumpToConditional( val1=(s)mem[0x102], val2=18, condition="val1 < val2", address_if_false=0xdfe )
0x0df9    -- 0x18()
0x0dfe    op00_Return()
...
Actor_0x17:on_talk:
0x0ff2    op02_JumpToConditional( val1=(s)mem[0x102], val2=18, condition="val1 < val2", address_if_false=0x1001 )
...
0x11e3    op02_JumpToConditional( val1=(s)mem[0x102], val2=0, condition="val1 == val2", address_if_false=0x11f0 )
0x11eb    opD2_MessageShowDynamic( text_id=0x51, flags=0 )
0x11ef    op9C_MessageSync()
0x11f0    op02_JumpToConditional( val1=(s)mem[0x102], val2=0, condition="val1 > val2", address_if_false=0x11fd )
...
function:
0x13e2    op02_JumpToConditional( val1=(s)mem[0x102], val2=8, condition="val1 >= val2", address_if_false=0x13fc )
0x13ea    op02_JumpToConditional( val1=(s)mem[0x102], val2=18, condition="val1 <= val2", address_if_false=0x13fc )
0x13f2    -- 0x75( ???=10 )
...
0x1400    op02_JumpToConditional( val1=(s)mem[0x102], val2=0, condition="val1 > val2", address_if_false=0x1424 )
...
0x1424    op02_JumpToConditional( val1=(s)mem[0x102], val2=0, condition="val1 > val2", address_if_false=0x1430 )
0x142c    op24_ActorEnable( actor_id=Actor_0x21 )
0x142e    -- 0x28()
0x1430    op02_JumpToConditional( val1=(s)mem[0x102], val2=19, condition="val1 < val2", address_if_false=0x143c )
0x1438    op25_ActorDisable( actor_id=Actor_0x21 )
0x143a    -- 0x27( actor_id=Actor_0x21 )
0x143c    op02_JumpToConditional( val1=(s)mem[0x102], val2=35, condition="val1 > val2", address_if_false=0x1448 )
0x1444    op25_ActorDisable( actor_id=Actor_0x21 )
0x1446    -- 0x27( actor_id=Actor_0x21 )
0x1448    op02_JumpToConditional( val1=(s)mem[0x102], val2=0, condition="val1 == val2", address_if_false=0x1454 )
0x1450    op25_ActorDisable( actor_id=Actor_0x0e )
0x1452    -- 0x27( actor_id=Actor_0x0e )
0x1454    op02_JumpToConditional( val1=(s)mem[0x102], val2=9, condition="val1 >= val2", address_if_false=0x1468 )
0x145c    op02_JumpToConditional( val1=(s)mem[0x102], val2=10, condition="val1 <= val2", address_if_false=0x1468 )
0x1464    op25_ActorDisable( actor_id=Actor_0x0e )
0x1466    -- 0x27( actor_id=Actor_0x0e )
0x1468    op02_JumpToConditional( val1=(s)mem[0x102], val2=16, condition="val1 >= val2", address_if_false=0x1474 )
0x1470    op25_ActorDisable( actor_id=Actor_0x0e )
0x1472    -- 0x27( actor_id=Actor_0x0e )
0x1474    op02_JumpToConditional( val1=(s)mem[0x102], val2=0, condition="val1 == val2", address_if_false=0x14a8 )
...
0x14a8    op02_JumpToConditional( val1=(s)mem[0x102], val2=18, condition="val1 > val2", address_if_false=0x14dc )
...
0x14dc    op02_JumpToConditional( val1=(s)mem[0x102], val2=0, condition="val1 >= val2", address_if_false=0x14f4 )
0x14e4    op02_JumpToConditional( val1=(s)mem[0x102], val2=19, condition="val1 < val2", address_if_false=0x14f4 )
...
0x14f4    op02_JumpToConditional( val1=(s)mem[0x102], val2=36, condition="val1 >= val2", address_if_false=0x1504 )
...
0x150b    opB3_FadeIn()
0x150e    op00_Return()
0x150f    -- 0xE0( actor_id=Actor_0x06, ???=(vf80)0x0016, ???=(vf40)0x3d28, flag=0x81 )
