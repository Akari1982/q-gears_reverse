...
0x04b2    -- 0xFE5E()
0x04b6    op26_Wait( time=5 )
0x04b9    -- 0xFEC3()
0x04bb    op00_Return()

Actor_0x0b:on_start:
0x04bc    -- 0x0B_InitNPC( 5 )
0x04bf    -- 0x2A()
0x04c0    op20_ActorSetFlags0( flags=13 )
0x04c3    -- 0x1F( ???=0x10 )
0x04c5    -- 0xFE09( ???=1 )
0x04c9    -- 0x21( ???=512 )
0x04cc    op00_Return()
...
0x04ea    -- 0xFE5E()
0x04ee    op26_Wait( time=5 )
0x04f1    -- 0xFE5E()
0x04f5    op26_Wait( time=5 )
0x04f8    -- 0xFE5E()
...
0x0e75    opFE42( ???=2 )
0x0e79    op0D_Return()
0x0e7a    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x6f97, ???=(vf40)0xc4de, flag=0x0 )
