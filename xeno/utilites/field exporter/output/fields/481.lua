...
0x0023    -- 0xA0()
0x002a    -- 0xA1()
0x002d    op02_JumpToConditional( val1=mem[0x102], val2=50, condition="val1 == val2", address_if_false=0x3b )
...
0x0875    op02_JumpToConditional( val1=mem[0x102], val2=50, condition="val1 == val2", address_if_false=0x880 )
...
0x09a2    op9C_MessageSync()
0x09a3    -- 0x9A()
0x09a6    mem[0x102] = 51 -- op35
0x09ac    -- 0xFE0A( ???=0x1081 )
0x09b0    -- 0xFE24()
0x09b2    -- 0xFE0B()
0x09b6    op26_Wait( time=10 )
0x09b9    -- 0xFE51()
0x09bb    -- 0xFE54()
0x09bd    op00_Return()
...
Actor_0x21:on_push:
0x09be    op00_Return()
0x09bf    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0000, ???=(vf40)0x6b00, flag=0xb6 )
