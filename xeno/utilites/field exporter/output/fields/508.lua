...
0x0034    op02_JumpToConditional( val1=mem[0x162], val2=8192, condition="val1 & val2", address_if_false=0x3f )
...
0x01e5    op00_Return()
0x01e6    op00_Return()
0x01e7    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0940, ???=(vf40)0xeafb, flag=0x10 )
