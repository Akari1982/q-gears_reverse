...
0x00cf    op02_JumpToConditional( val1=mem[0x2c4], val2=4, condition="val1 & val2", address_if_false=0x102 )
...
0x036b    op02_JumpToConditional( val1=mem[0x2c2], val2=4096, condition="val1 & val2", address_if_false=0x37b )
...
0x0ad5    -- 0xFEC6( char_id=mem[0x2d0] )
0x0ad9    -- 0xFE1A() sync load for 0xFEC6()
0x0adb    -- 0xFEC6( char_id=mem[0x2d2] )
0x0adf    -- 0xFE1A() sync load for 0xFEC6()
0x0ae1    -- 0xBB( ???=0x7 )
0x0ae3    -- 0x5A()
0x0ae4    op0D_Return()
0x0ae5    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0038, ???=(vf40)0x6900, flag=0x10 )
