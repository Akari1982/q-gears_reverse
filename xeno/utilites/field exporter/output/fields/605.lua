...
0x0017    mem[0x406] = 36 -- op35
0x001d    mem[0x408] = 113 -- op35
0x0023    mem[0x40a] = 0 -- op35
0x0029    mem[0x40c] = 3 -- op35
0x002f    mem[0x40e] = 315 -- op35
0x0035    op02_JumpToConditional( val1=(s)mem[0x162], val2=4096, condition="val1 & val2", address_if_false=0x40 )
...
0x00f1    -- 0x19_ActorSetPosition( x=(vf80)0xfd04, z=(vf40)0xfff9, flag=(flag)0xc0 )
0x00f7    -- 0xF8()
0x00fb    -- 0xF8()
0x00ff    -- 0x18()
...
0x0111    -- 0xFE68()
0x0118    -- 0x98_MapLoad( field_id=600, value=3 )
0x011d    -- 0x5B()
0x011e    op00_Return()
...
0x01e5    op00_Return()
0x01e6    op00_Return()
0x01e7    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0xe012, ???=(vf40)0x0000, flag=0x80 )
