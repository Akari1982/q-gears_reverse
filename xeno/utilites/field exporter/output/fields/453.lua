...
0x0c5a    op02_JumpToConditional( val1=(s)mem[0x2cc], val2=16, condition="val1 & val2", address_if_false=0xc65 )
...
0x0d5e    op02_JumpToConditional( val1=(s)mem[0x2cc], val2=32, condition="val1 & val2", address_if_false=0xd69 )
...
0x0e25    op02_JumpToConditional( val1=(s)mem[0x2cc], val2=64, condition="val1 & val2", address_if_false=0xe30 )
...
0x0f0e    op02_JumpToConditional( val1=(s)mem[0x2cc], val2=128, condition="val1 & val2", address_if_false=0xf19 )
...
0x0fd4    op02_JumpToConditional( val1=(s)mem[0x2cc], val2=256, condition="val1 & val2", address_if_false=0xfdf )
...
0x10ab    -- 0xFEC6( char_id=(s)mem[0x2d0] )
0x10af    -- 0xFE1A() sync load for 0xFEC6()
0x10b1    -- 0xFEC6( char_id=(s)mem[0x2d2] )
...
0x11cc    -- 0xFE54()
0x11ce    -- 0x23()
0x11cf    op02_JumpToConditional( val1=(s)mem[0x2ca], val2=64, condition="val1 & val2", address_if_false=0x11e2 )
...
0x1b40    -- 0xFEC6( char_id=(s)mem[0x2d0] )
0x1b44    -- 0xFE1A() sync load for 0xFEC6()
0x1b46    -- 0xFEC6( char_id=(s)mem[0x2d2] )
