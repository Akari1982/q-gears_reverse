...
0x074f    op02_JumpToConditional( val1=mem[0x18c], val2=64, condition="val1 & val2", address_if_false=0x762 )
...
0x09c1    op02_JumpToConditional( val1=mem[0x18c], val2=16, condition="val1 & val2", address_if_false=0xa0e )
...
0x13c6    op00_Return()
0x13c7    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0000, ???=(vf40)0x0059, flag=0x0 )
