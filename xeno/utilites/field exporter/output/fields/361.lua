...
0x023e    -- 0xFE8D()
0x0242    -- 0x12()
0x024b    op01_JumpTo( address=0x251 )
0x024e    op09_CallActorEventEndSync( actor_id=Actor_0x0c, event=event_0x05, priority=0x01 )
0x0251    op00_Return()
...
0x0254    -- 0x19_ActorSetPosition( x=(vf80)0x00ea, z=(vf40)0x0000, flag=(flag)0xc0 )
0x025a    -- 0xF8()
0x025e    -- 0xF8()
0x0262    -- 0x18()
0x0267    op20_ActorSetFlags0( flags=1 )
0x026a    op00_Return()
...
Actor_0x10:on_talk:
0x026c    op74_SoundPlayFixedVolume( sound_id=8 )
0x026f    -- 0x86_ProgressNotEqualJumpTo( value=166, jump=0x280 )
0x0274    -- 0x12()
0x027d    op01_JumpTo( address=0x28a )
0x0280    -- 0x56( ???=(vf80)0x0400, ???=(vf40)0x0011, ???=(vf20)0xffff, ???=(vf10)0x0001, flag=0xf0 )
0x028a    op00_Return()
...
Actor_0x15:on_push:
0x02a4    op00_Return()
0x02a5    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0038, ???=(vf40)0x092f, flag=0x50 )
