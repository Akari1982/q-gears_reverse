...
0x010b    -- 0xCB_TriggerJumpTo( trigger_id=mem[0x1400], jump=0x9801 )
0x0110    -- 0x0C()
0x0111    -- 0x80()
...
0x03c1    op0D_Return()
0x03c2    -- 0xFE69( actor_id=Actor_0x30, render_settings=(s)mem[0x3e04], rot_x=(s)mem[0x3500], rot_y=(s)mem[0x432] )
0x03cb    op01_JumpTo( address=0x4000 )
...
0x0641    -- 0x5A()
0x0642    op0D_Return()
0x0643    -- 0xE0( actor_id=Actor_0x87, ???=(vf80)0x51e0, ???=(vf40)0x3d85, flag=0x59 )
