...
0x011f    op02_JumpToConditional( val1=mem[0x2c4], val2=2, condition="val1 & val2", address_if_false=0x12a )
...
0x0633    -- 0xFEC6( char_id=mem[0x2d0] )
0x0637    -- 0xFE1A() sync load for 0xFEC6()
0x0639    -- 0xFEC6( char_id=mem[0x2d2] )
0x063d    -- 0xFE1A() sync load for 0xFEC6()
0x063f    -- 0xBB( ???=0x7 )
0x0641    -- 0x5A()
0x0642    op0D_Return()
0x0643    -- 0xE0( actor_id=Actor_0x36, ???=(vf80)0x1d40, ???=(vf40)0x31bb, flag=0xd4 )
