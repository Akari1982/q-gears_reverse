...
0x006a    op02_JumpToConditional( val1=mem[0x186], val2=-32768, condition="val1 & val2", address_if_false=0x78 )
...
Actor_0x0a:on_talk:
0x4492    -- 0xFE54()
0x4494    op02_JumpToConditional( val1=mem[0x186], val2=32, condition="val1 & val2", address_if_false=0x449f )
