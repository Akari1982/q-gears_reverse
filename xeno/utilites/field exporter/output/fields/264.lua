...
0x431a    opC6_ExpandRun() -- exp0x20
0x431b    -- 0xFEC1()
0x4323    op01_JumpTo( address=0x99 )
0x4326    op00_Return()
...
0x4336    -- 0xFEC1()
0x433e    op01_JumpTo( address=0x99 )
0x4341    op00_Return()
...
Actor_0x04:on_start:
0x4344    -- 0x16_ActorPCInit( char_id=0 )
0x4347    opFE0D_MessageSetFace( char_id=0 )
0x434b    -- 0xFE03( ???=5734 )
0x434f    -- 0xFE04()
0x4353    -- 0x18()
0x4358    op00_Return()
...
0x435c    -- 0x1F( ???=0x10 )
0x435e    -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call )
0x4364    -- 0x98_MapLoad( field_id=16645, value=0 )
0x4369    op00_Return()

Actor_0x04:event_0x05:
0x436a    -- 0x1F( ???=0x10 )
0x436c    -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call )
0x4372    -- 0x98_MapLoad( field_id=16644, value=1 )
0x4377    op00_Return()
...
0x4390    -- 0x1F( ???=0x10 )
0x4392    -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call )
0x4398    -- 0x98_MapLoad( field_id=16645, value=0 )
0x439d    op00_Return()

Actor_0x05:event_0x05:
0x439e    -- 0x1F( ???=0x10 )
0x43a0    -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call )
0x43a6    -- 0x98_MapLoad( field_id=16644, value=1 )
0x43ab    op00_Return()

Actor_0x06:on_start:
0x43ac    -- 0x16_ActorPCInit( char_id=2 )
0x43af    opFE0D_MessageSetFace( char_id=2 )
0x43b3    -- 0x18()
0x43b8    -- 0xFE03( ???=5734 )
0x43bc    -- 0xFE04()
0x43c0    op00_Return()
...
0x43c4    -- 0x1F( ???=0x10 )
0x43c6    -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call )
0x43cc    -- 0x98_MapLoad( field_id=16645, value=0 )
0x43d1    op00_Return()

Actor_0x06:event_0x05:
0x43d2    -- 0x1F( ???=0x10 )
0x43d4    -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call )
0x43da    -- 0x98_MapLoad( field_id=16644, value=1 )
0x43df    op00_Return()

Actor_0x07:on_start:
0x43e0    -- 0x16_ActorPCInit( char_id=3 )
0x43e3    opFE0D_MessageSetFace( char_id=3 )
0x43e7    -- 0x18()
0x43ec    -- 0xFE03( ???=5734 )
0x43f0    -- 0xFE04()
0x43f4    op00_Return()
...
0x43f8    -- 0x1F( ???=0x10 )
0x43fa    -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call )
0x4400    -- 0x98_MapLoad( field_id=16645, value=0 )
0x4405    op00_Return()

Actor_0x07:event_0x05:
0x4406    -- 0x1F( ???=0x10 )
0x4408    -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call )
0x440e    -- 0x98_MapLoad( field_id=16644, value=1 )
0x4413    op00_Return()

Actor_0x08:on_start:
0x4414    -- 0x16_ActorPCInit( char_id=4 )
0x4417    opFE0D_MessageSetFace( char_id=4 )
0x441b    -- 0x18()
0x4420    -- 0xFE03( ???=5734 )
0x4424    -- 0xFE04()
0x4428    op00_Return()
...
0x442c    -- 0x1F( ???=0x10 )
0x442e    -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call )
0x4434    -- 0x98_MapLoad( field_id=16645, value=0 )
0x4439    op00_Return()

Actor_0x08:event_0x05:
0x443a    -- 0x1F( ???=0x10 )
0x443c    -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call )
0x4442    -- 0x98_MapLoad( field_id=16644, value=1 )
0x4447    op00_Return()

Actor_0x09:on_start:
0x4448    -- 0x16_ActorPCInit( char_id=5 )
0x444b    opFE0D_MessageSetFace( char_id=5 )
0x444f    -- 0x18()
0x4454    -- 0xFE03( ???=5734 )
0x4458    -- 0xFE04()
0x445c    op00_Return()
...
0x4460    -- 0x1F( ???=0x10 )
0x4462    -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call )
0x4468    -- 0x98_MapLoad( field_id=16645, value=0 )
0x446d    op00_Return()

Actor_0x09:event_0x05:
0x446e    -- 0x1F( ???=0x10 )
0x4470    -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call )
0x4476    -- 0x98_MapLoad( field_id=16644, value=1 )
0x447b    op00_Return()
...
0x4481    -- 0xF8()
0x4485    -- 0x18()
0x448a    -- 0x19_ActorSetPosition( x=(vf80)0xf7d9, z=(vf40)0x06a4, flag=(flag)0xc0 )
0x4490    op00_Return()
...
Actor_0x0a:on_talk:
0x4492    -- 0xFE54()
0x4494    op02_JumpToConditional( val1=(s)mem[0x186], val2=32, condition="val1 & val2", address_if_false=0x449f )
0x449c    op01_JumpTo( address=0x4553 )
0x449f    op99()
0x44a0    -- 0xF0( ???=0x404, ???=0x406, ???=0x408 )
0x44a7    op02_JumpToConditional( val1=(s)mem[0x404], val2=2068, condition="val1 > val2", address_if_false=0x44b5 )
0x44af    mem[0x404] -= 64 -- op39
0x44b5    op02_JumpToConditional( val1=(s)mem[0x404], val2=2028, condition="val1 < val2", address_if_false=0x44c3 )
0x44bd    mem[0x404] += 64 -- op38
0x44c3    op02_JumpToConditional( val1=(s)mem[0x408], val2=512, condition="val1 > val2", address_if_false=0x44d1 )
0x44cb    mem[0x408] -= 8 -- op39
0x44d1    op02_JumpToConditional( val1=(s)mem[0x406], val2=8, condition="val1 > val2", address_if_false=0x44df )
0x44d9    mem[0x406] -= 1 -- op39
0x44df    op02_JumpToConditional( val1=(s)mem[0x410], val2=20, condition="val1 < val2", address_if_false=0x44ed )
0x44e7    mem[0x410] -= 2 -- op39
0x44ed    -- 0xEB()
0x4501    -- 0x64() -- exp0x1
0x4502    -- 0x60()
0x4503    -- 0xA3()
0x450b    -- 0x63( ???=-2087, ???=1702, ???=(s)mem[0x410] ) -- exp0x1
0x4513    opAC_MoveCamera( control=0x0, steps=1 )
0x4517    opAC_MoveCamera( control=0x1, steps=1 )
0x451b    opEF_MoveCameraSync()
0x451e    op02_JumpToConditional( val1=(s)mem[0x404], val2=2068, condition="val1 > val2", address_if_false=0x4529 )
0x4526    op01_JumpTo( address=0x44a7 )
0x4529    op02_JumpToConditional( val1=(s)mem[0x404], val2=2028, condition="val1 < val2", address_if_false=0x4534 )
0x4531    op01_JumpTo( address=0x44a7 )
0x4534    op02_JumpToConditional( val1=(s)mem[0x408], val2=512, condition="val1 > val2", address_if_false=0x453f )
0x453c    op01_JumpTo( address=0x44a7 )
0x453f    op02_JumpToConditional( val1=(s)mem[0x406], val2=8, condition="val1 > val2", address_if_false=0x454a )
0x4547    op01_JumpTo( address=0x44a7 )
0x454a    -- 0xF2()
0x4553    opC6_ExpandRun() -- exp0x20
0x4554    -- 0xFE65()
0x455a    -- 0xFE65()
0x4560    op07_CallActorEvent( actor_id=Actor_0x0d, event=event_0x04, priority=0x01 )
0x4563    op07_CallActorEvent( actor_id=Actor_0x0e, event=event_0x04, priority=0x01 )
0x4566    op09_CallActorEventEndSync( actor_id=Actor_0x0f, event=event_0x04, priority=0x01 )
0x4569    op09_CallActorEventEndSync( actor_id=party1, event=event_0x04, priority=0x01 )
0x456c    -- 0x5B()
0x456d    op00_Return()
...
0x4574    -- 0xF8()
0x4578    -- 0x18()
0x457d    -- 0x19_ActorSetPosition( x=(vf80)0xff2c, z=(vf40)0xf42a, flag=(flag)0xc0 )
0x4583    op00_Return()
...
0x4587    -- 0xFE65()
0x458d    -- 0xFE65()
0x4593    op07_CallActorEvent( actor_id=Actor_0x10, event=event_0x04, priority=0x00 )
0x4596    op07_CallActorEvent( actor_id=Actor_0x11, event=event_0x04, priority=0x00 )
0x4599    op09_CallActorEventEndSync( actor_id=Actor_0x12, event=event_0x04, priority=0x00 )
0x459c    op09_CallActorEventEndSync( actor_id=party1, event=event_0x05, priority=0x00 )
0x459f    -- 0x5B()
0x45a0    op00_Return()
...
Actor_0x0d:on_start:
0x45a3    -- 0xBC_ActorNoModelInit()
0x45a4    -- 0x21( ???=1024 )
0x45a7    -- 0x1F( ???=0x10 )
0x45a9    -- 0x19_ActorSetPosition( x=(vf80)0xffb8, z=(vf40)0x0000, flag=(flag)0xc0 )
0x45af    op00_Return()
...
0x45b1    -- 0x19_ActorSetPosition( x=(vf80)0xffb8, z=(vf40)0x0005, flag=(flag)0xc0 )
0x45b7    -- 0x4E()
0x45bd    op00_Return()
...
0x45bf    -- 0x21( ???=1024 )
0x45c2    -- 0x1F( ???=0x10 )
0x45c4    -- 0x19_ActorSetPosition( x=(vf80)0x0090, z=(vf40)0x0000, flag=(flag)0xc0 )
0x45ca    op00_Return()
...
0x45cc    -- 0x19_ActorSetPosition( x=(vf80)0x0090, z=(vf40)0x0005, flag=(flag)0xc0 )
0x45d2    -- 0x4E()
0x45d8    op00_Return()

Actor_0x0f:on_start:
0x45d9    -- 0xBC_ActorNoModelInit()
0x45da    -- 0x21( ???=1024 )
0x45dd    -- 0x1F( ???=0x10 )
0x45df    -- 0x19_ActorSetPosition( x=(vf80)0x0090, z=(vf40)0x0000, flag=(flag)0xc0 )
0x45e5    op00_Return()
...
0x45e7    -- 0x19_ActorSetPosition( x=(vf80)0x0090, z=(vf40)0x0005, flag=(flag)0xc0 )
0x45ed    -- 0x4E()
0x45f3    op00_Return()

Actor_0x10:on_start:
0x45f4    -- 0xBC_ActorNoModelInit()
0x45f5    -- 0x21( ???=1024 )
0x45f8    -- 0x1F( ???=0x10 )
0x45fa    -- 0x19_ActorSetPosition( x=(vf80)0xffb8, z=(vf40)0x0000, flag=(flag)0xc0 )
0x4600    op00_Return()
...
0x4602    -- 0x19_ActorSetPosition( x=(vf80)0xffb8, z=(vf40)0xfffb, flag=(flag)0xc0 )
0x4608    -- 0x4E()
0x460e    op00_Return()

Actor_0x11:on_start:
0x460f    -- 0xBC_ActorNoModelInit()
0x4610    -- 0x21( ???=1024 )
0x4613    -- 0x1F( ???=0x10 )
0x4615    -- 0x19_ActorSetPosition( x=(vf80)0x0090, z=(vf40)0x0000, flag=(flag)0xc0 )
0x461b    op00_Return()
...
0x461d    -- 0x19_ActorSetPosition( x=(vf80)0x0090, z=(vf40)0xfffb, flag=(flag)0xc0 )
0x4623    -- 0x4E()
0x4629    op00_Return()

Actor_0x12:on_start:
0x462a    -- 0xBC_ActorNoModelInit()
0x462b    -- 0x21( ???=1024 )
0x462e    -- 0x1F( ???=0x10 )
0x4630    -- 0x19_ActorSetPosition( x=(vf80)0x0090, z=(vf40)0x0000, flag=(flag)0xc0 )
0x4636    op00_Return()
...
0x4638    -- 0x19_ActorSetPosition( x=(vf80)0x0090, z=(vf40)0xfffb, flag=(flag)0xc0 )
0x463e    -- 0x4E()
0x4644    op00_Return()

Actor_0x13:on_start:
0x4645    -- 0x0B_InitNPC( (s)mem[0x412] )
0x4648    op02_JumpToConditional( val1=(s)mem[0x41e], val2=1, condition="val1 == val2", address_if_false=0x4653 )
0x4650    op29_ActorTurnOff( actor_id=self )
0x4652    op00_Return()
0x4653    -- 0x19_ActorSetPosition( x=(vf80)0x0414, z=(vf40)0x0416, flag=(flag)0x00 )
0x4659    op02_JumpToConditional( val1=(s)mem[0x418], val2=0, condition="val1 == val2", address_if_false=0x4666 )
0x4661    -- 0x1A()
0x4663    op01_JumpTo( address=0x4680 )
0x4666    op02_JumpToConditional( val1=(s)mem[0x418], val2=1, condition="val1 == val2", address_if_false=0x4673 )
0x466e    -- 0x1A()
0x4670    op01_JumpTo( address=0x4680 )
0x4673    op02_JumpToConditional( val1=(s)mem[0x418], val2=2, condition="val1 == val2", address_if_false=0x4680 )
0x467b    -- 0x1A()
0x467d    op01_JumpTo( address=0x4680 )
0x4680    op69_ActorSetRotation( rot=(s)mem[0x41a] )
0x4683    op20_ActorSetFlags0( flags=12 )
0x4686    -- 0x18()
0x468b    -- 0x1F( ???=0x70 )
0x468d    op00_Return()
...
0x468f    -- 0xFE54()
0x4691    -- 0x34()
0x4696    mem[0x422] = (s)mem[0x1c] -- op35
0x469c    mem[0x1c] = (s)mem[0x41c] -- op35
0x46a2    op02_JumpToConditional( val1=(s)mem[0x420], val2=99, condition="val1 == val2", address_if_false=0x46b8 )
0x46aa    opD2_MessageShowDynamic( text_id=0x0, flags=CLOSE_OFF_SCREEN )
0x46ae    op9C_MessageSync()
0x46af    mem[0x1c] = (s)mem[0x422] -- op35
0x46b5    -- 0xFE54()
0x46b7    op00_Return()
0x46b8    op09_CallActorEventEndSync( actor_id=Actor_0x00, event=event_0x04, priority=0x01 )
0x46bb    op74_SoundPlayFixedVolume( sound_id=250 )
0x46be    op2C_SpritePlayAnim( anim_id=0x1 )
0x46c0    op26_Wait( time=10 )
0x46c3    op74_SoundPlayFixedVolume( sound_id=55 )
0x46c6    opD0_MessageSettings( x=0, y=0, letters=16, rows=3, flags=0 )
0x46d1    opD2_MessageShowDynamic( text_id=0x1, flags=CLOSE_OFF_SCREEN )
0x46d5    op9C_MessageSync()
0x46d6    mem[0x1c] = (s)mem[0x422] -- op35
0x46dc    -- 0x8C()
0x46df    op2C_SpritePlayAnim( anim_id=0x2 )
0x46e1    op26_Wait( time=5 )
0x46e4    -- 0xFE54()
0x46e6    op29_ActorTurnOff( actor_id=Actor_0x13 )
0x46e8    op00_Return()
...
Actor_0x14:on_start:
0x46eb    -- 0x0B_InitNPC( (s)mem[0x424] )
0x46ee    -- 0x19_ActorSetPosition( x=(vf80)0x0426, z=(vf40)0x0428, flag=(flag)0x00 )
0x46f4    op02_JumpToConditional( val1=(s)mem[0x42a], val2=0, condition="val1 == val2", address_if_false=0x4701 )
0x46fc    -- 0x1A()
0x46fe    op01_JumpTo( address=0x471b )
0x4701    op02_JumpToConditional( val1=(s)mem[0x42a], val2=1, condition="val1 == val2", address_if_false=0x470e )
0x4709    -- 0x1A()
0x470b    op01_JumpTo( address=0x471b )
0x470e    op02_JumpToConditional( val1=(s)mem[0x42a], val2=2, condition="val1 == val2", address_if_false=0x471b )
0x4716    -- 0x1A()
0x4718    op01_JumpTo( address=0x471b )
0x471b    op20_ActorSetFlags0( flags=13 )
0x471e    -- 0xF8()
0x4722    -- 0x18()
0x4727    -- 0x1F( ???=0x70 )
0x4729    op00_Return()
...
Actor_0x14:on_push:
0x4739    -- 0xFE99()
0x473c    op02_JumpToConditional( val1=(s)mem[0x42c], val2=0, condition="val1 == val2", address_if_false=0x474a )
0x4744    op74_SoundPlayFixedVolume( sound_id=80 )
0x4747    mem[0x42c] = true -- op36
0x474a    op00_Return()
0x474b    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0xf400, ???=(vf40)0x0088, flag=0x0 )
