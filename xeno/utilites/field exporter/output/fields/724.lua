...
0x0e0f    -- 0xBA()
0x0e11    op01_JumpTo( address=0xe96 )
0x0e14    op02_JumpToConditional( val1=(s)mem[0x14], val2=1, condition="val1 == val2", address_if_false=0xe21 )
0x0e1c    -- 0xBA()
0x0e1e    op01_JumpTo( address=0xe96 )
0x0e21    op02_JumpToConditional( val1=(s)mem[0x14], val2=2, condition="val1 == val2", address_if_false=0xe2e )
0x0e29    -- 0xBA()
0x0e2b    op01_JumpTo( address=0xe96 )
0x0e2e    op02_JumpToConditional( val1=(s)mem[0x14], val2=3, condition="val1 == val2", address_if_false=0xe3b )
0x0e36    -- 0xBA()
0x0e38    op01_JumpTo( address=0xe96 )
0x0e3b    op02_JumpToConditional( val1=(s)mem[0x14], val2=4, condition="val1 == val2", address_if_false=0xe48 )
0x0e43    -- 0xBA()
0x0e45    op01_JumpTo( address=0xe96 )
0x0e48    op02_JumpToConditional( val1=(s)mem[0x14], val2=5, condition="val1 == val2", address_if_false=0xe55 )
0x0e50    -- 0xBA()
0x0e52    op01_JumpTo( address=0xe96 )
0x0e55    op02_JumpToConditional( val1=(s)mem[0x14], val2=6, condition="val1 == val2", address_if_false=0xe62 )
0x0e5d    -- 0xBA()
0x0e5f    op01_JumpTo( address=0xe96 )
0x0e62    op02_JumpToConditional( val1=(s)mem[0x14], val2=7, condition="val1 == val2", address_if_false=0xe6f )
0x0e6a    -- 0xBA()
0x0e6c    op01_JumpTo( address=0xe96 )
0x0e6f    op02_JumpToConditional( val1=(s)mem[0x14], val2=8, condition="val1 == val2", address_if_false=0xe7c )
0x0e77    -- 0xBA()
0x0e79    op01_JumpTo( address=0xe96 )
0x0e7c    op02_JumpToConditional( val1=(s)mem[0x14], val2=9, condition="val1 == val2", address_if_false=0xe89 )
0x0e84    -- 0xBA()
0x0e86    op01_JumpTo( address=0xe96 )
0x0e89    op02_JumpToConditional( val1=(s)mem[0x14], val2=10, condition="val1 == val2", address_if_false=0xe96 )
0x0e91    -- 0xBA()
0x0e93    op01_JumpTo( address=0xe96 )
0x0e96    op02_JumpToConditional( val1=(s)mem[0x414], val2=0, condition="val1 == val2", address_if_false=0xeb5 )
0x0e9e    op02_JumpToConditional( val1=(s)mem[0x40e], val2=9, condition="val1 == val2", address_if_false=0xeac )
0x0ea6    op01_JumpTo( address=0xf34 )
0x0ea9    op01_JumpTo( address=0xeb2 )
0x0eac    mem[0x40e] += 1 -- op3c
0x0eaf    op01_JumpTo( address=0xcdc )
0x0eb2    op01_JumpTo( address=0xec9 )
0x0eb5    op02_JumpToConditional( val1=(s)mem[0x40e], val2=2, condition="val1 == val2", address_if_false=0xec3 )
0x0ebd    op01_JumpTo( address=0xec9 )
0x0ec0    op01_JumpTo( address=0xec9 )
0x0ec3    mem[0x40e] += 1 -- op3c
0x0ec6    op01_JumpTo( address=0xd46 )
0x0ec9    opD2_MessageShowDynamic( text_id=0x10, flags=0 )
0x0ecd    op9C_MessageSync()
0x0ece    -- 0x91()
0x0ed2    opD2_MessageShowDynamic( text_id=0x11, flags=0 )
0x0ed6    op9C_MessageSync()
0x0ed7    -- 0x91()
0x0edb    opD2_MessageShowDynamic( text_id=0x12, flags=0 )
0x0edf    op9C_MessageSync()
0x0ee0    -- 0x91()
0x0ee4    opD2_MessageShowDynamic( text_id=0x13, flags=0 )
0x0ee8    op9C_MessageSync()
0x0ee9    -- 0x91()
0x0eed    opD2_MessageShowDynamic( text_id=0x14, flags=0 )
0x0ef1    op9C_MessageSync()
0x0ef2    -- 0x91()
0x0ef6    opD2_MessageShowDynamic( text_id=0x15, flags=0 )
0x0efa    op9C_MessageSync()
0x0efb    -- 0x91()
0x0eff    opD2_MessageShowDynamic( text_id=0x16, flags=0 )
0x0f03    op9C_MessageSync()
0x0f04    -- 0x91()
0x0f08    opD2_MessageShowDynamic( text_id=0x17, flags=0 )
0x0f0c    op9C_MessageSync()
0x0f0d    -- 0x91()
0x0f11    opD2_MessageShowDynamic( text_id=0x18, flags=0 )
0x0f15    op9C_MessageSync()
0x0f16    -- 0x91()
0x0f1a    opD2_MessageShowDynamic( text_id=0x19, flags=0 )
0x0f1e    op9C_MessageSync()
0x0f1f    -- 0x91()
0x0f23    opD2_MessageShowDynamic( text_id=0x1a, flags=0 )
0x0f27    op9C_MessageSync()
0x0f28    -- 0x91()
0x0f2c    opD2_MessageShowDynamic( text_id=0x1b, flags=0 )
0x0f30    op9C_MessageSync()
0x0f31    -- 0xFE54()
0x0f33    op00_Return()
0x0f34    opD2_MessageShowDynamic( text_id=0x1c, flags=0 )
0x0f38    op9C_MessageSync()
0x0f39    -- 0xB9()
0x0f3d    opD2_MessageShowDynamic( text_id=0x1d, flags=0 )
0x0f41    op9C_MessageSync()
0x0f42    -- 0xB9()
0x0f46    opD2_MessageShowDynamic( text_id=0x1e, flags=0 )
0x0f4a    op9C_MessageSync()
0x0f4b    -- 0xB9()
0x0f4f    opD2_MessageShowDynamic( text_id=0x1f, flags=0 )
0x0f53    op9C_MessageSync()
0x0f54    -- 0xB9()
0x0f58    opD2_MessageShowDynamic( text_id=0x20, flags=0 )
0x0f5c    op9C_MessageSync()
0x0f5d    -- 0xB9()
0x0f61    opD2_MessageShowDynamic( text_id=0x21, flags=0 )
0x0f65    op9C_MessageSync()
0x0f66    -- 0xB9()
0x0f6a    opD2_MessageShowDynamic( text_id=0x22, flags=0 )
0x0f6e    op9C_MessageSync()
0x0f6f    -- 0xB9()
0x0f73    opD2_MessageShowDynamic( text_id=0x23, flags=0 )
0x0f77    op9C_MessageSync()
0x0f78    -- 0xB9()
0x0f7c    opD2_MessageShowDynamic( text_id=0x24, flags=0 )
0x0f80    op9C_MessageSync()
0x0f81    -- 0xB9()
0x0f85    opD2_MessageShowDynamic( text_id=0x25, flags=0 )
0x0f89    op9C_MessageSync()
0x0f8a    -- 0xB9()
0x0f8e    opD2_MessageShowDynamic( text_id=0x26, flags=0 )
0x0f92    op9C_MessageSync()
0x0f93    -- 0xB9()
0x0f97    opD2_MessageShowDynamic( text_id=0x27, flags=0 )
0x0f9b    op9C_MessageSync()
0x0f9c    -- 0xFE54()
0x0f9e    op00_Return()
...
function:
0x0fb9    opC6_ExpandRun() -- exp0x20
0x0fba    -- 0xFE19( char_id=0x0 )
0x0fbd    -- 0xFE19( char_id=0x1 )
0x0fc0    -- 0xFE19( char_id=0x2 )
0x0fc3    opC6_ExpandRun() -- exp0x20
0x0fc4    -- 0xFE19( char_id=0x3 )
0x0fc7    -- 0xFE19( char_id=0x4 )
0x0fca    -- 0xFE19( char_id=0x5 )
0x0fcd    opC6_ExpandRun() -- exp0x20
0x0fce    -- 0xFE19( char_id=0x6 )
0x0fd1    -- 0xFE19( char_id=0x7 )
0x0fd4    -- 0xFE19( char_id=0x8 )
0x0fd7    opC6_ExpandRun() -- exp0x20
0x0fd8    -- 0xFE19( char_id=0x9 )
0x0fdb    -- 0xFE19( char_id=0xa )
0x0fde    op0D_Return()
0x0fdf    op00_Return()
