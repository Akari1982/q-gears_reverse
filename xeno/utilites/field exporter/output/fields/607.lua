...
0x07ec    op02_JumpToConditional( val1=(s)mem[0x14c], val2=120, condition="val1 == val2", address_if_false=0x7fd )
0x07f4    -- 0x19_ActorSetPosition( x=(vf80)0x028d, z=(vf40)0x02ea, flag=(flag)0xc0 )
0x07fa    op01_JumpTo( address=0x816 )
0x07fd    op02_JumpToConditional( val1=(s)mem[0x14c], val2=130, condition="val1 == val2", address_if_false=0x810 )
...
0x086a    op02_JumpToConditional( val1=(s)mem[0x14c], val2=120, condition="val1 == val2", address_if_false=0x87d )
...
0x0997    op02_JumpToConditional( val1=(s)mem[0x14c], val2=120, condition="val1 == val2", address_if_false=0x9b3 )
0x099f    -- 0x91()
...
0x0a47    -- 0x5F( ???=0x6 )
0x0a49    op02_JumpToConditional( val1=(s)mem[0x14c], val2=120, condition="val1 == val2", address_if_false=0xa53 )
...
0x0aaa    -- 0x5F( ???=0x6 )
0x0aac    op02_JumpToConditional( val1=(s)mem[0x14c], val2=120, condition="val1 == val2", address_if_false=0xab6 )
...
Actor_0x0a:on_start:
0x0e61    op02_JumpToConditional( val1=(s)mem[0x14c], val2=120, condition="val1 == val2", address_if_false=0xe6f )
0x0e69    -- 0x93( ???=47 )
0x0e6c    op01_JumpTo( address=0xe7e )
0x0e6f    op02_JumpToConditional( val1=(s)mem[0x14c], val2=130, condition="val1 == val2", address_if_false=0xe7d )
0x0e77    -- 0x93( ???=47 )
