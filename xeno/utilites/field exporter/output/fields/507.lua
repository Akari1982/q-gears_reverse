...
0x0413    op01_JumpTo( address=0x2880 )
0x0416    -- 0x80()
0x041b    op07_CallActorEvent( actor_id=Actor_0x80, event=event_0x14, priority=0x00 )
0x041e    -- 0x80()
0x0423    op0E_Nop()
0x0424    op00_Return()
0x0425    -- 0x80()
0x042a    mem[0x78b4] = false -- op37
0x042d    -- 0x80()
0x0432    -- 0x4F()
...
0x05a0    op01_JumpTo( address=0x1e80 )
0x05a3    -- 0x80()
0x05a8    op01_JumpTo( address=0x3e )
0x05ab    -- 0xC0( ???=(s)mem[0x55e] )
...
0x0675    op07_CallActorEvent( actor_id=Actor_0x80, event=event_0x1e, priority=0x00 )
0x0678    -- 0x80()
0x067d    opFF_Nop()
0x067e    -- 0xC0( ???=(s)mem[0x62c] )
...
0x0d5a    -- 0x10()
0x0d65    op00_Return()
0x0d66    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0000, ???=(vf40)0x0000, flag=0x0 )
