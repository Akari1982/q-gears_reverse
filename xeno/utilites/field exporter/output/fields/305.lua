...
0x03e0    mem[0x406] -= 142 -- op39
0x03e6    mem[0x408] += 2 -- op38
0x03ec    op0D_Return()
0x03ed    mem[0x6069] ^= -12240 -- op40
0x03f3    -- 0xE0( actor_id=Actor_0x36, ???=(vf80)0x4600, ???=(vf40)0x2df0, flag=0x50 )
0x03fa    -- 0x49()
0x0402    -- 0x44()
0x0407    -- 0xC0( ???=(s)mem[0x701a] )
0x040a    -- 0x60()
0x040b    -- 0xC0( ???=mem[0xc] )
0x040e    -- 0x48()
0x0415    op00_Return()
...
0x0419    -- 0xC0( ???=20493 )
0x041c    -- 0x5F( ???=0xd0 )
0x041e    -- 0x27( actor_id=Actor_0x90 )
0x0420    -- 0x4С( variable arguments based args )
0x0428    mem[0x4b00] ^= (s)mem[0x7750] -- op40
0x042e    -- 0x72()
0x0431    -- 0x30()
0x0434    op08_CallActorEventStartSync( actor_id=Actor_0x80, event=event_0x05, priority=0x01 )
0x0437    -- 0x30()
0x043a    -- 0x0C()
0x043b    op00_Return()
0x043c    op0D_Return()
0x043d    -- 0x10()
0x0448    op29_ActorTurnOff( actor_id=Actor_0xc0 )
0x044a    -- 0x76()
0x044b    -- 0xC0( ???=mem[0x26] )
0x044e    op00_Return()
0x044f    op00_Return()
0x0450    op00_Return()
0x0451    op00_Return()
...
0x0457    op00_Return()
0x0458    op00_Return()
0x0459    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0038, ???=(vf40)0xc400, flag=0x0 )
