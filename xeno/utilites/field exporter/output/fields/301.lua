...
0x037b    op02_JumpToConditional( val1=mem[0x1c8], val2=16, condition="val1 & val2", address_if_false=0x385 )
...
0x03a1    -- 0x91()
0x03a5    op02_JumpToConditional( val1=mem[0x1ca], val2=256, condition="val1 & val2", address_if_false=0x3b0 )
...
0x042c    op02_JumpToConditional( val1=mem[0x1ca], val2=64, condition="val1 & val2", address_if_false=0x437 )
0x0434    op01_JumpTo( address=0x447 )
0x0437    op02_JumpToConditional( val1=mem[0x1ca], val2=32, condition="val1 & val2", address_if_false=0x447 )
...
0x0569    -- 0x85()
0x056e    -- 0x85()
0x0573    op02_JumpToConditional( val1=mem[0x1c8], val2=4, condition="val1 & val2", address_if_false=0x594 )
0x057b    op02_JumpToConditional( val1=mem[0x1c8], val2=16, condition="val1 & val2", address_if_false=0x58b )
...
function:
0x05a6    op02_JumpToConditional( val1=mem[0x1c8], val2=2048, condition="val1 & val2", address_if_false=0x5b1 )
...
0x0633    op00_Return()
0x0634    op02_JumpToConditional( val1=mem[0x1c8], val2=16, condition="val1 & val2", address_if_false=0x645 )
...
0x0651    op02_JumpToConditional( val1=mem[0x1c8], val2=16, condition="val1 & val2", address_if_false=0x65b )
0x0659    -- 0xFE01()
0x065b    op00_Return()
...
0x06a3    -- 0x85()
0x06a8    -- 0x85()
0x06ad    op02_JumpToConditional( val1=mem[0x1c8], val2=2048, condition="val1 & val2", address_if_false=0x6bd )
...
0x07ae    op00_Return()
0x07af    -- 0x85()
0x07b4    op02_JumpToConditional( val1=mem[0x1c8], val2=8192, condition="val1 & val2", address_if_false=0x7cd )
...
0x07e7    op02_JumpToConditional( val1=mem[0x1ca], val2=16, condition="val1 & val2", address_if_false=0x7fa )
...
0x0909    op02_JumpToConditional( val1=mem[0x1ca], val2=64, condition="val1 & val2", address_if_false=0x914 )
0x0911    op01_JumpTo( address=0x935 )
0x0914    op02_JumpToConditional( val1=mem[0x1ca], val2=32, condition="val1 & val2", address_if_false=0x921 )
...
0x0c91    opFE42( ???=2 )
0x0c95    op0D_Return()
0x0c96    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x3d00, ???=(vf40)0x0402, flag=0x3e )
