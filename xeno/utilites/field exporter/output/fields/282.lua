...
0x0064    op02_JumpToConditional( val1=mem[0x14a], val2=0, condition="val1 == val2", address_if_false=0x8c )
0x006c    op99()
0x006d    -- 0x9B( ???=12, ???=12 )
0x0072    -- 0x60()
...
0x0108    op02_JumpToConditional( val1=mem[0x14a], val2=0, condition="val1 == val2", address_if_false=0x143 )
...
0x0600    op02_JumpToConditional( val1=mem[0x14a], val2=0, condition="val1 == val2", address_if_false=0x611 )
0x0608    -- 0x1B()
0x060f    -- 0x5F( ???=0x4 )
...
0x06ce    op02_JumpToConditional( val1=mem[0x14a], val2=0, condition="val1 == val2", address_if_false=0x6df )
0x06d6    -- 0x1B()
0x06dd    -- 0x5F( ???=0x4 )
...
0x081f    op02_JumpToConditional( val1=mem[0x14a], val2=0, condition="val1 == val2", address_if_false=0x833 )
0x0827    -- 0x1B()
0x082e    -- 0x5F( ???=0x0 )
...
0x0a90    op00_Return()
0x0a91    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x6438, ???=(vf40)0x1ab6, flag=0x30 )
