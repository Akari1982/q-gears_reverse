...
0x0397    -- 0x5F( ???=0x0 )
0x0399    op02_JumpToConditional( val1=(s)mem[0x14c], val2=75, condition="val1 == val2", address_if_false=0x3a4 )
...
0x05e8    op00_Return()
0x05e9    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x4538, ???=(vf40)0x0101, flag=0x5f )
