...
Actor_0x02:on_talk:
0x0076    -- 0x70()
0x0078    op02_JumpToConditional( val1=mem[0x2c2], val2=128, condition="val1 & val2", address_if_false=0x88 )
...
0x0101    opCB_TriggerJumpTo( trigger_id=0x0, jump=0x10a )
0x0105    -- 0x98_MapLoad( field_id=7, value=1 )
0x010a    op00_Return()
...
0x0634    -- 0xFEC6( char_id=mem[0x2d0] )
0x0638    -- 0xFE1A() sync load for 0xFEC6()
0x063a    -- 0xFEC6( char_id=mem[0x2d2] )
