...
0x0032    op01_JumpTo( address=0x3c80 )
0x0035    -- 0x80()
0x003a    -- 0x8E()
0x0041    op00_Return()
0x0042    -- 0xD9()
...
0x0636    op01_JumpTo( address=0x3c80 )
0x0639    -- 0x80()
0x063e    -- 0x5F( ???=0xfe )
0x0640    mem[0x5f00] <<= 16382 -- op41
0x0645    opFF_Nop()
0x0646    -- 0x5F( ???=0xfe )
0x0648    opFC_MessageShowFromActorCopyFace( actor_id=Actor_0x04, text_id=0x480, flags=0x80 )
0x064e    -- 0x80()
