...
0x0197    op02_JumpToConditional( val1=(s)mem[0x102], val2=18, condition="val1 > val2", address_if_false=0x1a5 )
0x019f    -- 0x19_ActorSetPosition( x=(vf80)0xffc8, z=(vf40)0xfdac, flag=(flag)0xc0 )
0x01a5    op00_Return()

Actor_0x0d:on_update:
0x01a6    op02_JumpToConditional( val1=(s)mem[0x102], val2=18, condition="val1 > val2", address_if_false=0x1b3 )
0x01ae    -- 0x5F( ???=0x5 )
...
Actor_0x0d:on_talk:
0x01b7    op02_JumpToConditional( val1=(s)mem[0x102], val2=15, condition="val1 == val2", address_if_false=0x1c6 )
0x01bf    op6F_ActorRotateToActor( actor_id=party1 )
0x01c1    opD2_MessageShowDynamic( text_id=0x1, flags=0 )
0x01c5    op9C_MessageSync()
0x01c6    op02_JumpToConditional( val1=(s)mem[0x102], val2=19, condition="val1 >= val2", address_if_false=0x1d5 )
...
0x022c    op02_JumpToConditional( val1=(s)mem[0x102], val2=66, condition="val1 >= val2", address_if_false=0x242 )
0x0234    -- 0x15()
...
0x0242    op02_JumpToConditional( val1=(s)mem[0x102], val2=35, condition="val1 == val2", address_if_false=0x258 )
...
0x0289    -- 0x14()
0x028a    op00_Return()
0x028b    op02_JumpToConditional( val1=(s)mem[0x102], val2=66, condition="val1 >= val2", address_if_false=0x2a1 )
0x0293    -- 0x15()
...
0x02a1    op02_JumpToConditional( val1=(s)mem[0x102], val2=35, condition="val1 == val2", address_if_false=0x2b7 )
0x02a9    -- 0x15()
...
0x0333    -- 0x14()
0x0334    op00_Return()
0x0335    op02_JumpToConditional( val1=(s)mem[0x102], val2=66, condition="val1 >= val2", address_if_false=0x34c )
0x033d    -- 0x15()
...
0x034c    op02_JumpToConditional( val1=(s)mem[0x102], val2=35, condition="val1 == val2", address_if_false=0x362 )
0x0354    -- 0x15()
...
0x0397    -- 0x14()
0x0398    op00_Return()
0x0399    op02_JumpToConditional( val1=(s)mem[0x102], val2=33, condition="val1 <= val2", address_if_false=0x3eb )
...
0x03e9    -- 0x14()
0x03ea    op00_Return()
0x03eb    op02_JumpToConditional( val1=(s)mem[0x102], val2=34, condition="val1 >= val2", address_if_false=0x409 )
0x03f3    op02_JumpToConditional( val1=(s)mem[0x102], val2=35, condition="val1 <= val2", address_if_false=0x409 )
0x03fb    -- 0x15()
...
0x0407    -- 0x14()
0x0408    op00_Return()
0x0409    op02_JumpToConditional( val1=(s)mem[0x102], val2=45, condition="val1 >= val2", address_if_false=0x425 )
0x0411    op02_JumpToConditional( val1=(s)mem[0x102], val2=66, condition="val1 < val2", address_if_false=0x425 )
0x0419    -- 0x15()
...
0x0423    -- 0x14()
0x0424    op00_Return()
0x0425    op02_JumpToConditional( val1=(s)mem[0x102], val2=66, condition="val1 >= val2", address_if_false=0x439 )
0x042d    -- 0x15()
...
0x0453    -- 0x14()
0x0454    op00_Return()
0x0455    op02_JumpToConditional( val1=(s)mem[0x102], val2=18, condition="val1 > val2", address_if_false=0x468 )
0x045d    op02_JumpToConditional( val1=(s)mem[0x102], val2=28, condition="val1 < val2", address_if_false=0x468 )
0x0465    op09_CallActorEventEndSync( actor_id=Actor_0x13, event=event_0x04, priority=0x03 )
0x0468    op02_JumpToConditional( val1=(s)mem[0x102], val2=28, condition="val1 > val2", address_if_false=0x47b )
0x0470    op02_JumpToConditional( val1=(s)mem[0x102], val2=35, condition="val1 < val2", address_if_false=0x47b )
0x0478    op09_CallActorEventEndSync( actor_id=Actor_0x13, event=event_0x05, priority=0x03 )
0x047b    op02_JumpToConditional( val1=(s)mem[0x102], val2=35, condition="val1 == val2", address_if_false=0x486 )
0x0483    op09_CallActorEventEndSync( actor_id=Actor_0x13, event=event_0x06, priority=0x03 )
0x0486    op02_JumpToConditional( val1=(s)mem[0x102], val2=45, condition="val1 >= val2", address_if_false=0x499 )
0x048e    op02_JumpToConditional( val1=(s)mem[0x102], val2=54, condition="val1 <= val2", address_if_false=0x499 )
0x0496    op09_CallActorEventEndSync( actor_id=Actor_0x13, event=event_0x07, priority=0x03 )
0x0499    op02_JumpToConditional( val1=(s)mem[0x102], val2=66, condition="val1 >= val2", address_if_false=0x4a4 )
...
0x04c2    -- 0x14()
0x04c3    op02_JumpToConditional( val1=(s)mem[0x102], val2=18, condition="val1 > val2", address_if_false=0x4d6 )
0x04cb    op02_JumpToConditional( val1=(s)mem[0x102], val2=28, condition="val1 < val2", address_if_false=0x4d6 )
0x04d3    op01_JumpTo( address=0x513 )
0x04d6    op02_JumpToConditional( val1=(s)mem[0x102], val2=28, condition="val1 > val2", address_if_false=0x4e9 )
0x04de    op02_JumpToConditional( val1=(s)mem[0x102], val2=35, condition="val1 < val2", address_if_false=0x4e9 )
0x04e6    op01_JumpTo( address=0x598 )
0x04e9    op02_JumpToConditional( val1=(s)mem[0x102], val2=35, condition="val1 == val2", address_if_false=0x4f4 )
0x04f1    op01_JumpTo( address=0x790 )
0x04f4    op02_JumpToConditional( val1=(s)mem[0x102], val2=45, condition="val1 >= val2", address_if_false=0x507 )
0x04fc    op02_JumpToConditional( val1=(s)mem[0x102], val2=54, condition="val1 <= val2", address_if_false=0x507 )
0x0504    op01_JumpTo( address=0x7b7 )
0x0507    op02_JumpToConditional( val1=(s)mem[0x102], val2=66, condition="val1 >= val2", address_if_false=0x512 )
...
0x059a    op02_JumpToConditional( val1=(s)mem[0x102], val2=28, condition="val1 >= val2", address_if_false=0x5a5 )
...
0x06d7    op02_JumpToConditional( val1=(s)mem[0x102], val2=28, condition="val1 >= val2", address_if_false=0x6e2 )
...
0x080a    op02_JumpToConditional( val1=(s)mem[0x102], val2=7, condition="val1 >= val2", address_if_false=0x820 )
0x0812    op02_JumpToConditional( val1=(s)mem[0x102], val2=18, condition="val1 <= val2", address_if_false=0x820 )
...
0x0824    op02_JumpToConditional( val1=(s)mem[0x102], val2=19, condition="val1 < val2", address_if_false=0x840 )
...
0x0840    op02_JumpToConditional( val1=(s)mem[0x102], val2=28, condition="val1 >= val2", address_if_false=0x84c )
0x0848    op25_ActorDisable( actor_id=Actor_0x0d )
0x084a    -- 0x27( actor_id=Actor_0x0d )
0x084c    op02_JumpToConditional( val1=(s)mem[0x102], val2=65, condition="val1 == val2", address_if_false=0x858 )
0x0854    op25_ActorDisable( actor_id=Actor_0x13 )
0x0856    -- 0x27( actor_id=Actor_0x13 )
0x0858    op02_JumpToConditional( val1=(s)mem[0x102], val2=45, condition="val1 >= val2", address_if_false=0x874 )
0x0860    op02_JumpToConditional( val1=(s)mem[0x102], val2=66, condition="val1 < val2", address_if_false=0x874 )
...
Actor_0x16:on_push:
0x0875    op00_Return()
0x0876    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x4c00, ???=(vf40)0x0000, flag=0xf0 )
