...
0x015c    -- 0xFE68()
0x0163    op02_JumpToConditional( val1=(s)mem[0x154], val2=0, condition="val1 == val2", address_if_false=0x173 )
...
0x0240    op00_Return()
0x0241    op00_Return()
0x0242    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x6fda, ???=(vf40)0x89de, flag=0xc1 )
