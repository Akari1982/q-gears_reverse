...
0x0013    -- 0xF7()
0x0018    -- 0xFEB8()
0x001d    op02_JumpToConditional( val1=(s)mem[0x220], val2=64, condition="val1 & val2", address_if_false=0x2b )
...
0x02fd    op0D_Return()
0x02fe    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0a00, ???=(vf40)0x1b5a, flag=0xde )
