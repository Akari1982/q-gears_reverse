...
0x047d    -- 0x7E()
0x0481    -- 0xC4()
0x0483    opFC_MessageShowFromActorCopyFace( actor_id=Actor_0x05, text_id=0x580, flags=0x80 )
0x0489    -- 0x80()
0x048e    -- 0x10()
0x0499    op00_Return()
0x049a    -- 0x80()
0x049f    op03_MessageShowFixed2( text_id=0xfc9c, flags=CLOSE_OFF_SCREEN )
0x04a3    -- 0x2E()
