...
0x0365    op0D_Return()
0x0366    -- 0xFE69( actor_id=Actor_0x30, render_settings=(s)mem[0x3e04], rot_x=(s)mem[0x3500], rot_y=(s)mem[0x432] )
0x036f    op01_JumpTo( address=0x4000 )
...
0x05d7    -- 0xFEC6( char_id=(s)mem[0x2d0] )
0x05db    -- 0xFE1A() sync load for 0xFEC6()
0x05dd    -- 0xFEC6( char_id=(s)mem[0x2d2] )
0x05e1    -- 0xFE1A() sync load for 0xFEC6()
0x05e3    -- 0xBB( ???=0x7 )
0x05e5    -- 0x5A()
0x05e6    op0D_Return()
0x05e7    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0000, ???=(vf40)0x0000, flag=0x0 )
