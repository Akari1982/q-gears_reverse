...
0x0009    -- 0xF7()
0x000e    -- 0xFEB8()
0x0013    op02_JumpToConditional( val1=mem[0x222], val2=256, condition="val1 & val2", address_if_false=0x21 )
...
0x02c6    op0D_Return()
0x02c7    -- 0xE0( actor_id=Actor_0x10, ???=(vf80)0x0001, ???=(vf40)0x1000, flag=0x8 )
