...
0x0009    -- 0xF7()
0x000e    -- 0xFEB8()
0x0013    op02_JumpToConditional( val1=(s)mem[0x222], val2=256, condition="val1 & val2", address_if_false=0x21 )
...
0x009b    -- 0x98_MapLoad( field_id=566, value=4 )
0x00a0    -- 0x5B()
0x00a1    op00_Return()
...
0x02c6    op0D_Return()
0x02c7    -- 0xE0( actor_id=Actor_0xe1, ???=(vf80)0x0001, ???=(vf40)0xc603, flag=0xfe )
