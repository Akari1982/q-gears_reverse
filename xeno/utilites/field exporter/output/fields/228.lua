...
0x0009    op02_JumpToConditional( val1=mem[0x204], val2=256, condition="val1 & val2", address_if_false=0x17 )
0x0011    mem[0x436] = 1 -- op35
0x0017    op02_JumpToConditional( val1=mem[0x204], val2=512, condition="val1 & val2", address_if_false=0x25 )
