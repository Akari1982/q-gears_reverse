...
0x00b4    op02_JumpToConditional( val1=mem[0x182], val2=1, condition="val1 & val2", address_if_false=0xbf )
0x00bc    op01_JumpTo( address=0xe6 )
0x00bf    op02_JumpToConditional( val1=mem[0x182], val2=2, condition="val1 & val2", address_if_false=0xd9 )
0x00c7    -- 0xA0()
...
Actor_0x03:on_start:
0x0130    op02_JumpToConditional( val1=mem[0x182], val2=1, condition="val1 & val2", address_if_false=0x13c )
...
0x0156    op02_JumpToConditional( val1=mem[0x182], val2=2, condition="val1 & val2", address_if_false=0x167 )
...
Actor_0x04:on_start:
0x0488    op02_JumpToConditional( val1=mem[0x182], val2=1, condition="val1 & val2", address_if_false=0x494 )
...
0x04ae    op02_JumpToConditional( val1=mem[0x182], val2=2, condition="val1 & val2", address_if_false=0x4bf )
...
0x0816    op02_JumpToConditional( val1=mem[0x182], val2=1, condition="val1 & val2", address_if_false=0x875 )
0x081e    op02_JumpToConditional( val1=mem[0x182], val2=2, condition="val1 & val2", address_if_false=0x85b )
0x0826    op02_JumpToConditional( val1=mem[0x182], val2=8, condition="val1 & val2", address_if_false=0x84c )
...
0x088a    op02_JumpToConditional( val1=mem[0x182], val2=1, condition="val1 & val2", address_if_false=0x8fa )
0x0892    op02_JumpToConditional( val1=mem[0x182], val2=2, condition="val1 & val2", address_if_false=0x8e0 )
0x089a    op02_JumpToConditional( val1=mem[0x182], val2=8, condition="val1 & val2", address_if_false=0x8c0 )
...
0x0963    op02_JumpToConditional( val1=mem[0x182], val2=1, condition="val1 & val2", address_if_false=0x96e )
0x096b    op01_JumpTo( address=0x9f6 )
0x096e    op02_JumpToConditional( val1=mem[0x182], val2=2, condition="val1 & val2", address_if_false=0x9b5 )
0x0976    -- 0xFE54()
0x0978    -- 0x67()
0x097c    -- 0x67()
...
0x0bfd    -- 0xFE46()
0x0c00    -- 0xFE3C( ???=(s)mem[0x400], ???=11 )
0x0c06    -- 0xFE46()
0x0c09    op00_Return()
0x0c0a    op07_CallActorEvent( actor_id=Actor_0x09, event=event_0x04, priority=0x01 )
0x0c0d    op26_Wait( time=6 )
0x0c10    -- 0x57( type=0x0, x=(vf80)0x0404, z=(vf40)0x0406, y=(vf20)0x0408, ???=(vf10)0x0402, flag=0x0 )
0x0c1b    -- 0x57( type=0x8f )
0x0c1d    op26_Wait( time=1 )
0x0c20    -- 0x57( type=0xf )
0x0c22    op26_Wait( time=8 )
0x0c25    op0D_Return()
...
function:
0x0c26    op07_CallActorEvent( actor_id=Actor_0x09, event=event_0x04, priority=0x01 )
0x0c29    op26_Wait( time=6 )
0x0c2c    -- 0x57( type=0x80, x=(vf80)0x0404, z=(vf40)0x0406, walkmesh_id=(vf20)0x040a, ???=(vf10)0x0402, flag=0x0 )
0x0c37    -- 0x57( type=0x8f )
0x0c39    op26_Wait( time=1 )
0x0c3c    -- 0x57( type=0xf )
0x0c3e    op26_Wait( time=8 )
0x0c41    op0D_Return()

Actor_0x0a:on_start:
0x0c42    -- 0xBC_ActorNoModelInit()
0x0c43    -- 0x2A()
0x0c44    op00_Return()
...
0x0c46    mem[0x41a] = (s)mem[0x410] -- op35
0x0c4c    mem[0x41a] -= 14 -- op39
0x0c52    -- 0xFE3C( ???=(s)mem[0x40e], ???=10 )
0x0c58    op26_Wait( time=(s)mem[0x41a] )
0x0c5b    -- 0xFE46()
0x0c5e    -- 0xFE3C( ???=(s)mem[0x40e], ???=11 )
0x0c64    -- 0xFE46()
0x0c67    op00_Return()
0x0c68    op07_CallActorEvent( actor_id=Actor_0x0a, event=event_0x04, priority=0x01 )
0x0c6b    op26_Wait( time=6 )
0x0c6e    -- 0x57( type=0x0, x=(vf80)0x0412, z=(vf40)0x0414, y=(vf20)0x0416, ???=(vf10)0x0410, flag=0x0 )
0x0c79    -- 0x57( type=0x8f )
0x0c7b    op26_Wait( time=1 )
0x0c7e    -- 0x57( type=0xf )
0x0c80    op26_Wait( time=8 )
0x0c83    op0D_Return()
...
function:
0x0c84    op07_CallActorEvent( actor_id=Actor_0x0a, event=event_0x04, priority=0x01 )
0x0c87    op26_Wait( time=6 )
0x0c8a    -- 0x57( type=0x80, x=(vf80)0x0412, z=(vf40)0x0414, walkmesh_id=(vf20)0x0418, ???=(vf10)0x0410, flag=0x0 )
0x0c95    -- 0x57( type=0x8f )
0x0c97    op26_Wait( time=1 )
0x0c9a    -- 0x57( type=0xf )
0x0c9c    op26_Wait( time=8 )
0x0c9f    op0D_Return()
