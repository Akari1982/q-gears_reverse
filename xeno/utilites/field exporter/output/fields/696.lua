...
0x05a7    -- 0xFEC6( char_id=mem[0x2d0] )
0x05ab    -- 0xFE1A() sync load for 0xFEC6()
0x05ad    -- 0xFEC6( char_id=mem[0x2d2] )
0x05b1    -- 0xFE1A() sync load for 0xFEC6()
0x05b3    -- 0xBB( ???=0x7 )
0x05b5    -- 0x5A()
0x05b6    op0D_Return()
0x05b7    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0000, ???=(vf40)0xb257, flag=0xd3 )
