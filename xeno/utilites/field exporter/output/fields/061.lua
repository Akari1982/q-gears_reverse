...
0x010c    op02_JumpToConditional( val1=(s)mem[0x140], val2=50, condition="val1 != val2", address_if_false=0x13f )
...
Actor_0x08:on_push:
0x0911    op00_Return()
0x0912    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x6fdd, ???=(vf40)0x8ede, flag=0x16 )
