...
0x035b    op0D_Return()
0x035c    -- 0xFE69( actor_id=Actor_0x38, render_settings=(s)mem[0x3e04], rot_x=(s)mem[0x3500], rot_y=(s)mem[0x43a] )
...
0x05db    -- 0x5A()
0x05dc    op0D_Return()
0x05dd    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0038, ???=(vf40)0x0000, flag=0x40 )
