...
0x05cd    -- 0xFEC6( char_id=mem[0x2d0] )
0x05d1    -- 0xFE1A() sync load for 0xFEC6()
0x05d3    -- 0xFEC6( char_id=mem[0x2d2] )
0x05d7    -- 0xFE1A() sync load for 0xFEC6()
0x05d9    -- 0xBB( ???=0x7 )
0x05db    -- 0x5A()
0x05dc    op0D_Return()
0x05dd    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0038, ???=(vf40)0x0000, flag=0x3e )
