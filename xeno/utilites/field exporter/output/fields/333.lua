...
0x008d    -- 0x9D()
0x0091    -- 0x2A()
0x0092    op02_JumpToConditional( val1=mem[0xc4], val2=4, condition="val1 & val2", address_if_false=0xac )
0x009a    -- 0x80()
0x009f    -- 0x80()
0x00a4    -- 0x80()
...
0x00f6    op02_JumpToConditional( val1=mem[0xc4], val2=4, condition="val1 & val2", address_if_false=0x101 )
...
0x0107    op02_JumpToConditional( val1=mem[0xc4], val2=4, condition="val1 & val2", address_if_false=0x112 )
