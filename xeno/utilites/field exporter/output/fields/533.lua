...
0x015b    -- 0xFE1C()
0x0164    -- 0xFE5E()
0x0168    op69_ActorSetRotation( rot=0 )
0x016b    op20_ActorSetFlags0( flags=13 )
0x016e    -- 0x2A()
0x016f    mem[0x40e] = false -- op37
0x0172    op00_Return()
...
0x064e    opFE42( ???=2 )
0x0652    op0D_Return()
0x0653    -- 0xE0( actor_id=Actor_0xe4, ???=(vf80)0xde6f, ???=(vf40)0x36b7, flag=0xb9 )
