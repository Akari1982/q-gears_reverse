...
0x0047    op02_JumpToConditional( val1=mem[0x156], val2=1024, condition="val1 & val2", address_if_false=0xfa )
0x004f    op02_JumpToConditional( val1=mem[0x156], val2=2048, condition="val1 & val2", address_if_false=0x5a )
...
0x036c    -- 0x5F( ???=0x2 )
0x036e    -- 0x2A()
0x036f    -- 0xFE5E()-- 0xFE5F()
0x037b    op07_CallActorEvent( actor_id=Actor_0x80, event=event_0x1e, priority=0x07 )
0x037e    op0D_Return()
0x037f    op29_ActorTurnOff( actor_id=Actor_0x80 )
0x0381    -- 0x1B()
0x0388    -- 0x5F( ???=0x4 )
0x038a    -- 0xFE5E()-- 0xFE5F()
0x0396    op03_MessageShowFixed2( text_id=0xfe80, flags=CLOSE_OFF_SCREEN|FORCE_LEFT|FORCE_RIGHT )
0x039a    op03_MessageShowFixed2( text_id=0x280, flags=NO_FACE )
0x039e    op00_Return()
0x039f    op01_JumpTo( address=0x4000 )
0x03a2    -- 0xAD()
0x03a9    op01_JumpTo( address=0x5fc0 )
0x03ac    op02_JumpToConditional( val1=(s)mem[0x200], val2=(s)mem[0x402], condition="val1 == val2", address_if_false=0x4000 )
0x03b4    -- 0xBA()
0x03b6    -- 0xA7()
...
0x0490    op02_JumpToConditional( val1=mem[0x156], val2=2048, condition="val1 & val2", address_if_false=0x4a1 )
0x0498    -- 0x1B()
...
0x055b    -- 0x80()
0x0560    op01_JumpTo( address=0x1780 )
0x0563    -- 0x55()
0x056a    op02_JumpToConditional( condition="val1 | val2", address_if_false=0xfafc )
0x0572    opFD_Nop()
0x0573    opFF_Nop()
0x0574    -- 0x1B()
0x057b    -- 0xFE5E()-- 0xFE5F()
0x0587    -- 0x2A()
0x0588    op20_ActorSetFlags0( flags=1 )
0x058b    -- 0x17()
0x059d    -- 0x1B()
0x05a4    -- 0xFE5E()-- 0xFE5F()
0x05b0    -- 0x80()
0x05b5    op01_JumpTo( address=0x1780 )
0x05b8    -- 0x2D()
0x05c0    op05_CallFunction( address=0xd201 )
0x05c3    opFD_Nop()
0x05c4    -- 0x8E()
0x05cb    opFF_Nop()
0x05cc    -- 0x4С( variable arguments based args )
0x05d4    -- 0x23()
0x05d5    op00_Return()
...
Actor_0x1d:on_push:
0x0802    op00_Return()
0x0803    -- 0xE0( actor_id=Actor_0x57, ???=(vf80)0x7695, ???=(vf40)0x0078, flag=0x5 )
