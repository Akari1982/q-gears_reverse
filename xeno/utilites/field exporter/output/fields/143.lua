...
0x0440    -- 0x11()
0x044d    mem[0x2] ^= mem[0x6304] -- op40
0x0453    mem[0x460] ^= (s)mem[0x28d2] -- op40
0x0459    op01_JumpTo( address=0x289c )
0x045c    -- 0x11()
0x0469    -- 0x64() -- exp0x1
0x046a    -- 0x80()
0x046f    op01_JumpTo( address=0xd281 )
0x0472    op29_ActorTurnOff( actor_id=Actor_0x00 )
0x0474    op00_Return()
...
0x048e    -- 0xCB_TriggerJumpTo( trigger_id=22017, jump=0x2704 )
0x0493    -- 0x10()
0x049e    mem[0x4000] -= (s)mem[0x2] -- op39
0x04a4    -- 0x63( ???=mem[0x4000], ???=(s)mem[0x4b2], ???=(s)mem[0x2ad2] ) -- exp0x1
0x04ac    op01_JumpTo( address=0x289c )
0x04af    -- 0x10()
0x04ba    0x32() -- jump if some buttons not pressed
0x04bf    -- 0x80()
...
0x04e1    -- 0xCB_TriggerJumpTo( trigger_id=(s)mem[0x2b02], jump=0x2705 )
0x04e6    -- 0x10()
0x04f1    mem[0x4000] |= 1 << (s)mem[0x2] -- op3a
0x04f7    -- 0x63( ???=mem[0x4000], ???=(s)mem[0x506], ???=(s)mem[0x2cd2] ) -- exp0x1
0x04ff    op01_JumpTo( address=0x289c )
0x0502    -- 0x10()
0x050d    0x32() -- jump if some buttons not pressed
0x0512    -- 0x80()
...
0x0545    -- 0xFE0A( ???=0x844 )
0x0549    -- 0xBF( ???=100 )
0x054c    op02_JumpToConditional( val1=(s)mem[0x402], val2=1, condition="val1 == val2", address_if_false=0x558 )
0x0554    -- 0x5A()
...
0x0568    op02_JumpToConditional( val1=(s)mem[0x402], val2=1, condition="val1 == val2", address_if_false=0x574 )
0x0570    -- 0x5A()
...
0x0590    -- 0x2A()
0x0591    op02_JumpToConditional( val1=(s)mem[0xae], val2=0, condition="val1 == val2", address_if_false=0x59b )
0x0599    op29_ActorTurnOff( actor_id=Actor_0x14 )
0x059b    op02_JumpToConditional( val1=(s)mem[0xae], val2=6, condition="val1 == val2", address_if_false=0x5a5 )
