...
0x064c    op02_JumpToConditional( val1=(s)mem[0xe2], val2=32, condition="val1 & val2", address_if_false=0x659 )
...
0x0881    -- 0x10()
0x088c    op00_Return()
0x088d    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0038, ???=(vf40)0x005a, flag=0xf0 )
