...
0x003f    opB4_FadeOut()
0x0042    op02_JumpToConditional( val1=mem[0x2c6], val2=8192, condition="val1 & val2", address_if_false=0x89 )
0x004a    op99()
...
0x06e6    op02_JumpToConditional( val1=mem[0x2c6], val2=8192, condition="val1 & val2", address_if_false=0x74b )
...
0x087a    op02_JumpToConditional( val1=mem[0x2c6], val2=8192, condition="val1 & val2", address_if_false=0x886 )
0x0882    -- 0x23()
...
0x089e    op02_JumpToConditional( val1=mem[0x2c6], val2=8192, condition="val1 & val2", address_if_false=0x8aa )
0x08a6    -- 0x23()
...
0x0e2b    -- 0xFEC6( char_id=mem[0x2d0] )
0x0e2f    -- 0xFE1A() sync load for 0xFEC6()
0x0e31    -- 0xFEC6( char_id=mem[0x2d2] )
0x0e35    -- 0xFE1A() sync load for 0xFEC6()
0x0e37    -- 0xBB( ???=0x7 )
0x0e39    -- 0x5A()
0x0e3a    op0D_Return()
0x0e3b    -- 0xE0( actor_id=Actor_0x16, ???=(vf80)0x8003, ???=(vf40)0x0dfe, flag=0x3 )
