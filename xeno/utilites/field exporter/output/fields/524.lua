...
0x00c5    op02_JumpToConditional( val1=mem[0x1c6], val2=1, condition="val1 & val2", address_if_false=0xd0 )
...
0x04f9    opFE42( ???=2 )
0x04fd    op0D_Return()
0x04fe    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x01c9, ???=(vf40)0x0000, flag=0x45 )
