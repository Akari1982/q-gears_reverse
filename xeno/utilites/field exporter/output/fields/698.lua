...
0x0344    op02_JumpToConditional( val1=(s)mem[0x2ca], val2=1024, condition="val1 & val2", address_if_false=0x34f )
...
0x0cb1    -- 0xFEC6( char_id=(s)mem[0x2d0] )
0x0cb5    -- 0xFE1A() sync load for 0xFEC6()
0x0cb7    -- 0xFEC6( char_id=(s)mem[0x2d2] )
0x0cbb    -- 0xFE1A() sync load for 0xFEC6()
0x0cbd    -- 0xBB( ???=0x7 )
0x0cbf    -- 0x5A()
0x0cc0    op0D_Return()
0x0cc1    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0xb238, ???=(vf40)0x9081, flag=0x0 )
