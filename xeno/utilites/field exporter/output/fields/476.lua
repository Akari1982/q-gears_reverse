...
0x0208    op02_JumpToConditional( val1=(s)mem[0x202], val2=mem[0x3000], condition="val1 == val2", address_if_false=0x1a44 )
...
Actor_0x0f:on_push:
0x0260    op00_Return()
0x0261    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0038, ???=(vf40)0x190e, flag=0x0 )
