...
0x01e4    -- 0x0A()
0x01e8    op02_JumpToConditional( val1=mem[0x802], val2=(s)mem[0x600], condition="val1 == val2", address_if_false=0xf940 )
0x01f0    op01_JumpTo( address=0x5b5 )
0x01f3    -- 0x80()
0x01f8    op02_JumpToConditional( val1=mem[0x802], val2=mem[0x700], condition="val1 == val2", address_if_false=0x940 )
...
Actor_0x0f:on_push:
0x0260    op00_Return()
0x0261    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x1438, ???=(vf40)0x3a3c, flag=0xc1 )
