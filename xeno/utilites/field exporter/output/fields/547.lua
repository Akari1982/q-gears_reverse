...
0x0206    op01_JumpTo( address=0x1e80 )
0x0209    -- 0x80()
0x020e    op01_JumpTo( address=0x728 )
0x0211    op02_JumpToConditional( val1=(s)mem[0x924], val2=(s)mem[0x2402], condition="val1 & val2", address_if_false=0x2901 )
