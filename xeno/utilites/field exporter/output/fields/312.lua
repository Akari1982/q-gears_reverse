...
0x026b    op02_JumpToConditional( val1=(s)mem[0x18a], val2=16384, condition="val1 & val2", address_if_false=0x275 )
...
0x0321    -- 0x75( ???=11 )
0x0324    op02_JumpToConditional( val1=(s)mem[0x18a], val2=2048, condition="val1 & val2", address_if_false=0x335 )
...
0x0365    op02_JumpToConditional( val1=(s)mem[0x18a], val2=16384, condition="val1 & val2", address_if_false=0x36f )
...
0x07d6    op00_Return()
0x07d7    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0000, ???=(vf40)0xf022, flag=0x80 )
