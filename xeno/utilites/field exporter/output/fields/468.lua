...
0x0335    op0D_Return()
0x0336    -- 0xFE69( actor_id=Actor_0x38, render_settings=(s)mem[0x3e04], rot_x=mem[0x3500], rot_y=(s)mem[0x43a] )
...
0x05b5    -- 0x5A()
0x05b6    op0D_Return()
0x05b7    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0000, ???=(vf40)0xe0e4, flag=0x51 )
