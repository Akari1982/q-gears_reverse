...
0x0aa6    op02_JumpToConditional( val1=(s)mem[0x1000], val2=mem[0xcc00], condition="val1 > val2", address_if_false=0xd0 )
...
0x3ca4    op0D_Return()
0x3ca5    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0038, ???=(vf40)0xb40e, flag=0x1a )
