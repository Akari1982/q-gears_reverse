...
0x0010    -- 0xA0()
0x0017    -- 0x2A()
0x0018    op02_JumpToConditional( val1=mem[0x152], val2=10, condition="val1 == val2", address_if_false=0x2e )
...
0x00dc    -- 0xFE68()
0x00e3    op02_JumpToConditional( val1=mem[0x152], val2=10, condition="val1 == val2", address_if_false=0xf3 )
...
0x011c    -- 0xFE68()
0x0123    op02_JumpToConditional( val1=mem[0x152], val2=10, condition="val1 == val2", address_if_false=0x133 )
...
Actor_0x1f:on_push:
0x0860    op00_Return()
0x0861    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x6738, ???=(vf40)0xd3b2, flag=0xa0 )
