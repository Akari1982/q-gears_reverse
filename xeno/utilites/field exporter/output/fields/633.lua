...
0x0017    -- 0xF7()
0x001c    op02_JumpToConditional( val1=mem[0x20e], val2=128, condition="val1 & val2", address_if_false=0x2a )
...
0x0354    op0D_Return()
0x0355    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x4b38, ???=(vf40)0x0064, flag=0x0 )
