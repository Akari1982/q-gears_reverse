...
0x011d    opA9_MessageSetSelectionSync( start_row=03, end_row=04 )
0x011f    op9C_MessageSync()
0x0120    op02_JumpToConditional( val1=(s)mem[0x14], val2=3, condition="val1 == val2", address_if_false=0x19d )
0x0128    mem[0x1c0] |= 1 << 14 -- op3a
...
0x023a    opA9_MessageSetSelectionSync( start_row=02, end_row=03 )
