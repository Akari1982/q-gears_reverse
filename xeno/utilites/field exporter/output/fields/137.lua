...
Actor_0x0c:on_talk:
0x009a    op02_JumpToConditional( val1=mem[0x400], val2=1, condition="val1 == val2", address_if_false=0xa6 )
0x00a2    -- 0x5A()
...
0x00c2    -- 0x2A()
0x00c3    op02_JumpToConditional( val1=mem[0xae], val2=0, condition="val1 == val2", address_if_false=0xcd )
0x00cb    op29_ActorTurnOff( actor_id=Actor_0x0d )
0x00cd    op02_JumpToConditional( val1=mem[0xae], val2=6, condition="val1 == val2", address_if_false=0xd7 )
...
0x00f1    -- 0xFE54()
0x00f3    -- 0xFE0B()
0x00f7    op02_JumpToConditional( val1=mem[0xae], val2=1, condition="val1 == val2", address_if_false=0x11a )
...
0x011a    op02_JumpToConditional( val1=mem[0xae], val2=2, condition="val1 == val2", address_if_false=0x13d )
...
0x013d    op02_JumpToConditional( val1=mem[0xae], val2=3, condition="val1 == val2", address_if_false=0x160 )
...
0x0160    op02_JumpToConditional( val1=mem[0xae], val2=4, condition="val1 == val2", address_if_false=0x183 )
...
0x0183    op02_JumpToConditional( val1=mem[0xae], val2=5, condition="val1 == val2", address_if_false=0x19c )
...
function:
0x0223    -- 0xFE18()
0x0228    op25_ActorDisable( actor_id=Actor_0x01 )
0x022a    -- 0xFE3B()
0x022e    op0D_Return()
0x022f    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0xfe00, ???=(vf40)0x263b, flag=0xb2 )
