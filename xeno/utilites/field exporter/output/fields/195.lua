...
0x01e1    op00_Return()
0x01e2    -- 0x80()
0x01e7    op24_ActorEnable( actor_id=Actor_0x2c )
0x01e9    op01_JumpTo( address=0x4772 )
0x01ec    -- 0x80()
0x01f1    op00_Return()
0x01f2    -- 0x76()
0x01f3    -- 0xFEC0()
...
0x03c4    op01_JumpTo( address=0x2d80 )
0x03c7    -- 0x80()
...
0x0446    op01_JumpTo( address=0x2d80 )
0x0449    -- 0x80()
...
0x06ef    op01_JumpTo( address=0x2d80 )
0x06f2    -- 0x80()
0x06f7    -- 0x04()
0x06f8    op01_JumpTo( address=0x4000 )
0x06fb    -- 0x10()
