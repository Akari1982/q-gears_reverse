...
0x050d    op02_JumpToConditional( val1=(s)mem[0x204], val2=8, condition="val1 & val2", address_if_false=0x538 )
0x0515    op02_JumpToConditional( val1=(s)mem[0x204], val2=128, condition="val1 & val2", address_if_false=0x520 )
...
0x06de    -- 0x91()
0x06e2    op02_JumpToConditional( val1=(s)mem[0x204], val2=32, condition="val1 & val2", address_if_false=0x6ed )
...
0x081d    -- 0x91()
0x0821    op02_JumpToConditional( val1=(s)mem[0x204], val2=32, condition="val1 & val2", address_if_false=0x82c )
...
0x09a4    -- 0x85()
0x09a9    op02_JumpToConditional( val1=(s)mem[0x204], val2=16, condition="val1 & val2", address_if_false=0x9b3 )
...
0x0d87    -- 0x5B()
0x0d88    op00_Return()
0x0d89    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0538, ???=(vf40)0x0000, flag=0x9c )
