...
0x0580    -- 0x85()
0x0585    -- 0x85()
0x058a    op02_JumpToConditional( val1=(s)mem[0x1c6], val2=16, condition="val1 & val2", address_if_false=0x595 )
...
0x0951    op00_Return()
0x0952    op00_Return()
0x0953    -- 0xE0( actor_id=Actor_0x7e, ???=(vf80)0x919d, ???=(vf40)0xcb58, flag=0x21 )
