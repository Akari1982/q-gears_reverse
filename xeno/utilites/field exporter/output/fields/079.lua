...
0x0524    op02_JumpToConditional( val1=mem[0x1c2], val2=4096, condition="val1 & val2", address_if_false=0x54e )
0x052c    -- 0xFE07( ???=0x1 )
0x052f    -- 0xF6( ???=0x2 )
0x0531    op02_JumpToConditional( val1=mem[0x1c2], val2=64, condition="val1 & val2", address_if_false=0x546 )
...
0x058c    op02_JumpToConditional( val1=mem[0x1c2], val2=64, condition="val1 & val2", address_if_false=0x5c1 )
...
0x1cbc    op02_JumpToConditional( val1=mem[0x1c2], val2=4096, condition="val1 & val2", address_if_false=0x1cd1 )
0x1cc4    op02_JumpToConditional( val1=mem[0x1c2], val2=64, condition="val1 & val2", address_if_false=0x1ccf )
