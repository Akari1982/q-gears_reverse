...
0x0096    op02_JumpToConditional( val1=mem[0x1c0], val2=4, condition="val1 & val2", address_if_false=0xa4 )
0x009e    mem[0x4e6] = 1 -- op35
0x00a4    op02_JumpToConditional( val1=mem[0x1c0], val2=8, condition="val1 & val2", address_if_false=0xb2 )
...
0x00bf    op00_Return()
0x00c0    -- 0x85()
0x00c5    op02_JumpToConditional( val1=mem[0x1c0], val2=128, condition="val1 & val2", address_if_false=0xd0 )
...
0x039b    op02_JumpToConditional( val1=mem[0x1c0], val2=1, condition="val1 & val2", address_if_false=0x3a6 )
...
0x0479    op02_JumpToConditional( val1=mem[0x1c0], val2=1, condition="val1 & val2", address_if_false=0x505 )
0x0481    op02_JumpToConditional( val1=mem[0x1c0], val2=32, condition="val1 & val2", address_if_false=0x48d )
0x0489    op00_Return()
...
0x04bc    opA9_MessageSetSelectionSync( start_row=02, end_row=03 )
...
0x0620    op02_JumpToConditional( val1=mem[0x1c0], val2=16, condition="val1 & val2", address_if_false=0x62b )
...
0x093c    op02_JumpToConditional( val1=mem[0x1c0], val2=2, condition="val1 & val2", address_if_false=0x947 )
...
0x0b96    op02_JumpToConditional( val1=mem[0x1c0], val2=64, condition="val1 & val2", address_if_false=0xba1 )
...
0x0c1e    op02_JumpToConditional( val1=mem[0x1c0], val2=64, condition="val1 & val2", address_if_false=0xc29 )
...
0x0d44    op00_Return()
0x0d45    -- 0x85()
0x0d4a    op02_JumpToConditional( val1=mem[0x1c0], val2=128, condition="val1 & val2", address_if_false=0xd57 )
...
0x0d6a    op02_JumpToConditional( val1=mem[0x1c0], val2=1, condition="val1 & val2", address_if_false=0xd88 )
0x0d72    op02_JumpToConditional( val1=mem[0x1c0], val2=32, condition="val1 & val2", address_if_false=0xd81 )
...
0x0d88    op02_JumpToConditional( val1=mem[0x1c0], val2=2, condition="val1 & val2", address_if_false=0xd92 )
...
0x18a6    op02_JumpToConditional( val1=(s)mem[0x50a], val2=1, condition="val1 < val2", address_if_false=0x18b7 )
0x18ae    mem[0x50a] += 1 -- op3c
0x18b1    -- 0xBF( ???=(s)mem[0x50a] )
0x18b4    op01_JumpTo( address=0x18a6 )
0x18b7    op26_Wait( time=8 )
0x18ba    mem[0x50a] += 1 -- op3c
0x18bd    op02_JumpToConditional( val1=(s)mem[0x50a], val2=0, condition="val1 > val2", address_if_false=0x18ce )
0x18c5    mem[0x50a] -= 1 -- op3d
0x18c8    -- 0xC0( ???=(s)mem[0x50a] )
0x18cb    op01_JumpTo( address=0x18bd )
0x18ce    mem[0x50a] = false -- op37
0x18d1    op02_JumpToConditional( val1=(s)mem[0x50a], val2=2, condition="val1 < val2", address_if_false=0x18e2 )
0x18d9    mem[0x50a] += 1 -- op3c
0x18dc    -- 0xBF( ???=(s)mem[0x50a] )
0x18df    op01_JumpTo( address=0x18d1 )
0x18e2    op26_Wait( time=6 )
0x18e5    mem[0x50a] += 1 -- op3c
0x18e8    op02_JumpToConditional( val1=(s)mem[0x50a], val2=0, condition="val1 > val2", address_if_false=0x18f9 )
0x18f0    mem[0x50a] -= 1 -- op3d
0x18f3    -- 0xC0( ???=(s)mem[0x50a] )
...
0x1915    op02_JumpToConditional( val1=(s)mem[0x50a], val2=5, condition="val1 < val2", address_if_false=0x1926 )
0x191d    mem[0x50a] += 1 -- op3c
0x1920    -- 0xBF( ???=(s)mem[0x50a] )
0x1923    op01_JumpTo( address=0x1915 )
0x1926    op26_Wait( time=8 )
0x1929    mem[0x50a] += 1 -- op3c
0x192c    op02_JumpToConditional( val1=(s)mem[0x50a], val2=0, condition="val1 > val2", address_if_false=0x193d )
0x1934    mem[0x50a] -= 1 -- op3d
0x1937    -- 0xC0( ???=(s)mem[0x50a] )
0x193a    op01_JumpTo( address=0x192c )
0x193d    op26_Wait( time=6 )
0x1940    mem[0x50a] = false -- op37
0x1943    op02_JumpToConditional( val1=(s)mem[0x50a], val2=4, condition="val1 < val2", address_if_false=0x1954 )
0x194b    mem[0x50a] += 1 -- op3c
0x194e    -- 0xBF( ???=(s)mem[0x50a] )
0x1951    op01_JumpTo( address=0x1943 )
0x1954    op26_Wait( time=6 )
0x1957    mem[0x50a] += 1 -- op3c
0x195a    op02_JumpToConditional( val1=(s)mem[0x50a], val2=0, condition="val1 > val2", address_if_false=0x196b )
0x1962    mem[0x50a] -= 1 -- op3d
0x1965    -- 0xC0( ???=(s)mem[0x50a] )
0x1968    op01_JumpTo( address=0x195a )
0x196b    op01_JumpTo( address=0x19c4 )
0x196e    op02_JumpToConditional( val1=(s)mem[0x50a], val2=3, condition="val1 < val2", address_if_false=0x197f )
0x1976    mem[0x50a] += 1 -- op3c
0x1979    -- 0xC0( ???=(s)mem[0x50a] )
0x197c    op01_JumpTo( address=0x196e )
0x197f    op26_Wait( time=6 )
0x1982    mem[0x50a] += 1 -- op3c
0x1985    op02_JumpToConditional( val1=(s)mem[0x50a], val2=0, condition="val1 > val2", address_if_false=0x1996 )
0x198d    mem[0x50a] -= 1 -- op3d
0x1990    -- 0xBF( ???=(s)mem[0x50a] )
0x1993    op01_JumpTo( address=0x1985 )
0x1996    mem[0x50a] = false -- op37
0x1999    op02_JumpToConditional( val1=(s)mem[0x50a], val2=2, condition="val1 < val2", address_if_false=0x19aa )
0x19a1    mem[0x50a] += 1 -- op3c
0x19a4    -- 0xC0( ???=(s)mem[0x50a] )
0x19a7    op01_JumpTo( address=0x1999 )
0x19aa    op26_Wait( time=5 )
0x19ad    mem[0x50a] += 1 -- op3c
0x19b0    op02_JumpToConditional( val1=(s)mem[0x50a], val2=0, condition="val1 > val2", address_if_false=0x19c1 )
0x19b8    mem[0x50a] -= 1 -- op3d
0x19bb    -- 0xBF( ???=(s)mem[0x50a] )
