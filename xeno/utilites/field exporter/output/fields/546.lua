...
Actor_0x07:on_talk:
0x01ed    -- 0xFE54()
0x01ef    op09_CallActorEventEndSync( actor_id=Actor_0x05, event=event_0x04, priority=0x01 )
0x01f2    op07_CallActorEvent( actor_id=Actor_0x01, event=event_0x05, priority=0x01 )
0x01f5    op26_Wait( time=10 )
0x01f8    -- 0x98_MapLoad( field_id=545, value=0 )
0x01fd    -- 0x5B()
0x01fe    op00_Return()
