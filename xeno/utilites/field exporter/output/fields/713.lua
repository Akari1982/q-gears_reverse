...
0x028a    op02_JumpToConditional( val1=mem[0x2d0], val2=3, condition="val1 == val2", address_if_false=0x295 )
0x0292    op01_JumpTo( address=0x2ac )
0x0295    op02_JumpToConditional( val1=mem[0x2d2], val2=3, condition="val1 == val2", address_if_false=0x2a0 )
...
0x02ac    op02_JumpToConditional( val1=mem[0x2d0], val2=5, condition="val1 == val2", address_if_false=0x2b7 )
0x02b4    op01_JumpTo( address=0x2ce )
0x02b7    op02_JumpToConditional( val1=mem[0x2d2], val2=5, condition="val1 == val2", address_if_false=0x2c2 )
...
0x02ce    op02_JumpToConditional( val1=mem[0x2d0], val2=9, condition="val1 == val2", address_if_false=0x2d9 )
0x02d6    op01_JumpTo( address=0x2f0 )
0x02d9    op02_JumpToConditional( val1=mem[0x2d2], val2=9, condition="val1 == val2", address_if_false=0x2e4 )
...
0x02f0    op02_JumpToConditional( val1=mem[0x2d0], val2=4, condition="val1 == val2", address_if_false=0x2fb )
0x02f8    op01_JumpTo( address=0x312 )
0x02fb    op02_JumpToConditional( val1=mem[0x2d2], val2=4, condition="val1 == val2", address_if_false=0x306 )
...
0x0312    op02_JumpToConditional( val1=mem[0x2d0], val2=7, condition="val1 == val2", address_if_false=0x31d )
0x031a    op01_JumpTo( address=0x337 )
0x031d    op02_JumpToConditional( val1=mem[0x2d2], val2=7, condition="val1 == val2", address_if_false=0x328 )
