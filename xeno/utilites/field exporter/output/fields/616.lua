...
0x028d    -- 0x85()
0x0292    op02_JumpToConditional( val1=mem[0x1cc], val2=64, condition="val1 & val2", address_if_false=0x2a3 )
...
0x03bb    -- 0xFE5E()-- 0xFE5F()
0x03c7    -- 0xCE()
0x03c8    opFF_Nop()
0x03c9    -- 0xE0( actor_id=Actor_0x10, ???=(vf80)0x1001, ???=(vf40)0xee00, flag=0x0 )
0x03d0    -- 0x92()
0x03d1    opFF_Nop()
0x03d2    -- 0xCE()
0x03d3    opFF_Nop()
0x03d4    -- 0xE0( actor_id=Actor_0x10, ???=(vf80)0x1001, ???=(vf40)0xee00, flag=0x0 )
0x03db    -- 0x92()
0x03dc    opFF_Nop()
0x03dd    op00_Return()
0x03de    op00_Return()
0x03df    -- 0xE0( actor_id=Actor_0x10, ???=(vf80)0x0001, ???=(vf40)0x2abc, flag=0x2 )
0x03e6    op02_JumpToConditional( condition="val1 == val2", address_if_false=0x103 )
0x03ee    -- 0xF2()
0x03f7    -- 0x04()
0x03f8    -- 0x67()
...
0x0aa3    op00_Return()
0x0aa4    op02_JumpToConditional( val1=mem[0x1c0], val2=1024, condition="val1 & val2", address_if_false=0xaba )
0x0aac    op02_JumpToConditional( val1=mem[0x1c0], val2=4096, condition="val1 & val2", address_if_false=0xab7 )
