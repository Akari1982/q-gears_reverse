...
0x016d    op02_JumpToConditional( val1=mem[0xbc], val2=13, condition="val1 == val2", address_if_false=0x18a )
...
0x019c    op02_JumpToConditional( val1=mem[0xbc], val2=0, condition="val1 == val2", address_if_false=0x1a8 )
0x01a4    op00_Return()
0x01a5    op01_JumpTo( address=0x250 )
0x01a8    op02_JumpToConditional( val1=mem[0xbc], val2=1, condition="val1 == val2", address_if_false=0x1b6 )
0x01b0    op01_JumpTo( address=0x251 )
0x01b3    op01_JumpTo( address=0x250 )
0x01b6    op02_JumpToConditional( val1=mem[0xbc], val2=2, condition="val1 == val2", address_if_false=0x1c4 )
0x01be    op01_JumpTo( address=0x260 )
0x01c1    op01_JumpTo( address=0x250 )
0x01c4    op02_JumpToConditional( val1=mem[0xbc], val2=3, condition="val1 == val2", address_if_false=0x1d2 )
0x01cc    op01_JumpTo( address=0x270 )
0x01cf    op01_JumpTo( address=0x250 )
0x01d2    op02_JumpToConditional( val1=mem[0xbc], val2=4, condition="val1 == val2", address_if_false=0x1e0 )
0x01da    op01_JumpTo( address=0x280 )
0x01dd    op01_JumpTo( address=0x250 )
0x01e0    op02_JumpToConditional( val1=mem[0xbc], val2=5, condition="val1 == val2", address_if_false=0x1ee )
0x01e8    op01_JumpTo( address=0x290 )
0x01eb    op01_JumpTo( address=0x250 )
0x01ee    op02_JumpToConditional( val1=mem[0xbc], val2=6, condition="val1 == val2", address_if_false=0x1fc )
0x01f6    op01_JumpTo( address=0x2a0 )
0x01f9    op01_JumpTo( address=0x250 )
0x01fc    op02_JumpToConditional( val1=mem[0xbc], val2=7, condition="val1 == val2", address_if_false=0x20a )
0x0204    op01_JumpTo( address=0x2b0 )
0x0207    op01_JumpTo( address=0x250 )
0x020a    op02_JumpToConditional( val1=mem[0xbc], val2=8, condition="val1 == val2", address_if_false=0x218 )
0x0212    op01_JumpTo( address=0x2c0 )
0x0215    op01_JumpTo( address=0x250 )
0x0218    op02_JumpToConditional( val1=mem[0xbc], val2=9, condition="val1 == val2", address_if_false=0x226 )
0x0220    op01_JumpTo( address=0x2d0 )
0x0223    op01_JumpTo( address=0x250 )
0x0226    op02_JumpToConditional( val1=mem[0xbc], val2=10, condition="val1 == val2", address_if_false=0x234 )
0x022e    op01_JumpTo( address=0x2e0 )
0x0231    op01_JumpTo( address=0x250 )
0x0234    op02_JumpToConditional( val1=mem[0xbc], val2=11, condition="val1 == val2", address_if_false=0x242 )
0x023c    op01_JumpTo( address=0x2f0 )
0x023f    op01_JumpTo( address=0x250 )
0x0242    op02_JumpToConditional( val1=mem[0xbc], val2=12, condition="val1 == val2", address_if_false=0x250 )
...
0x0417    op02_JumpToConditional( val1=mem[0xb6], val2=3, condition="val1 > val2", address_if_false=0x432 )
...
0x04b5    -- 0xFE68()
0x04bc    op02_JumpToConditional( val1=mem[0x400], val2=166, condition="val1 == val2", address_if_false=0x4cc )
...
Actor_0x16:on_push:
0x051d    op00_Return()
0x051e    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0000, ???=(vf40)0x4e00, flag=0xc9 )
