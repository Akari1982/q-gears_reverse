...
0x003a    op02_JumpToConditional( val1=mem[0x2ca], val2=256, condition="val1 & val2", address_if_false=0x11b )
0x0042    -- 0xFE54()
...
0x03a2    op02_JumpToConditional( val1=mem[0x2ca], val2=256, condition="val1 & val2", address_if_false=0x3b6 )
0x03aa    -- 0xFE1C()
...
0x03cc    op02_JumpToConditional( val1=mem[0x2ca], val2=256, condition="val1 & val2", address_if_false=0x3f6 )
...
0x043a    op02_JumpToConditional( val1=mem[0x2ca], val2=256, condition="val1 & val2", address_if_false=0x44e )
0x0442    -- 0xFE1C()
...
0x049e    op02_JumpToConditional( val1=mem[0x2ca], val2=256, condition="val1 & val2", address_if_false=0x4b2 )
0x04a6    -- 0xFE3C( ???=0, ???=12 )
...
0x04cf    op02_JumpToConditional( val1=mem[0x2ca], val2=256, condition="val1 & val2", address_if_false=0x53f )
...
0x088a    op02_JumpToConditional( val1=mem[0x2ca], val2=256, condition="val1 & val2", address_if_false=0x893 )
0x0892    -- 0x23()
0x0893    op00_Return()
...
0x1b0c    -- 0xFEC6( char_id=mem[0x2d0] )
0x1b10    -- 0xFE1A() sync load for 0xFEC6()
0x1b12    -- 0xFEC6( char_id=mem[0x2d2] )
