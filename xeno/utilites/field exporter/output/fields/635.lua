...
0x0568    op02_JumpToConditional( val1=mem[0x20c], val2=256, condition="val1 & val2", address_if_false=0x578 )
...
0x0684    op02_JumpToConditional( val1=mem[0x20c], val2=256, condition="val1 & val2", address_if_false=0x694 )
...
0x07a0    op02_JumpToConditional( val1=mem[0x20c], val2=256, condition="val1 & val2", address_if_false=0x7b0 )
...
0x08bc    op02_JumpToConditional( val1=mem[0x20c], val2=256, condition="val1 & val2", address_if_false=0x8cc )
...
0x09f0    op02_JumpToConditional( val1=mem[0x20c], val2=256, condition="val1 & val2", address_if_false=0xa00 )
...
0x0b8d    op02_JumpToConditional( val1=mem[0x20c], val2=1024, condition="val1 & val2", address_if_false=0xb98 )
...
Actor_0x10:on_push:
0x0bd5    op02_JumpToConditional( val1=mem[0x20c], val2=256, condition="val1 & val2", address_if_false=0xc03 )
...
0x0c7d    op02_JumpToConditional( val1=mem[0x20c], val2=4096, condition="val1 & val2", address_if_false=0xc88 )
...
0x0d0e    op00_Return()
0x0d0f    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0000, ???=(vf40)0x1100, flag=0x14 )
