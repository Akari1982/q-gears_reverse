...
0x01c5    op00_Return()
0x01c6    op02_JumpToConditional( val1=(s)mem[0x2c4], val2=16, condition="val1 & val2", address_if_false=0x1d1 )
...
0x07b3    -- 0xFEC6( char_id=(s)mem[0x2d0] )
0x07b7    -- 0xFE1A() sync load for 0xFEC6()
0x07b9    -- 0xFEC6( char_id=(s)mem[0x2d2] )
0x07bd    -- 0xFE1A() sync load for 0xFEC6()
0x07bf    -- 0xBB( ???=0x7 )
0x07c1    -- 0x5A()
0x07c2    op0D_Return()
0x07c3    -- 0xE0( actor_id=Actor_0x3e, ???=(vf80)0x919d, ???=(vf40)0x3018, flag=0x20 )
