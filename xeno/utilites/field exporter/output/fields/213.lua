...
0x005a    op02_JumpToConditional( val1=mem[0x242], val2=1, condition="val1 & val2", address_if_false=0x28e )
0x0062    op02_JumpToConditional( val1=mem[0x242], val2=8, condition="val1 & val2", address_if_false=0x245 )
0x006a    op02_JumpToConditional( val1=mem[0x242], val2=2048, condition="val1 & val2", address_if_false=0x242 )
0x0072    op02_JumpToConditional( val1=mem[0x242], val2=8192, condition="val1 & val2", address_if_false=0x194 )
0x007a    op02_JumpToConditional( val1=mem[0x242], val2=-32768, condition="val1 & val2", address_if_false=0x191 )
0x0082    op02_JumpToConditional( val1=mem[0x244], val2=4096, condition="val1 & val2", address_if_false=0x10b )
0x008a    op02_JumpToConditional( val1=mem[0x244], val2=1, condition="val1 & val2", address_if_false=0x95 )
0x0092    op01_JumpTo( address=0x108 )
0x0095    op02_JumpToConditional( val1=mem[0x244], val2=16384, condition="val1 & val2", address_if_false=0x108 )
0x009d    opB4_FadeOut()
...
0x010b    op02_JumpToConditional( val1=mem[0x244], val2=2048, condition="val1 & val2", address_if_false=0x14a )
0x0113    opB4_FadeOut()
0x0116    -- 0xFE54()
...
0x0194    op02_JumpToConditional( val1=mem[0x242], val2=4096, condition="val1 & val2", address_if_false=0x1e2 )
0x019c    opB4_FadeOut()
0x019f    -- 0x75( ???=71 )
0x01a2    -- 0xFE54()
0x01a4    opB3_FadeIn()
...
0x01e2    op02_JumpToConditional( val1=mem[0x246], val2=512, condition="val1 & val2", address_if_false=0x216 )
0x01ea    opB4_FadeOut()
0x01ed    -- 0xFE54()
...
0x0245    op02_JumpToConditional( val1=mem[0x242], val2=4, condition="val1 & val2", address_if_false=0x28b )
0x024d    opB4_FadeOut()
0x0250    -- 0xFE54()
...
0x0312    -- 0x5B()
0x0313    op02_JumpToConditional( val1=mem[0x244], val2=256, condition="val1 & val2", address_if_false=0x331 )
0x031b    op02_JumpToConditional( val1=mem[0x240], val2=16, condition="val1 & val2", address_if_false=0x326 )
...
0x033a    op02_JumpToConditional( val1=mem[0x244], val2=2, condition="val1 & val2", address_if_false=0x349 )
0x0342    opFE0D_MessageSetFace( char_id=0 )
0x0346    op01_JumpTo( address=0x35c )
0x0349    op02_JumpToConditional( val1=mem[0x242], val2=4, condition="val1 & val2", address_if_false=0x358 )
...
0x035d    op02_JumpToConditional( val1=mem[0x24a], val2=4, condition="val1 & val2", address_if_false=0x368 )
0x0365    -- 0x21( ???=192 )
0x0368    op02_JumpToConditional( val1=mem[0x24a], val2=16, condition="val1 & val2", address_if_false=0x373 )
0x0370    -- 0x21( ???=384 )
0x0373    -- 0xA7()
0x0374    op00_Return()
...
0x03ff    op02_JumpToConditional( val1=mem[0x242], val2=128, condition="val1 & val2", address_if_false=0x4c8 )
0x0407    opD2_MessageShowDynamic( text_id=0x3, flags=0 )
0x040b    op9C_MessageSync()
0x040c    op02_JumpToConditional( val1=mem[0x244], val2=64, condition="val1 & val2", address_if_false=0x4ad )
0x0414    op02_JumpToConditional( val1=mem[0x244], val2=128, condition="val1 & val2", address_if_false=0x46e )
0x041c    op02_JumpToConditional( val1=mem[0x244], val2=16384, condition="val1 & val2", address_if_false=0x43f )
...
0x04c8    op02_JumpToConditional( val1=mem[0x242], val2=64, condition="val1 & val2", address_if_false=0x597 )
0x04d0    opD2_MessageShowDynamic( text_id=0x4, flags=0 )
0x04d4    op9C_MessageSync()
0x04d5    op02_JumpToConditional( val1=mem[0x244], val2=64, condition="val1 & val2", address_if_false=0x57c )
0x04dd    op02_JumpToConditional( val1=mem[0x244], val2=128, condition="val1 & val2", address_if_false=0x53d )
0x04e5    op02_JumpToConditional( val1=mem[0x244], val2=16384, condition="val1 & val2", address_if_false=0x508 )
...
0x0597    op02_JumpToConditional( val1=mem[0x242], val2=32, condition="val1 & val2", address_if_false=0x666 )
0x059f    opD2_MessageShowDynamic( text_id=0x5, flags=0 )
0x05a3    op9C_MessageSync()
0x05a4    op02_JumpToConditional( val1=mem[0x244], val2=64, condition="val1 & val2", address_if_false=0x64b )
0x05ac    op02_JumpToConditional( val1=mem[0x244], val2=128, condition="val1 & val2", address_if_false=0x60c )
0x05b4    op02_JumpToConditional( val1=mem[0x244], val2=16384, condition="val1 & val2", address_if_false=0x5d7 )
...
0x0666    op02_JumpToConditional( val1=mem[0x242], val2=16, condition="val1 & val2", address_if_false=0x735 )
0x066e    opD2_MessageShowDynamic( text_id=0x6, flags=0 )
0x0672    op9C_MessageSync()
0x0673    op02_JumpToConditional( val1=mem[0x244], val2=64, condition="val1 & val2", address_if_false=0x71a )
0x067b    op02_JumpToConditional( val1=mem[0x244], val2=128, condition="val1 & val2", address_if_false=0x6db )
0x0683    op02_JumpToConditional( val1=mem[0x244], val2=16384, condition="val1 & val2", address_if_false=0x6a6 )
...
0x073a    op02_JumpToConditional( val1=mem[0x244], val2=64, condition="val1 & val2", address_if_false=0x7e1 )
0x0742    op02_JumpToConditional( val1=mem[0x244], val2=128, condition="val1 & val2", address_if_false=0x7a2 )
0x074a    op02_JumpToConditional( val1=mem[0x244], val2=16384, condition="val1 & val2", address_if_false=0x76d )
...
0x098e    op02_JumpToConditional( val1=mem[0x242], val2=1, condition="val1 & val2", address_if_false=0xa0b )
0x0996    op02_JumpToConditional( val1=mem[0x242], val2=8, condition="val1 & val2", address_if_false=0xa06 )
...
0x09ac    op02_JumpToConditional( val1=mem[0x244], val2=2, condition="val1 & val2", address_if_false=0x9f7 )
0x09b4    -- 0xB5() -- camera set direction
0x09b9    -- 0xFE54()
0x09bb    op02_JumpToConditional( val1=mem[0x244], val2=256, condition="val1 & val2", address_if_false=0x9e1 )
0x09c3    op02_JumpToConditional( val1=mem[0x240], val2=16, condition="val1 & val2", address_if_false=0x9d3 )
...
0x09e1    op02_JumpToConditional( val1=mem[0x240], val2=16384, condition="val1 & val2", address_if_false=0x9ef )
...
0x0a17    op02_JumpToConditional( val1=mem[0x244], val2=2, condition="val1 & val2", address_if_false=0xa26 )
...
0x0b4d    op02_JumpToConditional( val1=mem[0x244], val2=2, condition="val1 & val2", address_if_false=0xb5c )
...
Actor_0x08:on_talk:
0x0c61    op02_JumpToConditional( val1=mem[0x242], val2=8, condition="val1 & val2", address_if_false=0xc84 )
...
0x15d0    op00_Return()
0x15d1    op02_JumpToConditional( val1=mem[0x246], val2=16, condition="val1 & val2", address_if_false=0x15f4 )
...
0x165b    -- 0x2A()
0x165c    op02_JumpToConditional( val1=mem[0x242], val2=1, condition="val1 & val2", address_if_false=0x166c )
...
0x166c    op02_JumpToConditional( val1=mem[0x242], val2=512, condition="val1 & val2", address_if_false=0x1676 )
0x1674    op29_ActorTurnOff( actor_id=Actor_0x08 )
0x1676    op02_JumpToConditional( val1=mem[0x242], val2=8192, condition="val1 & val2", address_if_false=0x1683 )
0x167e    op29_ActorTurnOff( actor_id=Actor_0x07 )
0x1680    op01_JumpTo( address=0x169e )
0x1683    op02_JumpToConditional( val1=mem[0x242], val2=4096, condition="val1 & val2", address_if_false=0x1696 )
...
0x169e    op02_JumpToConditional( val1=mem[0x242], val2=-32768, condition="val1 & val2", address_if_false=0x16b1 )
...
0x16b9    op02_JumpToConditional( val1=mem[0x244], val2=16384, condition="val1 & val2", address_if_false=0x16d0 )
0x16c1    op02_JumpToConditional( val1=mem[0x244], val2=1024, condition="val1 & val2", address_if_false=0x16cc )
0x16c9    op01_JumpTo( address=0x16d0 )
0x16cc    op25_ActorDisable( actor_id=Actor_0x19 )
0x16ce    -- 0x27( actor_id=Actor_0x19 )
0x16d0    op02_JumpToConditional( val1=mem[0x244], val2=2, condition="val1 & val2", address_if_false=0x16dc )
0x16d8    op29_ActorTurnOff( actor_id=Actor_0x19 )
0x16da    op29_ActorTurnOff( actor_id=Actor_0x06 )
0x16dc    op02_JumpToConditional( val1=mem[0x240], val2=2048, condition="val1 & val2", address_if_false=0x16f7 )
0x16e4    -- 0x85()
0x16e9    -- 0x28()
...
0x1aa1    op02_JumpToConditional( val1=mem[0x242], val2=128, condition="val1 & val2", address_if_false=0x1ab2 )
0x1aa9    opD4_MessageShowFromActor( actor_id=Actor_0x08, text_id=0x63, flags=NO_FACE )
0x1aaf    op01_JumpTo( address=0x1aeb )
0x1ab2    op02_JumpToConditional( val1=mem[0x242], val2=64, condition="val1 & val2", address_if_false=0x1ac3 )
0x1aba    opD4_MessageShowFromActor( actor_id=Actor_0x08, text_id=0x64, flags=NO_FACE )
0x1ac0    op01_JumpTo( address=0x1aeb )
0x1ac3    op02_JumpToConditional( val1=mem[0x242], val2=32, condition="val1 & val2", address_if_false=0x1ad4 )
0x1acb    opD4_MessageShowFromActor( actor_id=Actor_0x08, text_id=0x65, flags=NO_FACE )
0x1ad1    op01_JumpTo( address=0x1aeb )
0x1ad4    op02_JumpToConditional( val1=mem[0x242], val2=16, condition="val1 & val2", address_if_false=0x1ae5 )
...
0x1b4a    op02_JumpToConditional( val1=mem[0x242], val2=128, condition="val1 & val2", address_if_false=0x1b73 )
...
0x1b73    op02_JumpToConditional( val1=mem[0x242], val2=64, condition="val1 & val2", address_if_false=0x1b9c )
...
0x1b9c    op02_JumpToConditional( val1=mem[0x242], val2=32, condition="val1 & val2", address_if_false=0x1bc5 )
...
0x1bc5    op02_JumpToConditional( val1=mem[0x242], val2=16, condition="val1 & val2", address_if_false=0x1bee )
...
0x2306    op02_JumpToConditional( val1=mem[0x242], val2=128, condition="val1 & val2", address_if_false=0x233f )
...
0x233f    op02_JumpToConditional( val1=mem[0x242], val2=64, condition="val1 & val2", address_if_false=0x2378 )
...
0x2378    op02_JumpToConditional( val1=mem[0x242], val2=32, condition="val1 & val2", address_if_false=0x23b1 )
...
0x23b1    op02_JumpToConditional( val1=mem[0x242], val2=16, condition="val1 & val2", address_if_false=0x23ea )
...
0x24df    op02_JumpToConditional( val1=mem[0x242], val2=128, condition="val1 & val2", address_if_false=0x24f0 )
0x24e7    opFC_MessageShowFromActorCopyFace( actor_id=Actor_0x07, text_id=0xf1, flags=0 )
0x24ed    op01_JumpTo( address=0x2529 )
0x24f0    op02_JumpToConditional( val1=mem[0x242], val2=64, condition="val1 & val2", address_if_false=0x2501 )
0x24f8    opFC_MessageShowFromActorCopyFace( actor_id=Actor_0x07, text_id=0xf2, flags=0 )
0x24fe    op01_JumpTo( address=0x2529 )
0x2501    op02_JumpToConditional( val1=mem[0x242], val2=32, condition="val1 & val2", address_if_false=0x2512 )
0x2509    opFC_MessageShowFromActorCopyFace( actor_id=Actor_0x07, text_id=0xf3, flags=0 )
0x250f    op01_JumpTo( address=0x2529 )
0x2512    op02_JumpToConditional( val1=mem[0x242], val2=16, condition="val1 & val2", address_if_false=0x2523 )
...
0x255c    op02_JumpToConditional( val1=mem[0x242], val2=128, condition="val1 & val2", address_if_false=0x256d )
0x2564    opFC_MessageShowFromActorCopyFace( actor_id=Actor_0x01, text_id=0xf9, flags=0 )
0x256a    op01_JumpTo( address=0x25a6 )
0x256d    op02_JumpToConditional( val1=mem[0x242], val2=64, condition="val1 & val2", address_if_false=0x257e )
0x2575    opFC_MessageShowFromActorCopyFace( actor_id=Actor_0x01, text_id=0xfa, flags=0 )
0x257b    op01_JumpTo( address=0x25a6 )
0x257e    op02_JumpToConditional( val1=mem[0x242], val2=32, condition="val1 & val2", address_if_false=0x258f )
0x2586    opFC_MessageShowFromActorCopyFace( actor_id=Actor_0x01, text_id=0xfb, flags=0 )
0x258c    op01_JumpTo( address=0x25a6 )
0x258f    op02_JumpToConditional( val1=mem[0x242], val2=16, condition="val1 & val2", address_if_false=0x25a0 )
...
0x3b2a    op02_JumpToConditional( val1=mem[0x242], val2=64, condition="val1 & val2", address_if_false=0x3b3d )
0x3b32    -- 0x7C()
0x3b36    -- 0x7E()
0x3b3a    op01_JumpTo( address=0x3b6b )
0x3b3d    op02_JumpToConditional( val1=mem[0x242], val2=32, condition="val1 & val2", address_if_false=0x3b50 )
0x3b45    -- 0x7C()
0x3b49    -- 0x7E()
0x3b4d    op01_JumpTo( address=0x3b6b )
0x3b50    op02_JumpToConditional( val1=mem[0x242], val2=16, condition="val1 & val2", address_if_false=0x3b63 )
0x3b58    -- 0x7C()
0x3b5c    -- 0x7E()
...
0x3b71    op0D_Return()
0x3b72    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x17a2, ???=(vf40)0xda9b, flag=0x3a )
