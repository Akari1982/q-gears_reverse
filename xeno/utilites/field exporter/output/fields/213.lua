...
0x19f0    opA9_MessageSetSelectionSync( start_row=02, end_row=03 )
...
0x1f21    opA9_MessageSetSelectionSync( start_row=00, end_row=02 )
0x1f23    op9C_MessageSync()
0x1f24    op02_JumpToConditional( val1=(s)mem[0x14], val2=0, condition="val1 == val2", address_if_false=0x1f76 )
0x1f2c    mem[0x424] = 4 -- op35
0x1f32    op09_CallActorEventEndSync( actor_id=Actor_0x10, event=event_0x17, priority=0x01 )
0x1f35    opFC_MessageShowFromActorCopyFace( actor_id=Actor_0x10, text_id=0xb9, flags=FORCE_TOP )
0x1f3a    op9C_MessageSync()
0x1f3b    -- 0x28()
...
0x200d    opA9_MessageSetSelectionSync( start_row=00, end_row=02 )
0x200f    op9C_MessageSync()
0x2010    op02_JumpToConditional( val1=(s)mem[0x14], val2=0, condition="val1 == val2", address_if_false=0x204a )
0x2018    mem[0x424] = 4 -- op35
0x201e    op09_CallActorEventEndSync( actor_id=Actor_0x10, event=event_0x17, priority=0x01 )
0x2021    opFC_MessageShowFromActorCopyFace( actor_id=Actor_0x10, text_id=0xbf, flags=FORCE_BOTTOM )
...
0x3b71    op0D_Return()
0x3b72    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0000, ???=(vf40)0xb79f, flag=0x1a )
