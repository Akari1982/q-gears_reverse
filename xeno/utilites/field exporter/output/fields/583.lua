...
0x0009    -- 0xF7()
0x000e    -- 0xFEB8()
0x0013    op02_JumpToConditional( val1=(s)mem[0x222], val2=512, condition="val1 & val2", address_if_false=0x21 )
0x001b    mem[0x40c] = 1 -- op35
0x0021    mem[0x400] = 1 -- op35
0x0027    mem[0x402] = 130 -- op35
0x002d    mem[0x404] = 130 -- op35
0x0033    mem[0x406] = 1 -- op35
0x0039    mem[0x408] = 3 -- op35
0x003f    mem[0x40a] = 1038 -- op35
0x0045    -- 0x2A()
0x0046    op00_Return()
...
0x007b    -- 0x19_ActorSetPosition( x=(vf80)0xfe16, z=(vf40)0xfe16, flag=(flag)0xc0 )
0x0081    -- 0xF8()
0x0085    -- 0xF8()
0x0089    -- 0x18()
0x008e    op00_Return()
...
0x009b    -- 0x98_MapLoad( field_id=566, value=5 )
0x00a0    -- 0x5B()
0x00a1    op00_Return()
...
0x02c6    op0D_Return()
0x02c7    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0000, ???=(vf40)0x0204, flag=0x26 )
