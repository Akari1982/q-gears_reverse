...
0x0223    op02_JumpToConditional( val1=(s)mem[0x27fe], val2=(s)mem[0xef02], condition="val1 < val2", address_if_false=0x6080 )
...
0x03e4    -- 0x2A()
0x03e5    -- 0xF9()
0x03e7    op02_JumpToConditional( val1=(s)mem[0x140], val2=1, condition="val1 == val2", address_if_false=0x3fb )
0x03ef    -- 0xFE1C()
