...
0x0a1c    op02_JumpToConditional( val1=(s)mem[0x1c2], val2=16, condition="val1 & val2", address_if_false=0xa73 )
0x0a24    -- 0xFE54()
...
Actor_0x17:on_start:
0x0ab8    op02_JumpToConditional( val1=(s)mem[0x1c2], val2=32, condition="val1 & val2", address_if_false=0xac5 )
0x0ac0    -- 0xBC_ActorNoModelInit()
0x0ac1    -- 0x2A()
0x0ac2    op01_JumpTo( address=0xae5 )
0x0ac5    -- 0x0B_InitNPC( 3 )
0x0ac8    -- 0xCD()
0x0ac9    op02_JumpToConditional( val1=(s)mem[0x1c2], val2=16, condition="val1 & val2", address_if_false=0xadf )
...
0x0af7    -- 0x85()
0x0afc    -- 0x85()
0x0b01    op02_JumpToConditional( val1=(s)mem[0x1c2], val2=1, condition="val1 & val2", address_if_false=0xb45 )
0x0b09    op02_JumpToConditional( val1=(s)mem[0x1c2], val2=16, condition="val1 & val2", address_if_false=0xb28 )
...
Actor_0x17:on_talk:
0x0b4a    -- 0x2A()
0x0b4b    op02_JumpToConditional( val1=(s)mem[0x1c2], val2=16, condition="val1 & val2", address_if_false=0xb5c )
...
0x1526    op02_JumpToConditional( val1=(s)mem[0x1c2], val2=1024, condition="val1 & val2", address_if_false=0x1530 )
0x152e    op29_ActorTurnOff( actor_id=Actor_0x10 )
0x1530    op02_JumpToConditional( val1=(s)mem[0x1c2], val2=2048, condition="val1 & val2", address_if_false=0x153a )
0x1538    op29_ActorTurnOff( actor_id=Actor_0x12 )
0x153a    op00_Return()
0x153b    -- 0x85()
0x1540    -- 0x85()
0x1545    op02_JumpToConditional( val1=(s)mem[0x1c2], val2=1, condition="val1 & val2", address_if_false=0x155e )
0x154d    op02_JumpToConditional( val1=(s)mem[0x1c2], val2=2, condition="val1 & val2", address_if_false=0x1558 )
