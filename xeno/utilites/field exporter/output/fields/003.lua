...
0x1257    op0D_Return()
0x1258    -- 0xFE69( actor_id=Actor_0x3c, render_settings=mem[0x3e04], rot_x=mem[0x3500], rot_y=(s)mem[0x43e] )
...
0x14d7    -- 0x5A()
0x14d8    op0D_Return()
0x14d9    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0038, ???=(vf40)0x00fd, flag=0x0 )
