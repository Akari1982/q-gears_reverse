...
0x06d6    -- 0x98_MapLoad( field_id=mem[0x400], value=1 )
0x06db    op00_Return()
...
0x07d8    op00_Return()
0x07d9    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0038, ???=(vf40)0x0000, flag=0x0 )
