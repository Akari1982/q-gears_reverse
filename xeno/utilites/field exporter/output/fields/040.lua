...
0x0020    op02_JumpToConditional( val1=mem[0xe4], val2=128, condition="val1 & val2", address_if_false=0x2c )
0x0028    -- 0x5B()
0x0029    op01_JumpTo( address=0x60 )
0x002c    -- 0xFE54()
0x002e    op26_Wait( time=3 )
0x0031    -- 0xB5() -- camera set direction
0x0036    op07_CallActorEvent( actor_id=Actor_0x0d, event=event_0x04, priority=0x06 )
0x0039    op26_Wait( time=20 )
0x003c    op07_CallActorEvent( actor_id=Actor_0x0e, event=event_0x04, priority=0x06 )
0x003f    op26_Wait( time=10 )
0x0042    op07_CallActorEvent( actor_id=Actor_0x12, event=event_0x04, priority=0x06 )
0x0045    -- 0xFE23()
0x005a    op26_Wait( time=100 )
0x005d    op07_CallActorEvent( actor_id=Actor_0x10, event=event_0x04, priority=0x06 )
0x0060    -- 0x5B()
0x0061    op00_Return()
...
0x01ca    op02_JumpToConditional( val1=mem[0xe4], val2=128, condition="val1 & val2", address_if_false=0x1d7 )
...
0x0295    op02_JumpToConditional( val1=mem[0xe4], val2=128, condition="val1 & val2", address_if_false=0x2a2 )
...
0x0400    op02_JumpToConditional( val1=mem[0xe4], val2=128, condition="val1 & val2", address_if_false=0x414 )
