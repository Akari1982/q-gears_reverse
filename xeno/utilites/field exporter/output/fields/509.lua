...
0x090c    op02_JumpToConditional( val1=(s)mem[0x1c6], val2=4096, condition="val1 & val2", address_if_false=0x91c )
...
0x0932    op02_JumpToConditional( val1=(s)mem[0x1c6], val2=4096, condition="val1 & val2", address_if_false=0x946 )
...
0x095e    -- 0x85()
0x0963    op01_JumpTo( address=0x974 )
0x0966    op01_JumpTo( address=0x987 )
0x0969    op02_JumpToConditional( val1=(s)mem[0x1c6], val2=4096, condition="val1 & val2", address_if_false=0x974 )
0x0971    op01_JumpTo( address=0x987 )
0x0974    op02_JumpToConditional( val1=(s)mem[0x438], val2=0, condition="val1 == val2", address_if_false=0x981 )
0x097c    op2C_SpritePlayAnim( anim_id=0x1 )
...
0x0994    op02_JumpToConditional( val1=(s)mem[0x1c6], val2=4096, condition="val1 & val2", address_if_false=0x9a8 )
...
0x09c0    -- 0x85()
0x09c5    op01_JumpTo( address=0x9d6 )
0x09c8    op01_JumpTo( address=0x9e9 )
0x09cb    op02_JumpToConditional( val1=(s)mem[0x1c6], val2=4096, condition="val1 & val2", address_if_false=0x9d6 )
0x09d3    op01_JumpTo( address=0x9e9 )
0x09d6    op02_JumpToConditional( val1=(s)mem[0x43a], val2=0, condition="val1 == val2", address_if_false=0x9e3 )
0x09de    op2C_SpritePlayAnim( anim_id=0x1 )
0x09e0    mem[0x43a] = true -- op36
0x09e3    op6C_ActorRotateAnticlockwise( rot=1 )
0x09e6    op26_Wait( time=1 )
0x09e9    op00_Return()
...
0x175e    opFE42( ???=2 )
0x1762    op0D_Return()
0x1763    -- 0xE0( actor_id=Actor_0x48, ???=(vf80)0xde6e, ???=(vf40)0x331a, flag=0xbb )
