...
0x0350    op0D_Return()
0x0351    -- 0xFE69( actor_id=Actor_0x3a, render_settings=(s)mem[0x3e04], rot_x=(s)mem[0x3500], rot_y=(s)mem[0x43c] )
0x035a    op01_JumpTo( address=0x4000 )
...
0x05d0    -- 0x5A()
0x05d1    op0D_Return()
0x05d2    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0xdb52, ???=(vf40)0x791c, flag=0x78 )
