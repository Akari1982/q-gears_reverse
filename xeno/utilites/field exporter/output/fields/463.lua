...
0x0350    op0D_Return()
0x0351    -- 0xFE69( actor_id=Actor_0x3a, render_settings=(s)mem[0x3e04], rot_x=mem[0x3500], rot_y=(s)mem[0x43c] )
...
0x05d0    -- 0x5A()
0x05d1    op0D_Return()
0x05d2    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0xe0f1, ???=(vf40)0xf351, flag=0x36 )
