...
0x31e1    op02_JumpToConditional( val1=mem[0x504], val2=512, condition="val1 < val2", address_if_false=0x31f2 )
0x31e9    -- 0xBF( ???=2 )
...
0x3266    op02_JumpToConditional( val1=mem[0x50a], val2=512, condition="val1 < val2", address_if_false=0x3277 )
0x326e    -- 0xBF( ???=2 )
...
0x3308    -- 0xA3()
0x3310    opAC_MoveCamera( control=0x0, steps=mem[0x50c] )
0x3314    opAC_MoveCamera( control=0x1, steps=mem[0x50c] )
0x3318    opEF_MoveCameraSync()
0x331b    -- 0x65( ???=(s)mem[0x526], ???=mem[0x52a], ???=(s)mem[0x528] ) -- exp0x1
...
0x3361    -- 0xA3()
0x3369    opAC_MoveCamera( control=0x0, steps=mem[0x50c] )
0x336d    opAC_MoveCamera( control=0x1, steps=mem[0x50c] )
0x3371    opEF_MoveCameraSync()
0x3374    -- 0x65( ???=(s)mem[0x526], ???=mem[0x52a], ???=(s)mem[0x528] ) -- exp0x1
...
0x346f    -- 0xA3()
0x3477    opAC_MoveCamera( control=0x0, steps=mem[0x50c] )
0x347b    opAC_MoveCamera( control=0x1, steps=mem[0x50c] )
0x347f    opEF_MoveCameraSync()
0x3482    -- 0x65( ???=(s)mem[0x526], ???=mem[0x52a], ???=(s)mem[0x528] ) -- exp0x1
...
0x34b4    op0D_Return()
0x34b5    opAC_MoveCamera( control=0x0, steps=mem[0x50c] )
0x34b9    opAC_MoveCamera( control=0x1, steps=mem[0x50c] )
0x34bd    opEF_MoveCameraSync()
0x34c0    op0D_Return()
0x34c1    opAC_MoveCamera( control=0x80, steps=mem[0x50c] )
0x34c5    opAC_MoveCamera( control=0x81, steps=mem[0x50c] )
