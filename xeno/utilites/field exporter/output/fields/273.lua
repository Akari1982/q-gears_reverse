...
0x331b    -- 0x65( ???=(s)mem[0x526], ???=mem[0x52a], ???=mem[0x528] ) -- exp0x1
...
0x3374    -- 0x65( ???=(s)mem[0x526], ???=mem[0x52a], ???=mem[0x528] ) -- exp0x1
...
0x33e6    -- 0x63( ???=mem[0x51a], ???=mem[0x51c], ???=(s)mem[0x51e] ) -- exp0x1
...
0x341d    -- 0x63( ???=mem[0x51a], ???=mem[0x51c], ???=(s)mem[0x51e] ) -- exp0x1
...
0x3482    -- 0x65( ???=(s)mem[0x526], ???=mem[0x52a], ???=mem[0x528] ) -- exp0x1
...
0x37ac    op00_Return()
0x37ad    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0038, ???=(vf40)0x0000, flag=0x78 )
