...
0x003f    op02_JumpToConditional( val1=mem[0x164], val2=16, condition="val1 & val2", address_if_false=0x4a )
...
0x01b7    op00_Return()
0x01b8    op00_Return()
0x01b9    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0038, ???=(vf40)0x0000, flag=0x53 )
