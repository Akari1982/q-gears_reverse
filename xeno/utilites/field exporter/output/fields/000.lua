...
0x0018    op02_JumpToConditional( val1=(s)mem[0x50], val2=0, condition="val1 == val2", address_if_false=0x23 )
...
0x07e8    mem[0x1a] = mem[0x408] -- op35
0x07ee    mem[0x16] = mem[0x40c] -- op35
...
0x0908    -- 0xC4()
0x090a    -- 0x1F( ???=0x11 )
0x090c    -- 0x47( ???=mem[0x408], ???=mem[0x40a] )
0x0912    op00_Return()
...
0x0ce7    mem[0x16] = mem[0x40e] -- op35
0x0ced    mem[0x18] = (s)mem[0x410] -- op35
0x0cf3    mem[0x1a] = mem[0x412] -- op35
...
0x0f9d    mem[0x1a] = mem[0x418] -- op35
0x0fa3    op74_SoundPlayFixedVolume( sound_id=mem[0x418] )
...
0x1037    op02_JumpToConditional( val1=mem[0x40e], val2=127, condition="val1 < val2", address_if_false=0x1048 )
0x103f    mem[0x40e] += 1 -- op3c
0x1042    -- 0xFE0E_SoundSetVolume( volume=mem[0x40e], steps=0 )
0x1048    op00_Return()
...
0x1072    op02_JumpToConditional( val1=mem[0x412], val2=-1, condition="val1 < val2", address_if_false=0x1083 )
0x107a    mem[0x412] += 1 -- op3c
0x107d    -- 0xFE10()
0x1083    op00_Return()
0x1084    op01_JumpTo( address=0x1087 )
0x1087    op31_JumpIfButtonNotPressed( buttons=L1, jump_to=0x10f0 )
0x108c    op02_JumpToConditional( val1=(s)mem[0x414], val2=0, condition="val1 == val2", address_if_false=0x1098 )
0x1094    op00_Return()
0x1095    op01_JumpTo( address=0x10f0 )
0x1098    op02_JumpToConditional( val1=(s)mem[0x414], val2=1, condition="val1 == val2", address_if_false=0x10b5 )
0x10a0    op02_JumpToConditional( val1=mem[0x40e], val2=0, condition="val1 > val2", address_if_false=0x10b1 )
0x10a8    mem[0x40e] -= 1 -- op3d
0x10ab    -- 0xFE0E_SoundSetVolume( volume=mem[0x40e], steps=0 )
0x10b1    op00_Return()
0x10b2    op01_JumpTo( address=0x10f0 )
0x10b5    op02_JumpToConditional( val1=(s)mem[0x414], val2=2, condition="val1 == val2", address_if_false=0x10d3 )
0x10bd    op02_JumpToConditional( val1=(s)mem[0x410], val2=-128, condition="val1 > val2", address_if_false=0x10cf )
0x10c5    mem[0x410] -= 1 -- op3d
0x10c8    -- 0xFE0F()
0x10cf    op00_Return()
0x10d0    op01_JumpTo( address=0x10f0 )
0x10d3    op02_JumpToConditional( val1=(s)mem[0x414], val2=3, condition="val1 == val2", address_if_false=0x10f0 )
0x10db    op02_JumpToConditional( val1=mem[0x412], val2=1, condition="val1 > val2", address_if_false=0x10ec )
0x10e3    mem[0x412] -= 1 -- op3d
0x10e6    -- 0xFE10()
0x10ec    op00_Return()
0x10ed    op01_JumpTo( address=0x10f0 )
0x10f0    op31_JumpIfButtonNotPressed( buttons=Cross, jump_to=0x114a )
0x10f5    op02_JumpToConditional( val1=(s)mem[0x414], val2=0, condition="val1 == val2", address_if_false=0x1101 )
0x10fd    op00_Return()
0x10fe    op01_JumpTo( address=0x114a )
0x1101    op02_JumpToConditional( val1=(s)mem[0x414], val2=1, condition="val1 == val2", address_if_false=0x1119 )
0x1109    mem[0x40e] = 127 -- op35
0x110f    -- 0xFE0E_SoundSetVolume( volume=mem[0x40e], steps=0 )
0x1115    op00_Return()
0x1116    op01_JumpTo( address=0x114a )
0x1119    op02_JumpToConditional( val1=(s)mem[0x414], val2=2, condition="val1 == val2", address_if_false=0x1132 )
0x1121    mem[0x410] = 0 -- op35
0x1127    -- 0xFE0F()
0x112e    op00_Return()
0x112f    op01_JumpTo( address=0x114a )
0x1132    op02_JumpToConditional( val1=(s)mem[0x414], val2=3, condition="val1 == val2", address_if_false=0x114a )
0x113a    mem[0x412] = 256 -- op35
0x1140    -- 0xFE10()
0x1146    op00_Return()
0x1147    op01_JumpTo( address=0x114a )
0x114a    op00_Return()
...
Actor_0x19:on_start:
0x114d    -- 0x0B_InitNPC( 4 )
0x1150    -- 0x19_ActorSetPosition( x=(vf80)0xfed4, z=(vf40)0x0064, flag=(flag)0xc0 )
0x1156    op00_Return()
...
Actor_0x19:on_talk:
0x1158    -- 0xE7( ???=0, ???=233, ???=153 )
0x115f    opD0_MessageSettings( x=16, y=0, letters=23, rows=0, flags=0 )
0x116a    mem[0x16] = false -- op37
0x116d    opD2_MessageShowDynamic( text_id=0x35, flags=NO_FACE )
0x1171    opA9_MessageSetSelectionSync( start_row=01, end_row=06 )
0x1173    op9C_MessageSync()
0x1174    op02_JumpToConditional( val1=(s)mem[0x14], val2=1, condition="val1 == val2", address_if_false=0x11ba )
0x117c    opFE0D_MessageSetFace( char_id=(s)mem[0x16] )
0x1180    opD2_MessageShowDynamic( text_id=0x36, flags=CLOSE_OFF_SCREEN )
0x1184    opA9_MessageSetSelectionSync( start_row=01, end_row=03 )
0x1186    op9C_MessageSync()
0x1187    op02_JumpToConditional( val1=(s)mem[0x14], val2=1, condition="val1 == val2", address_if_false=0x1198 )
0x118f    mem[0x16] += 1 -- op3c
0x1192    op01_JumpTo( address=0x117c )
0x1195    op01_JumpTo( address=0x11b7 )
0x1198    op02_JumpToConditional( val1=(s)mem[0x14], val2=2, condition="val1 == val2", address_if_false=0x11a9 )
0x11a0    mem[0x16] -= 1 -- op3d
0x11a3    op01_JumpTo( address=0x117c )
0x11a6    op01_JumpTo( address=0x11b7 )
0x11a9    op02_JumpToConditional( val1=(s)mem[0x14], val2=3, condition="val1 == val2", address_if_false=0x11b7 )
0x11b1    op01_JumpTo( address=0x116d )
0x11b4    op01_JumpTo( address=0x11b7 )
0x11b7    op01_JumpTo( address=0x120f )
0x11ba    op02_JumpToConditional( val1=(s)mem[0x14], val2=2, condition="val1 == val2", address_if_false=0x11cb )
0x11c2    mem[0x16] += 1 -- op3c
0x11c5    op01_JumpTo( address=0x116d )
0x11c8    op01_JumpTo( address=0x120f )
0x11cb    op02_JumpToConditional( val1=(s)mem[0x14], val2=3, condition="val1 == val2", address_if_false=0x11dc )
0x11d3    mem[0x16] -= 1 -- op3d
0x11d6    op01_JumpTo( address=0x116d )
0x11d9    op01_JumpTo( address=0x120f )
0x11dc    op02_JumpToConditional( val1=(s)mem[0x14], val2=4, condition="val1 == val2", address_if_false=0x11f0 )
0x11e4    mem[0x16] += 10 -- op38
0x11ea    op01_JumpTo( address=0x116d )
0x11ed    op01_JumpTo( address=0x120f )
0x11f0    op02_JumpToConditional( val1=(s)mem[0x14], val2=5, condition="val1 == val2", address_if_false=0x1204 )
0x11f8    mem[0x16] -= 10 -- op39
0x11fe    op01_JumpTo( address=0x116d )
0x1201    op01_JumpTo( address=0x120f )
0x1204    op02_JumpToConditional( val1=(s)mem[0x14], val2=6, condition="val1 == val2", address_if_false=0x120f )
0x120c    op01_JumpTo( address=0x120f )
0x120f    op00_Return()
...
Actor_0x1a:on_start:
0x1211    -- 0x0B_InitNPC( 2 )
0x1214    -- 0x19_ActorSetPosition( x=(vf80)0xff38, z=(vf40)0xffce, flag=(flag)0xc0 )
0x121a    -- 0x5F( ???=0x7 )
0x121c    op00_Return()
...
Actor_0x1a:on_talk:
0x121e    opD2_MessageShowDynamic( text_id=0x37, flags=0 )
0x1222    opA9_MessageSetSelectionSync( start_row=01, end_row=04 )
0x1224    op9C_MessageSync()
0x1225    op02_JumpToConditional( val1=(s)mem[0x14], val2=1, condition="val1 == val2", address_if_false=0x123c )
0x122d    -- 0xFE41()
0x1231    -- 0xFE41()
0x1235    -- 0xFE41()
0x1239    op01_JumpTo( address=0x1333 )
0x123c    op02_JumpToConditional( val1=(s)mem[0x14], val2=2, condition="val1 == val2", address_if_false=0x1253 )
0x1244    opFE42( ???=0 )
0x1248    opFE42( ???=1 )
0x124c    opFE42( ???=2 )
0x1250    op01_JumpTo( address=0x1333 )
0x1253    op02_JumpToConditional( val1=(s)mem[0x14], val2=3, condition="val1 == val2", address_if_false=0x1328 )
0x125b    opD2_MessageShowDynamic( text_id=0x38, flags=0 )
0x125f    opA9_MessageSetSelectionSync( start_row=02, end_row=0a )
0x1261    op9C_MessageSync()
0x1262    op02_JumpToConditional( val1=(s)mem[0x14], val2=2, condition="val1 == val2", address_if_false=0x1279 )
0x126a    opFE42( ???=0 )
0x126e    opFE42( ???=1 )
0x1272    opFE42( ???=2 )
0x1276    op01_JumpTo( address=0x1325 )
0x1279    op02_JumpToConditional( val1=(s)mem[0x14], val2=3, condition="val1 == val2", address_if_false=0x1290 )
0x1281    -- 0xFE41()
0x1285    opFE42( ???=1 )
0x1289    opFE42( ???=2 )
0x128d    op01_JumpTo( address=0x1325 )
0x1290    op02_JumpToConditional( val1=(s)mem[0x14], val2=4, condition="val1 == val2", address_if_false=0x12a7 )
0x1298    opFE42( ???=0 )
0x129c    -- 0xFE41()
0x12a0    opFE42( ???=2 )
0x12a4    op01_JumpTo( address=0x1325 )
0x12a7    op02_JumpToConditional( val1=(s)mem[0x14], val2=5, condition="val1 == val2", address_if_false=0x12be )
0x12af    opFE42( ???=0 )
0x12b3    opFE42( ???=1 )
0x12b7    -- 0xFE41()
0x12bb    op01_JumpTo( address=0x1325 )
0x12be    op02_JumpToConditional( val1=(s)mem[0x14], val2=6, condition="val1 == val2", address_if_false=0x12d5 )
0x12c6    opFE42( ???=0 )
0x12ca    -- 0xFE41()
0x12ce    -- 0xFE41()
0x12d2    op01_JumpTo( address=0x1325 )
0x12d5    op02_JumpToConditional( val1=(s)mem[0x14], val2=7, condition="val1 == val2", address_if_false=0x12ec )
0x12dd    -- 0xFE41()
0x12e1    opFE42( ???=1 )
0x12e5    -- 0xFE41()
0x12e9    op01_JumpTo( address=0x1325 )
0x12ec    op02_JumpToConditional( val1=(s)mem[0x14], val2=8, condition="val1 == val2", address_if_false=0x1303 )
0x12f4    -- 0xFE41()
0x12f8    -- 0xFE41()
0x12fc    opFE42( ???=2 )
0x1300    op01_JumpTo( address=0x1325 )
0x1303    op02_JumpToConditional( val1=(s)mem[0x14], val2=9, condition="val1 == val2", address_if_false=0x131a )
0x130b    -- 0xFE41()
0x130f    -- 0xFE41()
0x1313    -- 0xFE41()
0x1317    op01_JumpTo( address=0x1325 )
0x131a    op02_JumpToConditional( val1=(s)mem[0x14], val2=10, condition="val1 == val2", address_if_false=0x1325 )
0x1322    op01_JumpTo( address=0x1325 )
0x1325    op01_JumpTo( address=0x1333 )
0x1328    op02_JumpToConditional( val1=(s)mem[0x14], val2=3, condition="val1 == val2", address_if_false=0x1333 )
0x1330    op01_JumpTo( address=0x1333 )
0x1333    op00_Return()

Actor_0x1a:on_push:
0x1334    op00_Return()
0x1335    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0538, ???=(vf40)0x1635, flag=0x0 )
