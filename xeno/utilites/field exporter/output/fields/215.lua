...
0x0010    op02_JumpToConditional( val1=mem[0x244], val2=256, condition="val1 & val2", address_if_false=0x31 )
0x0018    op02_JumpToConditional( val1=mem[0x240], val2=16, condition="val1 & val2", address_if_false=0x23 )
...
0x003b    op02_JumpToConditional( val1=mem[0x244], val2=2, condition="val1 & val2", address_if_false=0x4a )
...
0x015c    opCB_TriggerJumpTo( trigger_id=0x0, jump=0x166 )
0x0160    -- 0x98_MapLoad( field_id=216, value=0 )
0x0165    -- 0x5B()
0x0166    op00_Return()
...
Actor_0x0c:on_start:
0x0168    -- 0x16_ActorPCInit( char_id=1 )
0x016b    opFE0D_MessageSetFace( char_id=1 )
0x016f    op00_Return()
...
Actor_0x0d:on_start:
0x0173    -- 0x16_ActorPCInit( char_id=2 )
0x0176    opFE0D_MessageSetFace( char_id=2 )
0x017a    op00_Return()
...
Actor_0x0e:on_start:
0x017e    -- 0x16_ActorPCInit( char_id=3 )
0x0181    opFE0D_MessageSetFace( char_id=3 )
0x0185    op00_Return()
...
Actor_0x0f:on_start:
0x0189    -- 0x16_ActorPCInit( char_id=4 )
...
Actor_0x10:on_start:
0x0194    -- 0x16_ActorPCInit( char_id=5 )
0x0197    opFE0D_MessageSetFace( char_id=5 )
0x019b    op00_Return()
...
Actor_0x12:on_start:
0x01aa    -- 0x16_ActorPCInit( char_id=7 )
0x01ad    opFE0D_MessageSetFace( char_id=7 )
0x01b1    op00_Return()
...
Actor_0x13:on_start:
0x01b5    -- 0x16_ActorPCInit( char_id=8 )
0x01b8    opFE0D_MessageSetFace( char_id=8 )
0x01bc    op00_Return()
...
Actor_0x14:on_start:
0x01c0    -- 0x16_ActorPCInit( char_id=9 )
0x01c3    opFE0D_MessageSetFace( char_id=9 )
0x01c7    op00_Return()
...
Actor_0x15:on_start:
0x01cb    -- 0x16_ActorPCInit( char_id=10 )
0x01ce    opFE0D_MessageSetFace( char_id=10 )
0x01d2    op00_Return()
...
Actor_0x16:on_push:
0x01da    op00_Return()
0x01db    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0xe840, ???=(vf40)0xd203, flag=0x8 )
