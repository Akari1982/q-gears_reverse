...
0x0101    -- 0x04()
0x0102    op02_JumpToConditional( val1=(s)mem[0x4000], val2=(s)mem[0xe34], condition="val1 >= val2", address_if_false=0x10 )
0x010a    mem[0x2e05] ^= (s)mem[0x3508] -- op40
0x0110    -- 0x04()
0x0111    op20_ActorSetFlags0( flags=(s)mem[0x4000] )
