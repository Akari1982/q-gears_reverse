...
0x001c    op02_JumpToConditional( val1=mem[0x140], val2=5, condition="val1 == val2", address_if_false=0x73 )
...
0x0107    op02_JumpToConditional( val1=mem[0x148], val2=20, condition="val1 == val2", address_if_false=0x160 )
...
0x0160    op02_JumpToConditional( val1=mem[0x148], val2=22, condition="val1 == val2", address_if_false=0x1b9 )
...
0x023e    op02_JumpToConditional( val1=mem[0x140], val2=5, condition="val1 == val2", address_if_false=0x257 )
...
0x02aa    op02_JumpToConditional( val1=mem[0x148], val2=20, condition="val1 == val2", address_if_false=0x2c3 )
...
0x02c3    op02_JumpToConditional( val1=mem[0x148], val2=22, condition="val1 == val2", address_if_false=0x2dc )
...
0x07b5    op02_JumpToConditional( val1=mem[0x140], val2=5, condition="val1 >= val2", address_if_false=0x823 )
...
0x07cb    op02_JumpToConditional( val1=mem[0x148], val2=20, condition="val1 == val2", address_if_false=0x7d8 )
0x07d3    op29_ActorTurnOff( actor_id=Actor_0x01 )
0x07d5    op01_JumpTo( address=0x820 )
0x07d8    op02_JumpToConditional( val1=mem[0x148], val2=30, condition="val1 == val2", address_if_false=0x803 )
...
0x0803    op02_JumpToConditional( val1=mem[0x148], val2=22, condition="val1 == val2", address_if_false=0x810 )
...
0x0c6a    op02_JumpToConditional( val1=mem[0x140], val2=5, condition="val1 == val2", address_if_false=0xc7b )
...
0x0c97    op02_JumpToConditional( val1=mem[0x148], val2=20, condition="val1 == val2", address_if_false=0xcb7 )
...
0x0cb7    op02_JumpToConditional( val1=mem[0x148], val2=22, condition="val1 == val2", address_if_false=0xcc8 )
...
0x0d6b    op02_JumpToConditional( val1=mem[0x140], val2=5, condition="val1 == val2", address_if_false=0xd7c )
...
0x0d98    op02_JumpToConditional( val1=mem[0x148], val2=20, condition="val1 == val2", address_if_false=0xdb8 )
...
0x0db8    op02_JumpToConditional( val1=mem[0x148], val2=22, condition="val1 == val2", address_if_false=0xdc9 )
...
0x0eb5    -- 0x5F( ???=0x1 )
0x0eb7    op02_JumpToConditional( val1=mem[0x140], val2=5, condition="val1 == val2", address_if_false=0xec4 )
...
0x0ee0    op02_JumpToConditional( val1=mem[0x148], val2=20, condition="val1 == val2", address_if_false=0xef7 )
...
0x0ef7    op02_JumpToConditional( val1=mem[0x148], val2=22, condition="val1 == val2", address_if_false=0xf08 )
...
Actor_0x1a:on_push:
0x11ea    op00_Return()
0x11eb    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0000, ???=(vf40)0x004a, flag=0x80 )
