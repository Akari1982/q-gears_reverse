...
0x0009    -- 0xA0()
0x0010    op02_JumpToConditional( val1=mem[0x102], val2=24, condition="val1 >= val2", address_if_false=0x26 )
0x0018    op02_JumpToConditional( val1=mem[0x102], val2=27, condition="val1 <= val2", address_if_false=0x26 )
...
0x0037    op02_JumpToConditional( val1=mem[0x102], val2=25, condition="val1 >= val2", address_if_false=0x4f )
0x003f    op02_JumpToConditional( val1=mem[0x102], val2=27, condition="val1 <= val2", address_if_false=0x4f )
...
0x00a1    op02_JumpToConditional( val1=mem[0x102], val2=25, condition="val1 >= val2", address_if_false=0xb9 )
0x00a9    op02_JumpToConditional( val1=mem[0x102], val2=27, condition="val1 <= val2", address_if_false=0xb9 )
...
0x0128    op02_JumpToConditional( val1=mem[0x102], val2=25, condition="val1 == val2", address_if_false=0x138 )
0x0130    -- 0x19_ActorSetPosition( x=(vf80)0x0044, z=(vf40)0x0099, flag=(flag)0xc0 )
0x0136    -- 0x5F( ???=0x6 )
0x0138    op02_JumpToConditional( val1=mem[0x102], val2=26, condition="val1 == val2", address_if_false=0x148 )
...
0x0148    op02_JumpToConditional( val1=mem[0x102], val2=27, condition="val1 == val2", address_if_false=0x158 )
...
0x0311    op02_JumpToConditional( val1=mem[0x102], val2=24, condition="val1 == val2", address_if_false=0x321 )
0x0319    -- 0x19_ActorSetPosition( x=(vf80)0xffed, z=(vf40)0xffbf, flag=(flag)0xc0 )
0x031f    -- 0x5F( ???=0x5 )
0x0321    op02_JumpToConditional( val1=mem[0x102], val2=25, condition="val1 >= val2", address_if_false=0x339 )
0x0329    op02_JumpToConditional( val1=mem[0x102], val2=27, condition="val1 <= val2", address_if_false=0x339 )
0x0331    -- 0x19_ActorSetPosition( x=(vf80)0xffbf, z=(vf40)0xfff0, flag=(flag)0xc0 )
0x0337    -- 0x5F( ???=0x5 )
0x0339    op02_JumpToConditional( val1=mem[0x102], val2=44, condition="val1 == val2", address_if_false=0x34a )
...
0x04d1    op02_JumpToConditional( val1=mem[0x102], val2=44, condition="val1 == val2", address_if_false=0x4e5 )
...
0x04f7    op02_JumpToConditional( val1=mem[0x102], val2=44, condition="val1 == val2", address_if_false=0x50b )
...
0x051a    op02_JumpToConditional( val1=mem[0x102], val2=44, condition="val1 == val2", address_if_false=0x52e )
...
0x053d    op02_JumpToConditional( val1=mem[0x102], val2=44, condition="val1 == val2", address_if_false=0x551 )
...
0x0560    op02_JumpToConditional( val1=mem[0x102], val2=44, condition="val1 == val2", address_if_false=0x574 )
...
0x0583    op02_JumpToConditional( val1=mem[0x102], val2=44, condition="val1 == val2", address_if_false=0x597 )
...
0x05a6    op02_JumpToConditional( val1=mem[0x102], val2=44, condition="val1 == val2", address_if_false=0x5b9 )
...
Actor_0x26:on_talk:
0x05c4    op02_JumpToConditional( val1=mem[0x102], val2=36, condition="val1 >= val2", address_if_false=0x5db )
0x05cc    -- 0x15()
0x05cd    -- 0xC4()
0x05cf    -- 0x1F( ???=0x11 )
0x05d1    -- 0x47( ???=474, ???=7 )
...
0x07a9    op02_JumpToConditional( val1=mem[0x102], val2=2, condition="val1 >= val2", address_if_false=0x800 )
0x07b1    op02_JumpToConditional( val1=mem[0x102], val2=18, condition="val1 <= val2", address_if_false=0x800 )
0x07b9    -- 0xFB()
...
0x07fc    -- 0x28()
0x07fe    -- 0x28()
0x0800    op02_JumpToConditional( val1=mem[0x102], val2=24, condition="val1 >= val2", address_if_false=0x81c )
0x0808    op02_JumpToConditional( val1=mem[0x102], val2=28, condition="val1 < val2", address_if_false=0x81c )
...
0x0820    op02_JumpToConditional( val1=mem[0x102], val2=44, condition="val1 == val2", address_if_false=0x833 )
0x0828    opF1_FadeSetUp( steps=2, r=255, g=255, b=255, semi_tr=1 )
0x0833    op00_Return()

Actor_0x2a:on_update:
0x0834    op02_JumpToConditional( val1=mem[0x102], val2=0, condition="val1 == val2", address_if_false=0x83d )
0x083c    op00_Return()
0x083d    op02_JumpToConditional( val1=mem[0x102], val2=8, condition="val1 <= val2", address_if_false=0x848 )
0x0845    op01_JumpTo( address=0x881 )
0x0848    op02_JumpToConditional( val1=mem[0x102], val2=24, condition="val1 == val2", address_if_false=0x853 )
0x0850    op01_JumpTo( address=0x9af )
0x0853    op02_JumpToConditional( val1=mem[0x102], val2=25, condition="val1 == val2", address_if_false=0x85e )
0x085b    op01_JumpTo( address=0xacc )
0x085e    op02_JumpToConditional( val1=mem[0x102], val2=26, condition="val1 == val2", address_if_false=0x869 )
0x0866    op01_JumpTo( address=0xb6f )
0x0869    op02_JumpToConditional( val1=mem[0x102], val2=27, condition="val1 == val2", address_if_false=0x874 )
0x0871    op01_JumpTo( address=0xc4e )
0x0874    op02_JumpToConditional( val1=mem[0x102], val2=44, condition="val1 == val2", address_if_false=0x87f )
...
0x08e5    op9C_MessageSync()
0x08e6    op02_JumpToConditional( val1=mem[0x12a], val2=1, condition="val1 == val2", address_if_false=0x8f4 )
...
0x093f    op02_JumpToConditional( val1=mem[0x12a], val2=2, condition="val1 == val2", address_if_false=0x94d )
...
0x098f    op02_JumpToConditional( val1=mem[0x12a], val2=2, condition="val1 == val2", address_if_false=0x99d )
...
0x09eb    op02_JumpToConditional( val1=mem[0x12a], val2=1, condition="val1 == val2", address_if_false=0x9f9 )
...
0x1122    op02_JumpToConditional( val1=mem[0x12a], val2=0, condition="val1 == val2", address_if_false=0x112d )
...
0x122f    op02_JumpToConditional( val1=mem[0x12a], val2=1, condition="val1 == val2", address_if_false=0x123a )
