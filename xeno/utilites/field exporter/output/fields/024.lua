...
0x082e    op02_JumpToConditional( val1=(s)mem[0x400], val2=2, condition="val1 == val2", address_if_false=0x843 )
...
0x0890    op02_JumpToConditional( val1=(s)mem[0x400], val2=3, condition="val1 == val2", address_if_false=0x89c )
0x0898    -- 0x5A()
...
0x08fd    op02_JumpToConditional( val1=(s)mem[0x400], val2=5, condition="val1 == val2", address_if_false=0x909 )
0x0905    -- 0x5A()
...
0x092b    op02_JumpToConditional( val1=(s)mem[0x400], val2=6, condition="val1 == val2", address_if_false=0x937 )
0x0933    -- 0x5A()
...
0x0954    op02_JumpToConditional( val1=(s)mem[0x400], val2=7, condition="val1 == val2", address_if_false=0x960 )
0x095c    -- 0x5A()
...
0x097c    op02_JumpToConditional( val1=(s)mem[0x400], val2=8, condition="val1 == val2", address_if_false=0x987 )
...
0x09d5    op02_JumpToConditional( val1=(s)mem[0x402], val2=0, condition="val1 == val2", address_if_false=0x9e1 )
0x09dd    -- 0x5A()
...
Actor_0x11:on_push:
0x0e84    op00_Return()
0x0e85    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x6338, ???=(vf40)0x4000, flag=0xdb )
