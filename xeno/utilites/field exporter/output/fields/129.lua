...
0x0058    op69_ActorSetRotation( rot=mem[0x406] )
...
0x0069    op69_ActorSetRotation( rot=mem[0x408] )
...
0x007a    op69_ActorSetRotation( rot=mem[0x40a] )
...
0x00aa    op69_ActorSetRotation( rot=mem[0x406] )
...
0x00bb    op69_ActorSetRotation( rot=mem[0x408] )
...
0x00cc    op69_ActorSetRotation( rot=mem[0x40a] )
...
0x00f1    op69_ActorSetRotation( rot=mem[0x406] )
...
0x0102    op69_ActorSetRotation( rot=mem[0x408] )
...
0x0113    op69_ActorSetRotation( rot=mem[0x40a] )
...
0x0138    op69_ActorSetRotation( rot=mem[0x406] )
...
0x0149    op69_ActorSetRotation( rot=mem[0x408] )
...
0x015a    op69_ActorSetRotation( rot=mem[0x40a] )
...
0x017f    op69_ActorSetRotation( rot=mem[0x406] )
...
0x0190    op69_ActorSetRotation( rot=mem[0x408] )
...
0x01a1    op69_ActorSetRotation( rot=mem[0x40a] )
...
0x01c6    op69_ActorSetRotation( rot=mem[0x406] )
...
0x01d7    op69_ActorSetRotation( rot=mem[0x408] )
...
0x01e8    op69_ActorSetRotation( rot=mem[0x40a] )
...
0x020d    op69_ActorSetRotation( rot=mem[0x406] )
...
0x021e    op69_ActorSetRotation( rot=mem[0x408] )
...
0x022f    op69_ActorSetRotation( rot=mem[0x40a] )
...
0x0254    op69_ActorSetRotation( rot=mem[0x406] )
...
0x0265    op69_ActorSetRotation( rot=mem[0x408] )
...
0x0276    op69_ActorSetRotation( rot=mem[0x40a] )
...
0x029b    op69_ActorSetRotation( rot=mem[0x406] )
...
0x02ac    op69_ActorSetRotation( rot=mem[0x408] )
...
0x02bd    op69_ActorSetRotation( rot=mem[0x40a] )
...
0x02e2    op69_ActorSetRotation( rot=mem[0x406] )
...
0x02f3    op69_ActorSetRotation( rot=mem[0x408] )
...
0x0304    op69_ActorSetRotation( rot=mem[0x40a] )
...
0x0329    op69_ActorSetRotation( rot=mem[0x406] )
...
0x033a    op69_ActorSetRotation( rot=mem[0x408] )
...
0x034b    op69_ActorSetRotation( rot=mem[0x40a] )
...
0x0427    op02_JumpToConditional( val1=mem[0x416], val2=3, condition="val1 == val2", address_if_false=0x444 )
0x042f    op02_JumpToConditional( val1=mem[0x418], val2=3, condition="val1 == val2", address_if_false=0x444 )
0x0437    op02_JumpToConditional( val1=mem[0x41a], val2=3, condition="val1 == val2", address_if_false=0x444 )
...
0x04dc    mem[0x432] -= mem[0x40c] -- op39
...
Actor_0x0f:on_start:
0x04e7    op02_JumpToConditional( val1=mem[0x400], val2=255, condition="val1 == val2", address_if_false=0x4f1 )
0x04ef    op29_ActorTurnOff( actor_id=self )
0x04f1    -- 0xFE21()
0x04f5    opFE0D_MessageSetFace( char_id=mem[0x400] )
...
0x0505    mem[0x416] = mem[0x414] -- op35
0x050b    op00_Return()
...
0x0520    mem[0x438] -= mem[0x406] -- op39
0x0526    op69_ActorSetRotation( rot=(s)mem[0x438] )
0x0529    op01_JumpTo( address=0x51a )
0x052c    op00_Return()

Actor_0x10:on_start:
0x052d    op02_JumpToConditional( val1=mem[0x402], val2=255, condition="val1 == val2", address_if_false=0x537 )
0x0535    op29_ActorTurnOff( actor_id=self )
0x0537    -- 0xFE21()
0x053b    opFE0D_MessageSetFace( char_id=mem[0x402] )
...
0x054b    mem[0x418] = mem[0x414] -- op35
0x0551    op00_Return()
...
0x0566    mem[0x43e] -= mem[0x408] -- op39
0x056c    op69_ActorSetRotation( rot=(s)mem[0x43e] )
0x056f    op01_JumpTo( address=0x560 )
0x0572    op00_Return()

Actor_0x11:on_start:
0x0573    op02_JumpToConditional( val1=mem[0x404], val2=255, condition="val1 == val2", address_if_false=0x57d )
0x057b    op29_ActorTurnOff( actor_id=self )
0x057d    -- 0xFE21()
0x0581    opFE0D_MessageSetFace( char_id=mem[0x404] )
...
0x0591    mem[0x41a] = mem[0x414] -- op35
0x0597    op00_Return()
...
0x05ac    mem[0x444] -= mem[0x40a] -- op39
...
0x088c    op0D_Return()
0x088d    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x7338, ???=(vf40)0x6570, flag=0x65 )
