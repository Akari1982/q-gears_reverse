...
0x0364    op02_JumpToConditional( val1=(s)mem[0x2c4], val2=-32768, condition="val1 & val2", address_if_false=0x372 )
...
0x3281    -- 0x5A()
0x3282    op0D_Return()
0x3283    -- 0xE0( actor_id=Actor_0xa5, ???=(vf80)0x9182, ???=(vf40)0x17d4, flag=0xba )
