...
0x0025    op02_JumpToConditional( val1=mem[0x406], val2=0, condition="val1 == val2", address_if_false=0x220 )
0x002d    -- 0x84_ProgressLessEqualJumpTo( value=51, jump=0x1ca )
0x0032    op02_JumpToConditional( val1=mem[0xc0], val2=128, condition="val1 & val2", address_if_false=0x3d )
...
0x01ca    op02_JumpToConditional( val1=mem[0xc0], val2=8, condition="val1 & val2", address_if_false=0x1e9 )
0x01d2    op02_JumpToConditional( val1=mem[0xc0], val2=16, condition="val1 & val2", address_if_false=0x1e3 )
0x01da    mem[0x404] = 3 -- op35
0x01e0    op01_JumpTo( address=0x1e9 )
0x01e3    mem[0x404] = 1 -- op35
0x01e9    op02_JumpToConditional( val1=mem[0xc0], val2=16, condition="val1 & val2", address_if_false=0x202 )
0x01f1    op02_JumpToConditional( val1=mem[0xc0], val2=8, condition="val1 & val2", address_if_false=0x1fc )
...
0x06b9    op02_JumpToConditional( val1=mem[0xc0], val2=128, condition="val1 & val2", address_if_false=0x6c7 )
0x06c1    -- 0x19_ActorSetPosition( x=(vf80)0xffe2, z=(vf40)0xfb50, flag=(flag)0xc0 )
0x06c7    op02_JumpToConditional( val1=mem[0xc0], val2=256, condition="val1 & val2", address_if_false=0x6d7 )
...
0x06e2    -- 0x5F( ???=0x0 )
0x06e4    op02_JumpToConditional( val1=mem[0xc0], val2=8, condition="val1 & val2", address_if_false=0x6fc )
0x06ec    op02_JumpToConditional( val1=mem[0xc0], val2=16, condition="val1 & val2", address_if_false=0x6fc )
...
0x0704    -- 0xFE1C()
0x070d    -- 0x5F( ???=0x0 )
0x070f    op02_JumpToConditional( val1=mem[0xc0], val2=512, condition="val1 & val2", address_if_false=0x71d )
...
Actor_0x03:on_talk:
0x0722    -- 0x70()
0x0724    op02_JumpToConditional( val1=mem[0xc0], val2=512, condition="val1 & val2", address_if_false=0x78e )
...
0x075a    op02_JumpToConditional( val1=mem[0xc0], val2=8192, condition="val1 & val2", address_if_false=0x765 )
...
0x0793    op02_JumpToConditional( val1=mem[0xc0], val2=256, condition="val1 & val2", address_if_false=0x908 )
...
0x07dd    op02_JumpToConditional( val1=mem[0xc0], val2=8192, condition="val1 & val2", address_if_false=0x7e8 )
...
0x084a    op02_JumpToConditional( val1=mem[0xc0], val2=8192, condition="val1 & val2", address_if_false=0x855 )
...
0x08b7    op02_JumpToConditional( val1=mem[0xc0], val2=8192, condition="val1 & val2", address_if_false=0x8c2 )
...
0x0b09    -- 0x75( ???=18 )
0x0b0c    op00_Return()
0x0b0d    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x6438, ???=(vf40)0x1d40, flag=0xe9 )
