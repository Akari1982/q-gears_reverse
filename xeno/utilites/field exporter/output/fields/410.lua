...
0x0271    op02_JumpToConditional( val1=mem[0x1480], val2=(s)mem[0x980], condition="val1 != val2", address_if_false=0xfe25 )
...
0x02ea    -- 0xCB_TriggerJumpTo( trigger_id=(s)mem[0xc00], jump=0xfe03 )
0x02ef    -- 0x54()
0x02f4    op05_CallFunction( address=0x780 )
0x02f7    op01_JumpTo( address=0x2629 )
0x02fa    op05_CallFunction( address=0x780 )
0x02fd    op02_JumpToConditional( val1=(s)mem[0x2624], val2=mem[0x8004], condition="val1 & val2", address_if_false=0x2403 )
