...
0x0010    -- 0xF7()
0x0015    -- 0xFEB8()
0x001a    op02_JumpToConditional( val1=(s)mem[0x222], val2=1024, condition="val1 & val2", address_if_false=0x28 )
...
0x00ae    -- 0x98_MapLoad( field_id=565, value=1 )
0x00b3    -- 0x5B()
0x00b4    op00_Return()
...
0x00d8    -- 0x98_MapLoad( field_id=566, value=0 )
0x00dd    -- 0x5B()
0x00de    op00_Return()
...
0x02f5    op0D_Return()
0x02f6    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0xb9ec, ???=(vf40)0x0000, flag=0x90 )
