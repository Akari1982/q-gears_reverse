...
0x0010    -- 0xF7()
0x0015    -- 0xFEB8()
0x001a    op02_JumpToConditional( val1=mem[0x222], val2=1024, condition="val1 & val2", address_if_false=0x28 )
...
0x02f5    op0D_Return()
0x02f6    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x8254, ???=(vf40)0x0000, flag=0xa0 )
