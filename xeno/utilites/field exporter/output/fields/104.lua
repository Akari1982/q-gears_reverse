...
0x03bc    mem[0x16] = mem[0x408] -- op35
0x03c2    mem[0x18] = mem[0x40a] -- op35
0x03c8    opD2_MessageShowDynamic( text_id=0x12, flags=0 )
0x03cc    op9C_MessageSync()
0x03cd    op02_JumpToConditional( val1=mem[0x408], val2=40, condition="val1 == val2", address_if_false=0x3e2 )
0x03d5    -- 0x8E()
0x03dc    op01_JumpTo( address=0x453 )
0x03df    op01_JumpTo( address=0x44b )
0x03e2    op02_JumpToConditional( val1=mem[0x408], val2=80, condition="val1 == val2", address_if_false=0x3f7 )
0x03ea    -- 0x8E()
0x03f1    op01_JumpTo( address=0x453 )
0x03f4    op01_JumpTo( address=0x44b )
0x03f7    op02_JumpToConditional( val1=mem[0x408], val2=120, condition="val1 == val2", address_if_false=0x40c )
0x03ff    -- 0x8E()
0x0406    op01_JumpTo( address=0x453 )
0x0409    op01_JumpTo( address=0x44b )
0x040c    op02_JumpToConditional( val1=mem[0x408], val2=50, condition="val1 == val2", address_if_false=0x421 )
0x0414    -- 0x8E()
0x041b    op01_JumpTo( address=0x453 )
0x041e    op01_JumpTo( address=0x44b )
0x0421    op02_JumpToConditional( val1=mem[0x408], val2=100, condition="val1 == val2", address_if_false=0x436 )
0x0429    -- 0x8E()
0x0430    op01_JumpTo( address=0x453 )
0x0433    op01_JumpTo( address=0x44b )
0x0436    op02_JumpToConditional( val1=mem[0x408], val2=150, condition="val1 == val2", address_if_false=0x44b )
0x043e    -- 0x8E()
...
0x0515    op02_JumpToConditional( val1=mem[0x40c], val2=10, condition="val1 > val2", address_if_false=0x535 )
...
0x0535    op02_JumpToConditional( val1=mem[0x40c], val2=8, condition="val1 == val2", address_if_false=0x540 )
0x053d    op07_CallActorEvent( actor_id=Actor_0x0e, event=event_0x05, priority=0x01 )
0x0540    op02_JumpToConditional( val1=mem[0x40c], val2=10, condition="val1 == val2", address_if_false=0x551 )
...
0x0701    op00_Return()
0x0702    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x4010, ???=(vf40)0x9d1d, flag=0x7d )
