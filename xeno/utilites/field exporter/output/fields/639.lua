...
0x0094    op02_JumpToConditional( val1=mem[0x190], val2=8, condition="val1 & val2", address_if_false=0x9f )
...
0x00cd    op02_JumpToConditional( val1=mem[0x190], val2=8, condition="val1 & val2", address_if_false=0xd8 )
...
0x0106    op02_JumpToConditional( val1=mem[0x190], val2=8, condition="val1 & val2", address_if_false=0x111 )
...
0x013f    op02_JumpToConditional( val1=mem[0x190], val2=8, condition="val1 & val2", address_if_false=0x14a )
...
0x0184    -- 0x18()
0x0189    op02_JumpToConditional( val1=mem[0x190], val2=8, condition="val1 & val2", address_if_false=0x196 )
...
0x01cd    op02_JumpToConditional( val1=mem[0x190], val2=16, condition="val1 & val2", address_if_false=0x1d8 )
...
0x0206    op02_JumpToConditional( val1=mem[0x190], val2=16, condition="val1 & val2", address_if_false=0x211 )
...
0x023f    op02_JumpToConditional( val1=mem[0x190], val2=16, condition="val1 & val2", address_if_false=0x24a )
...
0x0278    op02_JumpToConditional( val1=mem[0x190], val2=16, condition="val1 & val2", address_if_false=0x283 )
...
0x02bd    -- 0x18()
0x02c2    op02_JumpToConditional( val1=mem[0x190], val2=16, condition="val1 & val2", address_if_false=0x2cf )
...
0x0306    op02_JumpToConditional( val1=mem[0x190], val2=32, condition="val1 & val2", address_if_false=0x311 )
...
0x033f    op02_JumpToConditional( val1=mem[0x190], val2=32, condition="val1 & val2", address_if_false=0x34a )
...
0x0378    op02_JumpToConditional( val1=mem[0x190], val2=32, condition="val1 & val2", address_if_false=0x383 )
...
0x03b1    op02_JumpToConditional( val1=mem[0x190], val2=32, condition="val1 & val2", address_if_false=0x3bc )
...
0x03f6    -- 0x18()
0x03fb    op02_JumpToConditional( val1=mem[0x190], val2=32, condition="val1 & val2", address_if_false=0x408 )
...
0x0444    -- 0x2A()
0x0445    op02_JumpToConditional( val1=mem[0x190], val2=8, condition="val1 & val2", address_if_false=0x453 )
0x044d    -- 0xFE1B()
0x0453    op00_Return()
...
0x0484    -- 0x2A()
0x0485    op02_JumpToConditional( val1=mem[0x190], val2=8, condition="val1 & val2", address_if_false=0x493 )
0x048d    -- 0xFE1B()
0x0493    op00_Return()
...
0x04c4    -- 0x2A()
0x04c5    op02_JumpToConditional( val1=mem[0x190], val2=16, condition="val1 & val2", address_if_false=0x4d3 )
0x04cd    -- 0xFE1B()
0x04d3    op00_Return()
...
0x0504    -- 0x2A()
0x0505    op02_JumpToConditional( val1=mem[0x190], val2=16, condition="val1 & val2", address_if_false=0x513 )
0x050d    -- 0xFE1B()
0x0513    op00_Return()
...
0x0544    -- 0x2A()
0x0545    op02_JumpToConditional( val1=mem[0x190], val2=32, condition="val1 & val2", address_if_false=0x553 )
0x054d    -- 0xFE1B()
0x0553    op00_Return()
...
0x07aa    -- 0xFEC8()
0x07bd    -- 0xFEC8()
0x07d0    opC6_ExpandRun() -- exp0x20
0x07d1    opFE90_ParticleInitBase( particle_id=1, number_of_sprites=4, wait=0, ttl=8 )
0x07db    opFE91_ParticlePos( x=(vf80)0x0000, y=(vf40)0x000f, z=(vf20)0x0000, speed_x=(vf10)0x0000, speed_y=(vf08)0xff38, speed_z=(vf04)0x0000, flag=(flag)0xfc )
0x07ea    opFE92_ParticleSpeed( speed=(vf80)0x1388, acc_x=(vf40)0xff9c, acc_y=(vf20)0x0000, acc_z=(vf10)0x0000, rand_start=(vf08)0x0023, rand_speed=(vf04)0x03e8, flag=(flag)0xfc )
0x07f9    opFE93_ParticleWaitTtl( s_wait=1, var2=80, sprite_id=0, var4=1, var5=2 )
0x0805    opFE94_ParticleTranslation( trans_x=(vf80)0x012c, trans_y=(vf40)0x012c, trans_add_x=(vf20)0x000a, trans_add_y=(vf10)0x000a, flag=(flag)0xf0 )
0x0810    opFE95_ParticleColour( r=(vf80)0x006e, g=(vf40)0x006e, b=(vf20)0x006e, r_add=(vf10)0xfffc, g_add=(vf10)0xfffc, b_add=(vf10)0xfffc, flag=(flag)0xfc )
0x081f    opFEA5_ParticleRenderSettings( use_speed=1, settings=2, rot_z=0 )
0x0827    opFEBD_ParticleSpawnSettings( settings=1 )
0x082f    -- 0xFEC8()
0x0842    -- 0xFEC8()
0x0855    opC6_ExpandRun() -- exp0x20
0x0856    opFE90_ParticleInitBase( particle_id=2, number_of_sprites=4, wait=0, ttl=8 )
0x0860    opFE91_ParticlePos( x=(vf80)0x0000, y=(vf40)0x000f, z=(vf20)0x0000, speed_x=(vf10)0x0000, speed_y=(vf08)0xff38, speed_z=(vf04)0x0000, flag=(flag)0xfc )
0x086f    opFE92_ParticleSpeed( speed=(vf80)0x1388, acc_x=(vf40)0xff9c, acc_y=(vf20)0x0000, acc_z=(vf10)0x0000, rand_start=(vf08)0x0023, rand_speed=(vf04)0x03e8, flag=(flag)0xfc )
0x087e    opFE93_ParticleWaitTtl( s_wait=1, var2=80, sprite_id=0, var4=1, var5=2 )
0x088a    opFE94_ParticleTranslation( trans_x=(vf80)0x012c, trans_y=(vf40)0x012c, trans_add_x=(vf20)0x000a, trans_add_y=(vf10)0x000a, flag=(flag)0xf0 )
0x0895    opFE95_ParticleColour( r=(vf80)0x006e, g=(vf40)0x006e, b=(vf20)0x006e, r_add=(vf10)0xfffc, g_add=(vf10)0xfffc, b_add=(vf10)0xfffc, flag=(flag)0xfc )
0x08a4    opFEA5_ParticleRenderSettings( use_speed=1, settings=2, rot_z=0 )
0x08ac    opFEBD_ParticleSpawnSettings( settings=1 )
0x08b4    -- 0xFEC8()
0x08c7    -- 0xFEC8()
0x08da    op0D_Return()
0x08db    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0000, ???=(vf40)0x0000, flag=0x0 )
