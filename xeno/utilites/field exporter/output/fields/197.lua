...
0x06b0    op02_JumpToConditional( val1=(s)mem[0xd0], val2=(s)mem[0x26fc], condition="val1 != val2", address_if_false=0xe180 )
0x06b8    opD0_MessageSettings( x=20482, y=(s)mem[0x200], letters=mem[0x1000], rows=19456, flags=20482 )
0x06c3    op00_Return()
...
0x06c9    opD2_MessageShowDynamic( text_id=0xd002, flags=0 )
0x06cd    op02_JumpToConditional( val1=mem[0x1000], val2=mem[0xcc00], condition="val1 > val2", address_if_false=0xd0 )
0x06d5    opFC_MessageShowFromActorCopyFace( actor_id=Actor_0x26, text_id=0x8001, flags=CLOSE_OFF_SCREEN|FORCE_BOTTOM|NO_WINDOW|0x80 )
