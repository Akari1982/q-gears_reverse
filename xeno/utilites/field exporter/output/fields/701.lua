...
Actor_0x0c:on_talk:
0x00cb    op02_JumpToConditional( val1=mem[0x2ce], val2=1024, condition="val1 & val2", address_if_false=0xd9 )
...
0x063b    -- 0xFEC6( char_id=mem[0x2d0] )
0x063f    -- 0xFE1A() sync load for 0xFEC6()
0x0641    -- 0xFEC6( char_id=mem[0x2d2] )
0x0645    -- 0xFE1A() sync load for 0xFEC6()
0x0647    -- 0xBB( ???=0x7 )
0x0649    -- 0x5A()
0x064a    op0D_Return()
0x064b    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x8870, ???=(vf40)0x0207, flag=0x3e )
