...
0x0645    op02_JumpToConditional( val1=(s)mem[0x2ca], val2=64, condition="val1 & val2", address_if_false=0x650 )
...
0x0763    op02_JumpToConditional( val1=(s)mem[0x2ca], val2=64, condition="val1 & val2", address_if_false=0x76e )
...
0x0cba    -- 0xFEC6( char_id=(s)mem[0x2d0] )
0x0cbe    -- 0xFE1A() sync load for 0xFEC6()
0x0cc0    -- 0xFEC6( char_id=(s)mem[0x2d2] )
0x0cc4    -- 0xFE1A() sync load for 0xFEC6()
0x0cc6    -- 0xBB( ???=0x7 )
0x0cc8    -- 0x5A()
0x0cc9    op0D_Return()
0x0cca    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x8e00, ???=(vf40)0x12f0, flag=0x7a )
