...
0x001e    -- 0xA0()
0x0025    op02_JumpToConditional( val1=mem[0x102], val2=64, condition="val1 == val2", address_if_false=0x3f )
...
0x00c1    op02_JumpToConditional( val1=mem[0x102], val2=64, condition="val1 >= val2", address_if_false=0xd9 )
0x00c9    op02_JumpToConditional( val1=mem[0x102], val2=66, condition="val1 < val2", address_if_false=0xd9 )
...
0x00e8    op02_JumpToConditional( val1=mem[0x102], val2=64, condition="val1 >= val2", address_if_false=0x100 )
0x00f0    op02_JumpToConditional( val1=mem[0x102], val2=66, condition="val1 < val2", address_if_false=0x100 )
...
0x018e    op02_JumpToConditional( val1=mem[0x102], val2=28, condition="val1 >= val2", address_if_false=0x1a4 )
0x0196    op02_JumpToConditional( val1=mem[0x102], val2=32, condition="val1 <= val2", address_if_false=0x1a4 )
...
0x0264    op02_JumpToConditional( val1=mem[0x102], val2=64, condition="val1 >= val2", address_if_false=0x27c )
0x026c    op02_JumpToConditional( val1=mem[0x102], val2=66, condition="val1 < val2", address_if_false=0x27c )
...
0x028b    op02_JumpToConditional( val1=mem[0x102], val2=64, condition="val1 >= val2", address_if_false=0x2a3 )
0x0293    op02_JumpToConditional( val1=mem[0x102], val2=66, condition="val1 < val2", address_if_false=0x2a3 )
...
0x02bd    op02_JumpToConditional( val1=mem[0x102], val2=64, condition="val1 >= val2", address_if_false=0x2d5 )
0x02c5    op02_JumpToConditional( val1=mem[0x102], val2=66, condition="val1 < val2", address_if_false=0x2d5 )
...
0x02e4    op02_JumpToConditional( val1=mem[0x102], val2=64, condition="val1 >= val2", address_if_false=0x2fc )
0x02ec    op02_JumpToConditional( val1=mem[0x102], val2=66, condition="val1 < val2", address_if_false=0x2fc )
...
0x031d    -- 0xFE07( ???=0x1 )
0x0320    op02_JumpToConditional( val1=mem[0x102], val2=64, condition="val1 >= val2", address_if_false=0x333 )
...
Actor_0x0d:on_talk:
0x033d    op02_JumpToConditional( val1=mem[0x102], val2=65, condition="val1 == val2", address_if_false=0x351 )
...
0x0350    op00_Return()
0x0351    op02_JumpToConditional( val1=mem[0x102], val2=29, condition="val1 >= val2", address_if_false=0x365 )
...
0x0364    op00_Return()
0x0365    op02_JumpToConditional( val1=mem[0x102], val2=23, condition="val1 == val2", address_if_false=0x382 )
...
0x0430    op02_JumpToConditional( val1=mem[0x102], val2=28, condition="val1 >= val2", address_if_false=0x443 )
0x0438    -- 0x19_ActorSetPosition( x=(vf80)0xffaf, z=(vf40)0xfe17, flag=(flag)0xc0 )
0x043e    -- 0x5F( ???=0x5 )
0x0440    op01_JumpTo( address=0x461 )
0x0443    op02_JumpToConditional( val1=mem[0x102], val2=23, condition="val1 >= val2", address_if_false=0x459 )
...
Actor_0x0f:on_talk:
0x0464    op02_JumpToConditional( val1=mem[0x102], val2=23, condition="val1 >= val2", address_if_false=0x493 )
0x046c    op02_JumpToConditional( val1=mem[0x102], val2=28, condition="val1 < val2", address_if_false=0x493 )
...
0x0492    op00_Return()
0x0493    op02_JumpToConditional( val1=mem[0x102], val2=28, condition="val1 >= val2", address_if_false=0x4a7 )
...
0x04ec    op02_JumpToConditional( val1=mem[0x102], val2=28, condition="val1 == val2", address_if_false=0x4fb )
0x04f4    -- 0x19_ActorSetPosition( x=(vf80)0xff5b, z=(vf40)0xff07, flag=(flag)0xc0 )
0x04fa    -- 0x23()
0x04fb    op02_JumpToConditional( val1=mem[0x102], val2=29, condition="val1 >= val2", address_if_false=0x513 )
0x0503    op02_JumpToConditional( val1=mem[0x102], val2=32, condition="val1 <= val2", address_if_false=0x513 )
0x050b    -- 0x19_ActorSetPosition( x=(vf80)0x0039, z=(vf40)0xfea3, flag=(flag)0xc0 )
0x0511    -- 0x5F( ???=0x2 )
0x0513    op02_JumpToConditional( val1=mem[0x102], val2=64, condition="val1 >= val2", address_if_false=0x52d )
0x051b    op02_JumpToConditional( val1=mem[0x102], val2=65, condition="val1 <= val2", address_if_false=0x52d )
...
0x0532    op02_JumpToConditional( val1=mem[0x102], val2=65, condition="val1 == val2", address_if_false=0x540 )
...
0x063e    -- 0x5F( ???=0x3 )
0x0640    -- 0xFE07( ???=0x1 )
0x0643    op02_JumpToConditional( val1=mem[0x102], val2=64, condition="val1 == val2", address_if_false=0x659 )
...
0x0659    op02_JumpToConditional( val1=mem[0x102], val2=65, condition="val1 == val2", address_if_false=0x66f )
...
0x06b6    -- 0x5F( ???=0x3 )
0x06b8    -- 0xFE07( ???=0x1 )
0x06bb    op02_JumpToConditional( val1=mem[0x102], val2=64, condition="val1 == val2", address_if_false=0x6d1 )
...
0x06d1    op02_JumpToConditional( val1=mem[0x102], val2=65, condition="val1 == val2", address_if_false=0x6e7 )
...
0x072c    -- 0x5F( ???=0x2 )
0x072e    -- 0xFE07( ???=0x1 )
0x0731    op02_JumpToConditional( val1=mem[0x102], val2=64, condition="val1 == val2", address_if_false=0x747 )
...
0x0747    op02_JumpToConditional( val1=mem[0x102], val2=65, condition="val1 == val2", address_if_false=0x75d )
...
0x07a2    -- 0x5F( ???=0x3 )
0x07a4    -- 0xFE07( ???=0x1 )
0x07a7    op02_JumpToConditional( val1=mem[0x102], val2=64, condition="val1 == val2", address_if_false=0x7bd )
...
0x07bd    op02_JumpToConditional( val1=mem[0x102], val2=65, condition="val1 == val2", address_if_false=0x7d3 )
...
0x0818    -- 0x5F( ???=0x5 )
0x081a    -- 0xFE07( ???=0x1 )
0x081d    op02_JumpToConditional( val1=mem[0x102], val2=64, condition="val1 == val2", address_if_false=0x833 )
...
0x0833    op02_JumpToConditional( val1=mem[0x102], val2=65, condition="val1 == val2", address_if_false=0x849 )
...
0x088e    -- 0x5F( ???=0x2 )
0x0890    -- 0xFE07( ???=0x1 )
0x0893    op02_JumpToConditional( val1=mem[0x102], val2=64, condition="val1 == val2", address_if_false=0x8a9 )
...
0x08a9    op02_JumpToConditional( val1=mem[0x102], val2=65, condition="val1 == val2", address_if_false=0x8bf )
...
Actor_0x1c:on_talk:
0x0a5d    op02_JumpToConditional( val1=mem[0x102], val2=36, condition="val1 >= val2", address_if_false=0xa74 )
0x0a65    -- 0x15()
0x0a66    -- 0xC4()
0x0a68    -- 0x1F( ???=0x11 )
0x0a6a    -- 0x47( ???=474, ???=5 )
...
0x0dac    op02_JumpToConditional( val1=mem[0x102], val2=21, condition="val1 == val2", address_if_false=0xdba )
0x0db4    op01_JumpTo( address=0xdd9 )
0x0db7    op01_JumpTo( address=0xdd6 )
0x0dba    op02_JumpToConditional( val1=mem[0x102], val2=28, condition="val1 == val2", address_if_false=0xdc8 )
0x0dc2    op01_JumpTo( address=0x143b )
0x0dc5    op01_JumpTo( address=0xdd6 )
0x0dc8    op02_JumpToConditional( val1=mem[0x102], val2=64, condition="val1 == val2", address_if_false=0xdd6 )
...
0x1016    opA9_MessageSetSelectionSync( start_row=00, end_row=03 )
0x1018    op9C_MessageSync()
0x1019    op02_JumpToConditional( val1=(s)mem[0x14], val2=0, condition="val1 == val2", address_if_false=0x1027 )
0x1021    op01_JumpTo( address=0x107e )
...
0x105e    opA9_MessageSetSelectionSync( start_row=00, end_row=01 )
0x1060    op9C_MessageSync()
0x1061    op02_JumpToConditional( val1=(s)mem[0x14], val2=0, condition="val1 == val2", address_if_false=0x106f )
0x1069    op01_JumpTo( address=0x100a )
...
0x16c6    opA9_MessageSetSelectionSync( start_row=00, end_row=01 )
0x16c8    op9C_MessageSync()
0x16c9    op02_JumpToConditional( val1=(s)mem[0x14], val2=0, condition="val1 == val2", address_if_false=0x16fd )
0x16d1    opF4_MessageClose( type=0x0 )
0x16d3    op26_Wait( time=10 )
0x16d6    op09_CallActorEventEndSync( actor_id=Actor_0x04, event=event_0x05, priority=0x03 )
0x16d9    op26_Wait( time=10 )
0x16dc    -- 0xFE18()
0x16e1    op25_ActorDisable( actor_id=Actor_0x04 )
...
0x171a    op02_JumpToConditional( val1=mem[0x102], val2=0, condition="val1 == val2", address_if_false=0x1739 )
...
0x1739    op02_JumpToConditional( val1=mem[0x102], val2=21, condition="val1 == val2", address_if_false=0x1758 )
...
0x1758    op02_JumpToConditional( val1=mem[0x102], val2=23, condition="val1 == val2", address_if_false=0x1777 )
...
0x1777    op02_JumpToConditional( val1=mem[0x102], val2=28, condition="val1 == val2", address_if_false=0x178e )
...
0x178e    op02_JumpToConditional( val1=mem[0x102], val2=29, condition="val1 == val2", address_if_false=0x17a5 )
...
0x17a5    op02_JumpToConditional( val1=mem[0x102], val2=31, condition="val1 == val2", address_if_false=0x17bc )
...
0x17bc    op02_JumpToConditional( val1=mem[0x102], val2=31, condition="val1 == val2", address_if_false=0x17d3 )
...
0x17d3    op02_JumpToConditional( val1=mem[0x102], val2=32, condition="val1 == val2", address_if_false=0x17ea )
...
0x17ea    op02_JumpToConditional( val1=mem[0x102], val2=33, condition="val1 == val2", address_if_false=0x1801 )
...
0x1801    op02_JumpToConditional( val1=mem[0x102], val2=64, condition="val1 == val2", address_if_false=0x181c )
...
0x181c    op02_JumpToConditional( val1=mem[0x102], val2=65, condition="val1 == val2", address_if_false=0x1837 )
...
0x186d    op00_Return()
0x186e    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0000, ???=(vf40)0x0000, flag=0xb7 )
