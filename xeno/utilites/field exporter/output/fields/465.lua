...
0x05e9    -- 0xFEC6( char_id=mem[0x2d0] )
0x05ed    -- 0xFE1A() sync load for 0xFEC6()
0x05ef    -- 0xFEC6( char_id=mem[0x2d2] )
0x05f3    -- 0xFE1A() sync load for 0xFEC6()
0x05f5    -- 0xBB( ???=0x7 )
0x05f7    -- 0x5A()
0x05f8    op0D_Return()
0x05f9    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0038, ???=(vf40)0x0000, flag=0xc5 )
