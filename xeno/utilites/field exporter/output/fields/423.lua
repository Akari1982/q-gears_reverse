...
0x015b    op02_JumpToConditional( val1=mem[0x2c4], val2=64, condition="val1 & val2", address_if_false=0x17e )
0x0163    op02_JumpToConditional( val1=mem[0x2c4], val2=128, condition="val1 & val2", address_if_false=0x17e )
0x016b    op02_JumpToConditional( val1=mem[0x2c4], val2=256, condition="val1 & val2", address_if_false=0x17e )
0x0173    op02_JumpToConditional( val1=mem[0x2c4], val2=512, condition="val1 & val2", address_if_false=0x17e )
...
0x0190    op02_JumpToConditional( val1=mem[0x2c4], val2=64, condition="val1 & val2", address_if_false=0x1a6 )
...
0x01b4    op02_JumpToConditional( val1=mem[0x2c4], val2=128, condition="val1 & val2", address_if_false=0x1ca )
...
0x01d8    op02_JumpToConditional( val1=mem[0x2c4], val2=256, condition="val1 & val2", address_if_false=0x1ee )
...
0x01fc    op02_JumpToConditional( val1=mem[0x2c4], val2=512, condition="val1 & val2", address_if_false=0x212 )
...
0x0221    op02_JumpToConditional( val1=mem[0x2d6], val2=0, condition="val1 == val2", address_if_false=0x23b )
0x0229    -- 0xFE18()
0x022e    -- 0xFEA1( ???=0, ???=0 )
0x0234    -- 0xFE41()
0x0238    op01_JumpTo( address=0x2bd )
0x023b    op02_JumpToConditional( val1=mem[0x2d6], val2=2, condition="val1 == val2", address_if_false=0x255 )
0x0243    -- 0xFE18()
0x0248    -- 0xFEA1( ???=2, ???=3 )
0x024e    -- 0xFE41()
0x0252    op01_JumpTo( address=0x2bd )
0x0255    op02_JumpToConditional( val1=mem[0x2d6], val2=1, condition="val1 == val2", address_if_false=0x26f )
0x025d    -- 0xFE18()
0x0262    -- 0xFEA1( ???=1, ???=2 )
0x0268    -- 0xFE41()
0x026c    op01_JumpTo( address=0x2bd )
0x026f    op02_JumpToConditional( val1=mem[0x2d6], val2=3, condition="val1 == val2", address_if_false=0x289 )
0x0277    -- 0xFE18()
0x027c    -- 0xFEA1( ???=3, ???=4 )
0x0282    -- 0xFE41()
0x0286    op01_JumpTo( address=0x2bd )
0x0289    op02_JumpToConditional( val1=mem[0x2d6], val2=5, condition="val1 == val2", address_if_false=0x2a3 )
0x0291    -- 0xFE18()
0x0296    -- 0xFEA1( ???=5, ???=6 )
0x029c    -- 0xFE41()
0x02a0    op01_JumpTo( address=0x2bd )
0x02a3    op02_JumpToConditional( val1=mem[0x2d6], val2=4, condition="val1 == val2", address_if_false=0x2bd )
0x02ab    -- 0xFE18()
0x02b0    -- 0xFEA1( ???=4, ???=5 )
0x02b6    -- 0xFE41()
...
0x02de    -- 0xFE54()
0x02e0    mem[0x404] = mem[0x2d6] -- op35
...
0x0319    op02_JumpToConditional( val1=mem[0x2d8], val2=0, condition="val1 == val2", address_if_false=0x333 )
0x0321    -- 0xFE18()
0x0326    -- 0xFEA1( ???=0, ???=0 )
0x032c    -- 0xFE41()
0x0330    op01_JumpTo( address=0x3b5 )
0x0333    op02_JumpToConditional( val1=mem[0x2d8], val2=2, condition="val1 == val2", address_if_false=0x34d )
0x033b    -- 0xFE18()
0x0340    -- 0xFEA1( ???=2, ???=3 )
0x0346    -- 0xFE41()
0x034a    op01_JumpTo( address=0x3b5 )
0x034d    op02_JumpToConditional( val1=mem[0x2d8], val2=1, condition="val1 == val2", address_if_false=0x367 )
0x0355    -- 0xFE18()
0x035a    -- 0xFEA1( ???=1, ???=2 )
0x0360    -- 0xFE41()
0x0364    op01_JumpTo( address=0x3b5 )
0x0367    op02_JumpToConditional( val1=mem[0x2d8], val2=3, condition="val1 == val2", address_if_false=0x381 )
0x036f    -- 0xFE18()
0x0374    -- 0xFEA1( ???=3, ???=4 )
0x037a    -- 0xFE41()
0x037e    op01_JumpTo( address=0x3b5 )
0x0381    op02_JumpToConditional( val1=mem[0x2d8], val2=5, condition="val1 == val2", address_if_false=0x39b )
0x0389    -- 0xFE18()
0x038e    -- 0xFEA1( ???=5, ???=6 )
0x0394    -- 0xFE41()
0x0398    op01_JumpTo( address=0x3b5 )
0x039b    op02_JumpToConditional( val1=mem[0x2d8], val2=4, condition="val1 == val2", address_if_false=0x3b5 )
0x03a3    -- 0xFE18()
0x03a8    -- 0xFEA1( ???=4, ???=5 )
0x03ae    -- 0xFE41()
...
0x03d6    -- 0xFE54()
0x03d8    mem[0x404] = mem[0x2d8] -- op35
...
0x0411    op02_JumpToConditional( val1=mem[0x2da], val2=0, condition="val1 == val2", address_if_false=0x42b )
0x0419    -- 0xFE18()
0x041e    -- 0xFEA1( ???=0, ???=0 )
0x0424    -- 0xFE41()
0x0428    op01_JumpTo( address=0x4ad )
0x042b    op02_JumpToConditional( val1=mem[0x2da], val2=2, condition="val1 == val2", address_if_false=0x445 )
0x0433    -- 0xFE18()
0x0438    -- 0xFEA1( ???=2, ???=3 )
0x043e    -- 0xFE41()
0x0442    op01_JumpTo( address=0x4ad )
0x0445    op02_JumpToConditional( val1=mem[0x2da], val2=1, condition="val1 == val2", address_if_false=0x45f )
0x044d    -- 0xFE18()
0x0452    -- 0xFEA1( ???=1, ???=2 )
0x0458    -- 0xFE41()
0x045c    op01_JumpTo( address=0x4ad )
0x045f    op02_JumpToConditional( val1=mem[0x2da], val2=3, condition="val1 == val2", address_if_false=0x479 )
0x0467    -- 0xFE18()
0x046c    -- 0xFEA1( ???=3, ???=4 )
0x0472    -- 0xFE41()
0x0476    op01_JumpTo( address=0x4ad )
0x0479    op02_JumpToConditional( val1=mem[0x2da], val2=5, condition="val1 == val2", address_if_false=0x493 )
0x0481    -- 0xFE18()
0x0486    -- 0xFEA1( ???=5, ???=6 )
0x048c    -- 0xFE41()
0x0490    op01_JumpTo( address=0x4ad )
0x0493    op02_JumpToConditional( val1=mem[0x2da], val2=4, condition="val1 == val2", address_if_false=0x4ad )
0x049b    -- 0xFE18()
0x04a0    -- 0xFEA1( ???=4, ???=5 )
0x04a6    -- 0xFE41()
...
0x04ce    -- 0xFE54()
0x04d0    mem[0x404] = mem[0x2da] -- op35
...
0x0509    op02_JumpToConditional( val1=mem[0x2dc], val2=0, condition="val1 == val2", address_if_false=0x523 )
0x0511    -- 0xFE18()
0x0516    -- 0xFEA1( ???=0, ???=0 )
0x051c    -- 0xFE41()
0x0520    op01_JumpTo( address=0x5a5 )
0x0523    op02_JumpToConditional( val1=mem[0x2dc], val2=2, condition="val1 == val2", address_if_false=0x53d )
0x052b    -- 0xFE18()
0x0530    -- 0xFEA1( ???=2, ???=3 )
0x0536    -- 0xFE41()
0x053a    op01_JumpTo( address=0x5a5 )
0x053d    op02_JumpToConditional( val1=mem[0x2dc], val2=1, condition="val1 == val2", address_if_false=0x557 )
0x0545    -- 0xFE18()
0x054a    -- 0xFEA1( ???=1, ???=2 )
0x0550    -- 0xFE41()
0x0554    op01_JumpTo( address=0x5a5 )
0x0557    op02_JumpToConditional( val1=mem[0x2dc], val2=3, condition="val1 == val2", address_if_false=0x571 )
0x055f    -- 0xFE18()
0x0564    -- 0xFEA1( ???=3, ???=4 )
0x056a    -- 0xFE41()
0x056e    op01_JumpTo( address=0x5a5 )
0x0571    op02_JumpToConditional( val1=mem[0x2dc], val2=5, condition="val1 == val2", address_if_false=0x58b )
0x0579    -- 0xFE18()
0x057e    -- 0xFEA1( ???=5, ???=6 )
0x0584    -- 0xFE41()
0x0588    op01_JumpTo( address=0x5a5 )
0x058b    op02_JumpToConditional( val1=mem[0x2dc], val2=4, condition="val1 == val2", address_if_false=0x5a5 )
0x0593    -- 0xFE18()
0x0598    -- 0xFEA1( ???=4, ???=5 )
0x059e    -- 0xFE41()
...
0x05c6    -- 0xFE54()
0x05c8    mem[0x404] = mem[0x2dc] -- op35
...
0x0808    op02_JumpToConditional( val1=mem[0x2d6], val2=0, condition="val1 == val2", address_if_false=0x819 )
0x0810    -- 0x19_ActorSetPosition( x=(vf80)0xfeea, z=(vf40)0x0000, flag=(flag)0xc0 )
0x0816    op69_ActorSetRotation( rot=6 )
0x0819    op02_JumpToConditional( val1=mem[0x2d8], val2=0, condition="val1 == val2", address_if_false=0x82a )
0x0821    -- 0x19_ActorSetPosition( x=(vf80)0x0000, z=(vf40)0xfeed, flag=(flag)0xc0 )
0x0827    op69_ActorSetRotation( rot=4 )
0x082a    op02_JumpToConditional( val1=mem[0x2da], val2=0, condition="val1 == val2", address_if_false=0x83b )
0x0832    -- 0x19_ActorSetPosition( x=(vf80)0x0116, z=(vf40)0x0000, flag=(flag)0xc0 )
0x0838    op69_ActorSetRotation( rot=2 )
0x083b    op02_JumpToConditional( val1=mem[0x2dc], val2=0, condition="val1 == val2", address_if_false=0x84c )
...
0x0855    op02_JumpToConditional( val1=mem[0x2c4], val2=1024, condition="val1 & val2", address_if_false=0x860 )
...
0x086f    op02_JumpToConditional( val1=mem[0x2d6], val2=1, condition="val1 == val2", address_if_false=0x880 )
0x0877    -- 0x19_ActorSetPosition( x=(vf80)0xfeea, z=(vf40)0x0000, flag=(flag)0xc0 )
0x087d    op69_ActorSetRotation( rot=6 )
0x0880    op02_JumpToConditional( val1=mem[0x2d8], val2=1, condition="val1 == val2", address_if_false=0x891 )
0x0888    -- 0x19_ActorSetPosition( x=(vf80)0x0000, z=(vf40)0xfeed, flag=(flag)0xc0 )
0x088e    op69_ActorSetRotation( rot=4 )
0x0891    op02_JumpToConditional( val1=mem[0x2da], val2=1, condition="val1 == val2", address_if_false=0x8a2 )
0x0899    -- 0x19_ActorSetPosition( x=(vf80)0x0116, z=(vf40)0x0000, flag=(flag)0xc0 )
0x089f    op69_ActorSetRotation( rot=2 )
0x08a2    op02_JumpToConditional( val1=mem[0x2dc], val2=1, condition="val1 == val2", address_if_false=0x8b3 )
...
0x08bc    op02_JumpToConditional( val1=mem[0x2c4], val2=2048, condition="val1 & val2", address_if_false=0x8c7 )
...
0x08d6    op02_JumpToConditional( val1=mem[0x2d6], val2=2, condition="val1 == val2", address_if_false=0x8e7 )
0x08de    -- 0x19_ActorSetPosition( x=(vf80)0xfeea, z=(vf40)0x0000, flag=(flag)0xc0 )
0x08e4    op69_ActorSetRotation( rot=6 )
0x08e7    op02_JumpToConditional( val1=mem[0x2d8], val2=2, condition="val1 == val2", address_if_false=0x8f8 )
0x08ef    -- 0x19_ActorSetPosition( x=(vf80)0x0000, z=(vf40)0xfeed, flag=(flag)0xc0 )
0x08f5    op69_ActorSetRotation( rot=4 )
0x08f8    op02_JumpToConditional( val1=mem[0x2da], val2=2, condition="val1 == val2", address_if_false=0x909 )
0x0900    -- 0x19_ActorSetPosition( x=(vf80)0x0116, z=(vf40)0x0000, flag=(flag)0xc0 )
0x0906    op69_ActorSetRotation( rot=2 )
0x0909    op02_JumpToConditional( val1=mem[0x2dc], val2=2, condition="val1 == val2", address_if_false=0x91a )
...
0x0923    op02_JumpToConditional( val1=mem[0x2c4], val2=-32768, condition="val1 & val2", address_if_false=0x92e )
...
0x093d    op02_JumpToConditional( val1=mem[0x2d6], val2=3, condition="val1 == val2", address_if_false=0x94e )
0x0945    -- 0x19_ActorSetPosition( x=(vf80)0xfeea, z=(vf40)0x0000, flag=(flag)0xc0 )
0x094b    op69_ActorSetRotation( rot=6 )
0x094e    op02_JumpToConditional( val1=mem[0x2d8], val2=3, condition="val1 == val2", address_if_false=0x95f )
0x0956    -- 0x19_ActorSetPosition( x=(vf80)0x0000, z=(vf40)0xfeed, flag=(flag)0xc0 )
0x095c    op69_ActorSetRotation( rot=4 )
0x095f    op02_JumpToConditional( val1=mem[0x2da], val2=3, condition="val1 == val2", address_if_false=0x970 )
0x0967    -- 0x19_ActorSetPosition( x=(vf80)0x0116, z=(vf40)0x0000, flag=(flag)0xc0 )
0x096d    op69_ActorSetRotation( rot=2 )
0x0970    op02_JumpToConditional( val1=mem[0x2dc], val2=3, condition="val1 == val2", address_if_false=0x981 )
...
0x098a    op02_JumpToConditional( val1=mem[0x2c4], val2=4096, condition="val1 & val2", address_if_false=0x995 )
...
0x09a4    op02_JumpToConditional( val1=mem[0x2d6], val2=5, condition="val1 == val2", address_if_false=0x9b5 )
0x09ac    -- 0x19_ActorSetPosition( x=(vf80)0xfeea, z=(vf40)0x0000, flag=(flag)0xc0 )
0x09b2    op69_ActorSetRotation( rot=6 )
0x09b5    op02_JumpToConditional( val1=mem[0x2d8], val2=5, condition="val1 == val2", address_if_false=0x9c6 )
0x09bd    -- 0x19_ActorSetPosition( x=(vf80)0x0000, z=(vf40)0xfeed, flag=(flag)0xc0 )
0x09c3    op69_ActorSetRotation( rot=4 )
0x09c6    op02_JumpToConditional( val1=mem[0x2da], val2=5, condition="val1 == val2", address_if_false=0x9d7 )
0x09ce    -- 0x19_ActorSetPosition( x=(vf80)0x0116, z=(vf40)0x0000, flag=(flag)0xc0 )
0x09d4    op69_ActorSetRotation( rot=2 )
0x09d7    op02_JumpToConditional( val1=mem[0x2dc], val2=5, condition="val1 == val2", address_if_false=0x9e8 )
...
0x09f1    op02_JumpToConditional( val1=mem[0x2c4], val2=8192, condition="val1 & val2", address_if_false=0x9fc )
...
0x0a0b    op02_JumpToConditional( val1=mem[0x2d6], val2=4, condition="val1 == val2", address_if_false=0xa1c )
0x0a13    -- 0x19_ActorSetPosition( x=(vf80)0xfeea, z=(vf40)0x0000, flag=(flag)0xc0 )
0x0a19    op69_ActorSetRotation( rot=6 )
0x0a1c    op02_JumpToConditional( val1=mem[0x2d8], val2=4, condition="val1 == val2", address_if_false=0xa2d )
0x0a24    -- 0x19_ActorSetPosition( x=(vf80)0x0000, z=(vf40)0xfeed, flag=(flag)0xc0 )
0x0a2a    op69_ActorSetRotation( rot=4 )
0x0a2d    op02_JumpToConditional( val1=mem[0x2da], val2=4, condition="val1 == val2", address_if_false=0xa3e )
0x0a35    -- 0x19_ActorSetPosition( x=(vf80)0x0116, z=(vf40)0x0000, flag=(flag)0xc0 )
0x0a3b    op69_ActorSetRotation( rot=2 )
0x0a3e    op02_JumpToConditional( val1=mem[0x2dc], val2=4, condition="val1 == val2", address_if_false=0xa4f )
...
0x0a58    op02_JumpToConditional( val1=mem[0x2c4], val2=16384, condition="val1 & val2", address_if_false=0xa63 )
...
Actor_0x17:on_talk:
0x0bd4    op02_JumpToConditional( val1=mem[0x2cc], val2=1, condition="val1 & val2", address_if_false=0xbdf )
...
0x132b    -- 0xFEC6( char_id=mem[0x2d0] )
0x132f    -- 0xFE1A() sync load for 0xFEC6()
0x1331    -- 0xFEC6( char_id=mem[0x2d2] )
0x1335    -- 0xFE1A() sync load for 0xFEC6()
0x1337    -- 0xBB( ???=0x7 )
0x1339    -- 0x5A()
0x133a    op0D_Return()
0x133b    -- 0xE0( actor_id=Actor_0xb7, ???=(vf80)0x5020, ???=(vf40)0x0031, flag=0x0 )
