...
0x0093    -- 0x19_ActorSetPosition( x=(vf80)0x0072, z=(vf40)0x00c2, flag=(flag)0xc0 )
0x0099    op69_ActorSetRotation( rot=5 )
0x009c    op00_Return()
...
Actor_0x0d:on_start:
0x00a7    -- 0x0B_InitNPC( 1 )
0x00aa    -- 0x19_ActorSetPosition( x=(vf80)0xff59, z=(vf40)0xffb9, flag=(flag)0xc0 )
0x00b0    op69_ActorSetRotation( rot=6 )
0x00b3    op00_Return()
...
Actor_0x0d:on_talk:
0x00b6    op6F_ActorRotateToActor( actor_id=party1 )
0x00b8    opD2_MessageShowDynamic( text_id=0x1, flags=0 )
0x00bc    op9C_MessageSync()
0x00bd    op69_ActorSetRotation( rot=6 )
...
Actor_0x0e:on_push:
0x00d0    op00_Return()
0x00d1    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0038, ???=(vf40)0x06eb, flag=0xff )
