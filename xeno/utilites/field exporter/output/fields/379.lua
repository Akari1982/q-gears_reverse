...
0x0576    -- 0x5F( ???=0x0 )
0x0578    -- 0xFE5E()
0x057c    op01_JumpTo( address=0x581 )
0x057f    op29_ActorTurnOff( actor_id=Actor_0x0c )
0x0581    op00_Return()

Actor_0x0c:on_update:
0x0582    op02_JumpToConditional( val1=(s)mem[0x408], val2=0, condition="val1 == val2", address_if_false=0x5ad )
0x058a    -- 0x6E()
...
0x05bb    -- 0xFE5E()
0x05bf    op26_Wait( time=10 )
0x05c2    -- 0xFE5E()
0x05c6    op26_Wait( time=10 )
0x05c9    -- 0xFE5E()
...
0x05de    -- 0xFE5E()
0x05e2    op26_Wait( time=64 )
0x05e5    -- 0xFE5E()
0x05e9    op26_Wait( time=5 )
0x05ec    -- 0xFE5E()
0x05f0    op26_Wait( time=6 )
0x05f3    -- 0xFE5E()
0x05f7    op26_Wait( time=6 )
0x05fa    -- 0xFE5E()
0x05fe    op26_Wait( time=6 )
0x0601    -- 0xFE5E()
0x0605    op26_Wait( time=300 )
0x0608    op74_SoundPlayFixedVolume( sound_id=0 )
0x060b    op00_Return()
...
0x061f    -- 0x5F( ???=0x3 )
0x0621    -- 0x19_ActorSetPosition( x=(vf80)0x0053, z=(vf40)0x0017, flag=(flag)0xc0 )
0x0627    op00_Return()

Actor_0x0c:event_0x07:
0x0628    -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call )
0x062e    -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call )
0x0634    op29_ActorTurnOff( actor_id=Actor_0x0c )
0x0636    op00_Return()
...
0x0954    op02_JumpToConditional( val1=(s)mem[0x14c], val2=71, condition="val1 == val2", address_if_false=0xa56 )
0x095c    -- 0x91()
0x0960    -- 0xFE54()
...
0x0a56    -- 0xC9()
0x0a5a    op02_JumpToConditional( val1=(s)mem[0x14c], val2=70, condition="val1 < val2", address_if_false=0xa9e )
0x0a62    -- 0x91()
...
0x0aa3    -- 0xC9()
0x0aa7    op02_JumpToConditional( val1=(s)mem[0x14c], val2=72, condition="val1 == val2", address_if_false=0xcab )
...
0x11b6    op02_JumpToConditional( val1=(s)mem[0x14c], val2=72, condition="val1 < val2", address_if_false=0x11c4 )
...
0x1a70    op00_Return()
0x1a71    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x4d38, ???=(vf40)0xde6e, flag=0x1f )
