...
0x0093    opCB_TriggerJumpTo( trigger_id=0x0, jump=0x9c )
0x0097    -- 0x98_MapLoad( field_id=395, value=1 )
0x009c    op00_Return()
...
Actor_0x0d:on_push:
0x0278    op00_Return()
0x0279    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0038, ???=(vf40)0x0000, flag=0xc5 )
