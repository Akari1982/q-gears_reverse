...
0x04aa    op02_JumpToConditional( val1=mem[0x2ca], val2=64, condition="val1 & val2", address_if_false=0x4b5 )
...
0x1da8    -- 0xFEC6( char_id=mem[0x2d0] )
0x1dac    -- 0xFE1A() sync load for 0xFEC6()
0x1dae    -- 0xFEC6( char_id=mem[0x2d2] )
