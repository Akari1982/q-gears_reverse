...
0x00ff    op02_JumpToConditional( val1=(s)mem[0x14e], val2=4, condition="val1 & val2", address_if_false=0x11e )
0x0107    -- 0xFE54()
...
0x011e    -- 0xFE54()
0x0120    op02_JumpToConditional( val1=(s)mem[0x14e], val2=16, condition="val1 & val2", address_if_false=0x132 )
