...
0x1f4e    op02_JumpToConditional( val1=mem[0x524], val2=-417, condition="val1 < val2", address_if_false=0x1f61 )
0x1f56    op02_JumpToConditional( val1=mem[0x524], val2=-706, condition="val1 > val2", address_if_false=0x1f61 )
