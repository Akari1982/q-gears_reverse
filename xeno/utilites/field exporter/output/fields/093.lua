...
0x0153    -- 0xFE17()
0x0157    -- 0xFE17()
0x015b    op02_JumpToConditional( val1=(s)mem[0x12a], val2=2, condition="val1 == val2", address_if_false=0x169 )
...
0x026d    op02_JumpToConditional( val1=(s)mem[0x12a], val2=1, condition="val1 == val2", address_if_false=0x27b )
...
0x0323    op02_JumpToConditional( val1=(s)mem[0x12a], val2=1, condition="val1 == val2", address_if_false=0x331 )
...
0x03e7    op02_JumpToConditional( val1=(s)mem[0x12a], val2=1, condition="val1 == val2", address_if_false=0x3f5 )
...
0x04c8    op02_JumpToConditional( val1=(s)mem[0x102], val2=23, condition="val1 >= val2", address_if_false=0x4e2 )
0x04d0    op02_JumpToConditional( val1=(s)mem[0x102], val2=24, condition="val1 <= val2", address_if_false=0x4e2 )
0x04d8    -- 0x5F( ???=0x4 )
...
0x05a9    -- 0x18()
0x05ae    op02_JumpToConditional( val1=(s)mem[0x102], val2=2, condition="val1 == val2", address_if_false=0x5c1 )
0x05b6    -- 0x1A()
0x05b8    -- 0x19_ActorSetPosition( x=(vf80)0x023f, z=(vf40)0xf722, flag=(flag)0xc0 )
0x05be    -- 0x5F( ???=0x0 )
0x05c0    op00_Return()
0x05c1    op02_JumpToConditional( val1=(s)mem[0x102], val2=3, condition="val1 == val2", address_if_false=0x5d5 )
...
0x05d4    op00_Return()
0x05d5    op02_JumpToConditional( val1=(s)mem[0x102], val2=4, condition="val1 == val2", address_if_false=0x5ee )
...
0x05ed    op00_Return()
0x05ee    op02_JumpToConditional( val1=(s)mem[0x102], val2=32, condition="val1 >= val2", address_if_false=0x609 )
0x05f6    op02_JumpToConditional( val1=(s)mem[0x102], val2=33, condition="val1 <= val2", address_if_false=0x609 )
0x05fe    -- 0x1A()
...
Actor_0x0d:on_talk:
0x0611    op02_JumpToConditional( val1=(s)mem[0x102], val2=3, condition="val1 == val2", address_if_false=0x626 )
...
0x0626    op02_JumpToConditional( val1=(s)mem[0x102], val2=4, condition="val1 == val2", address_if_false=0x643 )
...
0x0642    -- 0x23()
0x0643    op02_JumpToConditional( val1=(s)mem[0x102], val2=33, condition="val1 == val2", address_if_false=0x65e )
...
0x06c7    op02_JumpToConditional( val1=(s)mem[0x102], val2=2, condition="val1 == val2", address_if_false=0x6d9 )
0x06cf    -- 0x1A()
0x06d1    -- 0x19_ActorSetPosition( x=(vf80)0x023f, z=(vf40)0xf6be, flag=(flag)0xc0 )
0x06d7    -- 0x5F( ???=0x0 )
0x06d9    op02_JumpToConditional( val1=(s)mem[0x102], val2=19, condition="val1 >= val2", address_if_false=0x705 )
0x06e1    op02_JumpToConditional( val1=(s)mem[0x102], val2=20, condition="val1 <= val2", address_if_false=0x6f3 )
0x06e9    -- 0x1A()
0x06eb    -- 0x19_ActorSetPosition( x=(vf80)0x03d6, z=(vf40)0xfcce, flag=(flag)0xc0 )
0x06f1    -- 0x5F( ???=0x4 )
0x06f3    op02_JumpToConditional( val1=(s)mem[0x102], val2=21, condition="val1 == val2", address_if_false=0x705 )
0x06fb    -- 0x1A()
0x06fd    -- 0x19_ActorSetPosition( x=(vf80)0x03a9, z=(vf40)0xfd2a, flag=(flag)0xc0 )
0x0703    -- 0x5F( ???=0x2 )
0x0705    op02_JumpToConditional( val1=(s)mem[0x102], val2=32, condition="val1 == val2", address_if_false=0x717 )
0x070d    -- 0x1A()
...
0x0718    op02_JumpToConditional( val1=(s)mem[0x102], val2=19, condition="val1 >= val2", address_if_false=0x722 )
0x0720    op6F_ActorRotateToActor( actor_id=party1 )
0x0722    op02_JumpToConditional( val1=(s)mem[0x102], val2=19, condition="val1 == val2", address_if_false=0x733 )
0x072a    -- 0x89()
0x0730    op05_CallFunction( address=0x7fc )
0x0733    op02_JumpToConditional( val1=(s)mem[0x102], val2=20, condition="val1 == val2", address_if_false=0x73d )
0x073b    op6F_ActorRotateToActor( actor_id=party1 )
0x073d    op00_Return()

Actor_0x0e:on_talk:
0x073e    op02_JumpToConditional( val1=(s)mem[0x102], val2=20, condition="val1 == val2", address_if_false=0x7ba )
0x0746    -- 0xFE52()
0x0748    -- 0xFE54()
...
0x07b7    op00_Return()
0x07b8    -- 0xFE51()
0x07ba    op02_JumpToConditional( val1=(s)mem[0x102], val2=21, condition="val1 == val2", address_if_false=0x7cb )
...
0x0843    op02_JumpToConditional( val1=(s)mem[0x102], val2=32, condition="val1 == val2", address_if_false=0x853 )
...
Actor_0x10:on_talk:
0x087a    op02_JumpToConditional( val1=(s)mem[0x102], val2=23, condition="val1 == val2", address_if_false=0x9ee )
...
0x0a08    -- 0x18()
0x0a0d    op02_JumpToConditional( val1=(s)mem[0x102], val2=0, condition="val1 == val2", address_if_false=0xa1d )
0x0a15    -- 0x19_ActorSetPosition( x=(vf80)0x0060, z=(vf40)0x078a, flag=(flag)0xc0 )
0x0a1b    -- 0x5F( ???=0x6 )
0x0a1d    op02_JumpToConditional( val1=(s)mem[0x102], val2=2, condition="val1 >= val2", address_if_false=0xa3a )
0x0a25    op02_JumpToConditional( val1=(s)mem[0x102], val2=3, condition="val1 <= val2", address_if_false=0xa3a )
0x0a2d    -- 0x19_ActorSetPosition( x=(vf80)0x0000, z=(vf40)0x07bd, flag=(flag)0xc0 )
0x0a33    -- 0x18()
0x0a38    -- 0x5F( ???=0x1 )
0x0a3a    op02_JumpToConditional( val1=(s)mem[0x102], val2=4, condition="val1 == val2", address_if_false=0xa4f )
...
0x0a50    op02_JumpToConditional( val1=(s)mem[0x102], val2=0, condition="val1 == val2", address_if_false=0xa5c )
0x0a58    -- 0x5F( ???=0x6 )
0x0a5a    -- 0x5A()
0x0a5b    op00_Return()
...
0x0a61    op02_JumpToConditional( val1=(s)mem[0x102], val2=0, condition="val1 == val2", address_if_false=0xa6f )
0x0a69    opD2_MessageShowDynamic( text_id=0x36, flags=0 )
0x0a6d    op9C_MessageSync()
0x0a6e    op00_Return()
0x0a6f    op02_JumpToConditional( val1=(s)mem[0x102], val2=3, condition="val1 == val2", address_if_false=0xaf6 )
0x0a77    -- 0xFE54()
...
0x0af3    -- 0xFE54()
0x0af5    op00_Return()
0x0af6    op02_JumpToConditional( val1=(s)mem[0x102], val2=4, condition="val1 == val2", address_if_false=0xb03 )
...
0x0b08    -- 0x18()
0x0b0d    op02_JumpToConditional( val1=(s)mem[0x102], val2=2, condition="val1 >= val2", address_if_false=0xb25 )
0x0b15    op02_JumpToConditional( val1=(s)mem[0x102], val2=3, condition="val1 <= val2", address_if_false=0xb25 )
0x0b1d    -- 0x19_ActorSetPosition( x=(vf80)0xff98, z=(vf40)0x077a, flag=(flag)0xc0 )
0x0b23    -- 0x5F( ???=0x3 )
0x0b25    op02_JumpToConditional( val1=(s)mem[0x102], val2=4, condition="val1 == val2", address_if_false=0xb35 )
...
Actor_0x14:on_talk:
0x0b84    op02_JumpToConditional( val1=(s)mem[0x102], val2=0, condition="val1 == val2", address_if_false=0xb92 )
...
0x0be9    op02_JumpToConditional( val1=(s)mem[0x102], val2=0, condition="val1 == val2", address_if_false=0xbf7 )
0x0bf1    opD2_MessageShowDynamic( text_id=0x43, flags=0 )
0x0bf5    op9C_MessageSync()
0x0bf6    op00_Return()
0x0bf7    op02_JumpToConditional( val1=(s)mem[0x102], val2=18, condition="val1 < val2", address_if_false=0xc04 )
0x0bff    opD2_MessageShowDynamic( text_id=0x44, flags=0 )
0x0c03    op9C_MessageSync()
0x0c04    op02_JumpToConditional( val1=(s)mem[0x102], val2=18, condition="val1 > val2", address_if_false=0xc19 )
0x0c0c    op02_JumpToConditional( val1=(s)mem[0x102], val2=33, condition="val1 <= val2", address_if_false=0xc19 )
...
0x0c73    -- 0x91()
0x0c77    op02_JumpToConditional( val1=(s)mem[0x102], val2=0, condition="val1 == val2", address_if_false=0xc97 )
...
0x0c95    -- 0x14()
0x0c96    op00_Return()
0x0c97    op02_JumpToConditional( val1=(s)mem[0x102], val2=20, condition="val1 <= val2", address_if_false=0xcbd )
...
0x0cbb    -- 0x14()
0x0cbc    op00_Return()
0x0cbd    op02_JumpToConditional( val1=(s)mem[0x102], val2=33, condition="val1 <= val2", address_if_false=0xce0 )
...
0x0cde    -- 0x14()
0x0cdf    op00_Return()
0x0ce0    op02_JumpToConditional( val1=(s)mem[0x102], val2=35, condition="val1 >= val2", address_if_false=0xcef )
0x0ce8    -- 0x15()
0x0ce9    opD2_MessageShowDynamic( text_id=0x4e, flags=0 )
0x0ced    op9C_MessageSync()
0x0cee    -- 0x14()
0x0cef    op01_JumpTo( address=0xd24 )
0x0cf2    op02_JumpToConditional( val1=(s)mem[0x102], val2=0, condition="val1 == val2", address_if_false=0xd06 )
...
0x0d06    op02_JumpToConditional( val1=(s)mem[0x102], val2=35, condition="val1 >= val2", address_if_false=0xd18 )
0x0d0e    -- 0x15()
...
Actor_0x17:on_talk:
0x0d41    op02_JumpToConditional( val1=(s)mem[0x102], val2=2, condition="val1 < val2", address_if_false=0xd4f )
0x0d49    opD2_MessageShowDynamic( text_id=0x52, flags=0 )
0x0d4d    op9C_MessageSync()
0x0d4e    op00_Return()
0x0d4f    op02_JumpToConditional( val1=(s)mem[0x102], val2=2, condition="val1 >= val2", address_if_false=0xdb3 )
0x0d57    op02_JumpToConditional( val1=(s)mem[0x102], val2=33, condition="val1 <= val2", address_if_false=0xdb3 )
0x0d5f    -- 0x91()
0x0d63    -- 0x15()
...
0x0db2    -- 0x14()
0x0db3    op02_JumpToConditional( val1=(s)mem[0x102], val2=34, condition="val1 >= val2", address_if_false=0xdc0 )
...
0x0dfd    op02_JumpToConditional( val1=(s)mem[0x102], val2=2, condition="val1 < val2", address_if_false=0xe0b )
0x0e05    opD2_MessageShowDynamic( text_id=0x5c, flags=0 )
0x0e09    op9C_MessageSync()
0x0e0a    op00_Return()
0x0e0b    op02_JumpToConditional( val1=(s)mem[0x102], val2=2, condition="val1 >= val2", address_if_false=0xe18 )
...
0x0e38    op02_JumpToConditional( val1=(s)mem[0x102], val2=2, condition="val1 < val2", address_if_false=0xe45 )
0x0e40    opD2_MessageShowDynamic( text_id=0x5e, flags=0 )
0x0e44    op9C_MessageSync()
0x0e45    op02_JumpToConditional( val1=(s)mem[0x102], val2=2, condition="val1 >= val2", address_if_false=0xe5a )
0x0e4d    op02_JumpToConditional( val1=(s)mem[0x102], val2=18, condition="val1 <= val2", address_if_false=0xe5a )
0x0e55    opD2_MessageShowDynamic( text_id=0x5f, flags=0 )
0x0e59    op9C_MessageSync()
0x0e5a    op02_JumpToConditional( val1=(s)mem[0x102], val2=18, condition="val1 > val2", address_if_false=0xe67 )
...
0x0e79    op02_JumpToConditional( val1=(s)mem[0x102], val2=23, condition="val1 == val2", address_if_false=0xe85 )
0x0e81    op00_Return()
...
0x0f09    op02_JumpToConditional( val1=(s)mem[0x102], val2=0, condition="val1 >= val2", address_if_false=0xf26 )
0x0f11    op02_JumpToConditional( val1=(s)mem[0x102], val2=28, condition="val1 <= val2", address_if_false=0xf21 )
...
0x0f3b    op02_JumpToConditional( val1=(s)mem[0x102], val2=0, condition="val1 == val2", address_if_false=0xf49 )
0x0f43    opD2_MessageShowDynamic( text_id=0x64, flags=0 )
0x0f47    op9C_MessageSync()
0x0f48    op00_Return()
0x0f49    op02_JumpToConditional( val1=(s)mem[0x102], val2=19, condition="val1 < val2", address_if_false=0xf83 )
...
0x0f83    op02_JumpToConditional( val1=(s)mem[0x102], val2=19, condition="val1 >= val2", address_if_false=0xfa4 )
0x0f8b    op02_JumpToConditional( val1=(s)mem[0x102], val2=28, condition="val1 < val2", address_if_false=0xfa4 )
...
0x0f9e    -- 0xFE0B()
0x0fa2    -- 0xFE54()
0x0fa4    op02_JumpToConditional( val1=(s)mem[0x102], val2=28, condition="val1 >= val2", address_if_false=0xfbd )
...
Actor_0x1e:on_talk:
0x0fd0    op02_JumpToConditional( val1=(s)mem[0x102], val2=19, condition="val1 < val2", address_if_false=0xfea )
...
0x0fe7    -- 0xFE54()
0x0fe9    op00_Return()
0x0fea    op02_JumpToConditional( val1=(s)mem[0x102], val2=19, condition="val1 >= val2", address_if_false=0x100c )
0x0ff2    op02_JumpToConditional( val1=(s)mem[0x102], val2=28, condition="val1 < val2", address_if_false=0x100c )
...
0x1009    -- 0xFE54()
0x100b    op00_Return()
0x100c    op02_JumpToConditional( val1=(s)mem[0x102], val2=28, condition="val1 >= val2", address_if_false=0x1025 )
...
Actor_0x29:on_talk:
0x113b    op02_JumpToConditional( val1=(s)mem[0x102], val2=20, condition="val1 == val2", address_if_false=0x1147 )
0x1143    op00_Return()
...
Actor_0x2b:on_talk:
0x116d    op02_JumpToConditional( val1=(s)mem[0x102], val2=0, condition="val1 > val2", address_if_false=0x118e )
0x1175    op02_JumpToConditional( val1=(s)mem[0x102], val2=18, condition="val1 <= val2", address_if_false=0x118e )
0x117d    -- 0xFB()
...
function:
0x15e4    op02_JumpToConditional( val1=(s)mem[0x102], val2=0, condition="val1 >= val2", address_if_false=0x15fb )
0x15ec    op02_JumpToConditional( val1=(s)mem[0x102], val2=19, condition="val1 <= val2", address_if_false=0x15fb )
0x15f4    opC6_ExpandRun() -- exp0x20
0x15f5    -- 0x75( ???=4 )
0x15f8    -- 0xFEA2()
0x15fa    op0D_Return()
0x15fb    op02_JumpToConditional( val1=(s)mem[0x102], val2=21, condition="val1 == val2", address_if_false=0x1604 )
0x1603    op0D_Return()
0x1604    op02_JumpToConditional( val1=(s)mem[0x102], val2=23, condition="val1 >= val2", address_if_false=0x161b )
0x160c    op02_JumpToConditional( val1=(s)mem[0x102], val2=24, condition="val1 <= val2", address_if_false=0x161b )
0x1614    opC6_ExpandRun() -- exp0x20
0x1615    -- 0x75( ???=41 )
0x1618    -- 0xFEA2()
0x161a    op0D_Return()
0x161b    op02_JumpToConditional( val1=(s)mem[0x102], val2=28, condition="val1 == val2", address_if_false=0x162a )
0x1623    opC6_ExpandRun() -- exp0x20
0x1624    -- 0x75( ???=255 )
0x1627    -- 0xFEA2()
0x1629    op0D_Return()
0x162a    op02_JumpToConditional( val1=(s)mem[0x102], val2=29, condition="val1 >= val2", address_if_false=0x1641 )
0x1632    op02_JumpToConditional( val1=(s)mem[0x102], val2=32, condition="val1 <= val2", address_if_false=0x1641 )
0x163a    opC6_ExpandRun() -- exp0x20
0x163b    -- 0x75( ???=16 )
0x163e    -- 0xFEA2()
0x1640    op0D_Return()
0x1641    op02_JumpToConditional( val1=(s)mem[0x102], val2=35, condition="val1 == val2", address_if_false=0x1650 )
0x1649    opC6_ExpandRun() -- exp0x20
0x164a    -- 0x75( ???=4 )
0x164d    -- 0xFEA2()
0x164f    op0D_Return()
0x1650    op02_JumpToConditional( val1=(s)mem[0x102], val2=45, condition="val1 >= val2", address_if_false=0x1667 )
0x1658    op02_JumpToConditional( val1=(s)mem[0x102], val2=65, condition="val1 <= val2", address_if_false=0x1667 )
0x1660    opC6_ExpandRun() -- exp0x20
0x1661    -- 0x75( ???=22 )
0x1664    -- 0xFEA2()
0x1666    op0D_Return()
0x1667    op02_JumpToConditional( val1=(s)mem[0x102], val2=66, condition="val1 >= val2", address_if_false=0x1675 )
0x166f    -- 0x75( ???=4 )
0x1672    -- 0xFEA2()
0x1674    op0D_Return()
0x1675    op0D_Return()
...
0x1680    op02_JumpToConditional( val1=(s)mem[0x102], val2=0, condition="val1 == val2", address_if_false=0x1690 )
...
0x1690    op02_JumpToConditional( val1=(s)mem[0x102], val2=3, condition="val1 >= val2", address_if_false=0x169c )
0x1698    op25_ActorDisable( actor_id=Actor_0x0e )
0x169a    -- 0x27( actor_id=Actor_0x0e )
0x169c    op02_JumpToConditional( val1=(s)mem[0x102], val2=5, condition="val1 >= val2", address_if_false=0x16b0 )
...
0x16b0    op02_JumpToConditional( val1=(s)mem[0x102], val2=5, condition="val1 > val2", address_if_false=0x16bc )
0x16b8    op25_ActorDisable( actor_id=Actor_0x0d )
0x16ba    -- 0x27( actor_id=Actor_0x0d )
0x16bc    op02_JumpToConditional( val1=(s)mem[0x102], val2=19, condition="val1 >= val2", address_if_false=0x16d0 )
0x16c4    op02_JumpToConditional( val1=(s)mem[0x102], val2=21, condition="val1 <= val2", address_if_false=0x16d0 )
0x16cc    -- 0x28()
0x16ce    op24_ActorEnable( actor_id=Actor_0x0e )
0x16d0    op02_JumpToConditional( val1=(s)mem[0x102], val2=23, condition="val1 == val2", address_if_false=0x16dc )
0x16d8    -- 0x28()
0x16da    op24_ActorEnable( actor_id=Actor_0x10 )
0x16dc    op02_JumpToConditional( val1=(s)mem[0x102], val2=28, condition="val1 == val2", address_if_false=0x170d )
...
0x170d    op02_JumpToConditional( val1=(s)mem[0x102], val2=28, condition="val1 > val2", address_if_false=0x1729 )
...
0x1729    op02_JumpToConditional( val1=(s)mem[0x102], val2=32, condition="val1 == val2", address_if_false=0x173d )
0x1731    -- 0x28()
