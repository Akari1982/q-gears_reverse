...
Actor[ "0x03" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=1 ) -- 0x00fa 0x16
        opcodeFE0D_MessageSetFace( char_id=1 ) -- 0x00fd 0xfe
...
Actor[ "0x04" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=3 ) -- 0x0105 0x16
        opcodeFE0D_MessageSetFace( char_id=3 ) -- 0x0108 0xfe
...
Actor[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=6 ) -- 0x0126 0x16
...
Actor[ "0x08" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=7 ) -- 0x0131 0x16
        opcodeFE0D_MessageSetFace( char_id=7 ) -- 0x0134 0xfe
...
Actor[ "0x09" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=8 ) -- 0x013c 0x16
        opcodeFE0D_MessageSetFace( char_id=8 ) -- 0x013f 0xfe
...
Actor[ "0x0a" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=9 ) -- 0x0147 0x16
        opcodeFE0D_MessageSetFace( char_id=9 ) -- 0x014a 0xfe
...
Actor[ "0x0b" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=10 ) -- 0x0152 0x16
        opcodeFE0D_MessageSetFace( char_id=10 ) -- 0x0155 0xfe
...
Actor[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xffa6, z=(vf40)0x005a, flag=(flag)0xc0 ) -- 0x0160 0x19
        opcode69_ActorSetRotation( rot=7 ) -- 0x0166 0x69
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x02ce ), value2=(s16)0x0040, condition="value1 & value2", jump_if_false=0x0177 ) -- 0x0169 0x02
        -- 0x19_ActorSetPosition( x=(vf80)0xfeca, z=(vf40)0x0136, flag=(flag)0xc0 ) -- 0x0171 0x19
    ...
    on_talk = function( self )
        ...
        opcodeD2_MessageShowDynamic( text_id=0x0000, flags=0 ) -- 0x0182 0xd2
    ...
    script_0x04 = function( self )
        -- 0x19_ActorSetPosition( x=(vf80)0xfeca, z=(vf40)0x0136, flag=(flag)0xc0 ) -- 0x0265 0x19
        opcode69_ActorSetRotation( rot=7 ) -- 0x026b 0x69
        return 0 -- 0x026e 0x00
    end,

    script_0x05 = function( self )
        -- 0x19_ActorSetPosition( x=(vf80)0xfdad, z=(vf40)0x0218, flag=(flag)0xc0 ) -- 0x026f 0x19
        opcode69_ActorSetRotation( rot=7 ) -- 0x0275 0x69
...
Actor[ "0x0d" ] = {
    ...
    script_0x04 = function( self )
        opcode20_ActorSetFlags0( flags=13 ) -- 0x029b 0x20
...
Actor[ "0x14" ] = {
    ...
    script_0x04 = function( self )
        opcode20_ActorSetFlags0( flags=13 ) -- 0x033d 0x20
...
Actor[ "0x1d" ] = {
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x03d1 0xfe
        opcodeD2_MessageShowDynamic( text_id=0x000f, flags=0 ) -- 0x03d3 0xd2
        opcodeA9_MessageSetSelectionSync( start_row=02, end_row=03 ) -- 0x03d7 0xa9
        opcode9C_MessageSync() -- 0x03d9 0x9c
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0014 ), value2=(s16)0x0002, condition="value1 == value2", jump_if_false=0x040c ) -- 0x03da 0x02
        -- MISSING OPCODE 0x8e
    end,
