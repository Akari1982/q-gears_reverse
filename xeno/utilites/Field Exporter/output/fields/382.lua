...
0x0010    -- 0xA0()
0x0017    op35_VariableSet( address=0x0144, value=(vf40)0x0000, flag=0x40 )
0x001d    -- 0x2A()
...
0x00ad    op37_VariableSetFalse( address=0x0402 )
0x00b0    -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0402 ), value2=(s16)0x000e, condition="value1 < value2", jump_if_false=0x00c8 )
0x00b8    -- 0xC6()
