...
Actor[ "0x0c" ] = {
    ...
    script_0x04 = function( self )
        opcode37_VariableSetFalse( address=0x0402 ) -- 0x00ad 0x37
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0402 ), value2=(s16)0x000e, condition="value1 < value2", jump_if_false=0x00c8 ) -- 0x00b0 0x02
        -- 0xC6() -- 0x00b8 0xc6
...
Actor[ "0x0d" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x00c9 0xbc
        -- 0x2A() -- 0x00ca 0x2a
    ...
    script_0x04 = function( self )
        opcode37_VariableSetFalse( address=0x0404 ) -- 0x00ce 0x37
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0404 ), value2=(s16)0x000e, condition="value1 < value2", jump_if_false=0x00e9 ) -- 0x00d1 0x02
        -- 0xC6() -- 0x00d9 0xc6
        -- MISSING OPCODE 0xFE1b
    end,
...
Actor[ "0x0e" ] = {
    ...
    script_0x04 = function( self )
        opcode37_VariableSetFalse( address=0x0406 ) -- 0x00ef 0x37
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0406 ), value2=(s16)0x000e, condition="value1 < value2", jump_if_false=0x010a ) -- 0x00f2 0x02
        -- 0xC6() -- 0x00fa 0xc6
        -- MISSING OPCODE 0xFE1b
    end,
...
Actor[ "0x0f" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0000, z=(vf40)0xff6f, flag=(flag)0xc0 ) -- 0x010c 0x19
        -- MISSING OPCODE 0xf8
    end,
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x0124 0xfe
        opcode74_SoundPlayFixedVolume( sound_id=119 ) -- 0x0126 0x74
        -- 0x07( actor_id=0x0c, script=0x24 ) -- 0x0129 0x07
        opcode09_ActorCallScriptEW( actor_id=0x0d, script=04, priority=01 ) -- 0x012c 0x09
...
Actor[ "0x10" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x00dc, z=(vf40)0x0000, flag=(flag)0xc0 ) -- 0x013e 0x19
        -- MISSING OPCODE 0xf8
    end,
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x0156 0xfe
        opcode74_SoundPlayFixedVolume( sound_id=119 ) -- 0x0158 0x74
        opcode09_ActorCallScriptEW( actor_id=0x0e, script=04, priority=01 ) -- 0x015b 0x09
        -- MISSING OPCODE 0xFE68
    end,
...
Actor[ "0x11" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xff2e, z=(vf40)0x0000, flag=(flag)0xc0 ) -- 0x016d 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Actor[ "0x12" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0000, z=(vf40)0x00d2, flag=(flag)0xc0 ) -- 0x0188 0x19
        -- MISSING OPCODE 0xf8
    end,
