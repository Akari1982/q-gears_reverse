...
Entity[ "0x01" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 0 ) -- 0x002f 0x16
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x0032 0xfe
...
Entity[ "0x04" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 3 ) -- 0x0050 0x16
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x0053 0xfe
...
Entity[ "0x05" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 4 ) -- 0x005b 0x16
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x005e 0xfe
...
Entity[ "0x06" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 5 ) -- 0x0066 0x16
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x0069 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 6 ) -- 0x0071 0x16
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x0074 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x007f 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 8 ) -- 0x0087 0x16
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x008a 0xfe
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 10 ) -- 0x009d 0x16
        opcodeFE0D_SetAvatar( character_id=10 ) -- 0x00a0 0xfe
...
Entity[ "0x0c" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x00a8 0xbc
        -- 0x2A() -- 0x00a9 0x2a
...
Entity[ "0x0d" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x00c9 0xbc
        -- 0x2A() -- 0x00ca 0x2a
...
Entity[ "0x0f" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x0000, z=(vf40)0xff6f, flag=(flag)0xc0 ) -- 0x010c 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x10" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x00dc, z=(vf40)0x0000, flag=(flag)0xc0 ) -- 0x013e 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x11" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xff2e, z=(vf40)0x0000, flag=(flag)0xc0 ) -- 0x016d 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x12" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x0000, z=(vf40)0x00d2, flag=(flag)0xc0 ) -- 0x0188 0x19
        -- MISSING OPCODE 0xf8
    end,
