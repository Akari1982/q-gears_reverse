...
Actor[ "0x01" ] = {
    ...
    script_0x04 = function( self )
        ...
        -- 0x5A() -- 0x0062 0x5a
        -- 0x57( type=0x80, x=(vf80)0xff70, z=(vf40)0xfe20, walkmesh_id=(vf20)0x0000, ???=(vf10)0x000f, flag=0xf0 ) -- 0x0063 0x57
        -- 0x57( type=0x8f ) -- 0x006e 0x57
        opcode26_Wait( time=1 ) -- 0x0070 0x26
        -- 0x57( type=0x0f ) -- 0x0073 0x57
        opcode2C_SpritePlayAnim( anim_id=0xff ) -- 0x0075 0x2c
        -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call ) -- 0x0077 0x4a
        opcode6F_ActorRotateToActor( actor_id=(entity)0x02 ) -- 0x007d 0x6f
    ...
    script_0x08 = function( self )
        ...
        -- 0x5A() -- 0x00b2 0x5a
        -- 0x57( type=0x80, x=(vf80)0xff6f, z=(vf40)0xfe88, walkmesh_id=(vf20)0x0000, ???=(vf10)0x0012, flag=0xf0 ) -- 0x00b3 0x57
        -- 0x57( type=0x8f ) -- 0x00be 0x57
        opcode26_Wait( time=1 ) -- 0x00c0 0x26
        -- 0x57( type=0x0f ) -- 0x00c3 0x57
        opcode2C_SpritePlayAnim( anim_id=0x02 ) -- 0x00c5 0x2c
...
Actor[ "0x02" ] = {
    on_start = function( self )
        -- 0x93( ???=10 ) -- 0x00ce 0x93
        -- 0x47( ???=1024 ) -- 0x00d1 0xfe
        -- 0x2A() -- 0x00d5 0x2a
        opcodeFE03( ???=3276 ) -- 0x00d6 0xfe
