...
Entity[ "0x02" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x004c 0xfe
...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x0057 0xfe
...
Entity[ "0x04" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x0062 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=10 ) -- 0x0099 0xfe
...
Entity[ "0x0d" ] = {
    ...
    on_talk = function( self )
        ...
        opcodeD2_MessageShow0( dialog_id=0x0000, ???=0x00 ) -- 0x00e0 0xd2
        -- 0x9C() -- 0x00e4 0x9c
        -- 0x01_JumpTo( 0x00f7 ) -- 0x00e5 0x01
        opcodeFE54() -- 0x00e8 0xfe
        opcodeD2_MessageShow0( dialog_id=0x0001, ???=0x00 ) -- 0x00ea 0xd2
        -- 0x9C() -- 0x00ee 0x9c
...
Entity[ "0x0e" ] = {
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0002, ???=0x00 ) -- 0x015d 0xd2
        -- 0x9C() -- 0x0161 0x9c
...
Entity[ "0x0f" ] = {
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0003, ???=0x00 ) -- 0x0172 0xd2
        -- 0x9C() -- 0x0176 0x9c
