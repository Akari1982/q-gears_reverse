...
Actor[ "0x04" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xff15, z=(vf40)0x00eb, flag=(flag)0xc0 ) -- 0x01a1 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Actor[ "0x05" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x00eb, z=(vf40)0xff15, flag=(flag)0xc0 ) -- 0x01cd 0x19
        -- MISSING OPCODE 0xf8
    end,
