...
0x002a    op00_Return()
0x002b    opD2_MessageShowDynamic( text_id=0x0000, flags=0 )
0x002f    op9C_MessageSync()
0x0030    op0D_FunctionRet()
...
Actor_0x07:on_talk:
0x0094    -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0040 ), value2=(s16)0x00ff, condition="value1 == value2", jump_if_false=0x00a2 )
0x009c    op05_FunctionCall( 0x002b )
0x009f    -- 0x01_JumpTo( 0x00ae )
0x00a2    opD2_MessageShowDynamic( text_id=0x0001, flags=0 )
0x00a6    op9C_MessageSync()
0x00a7    op6F_ActorRotateToActor( actor_id=(entity)party_1 )
0x00a9    opD2_MessageShowDynamic( text_id=0x0002, flags=0 )
