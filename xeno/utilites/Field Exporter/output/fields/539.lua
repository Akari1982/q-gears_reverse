...
Actor[ "0x03" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0057, z=(vf40)0xfefa, flag=(flag)0xc0 ) -- 0x002d 0x19
        return 0 -- 0x0033 0x00
    end,

    on_update = function( self )
        opcode69_ActorSetRotation( rot=3 ) -- 0x0034 0x69
        return 0 -- 0x0037 0x00
    end,

    on_talk = function( self )
        opcode6F_ActorRotateToActor( actor_id=(entity)party_1 ) -- 0x0038 0x6f
        opcode26_Wait( time=10 ) -- 0x003a 0x26
...
Actor[ "0x04" ] = {
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x008d 0xfe
        opcode09_ActorCallScriptEW( actor_id=0x05, script=04, priority=03 ) -- 0x008f 0x09
