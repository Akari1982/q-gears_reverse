...
Actor[ "0x00" ] = {
    ...
    on_update = function( self )
        ...
        opcode09_ActorCallScriptEW( actor_id=0x01, script=04, priority=01 ) -- 0x0037 0x09
        opcode26_Wait( time=32 ) -- 0x003a 0x26
        opcode09_ActorCallScriptEW( actor_id=0x01, script=05, priority=01 ) -- 0x003d 0x09
        opcode09_ActorCallScriptEW( actor_id=0x02, script=05, priority=01 ) -- 0x0040 0x09
        opcode09_ActorCallScriptEW( actor_id=0x03, script=05, priority=01 ) -- 0x0043 0x09
        opcode09_ActorCallScriptEW( actor_id=0x02, script=06, priority=01 ) -- 0x0046 0x09
        opcode09_ActorCallScriptEW( actor_id=0x03, script=06, priority=01 ) -- 0x0049 0x09
        opcode09_ActorCallScriptEW( actor_id=0x02, script=07, priority=01 ) -- 0x004c 0x09
        opcode09_ActorCallScriptEW( actor_id=0x03, script=07, priority=01 ) -- 0x004f 0x09
        opcode09_ActorCallScriptEW( actor_id=0x02, script=08, priority=01 ) -- 0x0052 0x09
        opcode26_Wait( time=24 ) -- 0x0055 0x26
        opcode09_ActorCallScriptEW( actor_id=0x01, script=06, priority=01 ) -- 0x0058 0x09
        -- MISSING OPCODE 0x12
    end,
...
Actor[ "0x02" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=33 ) -- 0x0107 0xfe
        -- MISSING OPCODE 0x1b
    end,
    ...
    script_0x05 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0000, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x0121 0xd2
        opcode9C_MessageSync() -- 0x0125 0x9c
        return 0 -- 0x0126 0x00
    end,

    script_0x06 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0001, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x0127 0xd2
        opcode9C_MessageSync() -- 0x012b 0x9c
        return 0 -- 0x012c 0x00
    end,

    script_0x07 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0002, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x012d 0xd2
        opcode9C_MessageSync() -- 0x0131 0x9c
        return 0 -- 0x0132 0x00
    end,

    script_0x08 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0003, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x0133 0xd2
...
Actor[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=41 ) -- 0x013c 0xfe
        -- MISSING OPCODE 0x1b
    end,
    ...
    script_0x05 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0004, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x0155 0xd2
        opcode9C_MessageSync() -- 0x0159 0x9c
        return 0 -- 0x015a 0x00
    end,

    script_0x06 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0005, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x015b 0xd2
        opcode9C_MessageSync() -- 0x015f 0x9c
        return 0 -- 0x0160 0x00
    end,

    script_0x07 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0006, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x0161 0xd2
...
Actor[ "0x13" ] = {
    ...
    on_update = function( self )
        -- 0xC6() -- 0x02bb 0xc6
        -- 0xFE8F_ParticleSystemInit1( actor_id=(entity)self, render_settings=0, rot_x=0, rot_y=0 ) -- 0x02bc 0xfe
