...
Entity[ "0x00" ] = {
    ...
    on_update = function( self )
        ...
        opcode09_EntityCallScriptEW( entity=0x01, script=04, priority=01 ) -- 0x0037 0x09
        opcode26_Wait( time=32 ) -- 0x003a 0x26
        opcode09_EntityCallScriptEW( entity=0x01, script=05, priority=01 ) -- 0x003d 0x09
        opcode09_EntityCallScriptEW( entity=0x02, script=05, priority=01 ) -- 0x0040 0x09
        opcode09_EntityCallScriptEW( entity=0x03, script=05, priority=01 ) -- 0x0043 0x09
        opcode09_EntityCallScriptEW( entity=0x02, script=06, priority=01 ) -- 0x0046 0x09
        opcode09_EntityCallScriptEW( entity=0x03, script=06, priority=01 ) -- 0x0049 0x09
        opcode09_EntityCallScriptEW( entity=0x02, script=07, priority=01 ) -- 0x004c 0x09
        opcode09_EntityCallScriptEW( entity=0x03, script=07, priority=01 ) -- 0x004f 0x09
        opcode09_EntityCallScriptEW( entity=0x02, script=08, priority=01 ) -- 0x0052 0x09
        opcode26_Wait( time=24 ) -- 0x0055 0x26
        opcode09_EntityCallScriptEW( entity=0x01, script=06, priority=01 ) -- 0x0058 0x09
        -- MISSING OPCODE 0x12
    end,
...
Entity[ "0x02" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=33 ) -- 0x0107 0xfe
        -- MISSING OPCODE 0x1b
    end,
...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=41 ) -- 0x013c 0xfe
        -- MISSING OPCODE 0x1b
    end,
