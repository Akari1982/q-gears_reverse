...
Entity[ "0x01" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x00a0 0xfe
...
Entity[ "0x02" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x00ab 0xfe
...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x00b6 0xfe
...
Entity[ "0x04" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x00c1 0xfe
...
Entity[ "0x05" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x00cc 0xfe
...
Entity[ "0x06" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x00d7 0xfe
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=10 ) -- 0x010e 0xfe
...
Entity[ "0x0c" ] = {
    ...
    on_talk = function( self )
        ...
        opcode09_EntityCallScriptEW( entity=0x13, script=04, priority=01 ) -- 0x012e 0x09
...
Entity[ "0x0d" ] = {
    ...
    on_talk = function( self )
        ...
        opcode09_EntityCallScriptEW( entity=0x14, script=04, priority=01 ) -- 0x0157 0x09
        -- MISSING OPCODE 0xFE68
    end,
...
Entity[ "0x0e" ] = {
    ...
    on_talk = function( self )
        ...
        opcode09_EntityCallScriptEW( entity=0x15, script=04, priority=01 ) -- 0x0180 0x09
        -- MISSING OPCODE 0xFE68
    end,
...
Entity[ "0x0f" ] = {
    ...
    on_talk = function( self )
        ...
        opcode09_EntityCallScriptEW( entity=0x16, script=04, priority=01 ) -- 0x01b5 0x09
        -- MISSING OPCODE 0xFE68
    end,
...
Entity[ "0x10" ] = {
    ...
    on_talk = function( self )
        ...
        opcode09_EntityCallScriptEW( entity=0x17, script=04, priority=01 ) -- 0x01de 0x09
        -- MISSING OPCODE 0xFE68
    end,
