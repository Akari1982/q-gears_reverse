...
Actor[ "0x05" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=4 ) -- 0x005c 0x16
        opcodeFE0D_MessageSetFace( char_id=4 ) -- 0x005f 0xfe
...
Actor[ "0x06" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=5 ) -- 0x0067 0x16
        opcodeFE0D_MessageSetFace( char_id=5 ) -- 0x006a 0xfe
...
Actor[ "0x0c" ] = {
    ...
    on_talk = function( self )
        opcode6F_ActorRotateToActor( actor_id=(entity)party_1 ) -- 0x00be 0x6f
