...
Actor[ "0x00" ] = {
    on_start = function( self )
        ...
        -- 0xA0() -- 0x0010 0xa0
        opcode35_VariableSet( address=0x0144, value=(vf40)0x0003, flag=0x40 ) -- 0x0017 0x35
        -- 0x2A() -- 0x001d 0x2a
...
Actor[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0000, z=(vf40)0xff4c, flag=(flag)0xc0 ) -- 0x00a9 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Actor[ "0x0d" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0000, z=(vf40)0x00b4, flag=(flag)0xc0 ) -- 0x00d2 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Actor[ "0x0e" ] = {
    ...
    script_0x04 = function( self )
        opcode37_VariableSetFalse( address=0x0402 ) -- 0x0105 0x37
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0402 ), value2=(s16)0x001c, condition="value1 < value2", jump_if_false=0x0120 ) -- 0x0108 0x02
        -- 0xC6() -- 0x0110 0xc6
        -- MISSING OPCODE 0xFE1b
    end,
