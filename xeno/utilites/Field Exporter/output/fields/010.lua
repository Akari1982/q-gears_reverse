...
Entity[ "0x02" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x0029 0xfe
...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x0034 0xfe
...
Entity[ "0x05" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x004a 0xfe
...
Entity[ "0x06" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x0055 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x0060 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x006b 0xfe
...
Entity[ "0x09" ] = {
    ...
    on_talk = function( self )
        ...
        opcodeD2_MessageShow0( dialog_id=0x0000, ???=0x00 ) -- 0x008c 0xd2
        -- 0x9C() -- 0x0090 0x9c
        -- 0x01_JumpTo( 0x00a1 ) -- 0x0091 0x01
        opcodeD2_MessageShow0( dialog_id=0x0001, ???=0x00 ) -- 0x0094 0xd2
        -- 0x9C() -- 0x0098 0x9c
        opcode26_Wait( time=15 ) -- 0x0099 0x26
        opcodeD2_MessageShow0( dialog_id=0x0002, ???=0x00 ) -- 0x009c 0xd2
        -- 0x9C() -- 0x00a0 0x9c
...
Entity[ "0x0b" ] = {
    ...
    on_update = function( self )
        ...
        opcode09_EntityCallScriptEW( entity=0x80, script=02, priority=00 ) -- 0x00ce 0x09
        -- MISSING OPCODE 0x80
    end,
