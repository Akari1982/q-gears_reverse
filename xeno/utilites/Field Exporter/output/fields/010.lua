...
Actor_0x09:on_talk:
0x0084    -- 0x02_ConditionalJumpTo( value1=GetVar( 0x02c2 ), value2=(s16)0x0800, condition="value1 & value2", jump_if_false=0x0094 )
0x008c    opD2_MessageShowDynamic( text_id=0x0000, flags=0 )
0x0090    op9C_MessageSync()
0x0091    -- 0x01_JumpTo( 0x00a1 )
0x0094    opD2_MessageShowDynamic( text_id=0x0001, flags=0 )
0x0098    op9C_MessageSync()
0x0099    op26_Wait( time=15 )
0x009c    opD2_MessageShowDynamic( text_id=0x0002, flags=0 )
