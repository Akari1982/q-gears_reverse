...
Entity[ "0x02" ] = {
    ...
    script_0x06 = function( self )
        ...
        opcode09_EntityCallScriptEW( entity=0x00, script=07, priority=00 ) -- 0x038c 0x09
        -- MISSING OPCODE 0x12
    end,
...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x039f 0xfe
...
Entity[ "0x04" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x0453 0xfe
...
Entity[ "0x05" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x045e 0xfe
...
Entity[ "0x06" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x04f2 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x04fd 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x0508 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x0513 0xfe
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x051e 0xfe
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x0529 0xfe
...
Entity[ "0x0c" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x0534 0xfe
...
Entity[ "0x0d" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=10 ) -- 0x053f 0xfe
...
Entity[ "0x0f" ] = {
    ...
    script_0x04 = function( self )
        opcodeFE0D_SetAvatar( character_id=64 ) -- 0x059e 0xfe
        opcodeD2_MessageShow0( dialog_id=0x0008, ???=0x80 ) -- 0x05a2 0xd2
        -- 0x9C() -- 0x05a6 0x9c
        opcodeD2_MessageShow0( dialog_id=0x0009, ???=0x00 ) -- 0x05a7 0xd2
        -- 0x9C() -- 0x05ab 0x9c
        opcode09_EntityCallScriptEW( entity=0x1c, script=05, priority=00 ) -- 0x05ac 0x09
        -- 0x35() -- 0x05af 0x35
        opcode09_EntityCallScriptEW( entity=0x00, script=06, priority=00 ) -- 0x05b5 0x09
        opcode09_EntityCallScriptEW( entity=0x00, script=05, priority=02 ) -- 0x05b8 0x09
        -- MISSING OPCODE 0x5f
    end,
...
Entity[ "0x23" ] = {
    ...
    on_talk = function( self )
        opcode09_EntityCallScriptEW( entity=0x29, script=04, priority=00 ) -- 0x0f74 0x09
        -- MISSING OPCODE 0x5f
    end,
...
Entity[ "0x3e" ] = {
    ...
    on_talk = function( self )
        ...
        opcode09_EntityCallScriptEW( entity=0x40, script=04, priority=01 ) -- 0x1500 0x09
        opcode09_EntityCallScriptEW( entity=0x00, script=07, priority=00 ) -- 0x1503 0x09
...
Entity[ "0x41" ] = {
    ...
    on_talk = function( self )
        ...
        opcode09_EntityCallScriptEW( entity=0x43, script=04, priority=01 ) -- 0x153d 0x09
        opcode09_EntityCallScriptEW( entity=0x00, script=07, priority=00 ) -- 0x1540 0x09
