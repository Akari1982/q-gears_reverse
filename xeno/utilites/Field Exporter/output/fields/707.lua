...
Entity[ "0x04" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 0 ) -- 0x4331 0x16
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x4334 0xfe
...
Entity[ "0x05" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 1 ) -- 0x433f 0x16
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x4342 0xfe
        return 0 -- 0x4346 0x00
    end,

    on_update = function( self )
        -- 0x0C_Encounter() -- 0x4347 0x0c
...
Entity[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 9 ) -- 0x4355 0x16
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x4358 0xfe
        return 0 -- 0x435c 0x00
    end,

    on_update = function( self )
        -- 0x0C_Encounter() -- 0x435d 0x0c
...
Entity[ "0x08" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 3 ) -- 0x4360 0x16
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x4363 0xfe
        return 0 -- 0x4367 0x00
    end,

    on_update = function( self )
        -- 0x0C_Encounter() -- 0x4368 0x0c
...
Entity[ "0x09" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 4 ) -- 0x436b 0x16
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x436e 0xfe
        return 0 -- 0x4372 0x00
    end,

    on_update = function( self )
        -- 0x0C_Encounter() -- 0x4373 0x0c
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 5 ) -- 0x4376 0x16
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x4379 0xfe
        return 0 -- 0x437d 0x00
    end,

    on_update = function( self )
        -- 0x0C_Encounter() -- 0x437e 0x0c
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 6 ) -- 0x4381 0x16
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x4384 0xfe
        return 0 -- 0x4388 0x00
    end,

    on_update = function( self )
        -- 0x0C_Encounter() -- 0x4389 0x0c
...
Entity[ "0x0c" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 10 ) -- 0x438c 0x16
        opcodeFE0D_SetAvatar( character_id=10 ) -- 0x438f 0xfe
        return 0 -- 0x4393 0x00
    end,

    on_update = function( self )
        -- 0x0C_Encounter() -- 0x4394 0x0c
...
Entity[ "0x0d" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 7 ) -- 0x4397 0x16
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x439a 0xfe
        return 0 -- 0x439e 0x00
    end,

    on_update = function( self )
        -- 0x0C_Encounter() -- 0x439f 0x0c
...
Entity[ "0x0e" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 8 ) -- 0x43a2 0x16
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x43a5 0xfe
        return 0 -- 0x43a9 0x00
    end,

    on_update = function( self )
        -- 0x0C_Encounter() -- 0x43aa 0x0c
...
Entity[ "0x0f" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x43ad 0xbc
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x11" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x43df 0xbc
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x12" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x43f8 0xbc
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x13" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x4411 0xbc
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x14" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x4428 0xbc
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x15" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x443f 0xbc
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x16" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x4456 0xbc
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x17" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x446d 0xbc
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x18" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x4484 0xbc
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x1a" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x44b2 0xbc
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x1c" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x44e0 0xbc
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x1e" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x4560 0xbc
        -- 0x2A() -- 0x4561 0x2a
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x1f" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x456c 0xbc
        -- 0x2A() -- 0x456d 0x2a
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x20" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x4578 0xbc
        -- 0x2A() -- 0x4579 0x2a
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x21" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x4584 0xbc
        -- 0x2A() -- 0x4585 0x2a
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x22" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x4590 0xbc
        -- 0x2A() -- 0x4591 0x2a
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x23" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x459c 0xbc
        -- 0x2A() -- 0x459d 0x2a
        -- MISSING OPCODE 0xf8
    end,
