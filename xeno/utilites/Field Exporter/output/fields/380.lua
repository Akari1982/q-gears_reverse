...
Actor[ "0x00" ] = {
    ...
    on_update = function( self )
        ...
        opcode09_ActorCallScriptEW( actor_id=0x20, script=08, priority=01 ) -- 0x00a2 0x09
        opcodeF1_FadeSetUp( steps=2, r=0, g=100, b=100, semi_tr=32 ) -- 0x00a5 0xf1
...
Actor[ "0x01" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0077, z=(vf40)0x008d, flag=(flag)0xc0 ) -- 0x02ef 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x02" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x117f, z=(vf40)0x1372, flag=(flag)0xc0 ) -- 0x0309 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x03" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x11ad, z=(vf40)0x1427, flag=(flag)0xc0 ) -- 0x0318 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x04" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x1151, z=(vf40)0x154b, flag=(flag)0xc0 ) -- 0x0326 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x05" ] = {
    on_start = function( self )
        ...
        -- 0x2A() -- 0x0335 0x2a
        -- 0x19_ActorSetPosition( x=(vf80)0x1181, z=(vf40)0x1566, flag=(flag)0xc0 ) -- 0x0336 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x06" ] = {
    on_start = function( self )
        ...
        -- 0x2A() -- 0x0344 0x2a
        -- 0x19_ActorSetPosition( x=(vf80)0x11ab, z=(vf40)0x15ac, flag=(flag)0xc0 ) -- 0x0345 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x07" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x11bf, z=(vf40)0x153c, flag=(flag)0xc0 ) -- 0x0353 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x08" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x11a3, z=(vf40)0x1627, flag=(flag)0xc0 ) -- 0x0362 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x09" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x114c, z=(vf40)0x149f, flag=(flag)0xc0 ) -- 0x0371 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x0b" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x005d, z=(vf40)0x000d, flag=(flag)0xc0 ) -- 0x0391 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x0d" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x03c4 0xbc
        -- 0x2A() -- 0x03c5 0x2a
...
Actor[ "0x0f" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x03ce 0xbc
        -- 0x2A() -- 0x03cf 0x2a
...
Actor[ "0x10" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x03d3 0xbc
        -- 0x2A() -- 0x03d4 0x2a
...
Actor[ "0x15" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x03ec 0xbc
        -- 0x2A() -- 0x03ed 0x2a
...
Actor[ "0x18" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x03fb 0xbc
        -- 0x2A() -- 0x03fc 0x2a
...
Actor[ "0x19" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x0400 0xbc
        -- 0x2A() -- 0x0401 0x2a
...
Actor[ "0x1a" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x0405 0xbc
        -- 0x2A() -- 0x0406 0x2a
...
Actor[ "0x20" ] = {
    ...
    script_0x07 = function( self )
        -- 0x60() -- 0x049b 0x60
        -- 0x63( ???=(vf80)0x00f3, ???=(vf40)0xff4d, ???=(vf20)0x016c, flag=0xe0 ) -- 0x049c 0x63
        -- 0x64() -- 0x04a4 0x64
    ...
    script_0x0c = function( self )
        -- 0x60() -- 0x0561 0x60
        -- 0x63( ???=(vf80)0x01df, ???=(vf40)0x0149, ???=(vf20)0x01f4, flag=0xe0 ) -- 0x0562 0x63
        -- 0x64() -- 0x056a 0x64
    ...
    script_0x0d = function( self )
        -- 0x60() -- 0x0583 0x60
        -- 0x63( ???=(vf80)0xfa08, ???=(vf40)0xffca, ???=(vf20)0xff03, flag=0xe0 ) -- 0x0584 0x63
        -- 0x64() -- 0x058c 0x64
    ...
    script_0x0e = function( self )
        -- 0x60() -- 0x05a5 0x60
        -- 0x63( ???=(vf80)0xf116, ???=(vf40)0xfc84, ???=(vf20)0xfb51, flag=0xe0 ) -- 0x05a6 0x63
        -- 0x64() -- 0x05ae 0x64
    ...
    script_0x0f = function( self )
        -- 0x60() -- 0x05c7 0x60
        -- 0x63( ???=(vf80)0xf116, ???=(vf40)0xfc84, ???=(vf20)0xfb51, flag=0xe0 ) -- 0x05c8 0x63
        -- 0x64() -- 0x05d0 0x64
