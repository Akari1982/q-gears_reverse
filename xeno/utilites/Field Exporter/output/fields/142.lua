...
Entity[ "0x01" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x004c 0xfe
...
Entity[ "0x02" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x0057 0xfe
...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x0062 0xfe
...
Entity[ "0x04" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x006d 0xfe
...
Entity[ "0x05" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x0078 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x008e 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 7 ) -- 0x0096 0x16
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x0099 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x00a4 0xfe
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 10 ) -- 0x00ac 0x16
        opcodeFE0D_SetAvatar( character_id=10 ) -- 0x00af 0xfe
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x00b7 0xbc
        -- MISSING OPCODE 0x46
    end,
...
Entity[ "0x0f" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x01c4 0xbc
        -- 0x2A() -- 0x01c5 0x2a
    ...
    script_0x04 = function( self )
        -- 0xD0() -- 0x01c8 0xd0
        opcodeD4_MessageShowE( entity=(entity)0x10, dialog_id=0x0002, ???=0x00 ) -- 0x01d3 0xd4
        -- 0xF4() -- 0x01d9 0xf4
        opcodeD4_MessageShowE( entity=(entity)0x12, dialog_id=0x0003, ???=0x01 ) -- 0x01db 0xd4
        -- 0x07( entity=0x10, script=0x24 ) -- 0x01e1 0x07
        opcodeD4_MessageShowE( entity=(entity)0x10, dialog_id=0x0004, ???=0x01 ) -- 0x01e4 0xd4
        opcodeD4_MessageShowE( entity=(entity)0x12, dialog_id=0x0005, ???=0x01 ) -- 0x01ea 0xd4
        opcodeD4_MessageShowE( entity=(entity)0x15, dialog_id=0x0006, ???=0x01 ) -- 0x01f0 0xd4
        opcodeD4_MessageShowE( entity=(entity)0x13, dialog_id=0x0007, ???=0x01 ) -- 0x01f6 0xd4
        opcodeD4_MessageShowE( entity=(entity)0x14, dialog_id=0x0008, ???=0x01 ) -- 0x01fc 0xd4
...
Entity[ "0x10" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x0043, z=(vf40)0xfe31, flag=(flag)0xc0 ) -- 0x023b 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Entity[ "0x11" ] = {
    ...
    script_0x04 = function( self )
        -- 0x19_SetPosition( x=(vf80)0xfee8, z=(vf40)0xff88, flag=(flag)0xc0 ) -- 0x0292 0x19
        -- MISSING OPCODE 0x2c
    end,
...
Entity[ "0x12" ] = {
    ...
    script_0x04 = function( self )
        -- 0x19_SetPosition( x=(vf80)0xff3d, z=(vf40)0xff9a, flag=(flag)0xc0 ) -- 0x0303 0x19
        -- MISSING OPCODE 0x2c
    end,
...
Entity[ "0x13" ] = {
    ...
    script_0x04 = function( self )
        -- 0x19_SetPosition( x=(vf80)0xffdf, z=(vf40)0xff8b, flag=(flag)0xc0 ) -- 0x0374 0x19
        -- MISSING OPCODE 0x2c
    end,
...
Entity[ "0x14" ] = {
    ...
    script_0x04 = function( self )
        -- 0x19_SetPosition( x=(vf80)0xfece, z=(vf40)0xfa37, flag=(flag)0xc0 ) -- 0x03e5 0x19
        -- MISSING OPCODE 0x2c
    end,
...
Entity[ "0x15" ] = {
    ...
    script_0x04 = function( self )
        -- 0x19_SetPosition( x=(vf80)0xff3a, z=(vf40)0xfdfa, flag=(flag)0xc0 ) -- 0x0458 0x19
        -- MISSING OPCODE 0x2c
    end,
...
Entity[ "0x16" ] = {
    ...
    script_0x04 = function( self )
        -- 0x19_SetPosition( x=(vf80)0xfff3, z=(vf40)0xfe0e, flag=(flag)0xc0 ) -- 0x04c3 0x19
        -- MISSING OPCODE 0x2c
    end,
