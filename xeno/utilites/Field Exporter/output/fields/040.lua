...
Actor[ "0x0c" ] = {
    ...
    on_talk = function( self )
        ...
        opcodeD2_MessageShowDynamic( text_id=0x0001, flags=0 ) -- 0x0101 0xd2
        ...
        opcodeD2_MessageShowDynamic( text_id=0x0002, flags=0 ) -- 0x0111 0xd2
        ...
        opcodeD2_MessageShowDynamic( text_id=0x0003, flags=0 ) -- 0x0124 0xd2
        opcode9C_MessageSync() -- 0x0128 0x9c
        opcode3C_VariableInc( address=0x0400 ) -- 0x0129 0x3c
        -- 0x01_JumpTo( 0x013a ) -- 0x012c 0x01
        opcodeD2_MessageShowDynamic( text_id=0x0004, flags=0 ) -- 0x012f 0xd2
    ...
    script_0x04 = function( self )
        ...
        opcodeF5_MessageShowStatic( text_id=0x0005, flags=0 ) -- 0x0153 0xf5
        opcode9C_MessageSync() -- 0x0157 0x9c
        opcode26_Wait( time=8 ) -- 0x0158 0x26
        -- 0x21( ???=512 ) -- 0x015b 0x21
        opcodeD2_MessageShowDynamic( text_id=0x0006, flags=0 ) -- 0x015e 0xd2
        ...
        opcodeD2_MessageShowDynamic( text_id=0x0007, flags=0 ) -- 0x016c 0xd2
        opcode9C_MessageSync() -- 0x0170 0x9c
        opcode09_ActorCallScriptEW( actor_id=0x0d, script=07, priority=06 ) -- 0x0171 0x09
        opcode5D_SpritePlayAnim2( anim_id=0x03 ) -- 0x0174 0x5d
        -- 0x5E() -- 0x0176 0x5e
        opcodeD2_MessageShowDynamic( text_id=0x0008, flags=0 ) -- 0x0177 0xd2
        opcode9C_MessageSync() -- 0x017b 0x9c
        opcode26_Wait( time=10 ) -- 0x017c 0x26
        opcodeD2_MessageShowDynamic( text_id=0x0009, flags=0 ) -- 0x017f 0xd2
        opcode9C_MessageSync() -- 0x0183 0x9c
        opcode09_ActorCallScriptEW( actor_id=0x0d, script=08, priority=06 ) -- 0x0184 0x09
        opcodeD2_MessageShowDynamic( text_id=0x000a, flags=0 ) -- 0x0187 0xd2
        opcode9C_MessageSync() -- 0x018b 0x9c
        opcode09_ActorCallScriptEW( actor_id=0x0d, script=09, priority=06 ) -- 0x018c 0x09
        opcode5D_SpritePlayAnim2( anim_id=0x03 ) -- 0x018f 0x5d
        -- 0x5E() -- 0x0191 0x5e
        opcodeD2_MessageShowDynamic( text_id=0x000b, flags=0 ) -- 0x0192 0xd2
        opcode9C_MessageSync() -- 0x0196 0x9c
        opcode09_ActorCallScriptEW( actor_id=0x0e, script=08, priority=06 ) -- 0x0197 0x09
        opcode09_ActorCallScriptEW( actor_id=0x0d, script=0a, priority=06 ) -- 0x019a 0x09
        opcode26_Wait( time=10 ) -- 0x019d 0x26
        opcodeD2_MessageShowDynamic( text_id=0x000c, flags=0 ) -- 0x01a0 0xd2
        opcode9C_MessageSync() -- 0x01a4 0x9c
        -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call ) -- 0x01a5 0x4a
        opcode69_ActorSetRotation( rot=7 ) -- 0x01ab 0x69
        -- MISSING OPCODE 0x91
    end,
...
Actor[ "0x0d" ] = {
    ...
    on_talk = function( self )
        ...
        opcodeD2_MessageShowDynamic( text_id=0x000d, flags=0 ) -- 0x01e7 0xd2
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x000e, flags=0 ) -- 0x01ee 0xd2
        opcode9C_MessageSync() -- 0x01f2 0x9c
        opcode26_Wait( time=15 ) -- 0x01f3 0x26
        opcodeD2_MessageShowDynamic( text_id=0x000f, flags=0 ) -- 0x01f6 0xd2
        opcode9C_MessageSync() -- 0x01fa 0x9c
        opcode26_Wait( time=15 ) -- 0x01fb 0x26
        opcodeD2_MessageShowDynamic( text_id=0x0010, flags=0 ) -- 0x01fe 0xd2
        opcode9C_MessageSync() -- 0x0202 0x9c
        opcode26_Wait( time=15 ) -- 0x0203 0x26
        opcodeD2_MessageShowDynamic( text_id=0x0011, flags=0 ) -- 0x0206 0xd2
        opcode9C_MessageSync() -- 0x020a 0x9c
        opcode26_Wait( time=15 ) -- 0x020b 0x26
        opcodeD2_MessageShowDynamic( text_id=0x0012, flags=0 ) -- 0x020e 0xd2
    ...
    script_0x07 = function( self )
        ...
        opcodeD2_MessageShowDynamic( text_id=0x0013, flags=0 ) -- 0x0251 0xd2
        opcode9C_MessageSync() -- 0x0255 0x9c
        return 0 -- 0x0256 0x00
    end,

    script_0x08 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0014, flags=0 ) -- 0x0257 0xd2
        opcode9C_MessageSync() -- 0x025b 0x9c
        return 0 -- 0x025c 0x00
    end,

    script_0x09 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0015, flags=0 ) -- 0x025d 0xd2
        ...
        opcodeD2_MessageShowDynamic( text_id=0x0016, flags=0 ) -- 0x0267 0xd2
    ...
    script_0x0a = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0017, flags=0 ) -- 0x026f 0xd2
        opcode9C_MessageSync() -- 0x0273 0x9c
        -- 0x21( ???=128 ) -- 0x0274 0x21
...
Actor[ "0x0e" ] = {
    ...
    on_talk = function( self )
        ...
        opcodeD2_MessageShowDynamic( text_id=0x0018, flags=0 ) -- 0x02b2 0xd2
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0019, flags=0 ) -- 0x02b9 0xd2
        opcode9C_MessageSync() -- 0x02bd 0x9c
        opcode26_Wait( time=15 ) -- 0x02be 0x26
        opcodeD2_MessageShowDynamic( text_id=0x001a, flags=0 ) -- 0x02c1 0xd2
        opcode9C_MessageSync() -- 0x02c5 0x9c
        opcode26_Wait( time=15 ) -- 0x02c6 0x26
        opcodeD2_MessageShowDynamic( text_id=0x001b, flags=0 ) -- 0x02c9 0xd2
        opcode9C_MessageSync() -- 0x02cd 0x9c
        opcode26_Wait( time=15 ) -- 0x02ce 0x26
        opcodeD2_MessageShowDynamic( text_id=0x001c, flags=0 ) -- 0x02d1 0xd2
        opcode9C_MessageSync() -- 0x02d5 0x9c
        opcode26_Wait( time=15 ) -- 0x02d6 0x26
        opcodeD2_MessageShowDynamic( text_id=0x001d, flags=0 ) -- 0x02d9 0xd2
    ...
    script_0x06 = function( self )
        ...
        -- 0x21( ???=128 ) -- 0x02ea 0x21
        -- MISSING OPCODE 0x5f
    end,

    script_0x07 = function( self )
        -- 0x21( ???=384 ) -- 0x031f 0x21
        opcode2C_SpritePlayAnim( anim_id=0x04 ) -- 0x0322 0x2c
        opcode26_Wait( time=5 ) -- 0x0324 0x26
        opcode2C_SpritePlayAnim( anim_id=0xff ) -- 0x0327 0x2c
        -- MISSING OPCODE 0x52
    end,

    script_0x08 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x001f, flags=0 ) -- 0x0331 0xd2
        opcode9C_MessageSync() -- 0x0335 0x9c
        -- 0xF6( ???=0x00 ) -- 0x0336 0xf6
        -- 0x21( ???=128 ) -- 0x0338 0x21
        -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call ) -- 0x033b 0x4a
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x0f" ] = {
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x036a 0xfe
        opcodeD2_MessageShowDynamic( text_id=0x0020, flags=0 ) -- 0x036c 0xd2
...
Actor[ "0x10" ] = {
    ...
    on_talk = function( self )
        opcodeF5_MessageShowStatic( text_id=0x0022, flags=0 ) -- 0x03b5 0xf5
    ...
    script_0x04 = function( self )
        ...
        opcodeD0_MessageSettings( x=0, y=0, letters=0, rows=0, flags=2048 ) -- 0x03bf 0xd0
        opcodeD2_MessageShowDynamic( text_id=0x0023, flags=FORCE_BOTTOM ) -- 0x03ca 0xd2
        opcode9C_MessageSync() -- 0x03ce 0x9c
        -- MISSING OPCODE 0x91
    end,

    script_0x05 = function( self )
        opcodeD0_MessageSettings( x=100, y=100, letters=0, rows=0, flags=2 ) -- 0x03ec 0xd0
        opcodeF5_MessageShowStatic( text_id=0x0026, flags=0 ) -- 0x03f7 0xf5
...
Actor[ "0x11" ] = {
    ...
    on_talk = function( self )
        ...
        opcodeD2_MessageShowDynamic( text_id=0x0027, flags=0 ) -- 0x041b 0xd2
...
Actor[ "0x14" ] = {
    ...
    on_update = function( self )
        -- 0xBF( ???=10 ) -- 0x0476 0xbf
        -- 0x01_JumpTo( 0x0476 ) -- 0x0479 0x01
...
Actor[ "0x15" ] = {
    ...
    on_update = function( self )
        -- 0xBF( ???=10 ) -- 0x047f 0xbf
        -- 0x01_JumpTo( 0x047f ) -- 0x0482 0x01
...
Actor[ "0x16" ] = {
    ...
    on_update = function( self )
        -- 0xBF( ???=15 ) -- 0x0488 0xbf
        -- 0x01_JumpTo( 0x0488 ) -- 0x048b 0x01
...
Actor[ "0x17" ] = {
    ...
    on_update = function( self )
        -- 0xBF( ???=15 ) -- 0x0491 0xbf
        -- 0x01_JumpTo( 0x0491 ) -- 0x0494 0x01
