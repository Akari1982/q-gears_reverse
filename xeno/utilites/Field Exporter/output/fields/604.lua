...
Actor[ "0x00" ] = {
    on_start = function( self )
        ...
        opcode35_VariableSet( address=0x0402, value=(vf40)0x0001, flag=0x40 ) -- 0x0019 0x35
        opcode35_VariableSet( address=0x0404, value=(vf40)0x00cf, flag=0x40 ) -- 0x001f 0x35
        opcode35_VariableSet( address=0x0406, value=(vf40)0xff28, flag=0x40 ) -- 0x0025 0x35
        opcode35_VariableSet( address=0x0408, value=(vf40)0x0000, flag=0x40 ) -- 0x002b 0x35
        opcode35_VariableSet( address=0x040a, value=(vf40)0x0005, flag=0x40 ) -- 0x0031 0x35
        opcode35_VariableSet( address=0x040c, value=(vf40)0x0136, flag=0x40 ) -- 0x0037 0x35
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0162 ), value2=(s16)0x0100, condition="value1 & value2", jump_if_false=0x0048 ) -- 0x003d 0x02
        opcode36_VariableSetTrue( address=0x040e ) -- 0x0045 0x36
        -- 0x01_JumpTo( 0x007a ) -- 0x0048 0x01
        opcode35_VariableSet( address=0x0402, value=(vf40)0x0001, flag=0x40 ) -- 0x004b 0x35
        opcode35_VariableSet( address=0x0404, value=(vf40)0x00cf, flag=0x40 ) -- 0x0051 0x35
        opcode35_VariableSet( address=0x0406, value=(vf40)0xff28, flag=0x40 ) -- 0x0057 0x35
        opcode35_VariableSet( address=0x0408, value=(vf40)0x0000, flag=0x40 ) -- 0x005d 0x35
        opcode35_VariableSet( address=0x040a, value=(vf40)0x0005, flag=0x40 ) -- 0x0063 0x35
        opcode35_VariableSet( address=0x040c, value=(vf40)0x0003, flag=0x40 ) -- 0x0069 0x35
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0162 ), value2=(s16)0x0200, condition="value1 & value2", jump_if_false=0x007a ) -- 0x006f 0x02
        opcode36_VariableSetTrue( address=0x040e ) -- 0x0077 0x36
        -- 0x75( ???=58 ) -- 0x007a 0x75
...
Actor[ "0x01" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=0 ) -- 0x009f 0xfe
...
Actor[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=9 ) -- 0x00b9 0xfe
        opcodeFE0D_MessageSetFace( char_id=9 ) -- 0x00bd 0xfe
...
Actor[ "0x04" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=3 ) -- 0x00c8 0xfe
...
Actor[ "0x06" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=5 ) -- 0x00ea 0xfe
...
Actor[ "0x07" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=6 ) -- 0x00f9 0xfe
...
Actor[ "0x08" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=7 ) -- 0x0104 0xfe
        opcodeFE0D_MessageSetFace( char_id=7 ) -- 0x0108 0xfe
...
Actor[ "0x09" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=8 ) -- 0x0113 0xfe
        opcodeFE0D_MessageSetFace( char_id=8 ) -- 0x0117 0xfe
...
Actor[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xfeb6, z=(vf40)0x014a, flag=(flag)0xc0 ) -- 0x013c 0x19
        -- MISSING OPCODE 0xf8
    end,
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x0154 0xfe
        opcode74_SoundPlayFixedVolume( sound_id=119 ) -- 0x0156 0x74
        opcode09_ActorCallScriptEW( actor_id=0x0d, script=04, priority=01 ) -- 0x0159 0x09
...
Actor[ "0x0d" ] = {
    ...
    script_0x04 = function( self )
        opcode37_VariableSetFalse( address=0x0400 ) -- 0x0180 0x37
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0400 ), value2=(s16)0x000e, condition="value1 < value2", jump_if_false=0x019b ) -- 0x0183 0x02
        -- 0xC6() -- 0x018b 0xc6
