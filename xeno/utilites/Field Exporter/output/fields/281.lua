...
Actor[ "0x00" ] = {
    ...
    on_update = function( self )
        ...
        opcode09_ActorCallScriptEW( actor_id=0x08, script=04, priority=01 ) -- 0x0073 0x09
        opcode26_Wait( time=32 ) -- 0x0076 0x26
        opcode09_ActorCallScriptEW( actor_id=0x0e, script=04, priority=01 ) -- 0x0079 0x09
        opcode09_ActorCallScriptEW( actor_id=0x09, script=04, priority=01 ) -- 0x007c 0x09
        opcode09_ActorCallScriptEW( actor_id=0x10, script=04, priority=01 ) -- 0x007f 0x09
        opcode26_Wait( time=45 ) -- 0x0082 0x26
        opcode09_ActorCallScriptEW( actor_id=0x12, script=04, priority=01 ) -- 0x0085 0x09
        opcode26_Wait( time=45 ) -- 0x0088 0x26
        opcode09_ActorCallScriptEW( actor_id=0x03, script=04, priority=01 ) -- 0x008b 0x09
        opcode09_ActorCallScriptEW( actor_id=0x05, script=04, priority=01 ) -- 0x008e 0x09
        opcode09_ActorCallScriptEW( actor_id=0x06, script=04, priority=01 ) -- 0x0091 0x09
        opcode09_ActorCallScriptEW( actor_id=0x13, script=04, priority=01 ) -- 0x0094 0x09
        opcode09_ActorCallScriptEW( actor_id=0x06, script=05, priority=01 ) -- 0x0097 0x09
        opcode09_ActorCallScriptEW( actor_id=0x13, script=05, priority=01 ) -- 0x009a 0x09
        opcode09_ActorCallScriptEW( actor_id=0x05, script=05, priority=01 ) -- 0x009d 0x09
        opcode09_ActorCallScriptEW( actor_id=0x06, script=06, priority=01 ) -- 0x00a0 0x09
        opcode09_ActorCallScriptEW( actor_id=0x05, script=06, priority=01 ) -- 0x00a3 0x09
        opcode09_ActorCallScriptEW( actor_id=0x06, script=07, priority=01 ) -- 0x00a6 0x09
        opcode26_Wait( time=16 ) -- 0x00a9 0x26
        opcode09_ActorCallScriptEW( actor_id=0x05, script=07, priority=01 ) -- 0x00ac 0x09
        opcode09_ActorCallScriptEW( actor_id=0x06, script=08, priority=01 ) -- 0x00af 0x09
        opcode36_VariableSetTrue( address=0x0406 ) -- 0x00b2 0x36
        opcode26_Wait( time=32 ) -- 0x00b5 0x26
        -- 0xB4_FadeIn() -- 0x00b8 0xb4
        opcode26_Wait( time=16 ) -- 0x00bb 0x26
        opcodeFE19( char_id=0x02 ) -- 0x00be 0xfe
        opcode26_Wait( time=16 ) -- 0x00c1 0x26
        -- MISSING OPCODE 0x12
    end,
...
Actor[ "0x02" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x00eb 0xbc
        -- 0x2A() -- 0x00ec 0x2a
...
Actor[ "0x04" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=0 ) -- 0x011c 0x16
        opcodeFE0D_MessageSetFace( char_id=0 ) -- 0x011f 0xfe
        -- 0x2A() -- 0x0123 0x2a
        -- 0x19_ActorSetPosition( x=(vf80)0x2710, z=(vf40)0x86a0, flag=(flag)0xc0 ) -- 0x0124 0x19
        -- 0x23() -- 0x012a 0x23
...
Actor[ "0x05" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=2 ) -- 0x012e 0x16
        opcodeFE0D_MessageSetFace( char_id=2 ) -- 0x0131 0xfe
        -- 0x19_ActorSetPosition( x=(vf80)0x00bf, z=(vf40)0xfe92, flag=(flag)0xc0 ) -- 0x0135 0x19
        opcodeFE0D_MessageSetFace( char_id=2 ) -- 0x013b 0xfe
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x06" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0046, z=(vf40)0xfe7f, flag=(flag)0xc0 ) -- 0x0179 0x19
        opcodeFE0D_MessageSetFace( char_id=27 ) -- 0x017f 0xfe
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x07" ] = {
    on_start = function( self )
        ...
        -- 0x2A() -- 0x01cd 0x2a
        -- 0x19_ActorSetPosition( x=(vf80)0x2af8, z=(vf40)0xadb0, flag=(flag)0xc0 ) -- 0x01ce 0x19
        -- 0x23() -- 0x01d4 0x23
...
Actor[ "0x0d" ] = {
    ...
    on_talk = function( self )
        ...
        -- 0x2A() -- 0x02d7 0x2a
        -- 0x19_ActorSetPosition( x=(vf80)0xff2c, z=(vf40)0x001e, flag=(flag)0xc0 ) -- 0x02d8 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x0f" ] = {
    on_start = function( self )
        ...
        -- 0x2A() -- 0x02eb 0x2a
        -- 0x19_ActorSetPosition( x=(vf80)0xfee4, z=(vf40)0x01de, flag=(flag)0xc0 ) -- 0x02ec 0x19
        -- MISSING OPCODE 0x5f
    end,
    ...
    on_talk = function( self )
        ...
        -- 0x2A() -- 0x02f9 0x2a
        -- 0x19_ActorSetPosition( x=(vf80)0x00ce, z=(vf40)0xff9c, flag=(flag)0xc0 ) -- 0x02fa 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x11" ] = {
    on_start = function( self )
        ...
        -- 0x2A() -- 0x0315 0x2a
        -- 0x19_ActorSetPosition( x=(vf80)0x00d2, z=(vf40)0x00d0, flag=(flag)0xc0 ) -- 0x0316 0x19
        -- MISSING OPCODE 0x5f
    end,
    ...
    on_talk = function( self )
        ...
        -- 0x2A() -- 0x0323 0x2a
        -- 0x19_ActorSetPosition( x=(vf80)0x0078, z=(vf40)0x01c6, flag=(flag)0xc0 ) -- 0x0324 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x13" ] = {
    ...
    script_0x04 = function( self )
        opcode36_VariableSetTrue( address=0x0404 ) -- 0x0377 0x36
        opcode2C_SpritePlayAnim( anim_id=0x12 ) -- 0x037a 0x2c
...
Actor[ "0x15" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x0404 0xbc
        -- 0x2A() -- 0x0405 0x2a
...
Actor[ "0x19" ] = {
    ...
    on_update = function( self )
        opcode35_VariableSet( address=0x0410, value=(vf40)0x0000, flag=0x40 ) -- 0x0442 0x35
        opcode35_VariableSet( address=0x040a, value=(vf40)0x0000, flag=0x40 ) -- 0x0448 0x35
        opcode35_VariableSet( address=0x040c, value=(vf40)0x0000, flag=0x40 ) -- 0x044e 0x35
        opcode35_VariableSet( address=0x040e, value=(vf40)0x0000, flag=0x40 ) -- 0x0454 0x35
        -- 0xC6() -- 0x045a 0xc6
...
Actor[ "0x1a" ] = {
    ...
    on_update = function( self )
        opcode35_VariableSet( address=0x0418, value=(vf40)0x0000, flag=0x40 ) -- 0x05a0 0x35
        opcode35_VariableSet( address=0x0412, value=(vf40)0x0000, flag=0x40 ) -- 0x05a6 0x35
        opcode35_VariableSet( address=0x0414, value=(vf40)0x0000, flag=0x40 ) -- 0x05ac 0x35
        opcode35_VariableSet( address=0x0416, value=(vf40)0x0000, flag=0x40 ) -- 0x05b2 0x35
        -- 0xC6() -- 0x05b8 0xc6
