...
Entity[ "0x04" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x452b 0xfe
...
Entity[ "0x05" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x4c7a 0xfe
...
Entity[ "0x06" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x4d7f 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x4e84 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x4f89 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x508e 0xfe
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x5193 0xfe
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x5298 0xfe
...
Entity[ "0x0c" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=10 ) -- 0x539d 0xfe
...
Entity[ "0x0d" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x54a2 0xfe
...
Entity[ "0x0e" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x55aa 0xfe
...
Entity[ "0x11" ] = {
    ...
    on_talk = function( self )
        ...
        -- 0x35() -- 0x5790 0x35
        opcode09_EntityCallScriptEW( entity=0xfe, script=0e, priority=06 ) -- 0x5796 0x09
        opcode26_Wait( time=2 ) -- 0x5799 0x26
        opcode09_EntityCallScriptEW( entity=0x0f, script=06, priority=06 ) -- 0x579c 0x09
        opcode26_Wait( time=10 ) -- 0x579f 0x26
        -- 0x35() -- 0x57a2 0x35
        opcode09_EntityCallScriptEW( entity=0xfd, script=0e, priority=06 ) -- 0x57a8 0x09
        opcode26_Wait( time=2 ) -- 0x57ab 0x26
        opcode09_EntityCallScriptEW( entity=0x0f, script=05, priority=06 ) -- 0x57ae 0x09
...
Entity[ "0x12" ] = {
    ...
    on_talk = function( self )
        ...
        -- 0x35() -- 0x57dd 0x35
        opcode09_EntityCallScriptEW( entity=0xfe, script=0e, priority=06 ) -- 0x57e3 0x09
    ...
    on_push = function( self )
        ...
        -- 0x35() -- 0x57f1 0x35
        opcode09_EntityCallScriptEW( entity=0xfd, script=0e, priority=06 ) -- 0x57f7 0x09
        -- MISSING OPCODE 0x3c
    end,
...
Entity[ "0x13" ] = {
    ...
    script_0x04 = function( self )
        -- 0x35() -- 0x581c 0x35
        opcode09_EntityCallScriptEW( entity=0xff, script=0f, priority=06 ) -- 0x5822 0x09
        -- 0x35() -- 0x5825 0x35
