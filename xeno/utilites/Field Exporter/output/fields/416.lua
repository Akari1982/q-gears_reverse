...
Entity[ "0x04" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( GetVar( 0x003e ) ) -- 0x4341 0x16
        opcodeFE0D_SetAvatar( character_id=GetVar( 0x003e ) ) -- 0x4344 0xfe
...
Entity[ "0x05" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( GetVar( 0x0040 ) ) -- 0x434c 0x16
        opcodeFE0D_SetAvatar( character_id=GetVar( 0x0040 ) ) -- 0x434f 0xfe
...
Entity[ "0x06" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( GetVar( 0x0042 ) ) -- 0x4357 0x16
        opcodeFE0D_SetAvatar( character_id=GetVar( 0x0042 ) ) -- 0x435a 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x4362 0xbc
        -- 0x19_SetPosition( x=(vf80)0x0000, z=(vf40)0x02f8, flag=(flag)0xc0 ) -- 0x4363 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x08" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x437d 0xbc
        -- 0x19_SetPosition( x=(vf80)0x0000, z=(vf40)0xfd08, flag=(flag)0xc0 ) -- 0x437e 0x19
        -- MISSING OPCODE 0xf8
    end,
