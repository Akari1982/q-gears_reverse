...
Entity[ "0x01" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x0097 0xfe
...
Entity[ "0x02" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x023e 0xfe
...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x029b 0xfe
...
Entity[ "0x04" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x0325 0xfe
...
Entity[ "0x05" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x0342 0xfe
...
Entity[ "0x06" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x035e 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x037b 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x0398 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x03b5 0xfe
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x03d2 0xfe
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=10 ) -- 0x03ef 0xfe
...
Entity[ "0x0c" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x040c 0xfe
...
Entity[ "0x0d" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x0519 0xfe
        -- MISSING OPCODE 0x1f
    end,
...
Entity[ "0x0f" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=27 ) -- 0x0749 0xfe
        -- MISSING OPCODE 0xf6
    end,
...
Entity[ "0x10" ] = {
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0008, ???=0x00 ) -- 0x0897 0xd2
        -- 0x9C() -- 0x089b 0x9c
...
Entity[ "0x15" ] = {
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0010, ???=0x00 ) -- 0x0b8d 0xd2
        -- 0x9C() -- 0x0b91 0x9c
...
Entity[ "0x16" ] = {
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0011, ???=0x10 ) -- 0x0bfd 0xd2
        -- 0x9C() -- 0x0c01 0x9c
...
Entity[ "0x17" ] = {
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0012, ???=0x20 ) -- 0x0c6d 0xd2
        -- 0x9C() -- 0x0c71 0x9c
...
Entity[ "0x18" ] = {
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0013, ???=0x10 ) -- 0x0d23 0xd2
        -- 0x9C() -- 0x0d27 0x9c
...
Entity[ "0x19" ] = {
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0014, ???=0x20 ) -- 0x0d93 0xd2
        -- 0x9C() -- 0x0d97 0x9c
...
Entity[ "0x1c" ] = {
    ...
    on_update = function( self )
        ...
        opcode09_EntityCallScriptEW( entity=0x01, script=06, priority=03 ) -- 0x10bb 0x09
...
Entity[ "0x1d" ] = {
    ...
    on_update = function( self )
        ...
        opcode09_EntityCallScriptEW( entity=0x1f, script=13, priority=03 ) -- 0x11ac 0x09
        ...
        opcodeD4_MessageShowE( entity=(entity)0x10, dialog_id=0x0046, ???=0x21 ) -- 0x11bb 0xd4
        opcodeD4_MessageShowE( entity=(entity)0x14, dialog_id=0x0047, ???=0x11 ) -- 0x11c1 0xd4
        opcode09_EntityCallScriptEW( entity=0x10, script=05, priority=03 ) -- 0x11c7 0x09
        -- MISSING OPCODE 0x29
    end,
...
Entity[ "0x21" ] = {
    ...
    on_talk = function( self )
        ...
        opcodeD2_MessageShow0( dialog_id=0x0056, ???=0x00 ) -- 0x19fa 0xd2
        -- MISSING OPCODE 0xa9
    end,
...
Entity[ "0x22" ] = {
    ...
    on_update = function( self )
        ...
        opcode09_EntityCallScriptEW( entity=0xff, script=06, priority=03 ) -- 0x1a70 0x09
        -- MISSING OPCODE 0xFE65
    end,

    on_talk = function( self )
        opcodeFE54() -- 0x1a88 0xfe
        opcodeD2_MessageShow0( dialog_id=0x0057, ???=0x00 ) -- 0x1a8a 0xd2
        -- MISSING OPCODE 0xa9
    end,
