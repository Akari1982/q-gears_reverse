...
Actor[ "0x03" ] = {
    ...
    on_talk = function( self )
        ...
        opcodeD2_MessageShow0( text_id=0x0009, ???=0x00 ) -- 0x01f8 0xd2
...
Actor[ "0x0c" ] = {
    ...
    on_update = function( self )
        ...
        opcodeD2_MessageShow0( text_id=0x0041, ???=0x00 ) -- 0x0629 0xd2
