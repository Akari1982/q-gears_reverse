...
Entity[ "0x02" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=GetVar( 0x0040 ) ) -- 0x0084 0xfe
...
Entity[ "0x04" ] = {
    ...
    on_talk = function( self )
        ...
        opcode09_EntityCallScriptEW( entity=0x05, script=04, priority=01 ) -- 0x0116 0x09
...
Entity[ "0x06" ] = {
    ...
    on_talk = function( self )
        ...
        opcodeD2_MessageShow0( dialog_id=0x0000, ???=0x00 ) -- 0x01af 0xd2
        -- MISSING OPCODE 0xa9
    end,
...
Entity[ "0x0b" ] = {
    ...
    script_0x04 = function( self )
        opcode25_EntityDisable( entity=(entity)0x0a ) -- 0x029b 0x25
        opcode24_EntityEnable( entity=(entity)0x0b ) -- 0x029d 0x24
        -- MISSING OPCODE 0x74
    end,
