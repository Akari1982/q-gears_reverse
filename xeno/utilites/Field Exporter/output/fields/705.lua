...
Actor[ "0x04" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=0 ) -- 0x0065 0x16
        opcodeFE0D_MessageSetFace( char_id=0 ) -- 0x0068 0xfe
        opcodeFE03( ???=2730 ) -- 0x006c 0xfe
        -- MISSING OPCODE 0xFE04
    end,

    on_update = function( self )
        opcode35_VariableSet( address=0x0408, value=(vf40)0x0001, flag=0x40 ) -- 0x0075 0x35
...
Actor[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=9 ) -- 0x0101 0x16
        opcodeFE0D_MessageSetFace( char_id=9 ) -- 0x0104 0xfe
        opcodeFE03( ???=2730 ) -- 0x0108 0xfe
        -- MISSING OPCODE 0xFE04
    end,
...
Actor[ "0x08" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=3 ) -- 0x0116 0x16
        opcodeFE0D_MessageSetFace( char_id=3 ) -- 0x0119 0xfe
        opcodeFE03( ???=2730 ) -- 0x011d 0xfe
        -- MISSING OPCODE 0xFE04
    end,
...
Actor[ "0x09" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=4 ) -- 0x012b 0x16
        opcodeFE0D_MessageSetFace( char_id=4 ) -- 0x012e 0xfe
...
Actor[ "0x0b" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=6 ) -- 0x0155 0x16
        opcodeFE0D_MessageSetFace( char_id=6 ) -- 0x0158 0xfe
        opcodeFE03( ???=2730 ) -- 0x015c 0xfe
        -- MISSING OPCODE 0xFE04
    end,
...
Actor[ "0x0c" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=10 ) -- 0x016a 0x16
        opcodeFE0D_MessageSetFace( char_id=10 ) -- 0x016d 0xfe
        opcodeFE03( ???=2730 ) -- 0x0171 0xfe
        -- MISSING OPCODE 0xFE04
    end,
...
Actor[ "0x0d" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=7 ) -- 0x017f 0x16
        opcodeFE0D_MessageSetFace( char_id=7 ) -- 0x0182 0xfe
        opcodeFE03( ???=2730 ) -- 0x0186 0xfe
        -- MISSING OPCODE 0xFE04
    end,
...
Actor[ "0x0f" ] = {
    ...
    on_update = function( self )
        -- 0x1F( ???=0x01 ) -- 0x01ac 0x1f
        opcode3C_VariableInc( address=0x0402 ) -- 0x01ae 0x3c
        -- MISSING OPCODE 0xd5
    end,
...
Actor[ "0x10" ] = {
    ...
    on_update = function( self )
        ...
        opcode09_ActorCallScriptEW( actor_id=0x11, script=04, priority=01 ) -- 0x01db 0x09
        opcode26_Wait( time=58 ) -- 0x01de 0x26
        opcode09_ActorCallScriptEW( actor_id=0x11, script=05, priority=01 ) -- 0x01e1 0x09
        opcode26_Wait( time=130 ) -- 0x01e4 0x26
        opcode09_ActorCallScriptEW( actor_id=0x11, script=05, priority=01 ) -- 0x01e7 0x09
        opcode26_Wait( time=25 ) -- 0x01ea 0x26
        opcode09_ActorCallScriptEW( actor_id=0x11, script=05, priority=01 ) -- 0x01ed 0x09
        opcode26_Wait( time=25 ) -- 0x01f0 0x26
        opcode09_ActorCallScriptEW( actor_id=0x11, script=04, priority=01 ) -- 0x01f3 0x09
        opcode26_Wait( time=23 ) -- 0x01f6 0x26
        opcode09_ActorCallScriptEW( actor_id=0x11, script=04, priority=01 ) -- 0x01f9 0x09
        opcode35_VariableSet( address=0x040c, value=(vf40)0x008c, flag=0x40 ) -- 0x01fc 0x35
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x040c ), value2=(s16)0x0000, condition="value1 > value2", jump_if_false=0x021c ) -- 0x0202 0x02
        opcode3D_VariableDec( address=0x040c ) -- 0x020a 0x3d
        opcode3C_VariableInc( address=0x0408 ) -- 0x020d 0x3c
        opcode38_VariableAdd( address=0x0406, value=(vf40)0x0010, flag=0x40 ) -- 0x0210 0x38
        opcode26_Wait( time=0 ) -- 0x0216 0x26
        -- 0x01_JumpTo( 0x0202 ) -- 0x0219 0x01
        opcode26_Wait( time=2 ) -- 0x021c 0x26
        -- 0x98_MapLoad( field_id=17093, value=0 ) -- 0x021f 0x98
...
Actor[ "0x11" ] = {
    ...
    script_0x04 = function( self )
        -- 0xC6() -- 0x0229 0xc6
        opcode35_VariableSet( address=0x040e, value=(vf40)0x0020, flag=0x40 ) -- 0x022a 0x35
        opcode35_VariableSet( address=0x0410, value=(vf40)0xfff0, flag=0x40 ) -- 0x0230 0x35
        -- 0x01_JumpTo( 0x0246 ) -- 0x0236 0x01
        -- 0xC6() -- 0x0239 0xc6
        opcode35_VariableSet( address=0x040e, value=(vf40)0x0020, flag=0x40 ) -- 0x023a 0x35
        opcode35_VariableSet( address=0x0410, value=(vf40)0x0010, flag=0x40 ) -- 0x0240 0x35
        ...
        -- 0xC6() -- 0x0251 0xc6
        opcode38_VariableAdd( address=0x0400, value=(vf40)0x0410, flag=0x00 ) -- 0x0252 0x38
        opcode3D_VariableDec( address=0x040e ) -- 0x0258 0x3d
        -- 0x01_JumpTo( 0x0246 ) -- 0x025b 0x01
...
Actor[ "0x19" ] = {
    ...
    on_update = function( self )
        ...
        -- 0xBC_ActorNoModelInit() -- 0x0314 0xbc
        -- MISSING OPCODE 0xf8
    end,
...
Actor[ "0x1a" ] = {
    ...
    on_update = function( self )
        ...
        -- 0xBC_ActorNoModelInit() -- 0x0320 0xbc
        -- MISSING OPCODE 0xf8
    end,
