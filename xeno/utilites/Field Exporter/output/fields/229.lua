...
Entity[ "0x00" ] = {
    ...
    on_update = function( self )
        ...
        opcode09_EntityCallScriptEW( entity=0x05, script=05, priority=01 ) -- 0x0033 0x09
...
Entity[ "0x01" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x00e6 0xfe
...
Entity[ "0x02" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x0111 0xfe
    ...
    script_0x05 = function( self )
        ...
        opcodeD2_MessageShow0( dialog_id=0x0000, ???=0x00 ) -- 0x0160 0xd2
        -- 0x9C() -- 0x0164 0x9c
        opcodeD2_MessageShow0( dialog_id=0x0001, ???=0x00 ) -- 0x0165 0xd2
        -- 0x9C() -- 0x0169 0x9c
...
Entity[ "0x03" ] = {
    ...
    script_0x04 = function( self )
        -- 0xD0() -- 0x0171 0xd0
        opcodeD2_MessageShow0( dialog_id=0x0002, ???=0x00 ) -- 0x017c 0xd2
        -- 0x9C() -- 0x0180 0x9c
...
Entity[ "0x04" ] = {
    ...
    script_0x09 = function( self )
        -- 0xD0() -- 0x01bf 0xd0
        opcodeD2_MessageShow0( dialog_id=0x0004, ???=0x00 ) -- 0x01ca 0xd2
        -- 0x9C() -- 0x01ce 0x9c
        opcodeD2_MessageShow0( dialog_id=0x0005, ???=0x00 ) -- 0x01cf 0xd2
        -- 0x9C() -- 0x01d3 0x9c
        -- MISSING OPCODE 0x4a
    end,
    ...
    script_0x0b = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0008, ???=0x00 ) -- 0x01fd 0xd2
        -- 0x9C() -- 0x0201 0x9c
    ...
    script_0x0d = function( self )
        ...
        opcodeD2_MessageShow0( dialog_id=0x000b, ???=0x00 ) -- 0x0221 0xd2
        -- 0x9C() -- 0x0225 0x9c
...
Entity[ "0x05" ] = {
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x000c, ???=0x00 ) -- 0x0236 0xd2
        -- 0x9C() -- 0x023a 0x9c
        return 0 -- 0x023b 0x00
    end,

    script_0x05 = function( self )
        opcode09_EntityCallScriptEW( entity=0x06, script=04, priority=01 ) -- 0x023c 0x09
        -- MISSING OPCODE 0x4a
    end,
    ...
    script_0x0a = function( self )
        -- 0xD0() -- 0x0283 0xd0
        opcodeD2_MessageShow0( dialog_id=0x000f, ???=0x00 ) -- 0x028e 0xd2
        -- 0x9C() -- 0x0292 0x9c
        opcode09_EntityCallScriptEW( entity=0x04, script=09, priority=01 ) -- 0x0293 0x09
        return 0 -- 0x0296 0x00
    end,

    script_0x0b = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0010, ???=0x00 ) -- 0x0297 0xd2
        -- 0x9C() -- 0x029b 0x9c
    ...
    script_0x0c = function( self )
        -- 0xD0() -- 0x029d 0xd0
        opcodeD2_MessageShow0( dialog_id=0x0011, ???=0x00 ) -- 0x02a8 0xd2
        -- 0x9C() -- 0x02ac 0x9c
        -- MISSING OPCODE 0x4a
    end,

    script_0x0d = function( self )
        opcode09_EntityCallScriptEW( entity=0x03, script=04, priority=01 ) -- 0x02e8 0x09
        opcode09_EntityCallScriptEW( entity=0x04, script=0c, priority=01 ) -- 0x02eb 0x09
    ...
    script_0x0f = function( self )
        opcode09_EntityCallScriptEW( entity=0x04, script=0d, priority=01 ) -- 0x0300 0x09
        opcode26_Wait( time=30 ) -- 0x0303 0x26
        opcodeD2_MessageShow0( dialog_id=0x0018, ???=0x00 ) -- 0x0306 0xd2
        -- 0x9C() -- 0x030a 0x9c
        opcodeD2_MessageShow0( dialog_id=0x0019, ???=0x00 ) -- 0x030b 0xd2
        -- 0x9C() -- 0x030f 0x9c
