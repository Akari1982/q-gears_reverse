...
Entity[ "17" ] = {
    ...
    on_talk = function( self )
        ...
        -- 0x09_EntityCallScriptEW( entity=0x04, script=0x24 ) -- 0x042f 0x09
        -- MISSING OPCODE 0x29
    end,
...
Entity[ "18" ] = {
    ...
    on_talk = function( self )
        -- 0x09_EntityCallScriptEW( entity=0x06, script=0x24 ) -- 0x044b 0x09
        -- MISSING OPCODE 0x29
    end,
...
Entity[ "19" ] = {
    ...
    on_talk = function( self )
        ...
        -- 0x09_EntityCallScriptEW( entity=0x05, script=0x24 ) -- 0x046e 0x09
        -- MISSING OPCODE 0x29
    end,
