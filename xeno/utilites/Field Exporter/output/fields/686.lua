...
Entity[ "0x02" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 1 ) -- 0x002b 0x16
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x002e 0xfe
...
Entity[ "0x03" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 2 ) -- 0x0036 0x16
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x0039 0xfe
...
Entity[ "0x04" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 3 ) -- 0x0041 0x16
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x0044 0xfe
...
Entity[ "0x05" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 4 ) -- 0x004c 0x16
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x004f 0xfe
...
Entity[ "0x06" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 5 ) -- 0x0057 0x16
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x005a 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 6 ) -- 0x0062 0x16
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x0065 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 7 ) -- 0x006d 0x16
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x0070 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 8 ) -- 0x0078 0x16
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x007b 0xfe
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 9 ) -- 0x0083 0x16
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x0086 0xfe
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 10 ) -- 0x008e 0x16
        opcodeFE0D_SetAvatar( character_id=10 ) -- 0x0091 0xfe
...
Entity[ "0x0c" ] = {
    ...
    script_0x04 = function( self )
        -- 0x07( entity=0x0d, script=0x05 ) -- 0x00b4 0x07
        -- 0x0A() -- 0x00b7 0xfe
        -- MISSING OPCODE 0x29
    end,
...
Entity[ "0x0d" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xfefe, z=(vf40)0xff9e, flag=(flag)0xc0 ) -- 0x00c1 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Entity[ "0x10" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xfefe, z=(vf40)0x0062, flag=(flag)0xc0 ) -- 0x016b 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Entity[ "0x17" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xff52, z=(vf40)0xfe4f, flag=(flag)0xc0 ) -- 0x0209 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Entity[ "0x1c" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x002c, z=(vf40)0x0177, flag=(flag)0xc0 ) -- 0x0293 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Entity[ "0x1f" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xff7e, z=(vf40)0xfe87, flag=(flag)0xc0 ) -- 0x02e5 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Entity[ "0x22" ] = {
    ...
    script_0x04 = function( self )
        opcodeD4_MessageShowE( entity=(entity)0x20, dialog_id=0x001a, ???=0x01 ) -- 0x039e 0xd4
        -- 0x07( entity=0x20, script=0x04 ) -- 0x03a4 0x07
...
Entity[ "0x23" ] = {
    ...
    script_0x04 = function( self )
        opcodeD4_MessageShowE( entity=(entity)0x21, dialog_id=0x001b, ???=0x01 ) -- 0x03ab 0xd4
        -- 0x07( entity=0x21, script=0x04 ) -- 0x03b1 0x07
...
Entity[ "0x26" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xfdce, z=(vf40)0x0000, flag=(flag)0xc0 ) -- 0x0428 0x19
        -- MISSING OPCODE 0x18
    end,
    ...
    on_talk = function( self )
        opcodeFE54() -- 0x0438 0xfe
        -- 0x07( entity=0x24, script=0x04 ) -- 0x043a 0x07
        opcode09_EntityCallScriptEW( entity=0x25, script=04, priority=00 ) -- 0x043d 0x09
