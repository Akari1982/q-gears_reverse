...
Entity[ "0x05" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=5 ) -- 0x0043 0xfe
...
Entity[ "0x06" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 4 ) -- 0x004b 0x16
        -- 0xFE0D_SetAvatar( character_id=4 ) -- 0x004e 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 6 ) -- 0x0056 0x16
        -- 0xFE0D_SetAvatar( character_id=6 ) -- 0x0059 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 7 ) -- 0x0061 0x16
        -- 0xFE0D_SetAvatar( character_id=7 ) -- 0x0064 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 8 ) -- 0x006c 0x16
        -- 0xFE0D_SetAvatar( character_id=8 ) -- 0x006f 0xfe
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 9 ) -- 0x0077 0x16
        -- 0xFE0D_SetAvatar( character_id=9 ) -- 0x007a 0xfe
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 10 ) -- 0x0082 0x16
        -- 0xFE0D_SetAvatar( character_id=10 ) -- 0x0085 0xfe
...
Entity[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xffef, z=(vf40)0xfff7, flag=(flag)0xc0 ) -- 0x0090 0x19
        -- MISSING OPCODE 0x69
    end,
...
Entity[ "0x0d" ] = {
    on_start = function( self )
        -- 0x0B_InitNPC( 0 ) -- 0x00ae 0x0b
        -- 0x19_SetPosition( x=(vf80)0x0078, z=(vf40)0xffaa, flag=(flag)0xc0 ) -- 0x00b1 0x19
        -- MISSING OPCODE 0x69
    end,
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0002, ???=0x00 ) -- 0x00bc 0xd2
        -- 0x9C() -- 0x00c0 0x9c
        -- MISSING OPCODE 0x70
    end,
...
Entity[ "0x0e" ] = {
    on_start = function( self )
        -- 0x0B_InitNPC( 0 ) -- 0x00cf 0x0b
        -- 0x19_SetPosition( x=(vf80)0x0069, z=(vf40)0x003d, flag=(flag)0xc0 ) -- 0x00d2 0x19
        -- MISSING OPCODE 0x69
    end,
