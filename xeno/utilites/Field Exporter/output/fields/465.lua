...
Actor[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xffef, z=(vf40)0xfff7, flag=(flag)0xc0 ) -- 0x0090 0x19
...
Actor[ "0x0d" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0078, z=(vf40)0xffaa, flag=(flag)0xc0 ) -- 0x00b1 0x19
        opcode69_ActorSetRotation( rot=7 ) -- 0x00b7 0x69
    ...
    on_talk = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0002, flags=0 ) -- 0x00bc 0xd2
...
Actor[ "0x0e" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0069, z=(vf40)0x003d, flag=(flag)0xc0 ) -- 0x00d2 0x19
        opcode69_ActorSetRotation( rot=5 ) -- 0x00d8 0x69
