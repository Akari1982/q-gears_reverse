...
Entity[ "0x01" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=36 ) -- 0x004a 0xfe
...
Entity[ "0x03" ] = {
    ...
    on_talk = function( self )
        opcode09_EntityCallScriptEW( entity=0x02, script=04, priority=01 ) -- 0x006b 0x09
...
Entity[ "0x06" ] = {
    ...
    on_talk = function( self )
        ...
        opcodeD2_MessageShow0( dialog_id=0x0005, ???=0x00 ) -- 0x00f2 0xd2
        -- 0x9C() -- 0x00f6 0x9c
        -- 0x01_JumpTo( 0x0105 ) -- 0x00f7 0x01
        opcodeD2_MessageShow0( dialog_id=0x0006, ???=0x00 ) -- 0x00fa 0xd2
        -- 0x9C() -- 0x00fe 0x9c
        -- 0x35() -- 0x00ff 0x35
...
Entity[ "0x07" ] = {
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0007, ???=0x00 ) -- 0x0116 0xd2
        -- 0x9C() -- 0x011a 0x9c
...
Entity[ "0x08" ] = {
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0008, ???=0x00 ) -- 0x012a 0xd2
        -- 0x9C() -- 0x012e 0x9c
...
Entity[ "0x09" ] = {
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0009, ???=0x00 ) -- 0x013e 0xd2
        -- 0x9C() -- 0x0142 0x9c
...
Entity[ "0x0c" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x016b 0xfe
...
Entity[ "0x0d" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x0176 0xfe
...
Entity[ "0x0e" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x0181 0xfe
...
Entity[ "0x10" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x0197 0xfe
...
Entity[ "0x11" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x01a2 0xfe
...
Entity[ "0x12" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x01ad 0xfe
...
Entity[ "0x13" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x01b8 0xfe
...
Entity[ "0x14" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x01c3 0xfe
...
Entity[ "0x15" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=10 ) -- 0x01ce 0xfe
