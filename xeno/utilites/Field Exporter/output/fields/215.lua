...
Actor[ "0x01" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=36 ) -- 0x004a 0xfe
...
Actor[ "0x03" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0000, z=(vf40)0x0126, flag=(flag)0xc0 ) -- 0x0063 0x19
...
Actor[ "0x04" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x01c9, z=(vf40)0xfffd, flag=(flag)0xc0 ) -- 0x0073 0x19
        -- MISSING OPCODE 0x5f
    end,
    ...
    on_talk = function( self )
        opcode6F_ActorRotateToActor( actor_id=(entity)party_1 ) -- 0x007d 0x6f
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0400 ), value2=(s16)0x0001, condition="value1 == value2", jump_if_false=0x008d ) -- 0x007f 0x02
        -- 0x01_JumpTo( 0x009e ) -- 0x0087 0x01
        -- 0x01_JumpTo( 0x0090 ) -- 0x008a 0x01
        -- 0x01_JumpTo( 0x0092 ) -- 0x008d 0x01
...
Actor[ "0x05" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0130, z=(vf40)0xff9a, flag=(flag)0xc0 ) -- 0x00ac 0x19
    ...
    on_talk = function( self )
        opcode6F_ActorRotateToActor( actor_id=(entity)party_1 ) -- 0x00b4 0x6f
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0402 ), value2=(s16)0x0001, condition="value1 == value2", jump_if_false=0x00c4 ) -- 0x00b6 0x02
        -- 0x01_JumpTo( 0x00d5 ) -- 0x00be 0x01
        -- 0x01_JumpTo( 0x00c7 ) -- 0x00c1 0x01
        -- 0x01_JumpTo( 0x00c9 ) -- 0x00c4 0x01
...
Actor[ "0x06" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xfeca, z=(vf40)0xff7d, flag=(flag)0xc0 ) -- 0x00de 0x19
        -- MISSING OPCODE 0x5f
    end,
    ...
    on_talk = function( self )
        ...
        opcodeD2_MessageShowDynamic( text_id=0x0005, flags=0 ) -- 0x00f2 0xd2
        opcode9C_MessageSync() -- 0x00f6 0x9c
        -- 0x01_JumpTo( 0x0105 ) -- 0x00f7 0x01
        opcodeD2_MessageShowDynamic( text_id=0x0006, flags=0 ) -- 0x00fa 0xd2
        opcode9C_MessageSync() -- 0x00fe 0x9c
        opcode35_VariableSet( address=0x0404, value=(vf40)0x0001, flag=0x40 ) -- 0x00ff 0x35
...
Actor[ "0x07" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xff86, z=(vf40)0x006f, flag=(flag)0xc0 ) -- 0x010a 0x19
        -- MISSING OPCODE 0x5f
    end,

    on_update = function( self )
        opcode6F_ActorRotateToActor( actor_id=(entity)party_1 ) -- 0x0113 0x6f
        return 0 -- 0x0115 0x00
    end,

    on_talk = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0007, flags=0 ) -- 0x0116 0xd2
...
Actor[ "0x08" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x013a, z=(vf40)0xff72, flag=(flag)0xc0 ) -- 0x0120 0x19
        -- MISSING OPCODE 0x5f
    end,
    ...
    on_talk = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0008, flags=0 ) -- 0x012a 0xd2
...
Actor[ "0x09" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x00ef, z=(vf40)0x00b4, flag=(flag)0xc0 ) -- 0x0134 0x19
        -- MISSING OPCODE 0x5f
    end,
    ...
    on_talk = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0009, flags=0 ) -- 0x013e 0xd2
...
Actor[ "0x0a" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x006c, z=(vf40)0xff9d, flag=(flag)0xc0 ) -- 0x0148 0x19
    ...
    on_talk = function( self )
        opcode6F_ActorRotateToActor( actor_id=(entity)party_1 ) -- 0x0150 0x6f
        opcodeD2_MessageShowDynamic( text_id=0x000a, flags=0 ) -- 0x0152 0xd2
...
Actor[ "0x0c" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=1 ) -- 0x0168 0x16
        opcodeFE0D_MessageSetFace( char_id=1 ) -- 0x016b 0xfe
...
Actor[ "0x0d" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=2 ) -- 0x0173 0x16
        opcodeFE0D_MessageSetFace( char_id=2 ) -- 0x0176 0xfe
...
Actor[ "0x0e" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=3 ) -- 0x017e 0x16
        opcodeFE0D_MessageSetFace( char_id=3 ) -- 0x0181 0xfe
...
Actor[ "0x0f" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=4 ) -- 0x0189 0x16
...
Actor[ "0x10" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=5 ) -- 0x0194 0x16
        opcodeFE0D_MessageSetFace( char_id=5 ) -- 0x0197 0xfe
...
Actor[ "0x11" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=6 ) -- 0x019f 0x16
        opcodeFE0D_MessageSetFace( char_id=6 ) -- 0x01a2 0xfe
...
Actor[ "0x12" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=7 ) -- 0x01aa 0x16
        opcodeFE0D_MessageSetFace( char_id=7 ) -- 0x01ad 0xfe
...
Actor[ "0x13" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=8 ) -- 0x01b5 0x16
        opcodeFE0D_MessageSetFace( char_id=8 ) -- 0x01b8 0xfe
...
Actor[ "0x14" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=9 ) -- 0x01c0 0x16
        opcodeFE0D_MessageSetFace( char_id=9 ) -- 0x01c3 0xfe
...
Actor[ "0x15" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=10 ) -- 0x01cb 0x16
        opcodeFE0D_MessageSetFace( char_id=10 ) -- 0x01ce 0xfe
