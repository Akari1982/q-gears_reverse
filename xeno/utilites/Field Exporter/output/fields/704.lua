...
Entity[ "0x06" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x00a4 0xfe
        -- MISSING OPCODE 0xFE03
    end,
...
Entity[ "0x07" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x00bb 0xfe
        -- MISSING OPCODE 0xFE03
    end,
...
Entity[ "0x08" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x00d2 0xfe
        -- MISSING OPCODE 0xFE03
    end,
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x0100 0xfe
        -- MISSING OPCODE 0xFE03
    end,
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x0117 0xfe
        -- MISSING OPCODE 0xFE03
    end,
...
Entity[ "0x0c" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=10 ) -- 0x012e 0xfe
        -- MISSING OPCODE 0xFE03
    end,
...
Entity[ "0x0d" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x0145 0xfe
        -- MISSING OPCODE 0xFE03
    end,
...
Entity[ "0x0e" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x015c 0xfe
        -- MISSING OPCODE 0xFE03
    end,
