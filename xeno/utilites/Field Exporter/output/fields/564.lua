...
Entity[ "0x02" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x0041 0xfe
...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x004c 0xfe
...
Entity[ "0x05" ] = {
    ...
    on_talk = function( self )
        opcodeFE54() -- 0x0093 0xfe
        opcode09_EntityCallScriptEW( entity=0x07, script=04, priority=01 ) -- 0x0095 0x09
