...
0x0010    -- 0xB6( ???=400, ???=1 )
0x0015    -- 0xA0()
0x001c    -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0102 ), value2=(s16)0x0030, condition="value1 == value2", jump_if_false=0x002a )
0x0024    op35_VariableSet( address=0x0008, value=(vf40)0x0000, flag=0x40 )
0x002a    -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0002 ), value2=(s16)0x0001, condition="value1 == value2", jump_if_false=0x003d )
