...
Entity[ "1" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=GetVar( 0x003e ) ) -- 0x00ff 0xfe
...
Entity[ "2" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=GetVar( 0x0040 ) ) -- 0x0127 0xfe
...
Entity[ "3" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=GetVar( 0x0042 ) ) -- 0x0132 0xfe
...
Entity[ "7" ] = {
    ...
    script_0x05 = function( self )
        -- 0x09_EntityCallScriptEW( entity=0x08, script=0x32 ) -- 0x01b1 0x09
        -- MISSING OPCODE 0xFE5d
    end,
...
Entity[ "11" ] = {
    ...
    on_talk = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0003, ???=0x00 ) -- 0x03e8 0xd2
        -- MISSING OPCODE 0xa9
    end,
    ...
    on_push = function( self )
        ...
        opcodeD2_DialogShow0( dialog_id=0x0006, ???=0x00 ) -- 0x0525 0xd2
        -- 0x9C() -- 0x0529 0x9c
...
Entity[ "12" ] = {
    ...
    on_talk = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0007, ???=0x00 ) -- 0x0549 0xd2
        -- MISSING OPCODE 0xa9
    end,
    ...
    on_push = function( self )
        ...
        opcodeD2_DialogShow0( dialog_id=0x0009, ???=0x00 ) -- 0x06a1 0xd2
        -- 0x9C() -- 0x06a5 0x9c
...
Entity[ "16" ] = {
    ...
    on_talk = function( self )
        ...
        -- 0x09_EntityCallScriptEW( entity=0x12, script=0x24 ) -- 0x0793 0x09
...
Entity[ "17" ] = {
    ...
    on_talk = function( self )
        ...
        -- 0x09_EntityCallScriptEW( entity=0x13, script=0x24 ) -- 0x07bc 0x09
