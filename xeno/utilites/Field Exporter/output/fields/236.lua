...
Actor[ "0x01" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=0 ) -- 0x0162 0x16
        opcodeFE0D_MessageSetFace( char_id=0 ) -- 0x0165 0xfe
    ...
    script_0x04 = function( self )
        ...
        -- 0x07( actor_id=0x15, script=0x26 ) -- 0x0170 0x07
        -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call ) -- 0x0173 0x4a
        opcode09_ActorCallScriptEW( actor_id=0x03, script=05, priority=01 ) -- 0x0179 0x09
        return 0 -- 0x017c 0x00
    end,

    script_0x05 = function( self )
        -- 0x19_ActorSetPosition( x=(vf80)0x0000, z=(vf40)0x0000, flag=(flag)0xc0 ) -- 0x017d 0x19
        return 0 -- 0x0183 0x00
    end,

    script_0x06 = function( self )
        -- 0x1F( ???=0x10 ) -- 0x0184 0x1f
        -- 0x19_ActorSetPosition( x=(vf80)0x0000, z=(vf40)0xfea7, flag=(flag)0xc0 ) -- 0x0186 0x19
        -- MISSING OPCODE 0x5f
    end,

    script_0x07 = function( self )
        -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call ) -- 0x01a3 0x4a
        -- 0x07( actor_id=0x0e, script=0x26 ) -- 0x01a9 0x07
        -- 0x1F( ???=0x00 ) -- 0x01ac 0x1f
        opcode2C_SpritePlayAnim( anim_id=0x05 ) -- 0x01ae 0x2c
        opcodeD2_MessageShowDynamic( text_id=0x0001, flags=0 ) -- 0x01b0 0xd2
        opcode9C_MessageSync() -- 0x01b4 0x9c
        opcode2C_SpritePlayAnim( anim_id=0xff ) -- 0x01b5 0x2c
        return 0 -- 0x01b7 0x00
    end,

    script_0x08 = function( self )
        -- 0x1F( ???=0x10 ) -- 0x01b8 0x1f
...
Actor[ "0x02" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=2 ) -- 0x01da 0x16
        opcodeFE0D_MessageSetFace( char_id=2 ) -- 0x01dd 0xfe
    ...
    script_0x04 = function( self )
        -- 0x1F( ???=0x10 ) -- 0x01e5 0x1f
        -- 0x19_ActorSetPosition( x=(vf80)0x0000, z=(vf40)0xfea7, flag=(flag)0xc0 ) -- 0x01e7 0x19
...
Actor[ "0x03" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=5 ) -- 0x01fa 0x16
        opcodeFE0D_MessageSetFace( char_id=5 ) -- 0x01fd 0xfe
    ...
    script_0x04 = function( self )
        -- 0x19_ActorSetPosition( x=(vf80)0x0000, z=(vf40)0x0000, flag=(flag)0xc0 ) -- 0x0205 0x19
        return 0 -- 0x020b 0x00
    end,

    script_0x05 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0002, flags=0 ) -- 0x020c 0xd2
    ...
    script_0x06 = function( self )
        ...
        opcodeD2_MessageShowDynamic( text_id=0x0003, flags=0 ) -- 0x0215 0xd2
...
Actor[ "0x04" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=1 ) -- 0x0276 0x16
        opcodeFE0D_MessageSetFace( char_id=1 ) -- 0x0279 0xfe
...
Actor[ "0x05" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=3 ) -- 0x0281 0x16
        opcodeFE0D_MessageSetFace( char_id=3 ) -- 0x0284 0xfe
...
Actor[ "0x06" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=4 ) -- 0x028c 0x16
        opcodeFE0D_MessageSetFace( char_id=4 ) -- 0x028f 0xfe
...
Actor[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=6 ) -- 0x0297 0x16
        opcodeFE0D_MessageSetFace( char_id=6 ) -- 0x029a 0xfe
...
Actor[ "0x08" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=7 ) -- 0x02a2 0x16
        opcodeFE0D_MessageSetFace( char_id=7 ) -- 0x02a5 0xfe
...
Actor[ "0x09" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=8 ) -- 0x02ad 0x16
        opcodeFE0D_MessageSetFace( char_id=8 ) -- 0x02b0 0xfe
...
Actor[ "0x0a" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=11 ) -- 0x02b8 0x16
        opcodeFE0D_MessageSetFace( char_id=11 ) -- 0x02bb 0xfe
...
Actor[ "0x0b" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=10 ) -- 0x02c3 0x16
        opcodeFE0D_MessageSetFace( char_id=10 ) -- 0x02c6 0xfe
...
Actor[ "0x0c" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=9 ) -- 0x02ce 0x16
        opcodeFE0D_MessageSetFace( char_id=9 ) -- 0x02d1 0xfe
...
Actor[ "0x0d" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0000, z=(vf40)0xfedf, flag=(flag)0xc0 ) -- 0x02da 0x19
        -- MISSING OPCODE 0xf8
    end,
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x02eb 0xfe
        opcode09_ActorCallScriptEW( actor_id=0x0e, script=05, priority=01 ) -- 0x02ed 0x09
        -- 0x07( actor_id=0x01, script=0x28 ) -- 0x02f0 0x07
...
Actor[ "0x0f" ] = {
    on_start = function( self )
        -- 0xFE15( ???=1, ???=1 ) -- 0x0315 0xfe
        -- 0x19_ActorSetPosition( x=(vf80)0x0083, z=(vf40)0x0048, flag=(flag)0xc0 ) -- 0x031b 0x19
        -- MISSING OPCODE 0x5f
    end,
    ...
    on_talk = function( self )
        opcode6F_ActorRotateToActor( actor_id=(entity)party_1 ) -- 0x0327 0x6f
        opcode2C_SpritePlayAnim( anim_id=0xff ) -- 0x0329 0x2c
        opcode2C_SpritePlayAnim( anim_id=0x05 ) -- 0x032b 0x2c
        opcode74_SoundPlayFixedVolume( sound_id=9 ) -- 0x032d 0x74
        opcode26_Wait( time=30 ) -- 0x0330 0x26
        opcode74_SoundPlayFixedVolume( sound_id=9 ) -- 0x0333 0x74
...
Actor[ "0x10" ] = {
    ...
    script_0x04 = function( self )
        opcode2C_SpritePlayAnim( anim_id=0x04 ) -- 0x034c 0x2c
        opcode74_SoundPlayFixedVolume( sound_id=10 ) -- 0x034e 0x74
...
Actor[ "0x11" ] = {
    on_start = function( self )
        ...
        -- 0x2A() -- 0x0376 0x2a
        opcode35_VariableSet( address=0x0410, value=(vf40)0x00c8, flag=0x40 ) -- 0x0377 0x35
    ...
    script_0x04 = function( self )
        opcode37_VariableSetFalse( address=0x040e ) -- 0x0381 0x37
        opcode37_VariableSetFalse( address=0x040a ) -- 0x0384 0x37
        opcode35_VariableSet( address=0x0410, value=(vf40)0x00c8, flag=0x40 ) -- 0x0387 0x35
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x040e ), value2=(s16)0x0080, condition="value1 < value2", jump_if_false=0x03ad ) -- 0x038d 0x02
        -- MISSING OPCODE 0x6d
    end,
...
Actor[ "0x12" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0104, z=(vf40)0xfff6, flag=(flag)0xc0 ) -- 0x03d8 0x19
        -- MISSING OPCODE 0xf8
    end,
    ...
    on_talk = function( self )
        -- 0x07( actor_id=0x10, script=0x24 ) -- 0x03ed 0x07
        opcode09_ActorCallScriptEW( actor_id=0x11, script=04, priority=01 ) -- 0x03f0 0x09
...
Actor[ "0x13" ] = {
    ...
    on_talk = function( self )
        ...
        opcode74_SoundPlayFixedVolume( sound_id=55 ) -- 0x0420 0x74
        opcodeD0_MessageSettings( x=0, y=0, letters=16, rows=3, flags=0 ) -- 0x0423 0xd0
        opcodeD2_MessageShowDynamic( text_id=0x0006, flags=CLOSE_OFF_SCREEN ) -- 0x042e 0xd2
...
Actor[ "0x15" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x04de 0xbc
        -- 0x19_ActorSetPosition( x=(vf80)0xffc5, z=(vf40)0x00c5, flag=(flag)0xc0 ) -- 0x04df 0x19
        -- 0x2A() -- 0x04e5 0x2a
    ...
    script_0x04 = function( self )
        opcodeFC_MessageShowFromActorCopyFace( actor_id=(entity)0x03, text_id=0x0007, flags=CLOSE_OFF_SCREEN ) -- 0x04e9 0xfc
        return 0 -- 0x04ef 0x00
    end,

    script_0x05 = function( self )
        opcodeFC_MessageShowFromActorCopyFace( actor_id=(entity)0x03, text_id=0x0008, flags=CLOSE_OFF_SCREEN ) -- 0x04f0 0xfc
        return 0 -- 0x04f6 0x00
    end,

    script_0x06 = function( self )
        opcodeFC_MessageShowFromActorCopyFace( actor_id=(entity)0x03, text_id=0x0009, flags=CLOSE_OFF_SCREEN ) -- 0x04f7 0xfc
...
Actor[ "0x16" ] = {
    ...
    on_update = function( self )
        ...
        opcode25_ActorDisable( actor_id=(entity)party_1 ) -- 0x0509 0x25
        opcode25_ActorDisable( actor_id=(entity)party_2 ) -- 0x050b 0x25
        -- 0xFE54() -- 0x050d 0xfe
...
Actor[ "0x17" ] = {
    ...
    on_update = function( self )
        ...
        -- 0xFE54() -- 0x0576 0xfe
        opcode25_ActorDisable( actor_id=(entity)party_1 ) -- 0x0578 0x25
        opcode25_ActorDisable( actor_id=(entity)party_2 ) -- 0x057a 0x25
        -- 0x07( actor_id=0x01, script=0x25 ) -- 0x057c 0x07
        opcode09_ActorCallScriptEW( actor_id=0x03, script=04, priority=01 ) -- 0x057f 0x09
        -- 0xA0() -- 0x0582 0xa0
        -- 0x07( actor_id=0x14, script=0x26 ) -- 0x0589 0x07
...
Actor[ "0x18" ] = {
    ...
    script_0x04 = function( self )
        ...
        opcodeF1_FadeSetUp( steps=1, r=255, g=255, b=255, semi_tr=2 ) -- 0x05d0 0xf1
        opcode26_Wait( time=10 ) -- 0x05db 0x26
        opcodeF1_FadeSetUp( steps=2, r=30, g=40, b=100, semi_tr=2 ) -- 0x05de 0xf1
        opcode74_SoundPlayFixedVolume( sound_id=173 ) -- 0x05e9 0x74
        -- MISSING OPCODE 0xFE65
    end,
...
Actor[ "0x19" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0000, z=(vf40)0x00df, flag=(flag)0xc0 ) -- 0x06bd 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x1c" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x076a 0xbc
