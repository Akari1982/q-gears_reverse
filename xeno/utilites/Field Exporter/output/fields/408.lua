...
Entity[ "0x01" ] = {
    ...
    script_0x04 = function( self )
        -- 0xD0() -- 0x005f 0xd0
        opcodeD2_MessageShow0( dialog_id=0x0000, ???=0x00 ) -- 0x006a 0xd2
        -- 0x9C() -- 0x006e 0x9c
        -- 0xD0() -- 0x006f 0xd0
...
Entity[ "0x02" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=GetVar( 0x0040 ) ) -- 0x00b7 0xfe
...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=GetVar( 0x0042 ) ) -- 0x00c2 0xfe
...
Entity[ "0x06" ] = {
    ...
    on_talk = function( self )
        ...
        opcode09_EntityCallScriptEW( entity=0x01, script=06, priority=01 ) -- 0x015c 0x09
        -- 0x75() -- 0x015f 0x75
        -- MISSING OPCODE 0x74
    end,
...
Entity[ "0x07" ] = {
    ...
    on_talk = function( self )
        ...
        opcode09_EntityCallScriptEW( entity=0x01, script=07, priority=01 ) -- 0x0198 0x09
...
Entity[ "0x08" ] = {
    ...
    on_talk = function( self )
        opcode09_EntityCallScriptEW( entity=0x09, script=04, priority=01 ) -- 0x01b0 0x09
