...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x00e3 0xfe
...
Entity[ "0x05" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x00f7 0xfe
...
Entity[ "0x06" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x0101 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x0115 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x011f 0xfe
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x0129 0xfe
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=10 ) -- 0x0133 0xfe
...
Entity[ "0x0d" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x0205 0xfe
...
Entity[ "0x0e" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=19 ) -- 0x0281 0xfe
        -- MISSING OPCODE 0xf6
    end,
    ...
    script_0x12 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0002, ???=0x11 ) -- 0x03fe 0xd2
        -- 0x9C() -- 0x0402 0x9c
...
Entity[ "0x16" ] = {
    ...
    script_0x06 = function( self )
        opcode09_EntityCallScriptEW( entity=0x25, script=04, priority=01 ) -- 0x0a7b 0x09
...
Entity[ "0x17" ] = {
    ...
    on_talk = function( self )
        ...
        opcodeD2_MessageShow0( dialog_id=0x003b, ???=0x02 ) -- 0x0b53 0xd2
        -- 0x9C() -- 0x0b57 0x9c
...
Entity[ "0x1a" ] = {
    ...
    script_0x07 = function( self )
        ...
        opcode60() -- 0x101d 0x60
        opcode64() -- 0x101e 0x64
        -- MISSING OPCODE 0x62
    end,
    ...
    script_0x0b = function( self )
        ...
        opcode60() -- 0x1110 0x60
        opcode64() -- 0x1111 0x64
        -- MISSING OPCODE 0x62
    end,

    script_0x0c = function( self )
        opcode60() -- 0x113a 0x60
...
Entity[ "0x24" ] = {
    ...
    on_talk = function( self )
        opcodeFE54() -- 0x13f3 0xfe
        -- 0x20_SpriteSetSolid() -- 0x13f5 0x20
        opcode09_EntityCallScriptEW( entity=0x25, script=04, priority=01 ) -- 0x13f8 0x09
