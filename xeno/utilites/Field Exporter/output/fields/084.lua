...
Entity[ "0x01" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x014e 0xfe
...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x025e 0xfe
...
Entity[ "0x04" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x02e5 0xfe
...
Entity[ "0x05" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x02fa 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x0324 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x0339 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x034e 0xfe
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x0363 0xfe
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=10 ) -- 0x0378 0xfe
...
Entity[ "0x16" ] = {
    ...
    on_update = function( self )
        opcodeFE54() -- 0x0924 0xfe
        opcode99() -- 0x0926 0x99
        opcode60() -- 0x0927 0x60
...
Entity[ "0x1a" ] = {
    ...
    on_update = function( self )
        ...
        opcodeFE54() -- 0x0c4e 0xfe
        -- 0x07( entity=0xfd, script=0x24 ) -- 0x0c50 0x07
        -- 0x07( entity=0xfe, script=0x24 ) -- 0x0c53 0x07
        -- 0x07( entity=0xff, script=0x24 ) -- 0x0c56 0x07
        opcode09_EntityCallScriptEW( entity=0x1b, script=04, priority=01 ) -- 0x0c59 0x09
        -- MISSING OPCODE 0xFE65
    end,

    on_talk = function( self )
        opcodeFE54() -- 0x0c6e 0xfe
        opcodeD2_MessageShow0( dialog_id=0x002a, ???=0x00 ) -- 0x0c70 0xd2
        -- MISSING OPCODE 0xa9
    end,
