...
Actor[ "0x04" ] = {
    ...
    script_0x06 = function( self )
        -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call ) -- 0x43c4 0x4a
        -- MISSING OPCODE 0x10
    end,

    script_0x07 = function( self )
        -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call ) -- 0x43ec 0x4a
...
Actor[ "0x05" ] = {
    ...
    script_0x04 = function( self )
        -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call ) -- 0x4420 0x4a
        -- MISSING OPCODE 0x10
    end,
...
Actor[ "0x06" ] = {
    ...
    script_0x04 = function( self )
        -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call ) -- 0x4476 0x4a
        -- MISSING OPCODE 0x10
    end,
...
Actor[ "0x09" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x4564 0xbc
        -- MISSING OPCODE 0xFE1c
    end,
...
Actor[ "0x0a" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x4594 0xbc
        -- MISSING OPCODE 0xFE1c
    end,
...
Actor[ "0x0f" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x46ca 0xbc
        -- MISSING OPCODE 0xf8
    end,
...
Actor[ "0x11" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x4778 0xbc
        -- 0x2A() -- 0x4779 0x2a
...
Actor[ "0x12" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x4787 0xbc
        -- 0x2A() -- 0x4788 0x2a
...
Actor[ "0x13" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x4796 0xbc
        -- 0x2A() -- 0x4797 0x2a
...
Actor[ "0x14" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x47a5 0xbc
        -- 0x2A() -- 0x47a6 0x2a
...
Actor[ "0x15" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x47b4 0xbc
        -- 0x2A() -- 0x47b5 0x2a
...
Actor[ "0x16" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x47c3 0xbc
        -- 0x2A() -- 0x47c4 0x2a
...
Actor[ "0x17" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x47d2 0xbc
        -- 0x2A() -- 0x47d3 0x2a
...
Actor[ "0x18" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x47e1 0xbc
        -- 0x2A() -- 0x47e2 0x2a
...
Actor[ "0x19" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x47f0 0xbc
        -- 0x2A() -- 0x47f1 0x2a
...
Actor[ "0x1a" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x47ff 0xbc
        -- 0x2A() -- 0x4800 0x2a
...
Actor[ "0x1b" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x480e 0xbc
        -- 0x2A() -- 0x480f 0x2a
...
Actor[ "0x1d" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x4833 0xbc
        -- MISSING OPCODE 0x1b
    end,
    ...
    on_talk = function( self )
        -- 0x07( actor_id=0x1f, script=0x24 ) -- 0x4849 0x07
        -- 0xFE54() -- 0x484c 0xfe
        ...
        -- 0x07( actor_id=0x04, script=0x26 ) -- 0x4868 0x07
        opcode26_Wait( time=5 ) -- 0x486b 0x26
        -- 0x07( actor_id=0x05, script=0x24 ) -- 0x486e 0x07
        opcode26_Wait( time=5 ) -- 0x4871 0x26
        -- 0x07( actor_id=0x06, script=0x24 ) -- 0x4874 0x07
        opcode26_Wait( time=100 ) -- 0x4877 0x26
        -- 0x98_MapLoad( field_id=16804, value=0 ) -- 0x487a 0x98
        -- 0x5B() -- 0x487f 0x5b
        -- 0x01_JumpTo( 0x4899 ) -- 0x4880 0x01
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0014 ), value2=(s16)0x0001, condition="value1 == value2", jump_if_false=0x4899 ) -- 0x4883 0x02
        opcode09_ActorCallScriptEW( actor_id=0x04, script=07, priority=01 ) -- 0x488b 0x09
        -- MISSING OPCODE 0x9a
    end,
...
Actor[ "0x1e" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x489a 0xbc
        -- 0x2A() -- 0x489b 0x2a
    ...
    on_update = function( self )
        ...
        opcode09_ActorCallScriptEW( actor_id=0x1f, script=05, priority=01 ) -- 0x48a5 0x09
        -- 0xFE54() -- 0x48a8 0xfe
        -- 0x07( actor_id=0x04, script=0x28 ) -- 0x48aa 0x07
        -- 0x07( actor_id=0x05, script=0x25 ) -- 0x48ad 0x07
        opcode09_ActorCallScriptEW( actor_id=0x06, script=05, priority=01 ) -- 0x48b0 0x09
        -- MISSING OPCODE 0x9a
    end,
...
Actor[ "0x1f" ] = {
    ...
    script_0x05 = function( self )
        ...
        -- 0x60() -- 0x48f0 0x60
        -- 0x63( ???=(vf80)0x0017, ???=(vf40)0xfc91, ???=(vf20)0xfa40, flag=0xe0 ) -- 0x48f1 0x63
        -- 0x64() -- 0x48f9 0x64
...
Actor[ "0x21" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x4932 0xbc
        -- MISSING OPCODE 0x1b
    end,
...
Actor[ "0x23" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x497a 0xbc
        -- MISSING OPCODE 0x1b
    end,
...
Actor[ "0x24" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x499e 0xbc
        -- MISSING OPCODE 0x1b
    end,
