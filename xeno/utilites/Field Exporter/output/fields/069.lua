...
Actor[ "0x04" ] = {
    ...
    script_0x04 = function( self )
        -- 0x15() -- 0x4426 0x15
        -- 0x1F( ???=0x70 ) -- 0x4427 0x1f
        -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call ) -- 0x4429 0x4a
        -- 0x1F( ???=0x00 ) -- 0x442f 0x1f
...
Actor[ "0x05" ] = {
    ...
    script_0x04 = function( self )
        -- 0x15() -- 0x45c3 0x15
        -- 0x1F( ???=0x70 ) -- 0x45c4 0x1f
        -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call ) -- 0x45c6 0x4a
        -- 0x1F( ???=0x00 ) -- 0x45cc 0x1f
