...
0x0010    -- 0x2A()
0x0011    -- 0xA0()
0x0018    -- 0x86_ProgressNotEqualJumpTo( value=242, jump=0x0023 )
0x001d    -- 0xFE0E_SoundSetVolume( volume=0, steps=0 )
0x0023    op00_Return()

Actor_0x00:on_update:
0x0024    -- 0x86_ProgressNotEqualJumpTo( value=242, jump=0x00d9 )
0x0029    -- 0xFE54()
...
0x003c    op25_ActorDisable( actor_id=(entity)0x04 )
0x003e    op25_ActorDisable( actor_id=(entity)0x05 )
0x0040    op25_ActorDisable( actor_id=(entity)0x06 )
0x0042    op25_ActorDisable( actor_id=(entity)0x08 )
0x0044    op25_ActorDisable( actor_id=(entity)0x09 )
0x0046    op25_ActorDisable( actor_id=(entity)0x07 )
0x0048    op99()
0x0049    op35_VariableSet( address=0x040a, value=(vf40)0x0000, flag=0x40 )
0x004f    -- 0x63( ???=(vf80)0x036f, ???=(vf40)0xfec5, ???=(vf20)0xffbc, flag=0xe0 )
0x0057    opA3()
0x005f    op05_FunctionCall( 0x02f0 )
0x0062    -- 0xFEA2()
0x0064    op26_Wait( time=30 )
0x0067    -- 0xFE0E_SoundSetVolume( volume=64, steps=480 )
0x006d    op08_ActorCallScriptSW( actor_id=0x0f, script=04, priority=03 )
0x0070    op09_ActorCallScriptEW( actor_id=0x0c, script=04, priority=03 )
0x0073    op09_ActorCallScriptEW( actor_id=0x0d, script=04, priority=03 )
0x0076    op09_ActorCallScriptEW( actor_id=0x0c, script=05, priority=03 )
0x0079    op09_ActorCallScriptEW( actor_id=0x0d, script=05, priority=03 )
0x007c    op09_ActorCallScriptEW( actor_id=0x0c, script=06, priority=03 )
0x007f    op09_ActorCallScriptEW( actor_id=0x0d, script=06, priority=03 )
0x0082    op09_ActorCallScriptEW( actor_id=0x0c, script=07, priority=03 )
0x0085    op09_ActorCallScriptEW( actor_id=0x0d, script=07, priority=03 )
0x0088    op09_ActorCallScriptEW( actor_id=0x0c, script=08, priority=03 )
0x008b    op09_ActorCallScriptEW( actor_id=0x0d, script=08, priority=03 )
...
0x00bc    op09_ActorCallScriptEW( actor_id=0x0d, script=09, priority=03 )
0x00bf    op09_ActorCallScriptEW( actor_id=0x0c, script=09, priority=03 )
