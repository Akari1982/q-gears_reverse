...
Entity[ "0x01" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x00d2 0xfe
...
Entity[ "0x03" ] = {
    ...
    script_0x04 = function( self )
        opcodeFE0D_SetAvatar( character_id=55 ) -- 0x010b 0xfe
        -- 0xD0() -- 0x010f 0xd0
        opcodeF5_MessageShow3( dialog_id=0x0000, flag=0x19 ) -- 0x011a 0xf5
        -- 0x9C() -- 0x011e 0x9c
        opcodeFE0D_SetAvatar( character_id=50 ) -- 0x011f 0xfe
        -- 0xD0() -- 0x0123 0xd0
        opcodeF5_MessageShow3( dialog_id=0x0001, flag=0x05 ) -- 0x012e 0xf5
        -- 0x9C() -- 0x0132 0x9c
        opcodeFE0D_SetAvatar( character_id=84 ) -- 0x0133 0xfe
        -- 0xD0() -- 0x0137 0xd0
        opcodeF5_MessageShow3( dialog_id=0x0002, flag=0x09 ) -- 0x0142 0xf5
        -- 0x9C() -- 0x0146 0x9c
        opcodeFE0D_SetAvatar( character_id=81 ) -- 0x0147 0xfe
        -- 0xD0() -- 0x014b 0xd0
        opcodeF5_MessageShow3( dialog_id=0x0003, flag=0x25 ) -- 0x0156 0xf5
        -- 0x9C() -- 0x015a 0x9c
        opcodeFE0D_SetAvatar( character_id=83 ) -- 0x015b 0xfe
        -- 0xD0() -- 0x015f 0xd0
        opcodeF5_MessageShow3( dialog_id=0x0004, flag=0x15 ) -- 0x016a 0xf5
        -- 0x9C() -- 0x016e 0x9c
        -- 0x07( entity=0x04, script=0x25 ) -- 0x016f 0x07
        opcodeFE0D_SetAvatar( character_id=26 ) -- 0x0172 0xfe
        -- 0xD0() -- 0x0176 0xd0
        opcodeD4_MessageShowE( entity=(entity)0x04, dialog_id=0x0005, ???=0x10 ) -- 0x0181 0xd4
        opcodeFE0D_SetAvatar( character_id=86 ) -- 0x0187 0xfe
        -- 0xD0() -- 0x018b 0xd0
        opcodeF5_MessageShow3( dialog_id=0x0006, flag=0x29 ) -- 0x0196 0xf5
        -- 0x9C() -- 0x019a 0x9c
        opcodeFE0D_SetAvatar( character_id=85 ) -- 0x019b 0xfe
        -- 0xD0() -- 0x019f 0xd0
        opcodeF5_MessageShow3( dialog_id=0x0007, flag=0x15 ) -- 0x01aa 0xf5
        -- 0x9C() -- 0x01ae 0x9c
        -- 0x07( entity=0x04, script=0x26 ) -- 0x01af 0x07
        opcodeFE0D_SetAvatar( character_id=26 ) -- 0x01b2 0xfe
        -- 0xD0() -- 0x01b6 0xd0
        opcodeD4_MessageShowE( entity=(entity)0x04, dialog_id=0x0008, ???=0x10 ) -- 0x01c1 0xd4
        opcode26_Wait( time=5 ) -- 0x01c7 0x26
        opcode09_EntityCallScriptEW( entity=0x04, script=04, priority=06 ) -- 0x01ca 0x09
        opcode26_Wait( time=5 ) -- 0x01cd 0x26
        -- 0x07( entity=0x04, script=0x25 ) -- 0x01d0 0x07
        opcodeFE0D_SetAvatar( character_id=26 ) -- 0x01d3 0xfe
        -- 0xD0() -- 0x01d7 0xd0
        opcodeD4_MessageShowE( entity=(entity)0x04, dialog_id=0x0009, ???=0x10 ) -- 0x01e2 0xd4
        -- 0x07( entity=0x05, script=0x24 ) -- 0x01e8 0x07
        opcodeFE0D_SetAvatar( character_id=28 ) -- 0x01eb 0xfe
        opcodeD4_MessageShowE( entity=(entity)0x05, dialog_id=0x000a, ???=0x20 ) -- 0x01ef 0xd4
        opcodeFE0D_SetAvatar( character_id=83 ) -- 0x01f5 0xfe
        -- 0xD0() -- 0x01f9 0xd0
        opcodeF5_MessageShow3( dialog_id=0x000b, flag=0x15 ) -- 0x0204 0xf5
        -- 0x9C() -- 0x0208 0x9c
        opcodeFE0D_SetAvatar( character_id=50 ) -- 0x0209 0xfe
        -- 0xD0() -- 0x020d 0xd0
        opcodeF5_MessageShow3( dialog_id=0x000c, flag=0x15 ) -- 0x0218 0xf5
        -- 0x9C() -- 0x021c 0x9c
        opcodeFE0D_SetAvatar( character_id=55 ) -- 0x021d 0xfe
        -- 0xD0() -- 0x0221 0xd0
        opcodeF5_MessageShow3( dialog_id=0x000d, flag=0x19 ) -- 0x022c 0xf5
        -- 0x9C() -- 0x0230 0x9c
        opcodeFE0D_SetAvatar( character_id=82 ) -- 0x0231 0xfe
        -- 0xD0() -- 0x0235 0xd0
        opcodeF5_MessageShow3( dialog_id=0x000e, flag=0x29 ) -- 0x0240 0xf5
        -- 0x9C() -- 0x0244 0x9c
