...
Entity[ "0x00" ] = {
    ...
    on_update = function( self )
        ...
        opcode08_EntityCallScriptSW( entity=0x1f, script=04, priority=01 ) -- 0x0046 0x08
        opcode08_EntityCallScriptSW( entity=0x06, script=04, priority=01 ) -- 0x0049 0x08
        opcode09_EntityCallScriptEW( entity=0x01, script=0a, priority=01 ) -- 0x004c 0x09
        -- MISSING OPCODE 0xb5
    end,
...
Entity[ "0x05" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=78 ) -- 0x0250 0xfe
        -- 0x01_JumpTo( 0x025b ) -- 0x0254 0x01
        opcodeFE0D_SetAvatar( character_id=46 ) -- 0x0257 0xfe
        -- 0xD0() -- 0x025b 0xd0
...
Entity[ "0x06" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=78 ) -- 0x03bc 0xfe
        -- 0x01_JumpTo( 0x03c7 ) -- 0x03c0 0x01
        opcodeFE0D_SetAvatar( character_id=46 ) -- 0x03c3 0xfe
        -- 0xD0() -- 0x03c7 0xd0
...
Entity[ "0x08" ] = {
    ...
    script_0x04 = function( self )
        opcode08_EntityCallScriptSW( entity=0x14, script=04, priority=01 ) -- 0x0563 0x08
        -- MISSING OPCODE 0x4a
    end,
    ...
    script_0x08 = function( self )
        opcode08_EntityCallScriptSW( entity=0x01, script=0c, priority=01 ) -- 0x05a5 0x08
        opcode08_EntityCallScriptSW( entity=0x09, script=09, priority=01 ) -- 0x05a8 0x08
        -- MISSING OPCODE 0x4a
    end,
...
Entity[ "0x15" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x0886 0xfe
...
Entity[ "0x16" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x0891 0xfe
...
Entity[ "0x17" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x089c 0xfe
...
Entity[ "0x18" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x08a7 0xfe
...
Entity[ "0x19" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x08b2 0xfe
...
Entity[ "0x1a" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x08bd 0xfe
...
Entity[ "0x1b" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x08c8 0xfe
...
Entity[ "0x1c" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x08d3 0xfe
...
Entity[ "0x1d" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x08de 0xfe
...
Entity[ "0x1e" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=10 ) -- 0x08e9 0xfe
...
Entity[ "0x20" ] = {
    ...
    script_0x05 = function( self )
        opcode09_EntityCallScriptEW( entity=0x01, script=11, priority=01 ) -- 0x09c4 0x09
        -- MISSING OPCODE 0xfc
    end,
