...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x0035 0xfe
...
Entity[ "0x06" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 4 ) -- 0x0053 0x16
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x0056 0xfe
...
Entity[ "0x0c" ] = {
    ...
    on_talk = function( self )
        ...
        -- 0x98_MapLoad( field_id=695, value=6 ) -- 0x00a9 0x98
...
Entity[ "0x0d" ] = {
    ...
    on_talk = function( self )
        ...
        -- 0x98_MapLoad( field_id=701, value=0 ) -- 0x00c4 0x98
