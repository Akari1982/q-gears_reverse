...
0x0347    op0D_Return()
0x0348    -- 0xFE69( actor_id=Actor_0x38, render_settings=(s)mem[0x3e04], rot_x=mem[0x3500], rot_y=(s)mem[0x43a] )
...
0x05c7    -- 0x5A()
0x05c8    op0D_Return()
0x05c9    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0038, ???=(vf40)0x4200, flag=0x6e )
0x05d0    op74_SoundPlayFixedVolume( sound_id=(s)mem[0x305e] )
0x05d3    -- MISSING OPCODE 0x78
