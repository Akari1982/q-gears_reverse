...
0x011c    -- 0xA3()
0x0124    opAC_MoveCamera( control=0x0, steps=mem[0x40a] )
0x0128    opAC_MoveCamera( control=0x1, steps=mem[0x40a] )
0x012c    opEF_MoveCameraSync()
0x012f    -- 0x65( ???=mem[0x424], ???=mem[0x428], ???=mem[0x426] ) -- exp0x1
0x0137    mem[0x41e] += 1 -- op3c
0x013a    mem[0x410] += mem[0x412] -- op38
...
0x015e    op02_JumpToConditional( val1=(s)mem[0x41e], val2=mem[0x414], condition="val1 < val2", address_if_false=0x1a8 )
0x0166    -- 0xEC( ???=0x1, ???=(vf80)0x040c, ???=(vf40)0x040e, ???=(vf20)0x0410, flag=0x0, ???=0x424, ???=0x428, ???=0x426 )
0x0175    -- 0xA3()
0x017d    opAC_MoveCamera( control=0x0, steps=mem[0x40a] )
0x0181    opAC_MoveCamera( control=0x1, steps=mem[0x40a] )
0x0185    opEF_MoveCameraSync()
0x0188    -- 0x65( ???=mem[0x424], ???=mem[0x428], ???=mem[0x426] ) -- exp0x1
0x0190    mem[0x41e] += 1 -- op3c
0x0193    mem[0x40e] += mem[0x416] -- op38
0x0199    mem[0x410] += mem[0x412] -- op38
...
0x01fa    -- 0x63( ???=mem[0x418], ???=mem[0x41a], ???=(s)mem[0x41c] ) -- exp0x1
...
0x0231    -- 0x63( ???=mem[0x418], ???=mem[0x41a], ???=(s)mem[0x41c] ) -- exp0x1
...
0x0283    -- 0xA3()
0x028b    opAC_MoveCamera( control=0x0, steps=mem[0x40a] )
0x028f    opAC_MoveCamera( control=0x1, steps=mem[0x40a] )
0x0293    opEF_MoveCameraSync()
0x0296    -- 0x65( ???=mem[0x424], ???=mem[0x428], ???=mem[0x426] ) -- exp0x1
...
0x02c8    op0D_Return()
0x02c9    opAC_MoveCamera( control=0x0, steps=mem[0x40a] )
0x02cd    opAC_MoveCamera( control=0x1, steps=mem[0x40a] )
0x02d1    opEF_MoveCameraSync()
0x02d4    op0D_Return()
0x02d5    opAC_MoveCamera( control=0x80, steps=mem[0x40a] )
0x02d9    opAC_MoveCamera( control=0x81, steps=mem[0x40a] )
...
0x0347    op0D_Return()
0x0348    -- 0xFE69( actor_id=Actor_0x38, render_settings=(s)mem[0x3e04], rot_x=mem[0x3500], rot_y=mem[0x43a] )
0x0351    op01_JumpTo( address=0x4000 )
0x0354    op02_JumpToConditional( val1=(s)mem[0x3e], val2=0, condition="val1 == val2", address_if_false=0x389 )
0x035c    op02_JumpToConditional( val1=mem[0x438], val2=51, condition="val1 < val2", address_if_false=0x36a )
0x0364    mem[0x43a] = 0 -- op35
0x036a    op02_JumpToConditional( val1=mem[0x438], val2=101, condition="val1 > val2", address_if_false=0x378 )
0x0372    mem[0x43a] = 2 -- op35
0x0378    op02_JumpToConditional( val1=mem[0x438], val2=156, condition="val1 > val2", address_if_false=0x386 )
...
0x0391    op02_JumpToConditional( val1=mem[0x438], val2=32, condition="val1 < val2", address_if_false=0x39f )
0x0399    mem[0x43a] = 0 -- op35
0x039f    op02_JumpToConditional( val1=mem[0x438], val2=62, condition="val1 > val2", address_if_false=0x3ad )
0x03a7    mem[0x43a] = 2 -- op35
0x03ad    op02_JumpToConditional( val1=mem[0x438], val2=142, condition="val1 > val2", address_if_false=0x3bb )
...
0x03c6    op02_JumpToConditional( val1=mem[0x438], val2=42, condition="val1 < val2", address_if_false=0x3d4 )
0x03ce    mem[0x43a] = 0 -- op35
0x03d4    op02_JumpToConditional( val1=mem[0x438], val2=102, condition="val1 > val2", address_if_false=0x3e2 )
0x03dc    mem[0x43a] = 2 -- op35
0x03e2    op02_JumpToConditional( val1=mem[0x438], val2=142, condition="val1 > val2", address_if_false=0x3f0 )
...
0x03fb    op02_JumpToConditional( val1=mem[0x438], val2=44, condition="val1 < val2", address_if_false=0x409 )
0x0403    mem[0x43a] = 0 -- op35
0x0409    op02_JumpToConditional( val1=mem[0x438], val2=104, condition="val1 > val2", address_if_false=0x417 )
0x0411    mem[0x43a] = 2 -- op35
0x0417    op02_JumpToConditional( val1=mem[0x438], val2=154, condition="val1 > val2", address_if_false=0x425 )
...
0x0430    op02_JumpToConditional( val1=mem[0x438], val2=63, condition="val1 < val2", address_if_false=0x43e )
0x0438    mem[0x43a] = 0 -- op35
0x043e    op02_JumpToConditional( val1=mem[0x438], val2=153, condition="val1 > val2", address_if_false=0x44c )
0x0446    mem[0x43a] = 2 -- op35
0x044c    op02_JumpToConditional( val1=mem[0x438], val2=193, condition="val1 > val2", address_if_false=0x45a )
...
0x0465    op02_JumpToConditional( val1=mem[0x438], val2=34, condition="val1 < val2", address_if_false=0x473 )
0x046d    mem[0x43a] = 0 -- op35
0x0473    op02_JumpToConditional( val1=mem[0x438], val2=94, condition="val1 > val2", address_if_false=0x481 )
0x047b    mem[0x43a] = 2 -- op35
0x0481    op02_JumpToConditional( val1=mem[0x438], val2=174, condition="val1 > val2", address_if_false=0x48f )
...
0x049a    op02_JumpToConditional( val1=mem[0x438], val2=12, condition="val1 < val2", address_if_false=0x4a8 )
0x04a2    mem[0x43a] = 0 -- op35
0x04a8    op02_JumpToConditional( val1=mem[0x438], val2=82, condition="val1 > val2", address_if_false=0x4b6 )
0x04b0    mem[0x43a] = 2 -- op35
0x04b6    op02_JumpToConditional( val1=mem[0x438], val2=182, condition="val1 > val2", address_if_false=0x4c4 )
...
0x04cf    op02_JumpToConditional( val1=mem[0x438], val2=28, condition="val1 < val2", address_if_false=0x4dd )
0x04d7    mem[0x43a] = 0 -- op35
0x04dd    op02_JumpToConditional( val1=mem[0x438], val2=83, condition="val1 > val2", address_if_false=0x4eb )
0x04e5    mem[0x43a] = 2 -- op35
0x04eb    op02_JumpToConditional( val1=mem[0x438], val2=153, condition="val1 > val2", address_if_false=0x4f9 )
...
0x0504    op02_JumpToConditional( val1=mem[0x438], val2=46, condition="val1 < val2", address_if_false=0x512 )
0x050c    mem[0x43a] = 0 -- op35
0x0512    op02_JumpToConditional( val1=mem[0x438], val2=136, condition="val1 > val2", address_if_false=0x520 )
0x051a    mem[0x43a] = 2 -- op35
0x0520    op02_JumpToConditional( val1=mem[0x438], val2=186, condition="val1 > val2", address_if_false=0x52e )
...
0x0539    op02_JumpToConditional( val1=mem[0x438], val2=18, condition="val1 < val2", address_if_false=0x547 )
0x0541    mem[0x43a] = 0 -- op35
0x0547    op02_JumpToConditional( val1=mem[0x438], val2=68, condition="val1 > val2", address_if_false=0x555 )
0x054f    mem[0x43a] = 2 -- op35
0x0555    op02_JumpToConditional( val1=mem[0x438], val2=148, condition="val1 > val2", address_if_false=0x563 )
0x055d    mem[0x43a] = 3 -- op35
0x0563    op01_JumpTo( address=0x566 )
0x0566    op02_JumpToConditional( val1=mem[0x43a], val2=0, condition="val1 == val2", address_if_false=0x579 )
0x056e    -- opFE08( scale_x=3000, scale_y=4096, scale_z=3500 )
0x0576    op01_JumpTo( address=0x5b2 )
0x0579    op02_JumpToConditional( val1=mem[0x43a], val2=1, condition="val1 == val2", address_if_false=0x58c )
0x0581    -- opFE08( scale_x=4096, scale_y=4096, scale_z=3500 )
0x0589    op01_JumpTo( address=0x5b2 )
0x058c    op02_JumpToConditional( val1=mem[0x43a], val2=2, condition="val1 == val2", address_if_false=0x59f )
0x0594    -- opFE08( scale_x=6096, scale_y=4096, scale_z=3500 )
0x059c    op01_JumpTo( address=0x5b2 )
0x059f    op02_JumpToConditional( val1=mem[0x43a], val2=3, condition="val1 == val2", address_if_false=0x5b2 )
...
0x05c7    -- 0x5A()
0x05c8    op0D_Return()
0x05c9    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0038, ???=(vf40)0x2800, flag=0xf0 )
0x05d0    -- MISSING OPCODE 0x91
