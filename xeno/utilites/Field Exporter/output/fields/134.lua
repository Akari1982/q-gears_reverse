...
Entity[ "1" ] = {
    ...
    on_update = function( self )
        ...
        -- 0x09_EntityCallScriptEW( entity=0x05, script=0x08 ) -- 0x0044 0x09
        -- 0x75() -- 0x0047 0x75
        -- 0x07( entity=0x1e, script=0x04 ) -- 0x004a 0x07
        -- 0x09_EntityCallScriptEW( entity=0x1f, script=0x04 ) -- 0x004d 0x09
...
Entity[ "3" ] = {
    ...
    script_0x06 = function( self )
        -- 0x09_EntityCallScriptEW( entity=0x08, script=0x05 ) -- 0x04a7 0x09
...
Entity[ "5" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=3 ) -- 0x0941 0xfe
    ...
    script_0x07 = function( self )
        -- 0xFE0D_SetAvatar( character_id=3 ) -- 0x0995 0xfe
        opcodeD2_DialogShow0( dialog_id=0x0001, ???=0x00 ) -- 0x0999 0xd2
        -- 0x9C() -- 0x099d 0x9c
        -- MISSING OPCODE 0xFE1c
    end,

    script_0x08 = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0002, ???=0x00 ) -- 0x09ab 0xd2
        -- 0x9C() -- 0x09af 0x9c
...
Entity[ "6" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=2 ) -- 0x0a88 0xfe
...
Entity[ "8" ] = {
    ...
    script_0x04 = function( self )
        -- 0x75() -- 0x0b98 0x75
        -- 0xFE0D_SetAvatar( character_id=19 ) -- 0x0b9b 0xfe
        opcodeD2_DialogShow0( dialog_id=0x0011, ???=0x01 ) -- 0x0b9f 0xd2
        -- 0x9C() -- 0x0ba3 0x9c
        -- 0x35() -- 0x0ba4 0x35
        -- 0xFE0D_SetAvatar( character_id=3 ) -- 0x0baa 0xfe
        -- MISSING OPCODE 0xd4
    end,

    script_0x05 = function( self )
        -- 0xFE0D_SetAvatar( character_id=19 ) -- 0x0bcb 0xfe
        opcodeD2_DialogShow0( dialog_id=0x0014, ???=0x01 ) -- 0x0bcf 0xd2
        -- 0x9C() -- 0x0bd3 0x9c
    ...
    script_0x06 = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=64 ) -- 0x0bde 0xfe
        -- MISSING OPCODE 0xd4
    end,

    script_0x07 = function( self )
        -- 0xFE0D_SetAvatar( character_id=3 ) -- 0x0c13 0xfe
        -- MISSING OPCODE 0xfc
    end,
