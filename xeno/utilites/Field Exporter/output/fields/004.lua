...
0x14a2    -- 0x65( ???=mem[0x424], ???=(s)mem[0x428], ???=mem[0x426] ) -- exp0x1
...
0x14fb    -- 0x65( ???=mem[0x424], ???=(s)mem[0x428], ???=mem[0x426] ) -- exp0x1
...
0x1609    -- 0x65( ???=mem[0x424], ???=(s)mem[0x428], ???=mem[0x426] ) -- exp0x1
...
0x16be    op0D_Return()
0x16bf    -- 0xFE69( actor_id=Actor_0x38, render_settings=mem[0x3e04], rot_x=mem[0x3500], rot_y=(s)mem[0x43a] )
...
0x193f    op0D_Return()
0x1940    op00_Return()
0x1941    op01_JumpTo( address=0x256 )
0x1944    -- MISSING OPCODE 0x30
