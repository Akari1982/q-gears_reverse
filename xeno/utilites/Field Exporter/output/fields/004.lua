...
Actor_0x0d:on_start:
    ...
    -- opFE08( scale_x=3000, scale_y=4096, scale_z=3500 ) -- 0x18e5 0xfe
    -- 0x01_JumpTo( 0x1929 ) -- 0x18ed 0x01
    -- 0x02_ConditionalJumpTo( value1=GetVar( 0x043a ), value2=(s16)0x0001, condition="value1 == value2", jump_if_false=0x1903 ) -- 0x18f0 0x02
    -- opFE08( scale_x=4096, scale_y=4096, scale_z=3500 ) -- 0x18f8 0xfe
    -- 0x01_JumpTo( 0x1929 ) -- 0x1900 0x01
    -- 0x02_ConditionalJumpTo( value1=GetVar( 0x043a ), value2=(s16)0x0002, condition="value1 == value2", jump_if_false=0x1916 ) -- 0x1903 0x02
    -- opFE08( scale_x=6096, scale_y=4096, scale_z=3500 ) -- 0x190b 0xfe
    -- 0x01_JumpTo( 0x1929 ) -- 0x1913 0x01
    -- 0x02_ConditionalJumpTo( value1=GetVar( 0x043a ), value2=(s16)0x0003, condition="value1 == value2", jump_if_false=0x1929 ) -- 0x1916 0x02
    -- opFE08( scale_x=12288, scale_y=4096, scale_z=3500 ) -- 0x191e 0xfe
    -- 0x01_JumpTo( 0x1929 ) -- 0x1926 0x01
    op0D_FunctionRet() -- 0x1929 0x0d
    -- 0xFE19( char_id=0xff ) -- 0x192a 0xfe
    -- 0xFE19( char_id=0xfe ) -- 0x192d 0xfe
    -- 0xFEC6( char_id=GetVar( 0x02d0 ) ) -- 0x1930 0xfe
    -- 0xFE1A() sync load for 0xFEC6() -- 0x1934 0xfe
    -- 0xFEC6( char_id=GetVar( 0x02d2 ) ) -- 0x1936 0xfe
    -- 0xFE1A() sync load for 0xFEC6() -- 0x193a 0xfe
    -- 0xBB( ???=0x07 ) -- 0x193c 0xbb
    -- 0x5A() -- 0x193e 0x5a
    op0D_FunctionRet() -- 0x193f 0x0d
    return 0 -- 0x1940 0x00
    op36_VariableSetTrue( address=0x003a ) -- 0x1941 0x36
    -- MISSING OPCODE 0x11
