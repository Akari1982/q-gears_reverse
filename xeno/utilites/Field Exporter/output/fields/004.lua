...
0x0037    opA3()
0x003f    op05_FunctionCall( 0x1444 )
0x0042    op26_Wait( time=60 )
0x0045    op08_ActorCallScriptSW( actor_id=0x0c, script=05, priority=03 )
0x0048    op26_Wait( time=240 )
0x004b    op05_FunctionCall( 0x1659 )
0x004e    -- 0xB4_FadeIn()
0x0051    op26_Wait( time=80 )
0x0054    op09_ActorCallScriptEW( actor_id=0x0c, script=04, priority=03 )
0x0057    -- 0xB3()
0x005a    op08_ActorCallScriptSW( actor_id=0x0c, script=06, priority=03 )
0x005d    op26_Wait( time=200 )
0x0060    op05_FunctionCall( 0x1659 )
0x0063    -- 0xB4_FadeIn()
0x0066    op26_Wait( time=80 )
0x0069    op09_ActorCallScriptEW( actor_id=0x0c, script=04, priority=03 )
0x006c    -- 0xB3()
0x006f    op08_ActorCallScriptSW( actor_id=0x0c, script=07, priority=03 )
0x0072    op26_Wait( time=160 )
0x0075    op05_FunctionCall( 0x1659 )
0x0078    -- 0xB4_FadeIn()
0x007b    op26_Wait( time=80 )
0x007e    op09_ActorCallScriptEW( actor_id=0x0c, script=04, priority=03 )
0x0081    -- 0xB3()
0x0084    op08_ActorCallScriptSW( actor_id=0x0c, script=08, priority=03 )
0x0087    op26_Wait( time=240 )
0x008a    op05_FunctionCall( 0x1659 )
0x008d    -- 0xB4_FadeIn()
0x0090    op26_Wait( time=80 )
0x0093    op09_ActorCallScriptEW( actor_id=0x0c, script=04, priority=03 )
0x0096    -- 0xB3()
0x0099    op08_ActorCallScriptSW( actor_id=0x0c, script=09, priority=03 )
0x009c    op26_Wait( time=160 )
0x009f    op05_FunctionCall( 0x1659 )
0x00a2    -- 0xB4_FadeIn()
0x00a5    op26_Wait( time=80 )
0x00a8    op09_ActorCallScriptEW( actor_id=0x0c, script=04, priority=03 )
0x00ab    -- 0xB3()
0x00ae    op08_ActorCallScriptSW( actor_id=0x01, script=04, priority=03 )
...
0x00d2    -- 0x07( actor_id=0x0b, script=0x24 )
...
0x00ee    op08_ActorCallScriptSW( actor_id=0x01, script=05, priority=03 )
0x00f1    op26_Wait( time=40 )
0x00f4    -- 0x07( actor_id=0x0b, script=0x25 )
...
0x011f    opA3()
0x0127    op05_FunctionCall( 0x1444 )
0x012a    op00_Return()
...
0x0139    opA3()
0x0141    op05_FunctionCall( 0x1444 )
...
0x0152    opA3()
0x015a    op05_FunctionCall( 0x1444 )
...
0x01d7    -- 0xC6()
0x01d8    -- 0x31_JumpIfButtonNotPressed( button_mask=0x0040, jump_to=0x01e3 )
0x01dd    opFE97_ParticleReset( all=0x00 )
0x01e0    op26_Wait( time=30 )
0x01e3    -- 0x5A()
0x01e4    -- 0x31_JumpIfButtonNotPressed( button_mask=0x0080, jump_to=0x0ae3 )
0x01e9    opFE97_ParticleReset( all=0x00 )
0x01ec    -- 0x5A()
0x01ed    opFE8F_ParticleSystemInit1( actor_id=(entity)self, render_settings=2, rot_x=0, rot_y=0 )
...
0x04e8    -- 0x5A()
0x04e9    opFE8F_ParticleSystemInit1( actor_id=(entity)self, render_settings=2, rot_x=0, rot_y=0 )
...
0x07e4    -- 0x5A()
0x07e5    opFE8F_ParticleSystemInit1( actor_id=(entity)self, render_settings=2, rot_x=0, rot_y=0 )
...
0x0ae5    -- 0xC6()
0x0ae6    opFE8F_ParticleSystemInit1( actor_id=(entity)self, render_settings=2, rot_x=0, rot_y=0 )
...
0x0de1    -- 0x5A()
0x0de2    -- 0xC6()
0x0de3    opFE8F_ParticleSystemInit1( actor_id=(entity)self, render_settings=2, rot_x=0, rot_y=0 )
...
0x10de    -- 0x5A()
0x10df    -- 0xC6()
0x10e0    opFE8F_ParticleSystemInit1( actor_id=(entity)self, render_settings=2, rot_x=0, rot_y=0 )
...
0x1535    op05_FunctionCall( 0x161e )
...
0x15d3    op05_FunctionCall( 0x161e )
...
function:
0x1659    -- 0x31_JumpIfButtonNotPressed( button_mask=0x0020, jump_to=0x1661 )
...
0x16bf    -- 0xFE69( actor_id=(entity)0x38, render_settings=GetVar( 0x3e04 ), rot_x=GetVar( 0x3500 ), rot_y=GetVar( 0x043a ) )
...
0x1942    op00_Return()
0x1943    op00_Return()
0x1944    opD2_MessageShowDynamic( text_id=0xdda6, flags=FORCE_LEFT|FORCE_RIGHT|FORCE_BOTTOM|NO_WINDOW )
0x1948    -- MISSING OPCODE 0x58
