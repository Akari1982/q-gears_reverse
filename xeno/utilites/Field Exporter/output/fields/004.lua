...
0x156d    -- 0x63( ???=mem[0x418], ???=mem[0x41a], ???=mem[0x41c] ) -- exp0x1
...
0x15a4    -- 0x63( ???=mem[0x418], ???=mem[0x41a], ???=mem[0x41c] ) -- exp0x1
...
0x1930    -- 0xFEC6( char_id=mem[0x2d0] )
0x1934    -- 0xFE1A() sync load for 0xFEC6()
0x1936    -- 0xFEC6( char_id=mem[0x2d2] )
...
0x1944    -- 0x5F( ???=0x88 )
0x1946    -- 0x9F()
0x1947    op31_JumpIfButtonNotPressed( buttons=L2|R2|L1|Circle|Select|R3|Start|Up|Right, jump_to=0xc00 )
0x194c    -- 0xF0( ???=0x9d07, ???=0x12, ???=0x0 )
