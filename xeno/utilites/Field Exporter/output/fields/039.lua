...
0x0019    -- 0x07( actor_id=0x0c, script=0xc4 )
0x001c    -- 0x5B()
0x001d    op00_Return()
...
0x00a4    -- 0x60()
0x00a5    -- 0x64()
0x00a6    -- 0x63( ???=(vf80)0x009e, ???=(vf40)0xfd70, ???=(vf20)0xfcf1, flag=0xe0 )
0x00ae    opA3()
0x00b6    opAC_MoveCamera( control=0x00, steps=0 )
0x00ba    opAC_MoveCamera( control=0x01, steps=0 )
0x00be    opEF_MoveCameraSync()
0x00c1    op26_Wait( time=115 )
0x00c4    -- 0x60()
0x00c5    -- 0x64()
0x00c6    -- 0x63( ???=(vf80)0xffd6, ???=(vf40)0xf947, ???=(vf20)0xfcbe, flag=0xe0 )
0x00ce    opA3()
0x00d6    opAC_MoveCamera( control=0x00, steps=100 )
0x00da    opAC_MoveCamera( control=0x01, steps=100 )
...
0x00fe    opD2_MessageShowDynamic( text_id=0x0000, flags=0 )
0x0102    op9C_MessageSync()
0x0103    op26_Wait( time=10 )
0x0106    -- 0x07( actor_id=0x0e, script=0xc4 )
0x0109    -- 0x07( actor_id=0x0f, script=0xc4 )
0x010c    opD0_MessageSettings( x=0, y=0, letters=0, rows=0, flags=421 )
0x0117    opFE0D_MessageSetFace( char_id=2 )
0x011b    opD2_MessageShowDynamic( text_id=0x0001, flags=0 )
0x011f    op9C_MessageSync()
0x0120    op26_Wait( time=30 )
0x0123    opD2_MessageShowDynamic( text_id=0x0002, flags=0 )
0x0127    op9C_MessageSync()
0x0128    -- 0x07( actor_id=0x0c, script=0xc5 )
