...
Actor[ "0x05" ] = {
    on_start = function( self )
        ...
        -- 0x2A() -- 0x0128 0x2a
        opcodeFE0D_MessageSetFace( char_id=0 ) -- 0x0129 0xfe
        -- MISSING OPCODE 0xFE1c
    end,
...
Actor[ "0x06" ] = {
    on_start = function( self )
        ...
        -- 0x93( ???=0 ) -- 0x0144 0x93
        opcodeFE0D_MessageSetFace( char_id=0 ) -- 0x0147 0xfe
        -- MISSING OPCODE 0xFE1c
    end,
    ...
    script_0x05 = function( self )
        -- 0x21( ???=64 ) -- 0x0188 0x21
        -- 0x05_CallFunction( 0x01b7 ) -- 0x018b 0x05
        opcode2C_SpritePlayAnim( anim_id=0x1c ) -- 0x018e 0x2c
        -- MISSING OPCODE 0xFE1c
    end,
...
Actor[ "0x08" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=3 ) -- 0x0622 0xfe
        -- MISSING OPCODE 0xFE1c
    end,
...
Actor[ "0x09" ] = {
    ...
    on_update = function( self )
        -- 0x5A() -- 0x064a 0x5a
        -- 0xFE3C( ???=2, ???=4 ) -- 0x064b 0xfe
        -- 0x5A() -- 0x0651 0x5a
        opcode2C_SpritePlayAnim( anim_id=0x11 ) -- 0x0652 0x2c
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x0a" ] = {
    on_start = function( self )
        -- 0x93( ???=40 ) -- 0x0658 0x93
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0002 ), value2=(s16)0x0000, condition="value1 == value2", jump_if_false=0x066f ) -- 0x065b 0x02
        -- MISSING OPCODE 0xFE1c
    end,
    ...
    script_0x04 = function( self )
        -- 0xFE8F_ParticleSystemInit1( actor_id=(entity)self, render_settings=1, rot_x=0, rot_y=40 ) -- 0x0697 0xfe
    ...
    script_0x05 = function( self )
        -- 0x47( ???=1023 ) -- 0x08a7 0xfe
        -- MISSING OPCODE 0x5f
    end,

    script_0x06 = function( self )
        -- 0x47( ???=32 ) -- 0x08b7 0xfe
        opcode2C_SpritePlayAnim( anim_id=0x12 ) -- 0x08bb 0x2c
        -- 0x21( ???=32 ) -- 0x08bd 0x21
        -- MISSING OPCODE 0x10
    end,

    script_0x07 = function( self )
        opcode2C_SpritePlayAnim( anim_id=0x13 ) -- 0x08cc 0x2c
        -- 0x21( ???=1024 ) -- 0x08ce 0x21
        -- MISSING OPCODE 0x10
    end,
...
Actor[ "0x0b" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x08dd 0xbc
        -- 0x2A() -- 0x08de 0x2a
        -- 0x23() -- 0x08df 0x23
...
Actor[ "0x0d" ] = {
    ...
    script_0x04 = function( self )
        -- 0x60() -- 0x0c3b 0x60
        -- 0x64() -- 0x0c3c 0x64
        -- 0x63( ???=(vf80)0xffd2, ???=(vf40)0x0143, ???=(vf20)0x006f, flag=0xe0 ) -- 0x0c3d 0x63
    ...
    script_0x06 = function( self )
        -- 0x60() -- 0x0c83 0x60
        -- 0x64() -- 0x0c84 0x64
        -- 0x63( ???=(vf80)0x002e, ???=(vf40)0x0143, ???=(vf20)0x006f, flag=0xe0 ) -- 0x0c85 0x63
    ...
    script_0x0b = function( self )
        -- 0x60() -- 0x0db2 0x60
        -- 0x64() -- 0x0db3 0x64
        -- 0x63( ???=(vf80)0xf7d9, ???=(vf40)0x0052, ???=(vf20)0xfecb, flag=0xe0 ) -- 0x0db4 0x63
    ...
    script_0x0c = function( self )
        -- 0x60() -- 0x0dcd 0x60
        -- 0x64() -- 0x0dce 0x64
        -- 0x63( ???=(vf80)0xf95c, ???=(vf40)0x007e, ???=(vf20)0xfeca, flag=0xe0 ) -- 0x0dcf 0x63
