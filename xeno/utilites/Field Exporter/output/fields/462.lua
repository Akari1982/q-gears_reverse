...
Entity[ "12" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xffbb, z=(vf40)0x00ab, flag=(flag)0xc0 ) -- 0x0090 0x19
        -- MISSING OPCODE 0x69
    end,
...
Entity[ "13" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x001c, z=(vf40)0x0055, flag=(flag)0xc0 ) -- 0x00b5 0x19
        -- MISSING OPCODE 0x69
    end,
