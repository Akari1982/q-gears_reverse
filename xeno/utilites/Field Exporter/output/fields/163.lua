...
Actor[ "0x0b" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xfa38, z=(vf40)0x0000, flag=(flag)0xc0 ) -- 0x008d 0x19
        -- MISSING OPCODE 0xf8
    end,
    ...
    on_talk = function( self )
        -- 0x07( actor_id=0x0d, script=0x04 ) -- 0x00a4 0x07
...
Actor[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0359, z=(vf40)0x0000, flag=(flag)0xc0 ) -- 0x00a9 0x19
        -- MISSING OPCODE 0xf8
    end,
    ...
    on_talk = function( self )
        -- 0x15() -- 0x00c0 0x15
        -- 0x07( actor_id=0x0e, script=0x05 ) -- 0x00c1 0x07
...
Actor[ "0x0e" ] = {
    ...
    script_0x04 = function( self )
        opcode35_VariableSet( address=0x0400, value=(vf40)0x0014, flag=0x40 ) -- 0x00dc 0x35
