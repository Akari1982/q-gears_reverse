...
Actor[ "0x00" ] = {
    ...
    on_update = function( self )
        ...
        opcode35_VariableSet( address=0x0400, value=(vf40)0x0001, flag=0x40 ) -- 0x0050 0x35
        ...
        opcode35_VariableSet( address=0x0400, value=(vf40)0x0002, flag=0x40 ) -- 0x0061 0x35
        -- 0x5B() -- 0x0067 0x5b
...
Actor[ "0x0d" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0032, z=(vf40)0x0000, flag=(flag)0xc0 ) -- 0x01bf 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Actor[ "0x0e" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0000, z=(vf40)0x003c, flag=(flag)0xc0 ) -- 0x01da 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Actor[ "0x0f" ] = {
    ...
    script_0x04 = function( self )
        opcode37_VariableSetFalse( address=0x0408 ) -- 0x0233 0x37
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0408 ), value2=(s16)0x000e, condition="value1 < value2", jump_if_false=0x024e ) -- 0x0236 0x02
        -- 0xC6() -- 0x023e 0xc6
...
Actor[ "0x10" ] = {
    ...
    script_0x04 = function( self )
        opcode37_VariableSetFalse( address=0x040a ) -- 0x0254 0x37
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x040a ), value2=(s16)0x000e, condition="value1 < value2", jump_if_false=0x026f ) -- 0x0257 0x02
        -- 0xC6() -- 0x025f 0xc6
        -- MISSING OPCODE 0xFE1b
    end,
