...
Actor[ "0x01" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=0 ) -- 0x0025 0x16
        opcodeFE0D_MessageSetFace( char_id=0 ) -- 0x0028 0xfe
        -- 0x23() -- 0x002c 0x23
...
Actor[ "0x02" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=9 ) -- 0x003e 0x16
        opcodeFE0D_MessageSetFace( char_id=9 ) -- 0x0041 0xfe
        -- 0x23() -- 0x0045 0x23
...
Actor[ "0x04" ] = {
    on_start = function( self )
        ...
        -- 0x2A() -- 0x0071 0x2a
        opcode35_VariableSet( address=0x0408, value=(vf40)0x0001, flag=0x40 ) -- 0x0072 0x35
        opcode35_VariableSet( address=0x0054, value=(vf40)0x0002, flag=0x40 ) -- 0x0078 0x35
    ...
    on_update = function( self )
        ...
        opcodeF1_FadeSetUp( steps=2, r=255, g=255, b=255, semi_tr=1 ) -- 0x0089 0xf1
