...
Entity[ "0x00" ] = {
    ...
    on_update = function( self )
        opcode09_EntityCallScriptEW( entity=0x0b, script=05, priority=02 ) -- 0x001b 0x09
        -- 0x84_ProgressLessEqualJumpTo( value=8, jump=0x004c ) -- 0x001e 0x84
        opcode26_Wait( time=10 ) -- 0x0023 0x26
        opcode08_EntityCallScriptSW( entity=0x0a, script=04, priority=05 ) -- 0x0026 0x08
        opcode08_EntityCallScriptSW( entity=0x01, script=04, priority=05 ) -- 0x0029 0x08
        opcode26_Wait( time=84 ) -- 0x002c 0x26
        opcode09_EntityCallScriptEW( entity=0x01, script=05, priority=05 ) -- 0x002f 0x09
        opcode08_EntityCallScriptSW( entity=0x0a, script=05, priority=05 ) -- 0x0032 0x08
        opcode09_EntityCallScriptEW( entity=0x09, script=04, priority=05 ) -- 0x0035 0x09
        -- 0x87_SetProgress( progress=8 ) -- 0x0038 0x87
        opcode08_EntityCallScriptSW( entity=0x0a, script=08, priority=05 ) -- 0x003b 0x08
...
Entity[ "0x01" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x0061 0xfe
    ...
    script_0x05 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0000, ???=0x00 ) -- 0x0087 0xd2
        -- 0x9C() -- 0x008b 0x9c
    ...
    script_0x0a = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0003, ???=0x00 ) -- 0x00b5 0xd2
        -- 0x9C() -- 0x00b9 0x9c
    ...
    script_0x0d = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0007, ???=0x00 ) -- 0x00e5 0xd2
        -- 0x9C() -- 0x00e9 0x9c
        return 0 -- 0x00ea 0x00
    end,

    script_0x0e = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0008, ???=0x00 ) -- 0x00eb 0xd2
        -- 0x9C() -- 0x00ef 0x9c
    ...
    script_0x13 = function( self )
        -- 0xD0() -- 0x011a 0xd0
        opcodeD2_MessageShow0( dialog_id=0x000c, ???=0x20 ) -- 0x0125 0xd2
        -- 0x9C() -- 0x0129 0x9c
    ...
    script_0x15 = function( self )
        ...
        opcodeD2_MessageShow0( dialog_id=0x000e, ???=0x20 ) -- 0x0140 0xd2
        -- 0x9C() -- 0x0144 0x9c
...
Entity[ "0x02" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x015a 0xfe
...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x0165 0xfe
...
Entity[ "0x04" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x0170 0xfe
...
Entity[ "0x06" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x0186 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=20 ) -- 0x01a7 0xfe
