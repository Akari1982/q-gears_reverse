...
0x0030    op6F_ActorRotateToActor( actor_id=(entity)0x0a )
0x0032    op00_Return()

Actor_0x01:script_0x05:
0x0033    op26_Wait( time=35 )
0x0036    op6F_ActorRotateToActor( actor_id=(entity)0x10 )
0x0038    op00_Return()

Actor_0x01:script_0x06:
0x0039    op6F_ActorRotateToActor( actor_id=(entity)0x0f )
0x003b    op00_Return()

Actor_0x01:script_0x07:
0x003c    op6F_ActorRotateToActor( actor_id=(entity)0x0f )
...
0x0056    opD2_MessageShowDynamic( text_id=0x0000, flags=0 )
0x005a    op9C_MessageSync()
0x005b    -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call )
0x0061    op6F_ActorRotateToActor( actor_id=(entity)0x0f )
0x0063    op00_Return()

Actor_0x01:script_0x08:
0x0064    op6F_ActorRotateToActor( actor_id=(entity)0x10 )
0x0066    opD2_MessageShowDynamic( text_id=0x0001, flags=0 )
0x006a    op9C_MessageSync()
0x006b    op00_Return()

Actor_0x01:script_0x09:
0x006c    opD2_MessageShowDynamic( text_id=0x0002, flags=0 )
0x0070    op9C_MessageSync()
0x0071    op6F_ActorRotateToActor( actor_id=(entity)0x0f )
0x0073    opD2_MessageShowDynamic( text_id=0x0003, flags=0 )
...
0x007f    op6F_ActorRotateToActor( actor_id=(entity)0x09 )
