...
Entity[ "0x01" ] = {
    ...
    script_0x09 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0002, ???=0x00 ) -- 0x006c 0xd2
        -- 0x9C() -- 0x0070 0x9c
        -- MISSING OPCODE 0x6f
    end,
...
Entity[ "0x02" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 2 ) -- 0x0085 0x16
...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x0093 0xfe
...
Entity[ "0x04" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 3 ) -- 0x009b 0x16
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x009e 0xfe
...
Entity[ "0x05" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 5 ) -- 0x00a6 0x16
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x00a9 0xfe
...
Entity[ "0x06" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 6 ) -- 0x00b1 0x16
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x00b4 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 7 ) -- 0x00bc 0x16
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x00bf 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 8 ) -- 0x00c7 0x16
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x00ca 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x00d2 0xbc
        -- MISSING OPCODE 0x1d
    end,
