...
Entity[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xff3f, z=(vf40)0xffe6, flag=(flag)0xc0 ) -- 0x0090 0x19
        -- MISSING OPCODE 0x69
    end,
...
Entity[ "0x0d" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x0241, z=(vf40)0x004e, flag=(flag)0xc0 ) -- 0x00ad 0x19
        -- MISSING OPCODE 0x69
    end,
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0001, ???=0x00 ) -- 0x00b9 0xd2
        -- 0x9C() -- 0x00bd 0x9c
...
Entity[ "0x0e" ] = {
    ...
    on_talk = function( self )
        ...
        opcode09_EntityCallScriptEW( entity=0x0f, script=04, priority=02 ) -- 0x00d6 0x09
