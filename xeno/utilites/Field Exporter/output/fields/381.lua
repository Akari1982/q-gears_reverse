...
Actor[ "0x00" ] = {
    ...
    on_update = function( self )
        ...
        -- 0xFE54() -- 0x005e 0xfe
        opcode74_SoundPlayFixedVolume( sound_id=37 ) -- 0x0060 0x74
        opcode26_Wait( time=32 ) -- 0x0063 0x26
        -- MISSING OPCODE 0xcf
    end,
...
Actor[ "0x05" ] = {
    on_start = function( self )
        ...
        opcode35_VariableSet( address=0x0406, value=(vf40)0x0000, flag=0x40 ) -- 0x011e 0x35
        opcode35_VariableSet( address=0x0408, value=(vf40)0x0099, flag=0x40 ) -- 0x0124 0x35
        -- 0x2A() -- 0x012a 0x2a
    ...
    on_update = function( self )
        ...
        -- 0xC6() -- 0x0134 0xc6
        -- 0xFE8F_ParticleSystemInit1( actor_id=(entity)self, render_settings=2, rot_x=0, rot_y=0 ) -- 0x0135 0xfe
    ...
    script_0x04 = function( self )
        -- 0xC6() -- 0x0355 0xc6
        -- 0xFE8F_ParticleSystemInit1( actor_id=(entity)self, render_settings=2, rot_x=0, rot_y=0 ) -- 0x0356 0xfe
