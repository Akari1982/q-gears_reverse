...
Entity[ "0x0b" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x017e, z=(vf40)0x0142, flag=(flag)0xc0 ) -- 0x007c 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Entity[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xffb3, z=(vf40)0xff2f, flag=(flag)0xc0 ) -- 0x00c4 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Entity[ "0x0d" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x00f7 0xbc
