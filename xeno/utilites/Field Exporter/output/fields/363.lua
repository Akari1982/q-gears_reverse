...
Entity[ "0x01" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x00bf 0xfe
...
Entity[ "0x02" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x00ca 0xfe
...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x00d5 0xfe
...
Entity[ "0x04" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x00e0 0xfe
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x00e4 0xfe
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0000, ???=0x01 ) -- 0x00ec 0xd2
        -- 0x9C() -- 0x00f0 0x9c
...
Entity[ "0x05" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x00f5 0xfe
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x00f9 0xfe
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0001, ???=0x01 ) -- 0x0101 0xd2
        -- 0x9C() -- 0x0105 0x9c
...
Entity[ "0x06" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x010a 0xfe
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0002, ???=0x01 ) -- 0x0116 0xd2
        -- 0x9C() -- 0x011a 0x9c
...
Entity[ "0x07" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x011f 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x0135 0xfe
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x0140 0xfe
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=10 ) -- 0x014b 0xfe
...
Entity[ "0x0d" ] = {
    ...
    on_talk = function( self )
        ...
        opcodeD2_MessageShow0( dialog_id=0x0003, ???=0x01 ) -- 0x01c8 0xd2
        -- 0x9C() -- 0x01cc 0x9c
