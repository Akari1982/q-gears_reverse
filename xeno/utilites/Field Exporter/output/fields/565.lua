...
Actor[ "0x01" ] = {
    ...
    script_0x0b = function( self )
        opcode2C_SpritePlayAnim( anim_id=0x07 ) -- 0x01fe 0x2c
        opcodeD2_MessageShowDynamic( text_id=0x0000, flags=0 ) -- 0x0200 0xd2
...
Actor[ "0x02" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=1 ) -- 0x0218 0x16
        opcodeFE0D_MessageSetFace( char_id=1 ) -- 0x021b 0xfe
...
Actor[ "0x03" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=2 ) -- 0x0223 0x16
        opcodeFE0D_MessageSetFace( char_id=2 ) -- 0x0226 0xfe
...
Actor[ "0x04" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x0251 0xbc
        -- 0x19_ActorSetPosition( x=(vf80)0xffc2, z=(vf40)0x003e, flag=(flag)0xc0 ) -- 0x0252 0x19
        -- MISSING OPCODE 0xf8
    end,
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x0267 0xfe
        opcode09_ActorCallScriptEW( actor_id=0x13, script=04, priority=01 ) -- 0x0269 0x09
        -- 0x07( actor_id=0x01, script=0x24 ) -- 0x026c 0x07
        opcode26_Wait( time=10 ) -- 0x026f 0x26
...
Actor[ "0x05" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x1329, z=(vf40)0xf1fa, flag=(flag)0xc0 ) -- 0x027b 0x19
        -- MISSING OPCODE 0xf8
    end,
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x0290 0xfe
        opcode09_ActorCallScriptEW( actor_id=0x10, script=04, priority=01 ) -- 0x0292 0x09
        -- 0x07( actor_id=0x01, script=0x25 ) -- 0x0295 0x07
...
Actor[ "0x06" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x10b8, z=(vf40)0xf46b, flag=(flag)0xc0 ) -- 0x02a4 0x19
        -- MISSING OPCODE 0xf8
    end,
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x02b9 0xfe
        opcode09_ActorCallScriptEW( actor_id=0x11, script=04, priority=01 ) -- 0x02bb 0x09
        -- 0x07( actor_id=0x01, script=0x26 ) -- 0x02be 0x07
        opcode26_Wait( time=10 ) -- 0x02c1 0x26
...
Actor[ "0x07" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0e4c, z=(vf40)0xf6dc, flag=(flag)0xc0 ) -- 0x02cd 0x19
        -- MISSING OPCODE 0xf8
    end,
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x02e2 0xfe
        opcode09_ActorCallScriptEW( actor_id=0x12, script=04, priority=01 ) -- 0x02e4 0x09
        -- 0x07( actor_id=0x01, script=0x27 ) -- 0x02e7 0x07
        opcode26_Wait( time=10 ) -- 0x02ea 0x26
...
Actor[ "0x08" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0424, z=(vf40)0xee30, flag=(flag)0xc0 ) -- 0x02f6 0x19
        -- MISSING OPCODE 0xf8
    end,
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x030b 0xfe
        opcode09_ActorCallScriptEW( actor_id=0x0d, script=04, priority=01 ) -- 0x030d 0x09
        -- 0x07( actor_id=0x01, script=0x28 ) -- 0x0310 0x07
        opcode26_Wait( time=10 ) -- 0x0313 0x26
...
Actor[ "0x09" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x031e 0xbc
        -- 0x19_ActorSetPosition( x=(vf80)0x0bef, z=(vf40)0xeea8, flag=(flag)0xc0 ) -- 0x031f 0x19
        -- MISSING OPCODE 0xf8
    end,
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x0334 0xfe
        opcode09_ActorCallScriptEW( actor_id=0x0e, script=04, priority=01 ) -- 0x0336 0x09
        -- 0x07( actor_id=0x01, script=0x29 ) -- 0x0339 0x07
        opcode26_Wait( time=10 ) -- 0x033c 0x26
...
Actor[ "0x0a" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x0347 0xbc
        -- 0x19_ActorSetPosition( x=(vf80)0x0d2a, z=(vf40)0xe94e, flag=(flag)0xc0 ) -- 0x0348 0x19
        -- MISSING OPCODE 0xf8
    end,
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x035d 0xfe
        opcode09_ActorCallScriptEW( actor_id=0x0f, script=04, priority=01 ) -- 0x035f 0x09
        -- 0x07( actor_id=0x01, script=0x2a ) -- 0x0362 0x07
        opcode26_Wait( time=10 ) -- 0x0365 0x26
...
Actor[ "0x0b" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0230, z=(vf40)0xfdd0, flag=(flag)0xc0 ) -- 0x0371 0x19
        -- MISSING OPCODE 0xf8
    end,
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x0385 0xfe
        opcode36_VariableSetTrue( address=0x0400 ) -- 0x0387 0x36
        opcode09_ActorCallScriptEW( actor_id=0x14, script=04, priority=01 ) -- 0x038a 0x09
        -- MISSING OPCODE 0x80
    end,
...
Actor[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0dac, z=(vf40)0xfbdc, flag=(flag)0xc0 ) -- 0x0398 0x19
        -- MISSING OPCODE 0xf8
    end,
    ...
    on_talk = function( self )
        ...
        opcode09_ActorCallScriptEW( actor_id=0x15, script=04, priority=01 ) -- 0x03b4 0x09
        -- MISSING OPCODE 0x80
    end,
...
Actor[ "0x14" ] = {
    ...
    script_0x04 = function( self )
        opcode74_SoundPlayFixedVolume( sound_id=119 ) -- 0x057e 0x74
        opcode37_VariableSetFalse( address=0x0418 ) -- 0x0581 0x37
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0418 ), value2=(s16)0x0020, condition="value1 < value2", jump_if_false=0x059c ) -- 0x0584 0x02
        -- 0xC6() -- 0x058c 0xc6
...
Actor[ "0x15" ] = {
    on_start = function( self )
        ...
        -- 0x2A() -- 0x05a5 0x2a
        opcode37_VariableSetFalse( address=0x0402 ) -- 0x05a6 0x37
    ...
    script_0x04 = function( self )
        opcode36_VariableSetTrue( address=0x0402 ) -- 0x05ac 0x36
        opcode74_SoundPlayFixedVolume( sound_id=119 ) -- 0x05af 0x74
        opcode37_VariableSetFalse( address=0x041a ) -- 0x05b2 0x37
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x041a ), value2=(s16)0x0020, condition="value1 < value2", jump_if_false=0x05cd ) -- 0x05b5 0x02
        -- 0xC6() -- 0x05bd 0xc6
        -- MISSING OPCODE 0xFE1b
    end,
