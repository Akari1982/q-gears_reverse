...
Entity[ "1" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=GetVar( 0x003e ) ) -- 0x008c 0xfe
    ...
    script_0x07 = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0004, ???=0x00 ) -- 0x00f8 0xd2
        -- 0x9C() -- 0x00fc 0x9c
...
Entity[ "2" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=GetVar( 0x0040 ) ) -- 0x018b 0xfe
...
Entity[ "3" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=GetVar( 0x0042 ) ) -- 0x01c9 0xfe
...
Entity[ "4" ] = {
    ...
    on_talk = function( self )
        -- 0x09_EntityCallScriptEW( entity=0x01, script=0x2a ) -- 0x0216 0x09
