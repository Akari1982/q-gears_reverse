...
Actor[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0024, z=(vf40)0x00c4, flag=(flag)0xc0 ) -- 0x0093 0x19
        opcode69_ActorSetRotation( rot=2 ) -- 0x0099 0x69
...
Actor[ "0x0d" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0046, z=(vf40)0x0000, flag=(flag)0xc0 ) -- 0x00d9 0x19
...
Actor[ "0x0e" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0019, z=(vf40)0xffa6, flag=(flag)0xc0 ) -- 0x00f9 0x19
        return 0 -- 0x00ff 0x00
    end,

    on_update = function( self )
        opcode69_ActorSetRotation( rot=7 ) -- 0x0100 0x69
        opcode2C_SpritePlayAnim( anim_id=0x02 ) -- 0x0103 0x2c
        -- 0x5B() -- 0x0105 0x5b
