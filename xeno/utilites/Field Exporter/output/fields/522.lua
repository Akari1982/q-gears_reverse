...
Actor[ "0x02" ] = {
    ...
    script_0x04 = function( self )
        ...
        -- 0x1F( ???=0x00 ) -- 0x0063 0x1f
        opcode6F_ActorRotateToActor( actor_id=(entity)0x04 ) -- 0x0065 0x6f
    ...
    script_0x05 = function( self )
        ...
        -- 0x1F( ???=0x00 ) -- 0x0070 0x1f
        opcode6F_ActorRotateToActor( actor_id=(entity)0x04 ) -- 0x0072 0x6f
...
Actor[ "0x04" ] = {
    on_start = function( self )
        ...
        -- 0xFE15( ???=0, ???=1 ) -- 0x0091 0xfe
        -- 0x19_ActorSetPosition( x=(vf80)0xfff0, z=(vf40)0x000e, flag=(flag)0xc0 ) -- 0x0097 0x19
        -- 0x01_JumpTo( 0x00a2 ) -- 0x009d 0x01
