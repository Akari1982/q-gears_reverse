...
0x009f    -- 0xF8()
0x00a3    -- 0x18()
0x00a8    op20_ActorSetFlags0( flags=1 )
0x00ab    op00_Return()
...
Actor_0x0c:on_push:
0x00ae    -- 0x98_MapLoad( field_id=398, value=1 )
0x00b3    -- 0x5B()
0x00b4    op00_Return()

Actor_0x0d:on_start:
0x00b5    -- 0xBC_ActorNoModelInit()
0x00b6    -- 0x19_ActorSetPosition( x=(vf80)0xfac3, z=(vf40)0x0000, flag=(flag)0xc0 )
0x00bc    -- 0xF8()
0x00c0    -- 0xF8()
0x00c4    -- 0x18()
0x00c9    op20_ActorSetFlags0( flags=1 )
0x00cc    op00_Return()
...
Actor_0x0d:on_push:
0x00cf    -- 0x98_MapLoad( field_id=397, value=0 )
0x00d4    -- 0x5B()
0x00d5    op00_Return()
0x00d6    -- 0xE0( actor_id=Actor_0x00, ???=(vf80)0x0000, ???=(vf40)0x0098, flag=0x60 )
0x00dd    -- 0x5B()
0x00de    opFF_Nop()
0x00df    -- 0xC0( ???=(s)mem[0x248] )
0x00e2    op00_Return()
0x00e3    op00_Return()
0x00e4    -- 0xCB_TriggerJumpTo( trigger_id=15677, jump=0x45d2 )
