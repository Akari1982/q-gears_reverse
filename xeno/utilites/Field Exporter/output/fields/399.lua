...
unknown = [
    0xabff, 0x0004, 0x0000, 0xffff, 0xfb1e, 0x0000, 0xff00, 0xbcff,
]
...
0x0095    -- 0x19_ActorSetPosition( x=(vf80)0x053d, z=(vf40)0x0000, flag=(flag)0xc0 )
0x009b    -- MISSING OPCODE 0xf8
