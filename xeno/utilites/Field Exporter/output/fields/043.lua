...
Actor[ "0x0d" ] = {
    on_start = function( self )
        -- 0x0B_InitNPC( 0 ) -- 0x00b4 0x0b
        -- 0x19_ActorSetPosition( x=(vf80)0xffef, z=(vf40)0xffed, flag=(flag)0xc0 ) -- 0x00b7 0x19
        opcode69_ActorSetRotation( rot=4 ) -- 0x00bd 0x69
...
Actor[ "0x0e" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x00db 0xbc
        -- MISSING OPCODE 0xf8
    end,
