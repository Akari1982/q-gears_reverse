...
Actor[ "0x0d" ] = {
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x00e1 0xfe
        -- 0x07( actor_id=0x0e, script=0x24 ) -- 0x00e3 0x07
        opcode09_ActorCallScriptEW( actor_id=0x0f, script=04, priority=01 ) -- 0x00e6 0x09
        ...
        -- 0x27( actor_id=(entity)0x10 ) -- 0x00f5 0x27
