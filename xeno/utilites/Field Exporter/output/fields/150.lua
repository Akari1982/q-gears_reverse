...
Entity[ "0x04" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=2 ) -- 0x004d 0xfe
...
Entity[ "0x05" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=3 ) -- 0x0058 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=5 ) -- 0x006e 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=6 ) -- 0x0079 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=7 ) -- 0x0084 0xfe
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=8 ) -- 0x008f 0xfe
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=10 ) -- 0x009a 0xfe
...
Entity[ "0x0c" ] = {
    on_start = function( self )
        -- 0x0B_InitNPC( 0 ) -- 0x00a2 0x0b
        -- 0x84_ProgressLessEqualJumpTo( value=201, jump=0x00ac ) -- 0x00a5 0x84
        -- MISSING OPCODE 0x29
    end,
...
Entity[ "0x10" ] = {
    on_start = function( self )
        ...
        -- 0x2A() -- 0x0114 0x2a
        -- 0x23() -- 0x0115 0x23
        -- 0x86_ProgressNotEqualJumpTo( value=70, jump=0x011e ) -- 0x0116 0x86
        -- 0x01_JumpTo( 0x0120 ) -- 0x011b 0x01
        -- MISSING OPCODE 0x29
    end,

    on_update = function( self )
        -- 0x86_ProgressNotEqualJumpTo( value=70, jump=0x013e ) -- 0x0136 0x86
        -- 0x01_JumpTo( 0x013f ) -- 0x013b 0x01
