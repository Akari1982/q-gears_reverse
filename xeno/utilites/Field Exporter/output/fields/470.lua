...
0x001f    opD2_MessageShowDynamic( text_id=0x0000, flags=0 )
0x0023    op9C_MessageSync()
0x0024    op00_Return()

Actor_0x01:script_0x05:
0x0025    op2C_SpritePlayAnim( anim_id=0x07 )
...
0x0030    op2C_SpritePlayAnim( anim_id=0x04 )
0x0032    op26_Wait( time=10 )
0x0035    opD2_MessageShowDynamic( text_id=0x0002, flags=0 )
0x0039    op9C_MessageSync()
0x003a    op00_Return()

Actor_0x01:script_0x07:
0x003b    op2C_SpritePlayAnim( anim_id=0x04 )
0x003d    op26_Wait( time=10 )
0x0040    opD2_MessageShowDynamic( text_id=0x0003, flags=0 )
0x0044    op9C_MessageSync()
0x0045    op2C_SpritePlayAnim( anim_id=0xff )
0x0047    op00_Return()

Actor_0x01:script_0x08:
0x0048    op6F_ActorRotateToActor( actor_id=(entity)0x04 )
0x004a    op26_Wait( time=10 )
0x004d    opD2_MessageShowDynamic( text_id=0x0004, flags=0 )
0x0051    op9C_MessageSync()
0x0052    op00_Return()

Actor_0x01:script_0x09:
0x0053    op6F_ActorRotateToActor( actor_id=(entity)0x0d )
0x0055    op26_Wait( time=10 )
0x0058    op5D_SpritePlayAnim2( anim_id=0x04 )
0x005a    -- 0x5E()
0x005b    op26_Wait( time=10 )
0x005e    opD2_MessageShowDynamic( text_id=0x0005, flags=0 )
...
0x006f    op2C_SpritePlayAnim( anim_id=0x04 )
0x0071    op26_Wait( time=10 )
0x0074    opD2_MessageShowDynamic( text_id=0x0006, flags=0 )
