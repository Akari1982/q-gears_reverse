...
Actor[ "0x00" ] = {
    on_start = function( self )
        ...
        -- 0xA0() -- 0x000d 0xa0
        opcode35_VariableSet( address=0x045c, value=(vf40)0x00a7, flag=0x40 ) -- 0x0014 0x35
        opcode35_VariableSet( address=0x045e, value=(vf40)0x0082, flag=0x40 ) -- 0x001a 0x35
        opcode35_VariableSet( address=0x0460, value=(vf40)0x0000, flag=0x40 ) -- 0x0020 0x35
        opcode35_VariableSet( address=0x0462, value=(vf40)0x0000, flag=0x40 ) -- 0x0026 0x35
        opcode35_VariableSet( address=0x045a, value=(vf40)0x0001, flag=0x40 ) -- 0x002c 0x35
        opcode35_VariableSet( address=0x0464, value=(vf40)0x0111, flag=0x40 ) -- 0x0032 0x35
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x01cc ), value2=(s16)0x0010, condition="value1 & value2", jump_if_false=0x0046 ) -- 0x0038 0x02
        opcode35_VariableSet( address=0x0466, value=(vf40)0x0001, flag=0x40 ) -- 0x0040 0x35
...
Actor[ "0x04" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=1 ) -- 0x00b2 0x16
        opcodeFE0D_MessageSetFace( char_id=1 ) -- 0x00b5 0xfe
...
Actor[ "0x06" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=5 ) -- 0x00c6 0x16
        opcodeFE0D_MessageSetFace( char_id=5 ) -- 0x00c9 0xfe
...
Actor[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=6 ) -- 0x00d0 0x16
        opcodeFE0D_MessageSetFace( char_id=6 ) -- 0x00d3 0xfe
...
Actor[ "0x08" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=7 ) -- 0x00da 0x16
        opcodeFE0D_MessageSetFace( char_id=7 ) -- 0x00dd 0xfe
...
Actor[ "0x09" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=8 ) -- 0x00e4 0x16
        opcodeFE0D_MessageSetFace( char_id=8 ) -- 0x00e7 0xfe
...
Actor[ "0x0a" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=9 ) -- 0x00ee 0x16
        opcodeFE0D_MessageSetFace( char_id=9 ) -- 0x00f1 0xfe
...
Actor[ "0x0b" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=10 ) -- 0x00f8 0x16
        opcodeFE0D_MessageSetFace( char_id=10 ) -- 0x00fb 0xfe
...
Actor[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x005f, z=(vf40)0x0059, flag=(flag)0xc0 ) -- 0x010e 0x19
        opcode69_ActorSetRotation( rot=0 ) -- 0x0114 0x69
    ...
    script_0x06 = function( self )
        ...
        opcode20_ActorSetFlags0( flags=12 ) -- 0x018d 0x20
        -- MISSING OPCODE 0x2b
    end,
...
Actor[ "0x0e" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x0238 0xbc
        -- 0x19_ActorSetPosition( x=(vf80)0x00da, z=(vf40)0x0021, flag=(flag)0xc0 ) -- 0x0239 0x19
...
Actor[ "0x0f" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0069, z=(vf40)0xff9a, flag=(flag)0xc0 ) -- 0x0274 0x19
...
Actor[ "0x10" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xff93, z=(vf40)0xff7d, flag=(flag)0xc0 ) -- 0x02c6 0x19
...
Actor[ "0x11" ] = {
    ...
    script_0x04 = function( self )
        opcode37_VariableSetFalse( address=0x0428 ) -- 0x02fa 0x37
        -- MISSING OPCODE 0x2d
    end,
...
Actor[ "0x13" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x038e 0xbc
        -- MISSING OPCODE 0xf9
    end,
...
Actor[ "0x16" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x005a, z=(vf40)0x0093, flag=(flag)0xc0 ) -- 0x03b2 0x19
        -- MISSING OPCODE 0xf8
    end,
