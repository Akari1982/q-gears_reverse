...
Entity[ "0x01" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x0015 0xfe
...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x0041 0xfe
...
Entity[ "0x04" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x0059 0xfe
...
Entity[ "0x05" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 4 ) -- 0x006b 0x16
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x006e 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 6 ) -- 0x0093 0x16
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x0096 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 7 ) -- 0x00a7 0x16
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x00aa 0xfe
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 9 ) -- 0x00cf 0x16
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x00d2 0xfe
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 14 ) -- 0x00e3 0x16
        opcodeFE0D_SetAvatar( character_id=14 ) -- 0x00e6 0xfe
...
Entity[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xfed4, z=(vf40)0x0113, flag=(flag)0xc0 ) -- 0x00fa 0x19
...
Entity[ "0x0d" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x004e, z=(vf40)0xfec3, flag=(flag)0xc0 ) -- 0x0130 0x19
    ...
    on_talk = function( self )
        ...
        opcode15() -- 0x015a 0x15
        opcodeD2_MessageShow0( dialog_id=0x0002, ???=0x00 ) -- 0x015b 0xd2
        -- 0x9C() -- 0x015f 0x9c
        opcode14() -- 0x0160 0x14
        ...
        opcodeD2_MessageShow0( dialog_id=0x0003, ???=0x00 ) -- 0x0171 0xd2
        -- 0x9C() -- 0x0175 0x9c
        ...
        opcodeD2_MessageShow0( dialog_id=0x0004, ???=0x00 ) -- 0x0186 0xd2
        -- 0x9C() -- 0x018a 0x9c
        ...
        opcodeD2_MessageShow0( dialog_id=0x0006, ???=0x00 ) -- 0x01a0 0xd2
        -- 0x9C() -- 0x01a4 0x9c
...
Entity[ "0x0e" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xff3f, z=(vf40)0x0160, flag=(flag)0xc0 ) -- 0x01a8 0x19
        -- MISSING OPCODE 0x18
    end,
...
Entity[ "0x10" ] = {
    ...
    on_update = function( self )
        ...
        opcode25_EntityDisable( entity=(entity)0x0c ) -- 0x0252 0x25
        opcode25_EntityDisable( entity=(entity)0x0d ) -- 0x0254 0x25
        -- MISSING OPCODE 0x27
    end,
