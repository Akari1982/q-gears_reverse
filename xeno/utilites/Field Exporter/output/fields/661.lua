...
Entity[ "0x01" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 2 ) -- 0x0011 0x16
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x0014 0xfe
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0000, ???=0x11 ) -- 0x0026 0xd2
        -- 0x9C() -- 0x002a 0x9c
...
Entity[ "0x02" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 3 ) -- 0x002c 0x16
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x002f 0xfe
        -- MISSING OPCODE 0xFE1c
    end,
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0001, ???=0x11 ) -- 0x0041 0xd2
        -- 0x9C() -- 0x0045 0x9c
...
Entity[ "0x03" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 4 ) -- 0x0047 0x16
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x004a 0xfe
        -- MISSING OPCODE 0xFE1c
    end,
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0002, ???=0x11 ) -- 0x005c 0xd2
        -- 0x9C() -- 0x0060 0x9c
...
Entity[ "0x04" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 5 ) -- 0x0062 0x16
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x0065 0xfe
        -- MISSING OPCODE 0xFE1c
    end,
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0003, ???=0x11 ) -- 0x0077 0xd2
        -- 0x9C() -- 0x007b 0x9c
...
Entity[ "0x05" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 6 ) -- 0x007d 0x16
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x0080 0xfe
        -- MISSING OPCODE 0xFE1c
    end,
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0004, ???=0x11 ) -- 0x0092 0xd2
        -- 0x9C() -- 0x0096 0x9c
...
Entity[ "0x06" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 7 ) -- 0x0098 0x16
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x009b 0xfe
        -- MISSING OPCODE 0xFE1c
    end,
...
Entity[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 8 ) -- 0x00b9 0x16
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x00bc 0xfe
        -- MISSING OPCODE 0xFE1c
    end,
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0006, ???=0x11 ) -- 0x00ce 0xd2
        -- 0x9C() -- 0x00d2 0x9c
...
Entity[ "0x08" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 9 ) -- 0x00d4 0x16
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x00d7 0xfe
        -- MISSING OPCODE 0xFE1c
    end,
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0007, ???=0x11 ) -- 0x00e9 0xd2
        -- 0x9C() -- 0x00ed 0x9c
...
Entity[ "0x09" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 10 ) -- 0x00ef 0x16
        opcodeFE0D_SetAvatar( character_id=10 ) -- 0x00f2 0xfe
        -- MISSING OPCODE 0xFE1c
    end,
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0008, ???=0x11 ) -- 0x0104 0xd2
        -- 0x9C() -- 0x0108 0x9c
...
Entity[ "0x0f" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x0382 0xbc
        -- 0x2A() -- 0x0383 0x2a
...
Entity[ "0x1a" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x0444 0xbc
        -- 0x2A() -- 0x0445 0x2a
        -- MISSING OPCODE 0xf9
    end,
...
Entity[ "0x22" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x06df 0xbc
        -- 0x2A() -- 0x06e0 0x2a
...
Entity[ "0x23" ] = {
    ...
    on_update = function( self )
        -- 0xC6() -- 0x0a3f 0xc6
        -- 0xFE8F_ParticleSystemInit1( entity=(entity)0xfb, render_settings=0, rot_x=0, rot_y=0 ) -- 0x0a40 0xfe
        ...
        -- 0x5A() -- 0x0ce4 0x5a
        -- 0xC6() -- 0x0ce5 0xc6
        -- 0xFE8F_ParticleSystemInit1( entity=(entity)0xfb, render_settings=0, rot_x=0, rot_y=0 ) -- 0x0ce6 0xfe
...
Entity[ "0x25" ] = {
    ...
    script_0x04 = function( self )
        -- 0xC6() -- 0x1b26 0xc6
        -- 0xFE8F_ParticleSystemInit1( entity=(entity)0xfb, render_settings=0, rot_x=0, rot_y=0 ) -- 0x1b27 0xfe
