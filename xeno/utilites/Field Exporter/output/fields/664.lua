...
Actor_0x01:on_start:
    ...
    -- 0x5F( ???=0x02 ) -- 0x001b 0x5f
    -- 0x01_JumpTo( 0x0028 ) -- 0x001d 0x01
    -- 0x19_ActorSetPosition( x=(vf80)0x01e0, z=(vf40)0xffce, flag=(flag)0xc0 ) -- 0x0020 0x19
    -- 0x5F( ???=0x02 ) -- 0x0026 0x5f
...
Actor_0x02:on_start:
    ...
    -- 0x5F( ???=0x02 ) -- 0x0040 0x5f
    -- 0x01_JumpTo( 0x004d ) -- 0x0042 0x01
    -- 0x19_ActorSetPosition( x=(vf80)0x01e0, z=(vf40)0xffef, flag=(flag)0xc0 ) -- 0x0045 0x19
    -- 0x5F( ???=0x03 ) -- 0x004b 0x5f
...
Actor_0x02:script_0x04:
    ...
    -- 0x5F( ???=0x06 ) -- 0x0058 0x5f
    op26_Wait( time=1 ) -- 0x005a 0x26
    -- 0xF6( ???=0x01 ) -- 0x005d 0xf6
    -- 0x19_ActorSetPosition( x=(vf80)0x01c7, z=(vf40)0xffc9, flag=(flag)0xc0 ) -- 0x005f 0x19
    op26_Wait( time=2 ) -- 0x0065 0x26
    -- 0x19_ActorSetPosition( x=(vf80)0x01cc, z=(vf40)0xffce, flag=(flag)0xc0 ) -- 0x0068 0x19
    op26_Wait( time=15 ) -- 0x006e 0x26
    -- 0x01_JumpTo( 0x005f ) -- 0x0071 0x01
    return 0 -- 0x0074 0x00

Actor_0x02:script_0x05:
    -- 0x19_ActorSetPosition( x=(vf80)0x0691, z=(vf40)0xfffb, flag=(flag)0xc0 ) -- 0x0075 0x19
    op2C_SpritePlayAnim( anim_id=0x03 ) -- 0x007b 0x2c
    -- 0xF6( ???=0x00 ) -- 0x007d 0xf6
    -- 0x5F( ???=0x04 ) -- 0x007f 0x5f
    -- 0x5B() -- 0x0081 0x5b
    -- MISSING OPCODE 0x92
