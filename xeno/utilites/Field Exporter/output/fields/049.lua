...
Entity[ "0x01" ] = {
    ...
    script_0x08 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0003, ???=0x00 ) -- 0x0101 0xd2
        -- 0x9C() -- 0x0105 0x9c
        -- MISSING OPCODE 0x2c
    end,
...
Entity[ "0x0f" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x027d 0xbc
        -- 0x2A() -- 0x027e 0x2a
        -- MISSING OPCODE 0xf9
    end,
...
Entity[ "0x19" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x02b9 0xbc
        -- 0x2A() -- 0x02ba 0x2a
        -- MISSING OPCODE 0xf9
    end,
...
Entity[ "0x1a" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x02bf 0xbc
        -- 0x2A() -- 0x02c0 0x2a
        -- MISSING OPCODE 0xf9
    end,
...
Entity[ "0x1c" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x02cb 0xbc
        -- 0x2A() -- 0x02cc 0x2a
        -- MISSING OPCODE 0xf9
    end,
...
Entity[ "0x1d" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x02d1 0xbc
        -- 0x2A() -- 0x02d2 0x2a
        -- MISSING OPCODE 0xf9
    end,
...
Entity[ "0x25" ] = {
    ...
    script_0x07 = function( self )
        opcode60() -- 0x0418 0x60
        opcode64() -- 0x0419 0x64
        -- MISSING OPCODE 0x62
    end,
