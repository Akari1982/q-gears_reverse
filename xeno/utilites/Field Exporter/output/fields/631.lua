...
Actor[ "0x01" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=GetVar( 0x003e ) ) -- 0x0010 0xfe
    ...
    script_0x05 = function( self )
        opcode2C_SpritePlayAnim( anim_id=0x0a ) -- 0x0021 0x2c
        opcode74_SoundPlayFixedVolume( sound_id=249 ) -- 0x0023 0x74
        opcode26_Wait( time=5 ) -- 0x0026 0x26
        opcode74_SoundPlayFixedVolume( sound_id=249 ) -- 0x0029 0x74
        opcode26_Wait( time=10 ) -- 0x002c 0x26
        opcode74_SoundPlayFixedVolume( sound_id=151 ) -- 0x002f 0x74
        opcode26_Wait( time=10 ) -- 0x0032 0x26
        opcode2C_SpritePlayAnim( anim_id=0xff ) -- 0x0035 0x2c
...
Actor[ "0x02" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=GetVar( 0x0040 ) ) -- 0x003b 0xfe
...
Actor[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=GetVar( 0x0042 ) ) -- 0x0046 0xfe
...
Actor[ "0x04" ] = {
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x0064 0xfe
        -- 0x07( actor_id=0x08, script=0x24 ) -- 0x0066 0x07
        opcode09_ActorCallScriptEW( actor_id=0x09, script=04, priority=01 ) -- 0x0069 0x09
        -- 0x07( actor_id=0x01, script=0x24 ) -- 0x006c 0x07
...
Actor[ "0x05" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0000, z=(vf40)0x0028, flag=(flag)0xc0 ) -- 0x007b 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Actor[ "0x06" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x001e, z=(vf40)0xfff6, flag=(flag)0xc0 ) -- 0x00c7 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Actor[ "0x07" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xffe7, z=(vf40)0xfff6, flag=(flag)0xc0 ) -- 0x00eb 0x19
        -- MISSING OPCODE 0xf8
    end,
