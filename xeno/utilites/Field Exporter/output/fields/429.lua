...
0x0012    op37_VariableSetFalse( address=0x040c )
0x0015    opF1_FadeSetUp( steps=2, r=135, g=155, b=95, semi_tr=1 )
0x0020    op26_Wait( time=60 )
0x0023    op09_ActorCallScriptEW( actor_id=0x1b, script=04, priority=03 )
0x0026    -- 0x5B()
0x0027    op00_Return()
...
0x0034    op5D_SpritePlayAnim2( anim_id=0x0a )
0x0036    -- 0x5E()
0x0037    op00_Return()
...
0x0043    op05_FunctionCall( 0x0034 )
0x0046    op00_Return()
...
0x0052    op05_FunctionCall( 0x0034 )
0x0055    op00_Return()
...
0x0061    op05_FunctionCall( 0x0034 )
0x0064    op00_Return()
...
0x0070    op05_FunctionCall( 0x0034 )
0x0073    op00_Return()
...
0x007f    op05_FunctionCall( 0x0034 )
0x0082    op00_Return()
...
0x008e    op05_FunctionCall( 0x0034 )
0x0091    op00_Return()
...
0x009d    op05_FunctionCall( 0x0034 )
0x00a0    op00_Return()
...
0x00ac    op05_FunctionCall( 0x0034 )
0x00af    op00_Return()
