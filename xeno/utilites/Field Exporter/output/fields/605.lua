...
Actor[ "0x00" ] = {
    on_start = function( self )
        ...
        opcode35_VariableSet( address=0x0406, value=(vf40)0x0024, flag=0x40 ) -- 0x0017 0x35
        opcode35_VariableSet( address=0x0408, value=(vf40)0x0071, flag=0x40 ) -- 0x001d 0x35
        opcode35_VariableSet( address=0x040a, value=(vf40)0x0000, flag=0x40 ) -- 0x0023 0x35
        opcode35_VariableSet( address=0x040c, value=(vf40)0x0003, flag=0x40 ) -- 0x0029 0x35
        opcode35_VariableSet( address=0x040e, value=(vf40)0x013b, flag=0x40 ) -- 0x002f 0x35
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0162 ), value2=(s16)0x1000, condition="value1 & value2", jump_if_false=0x0040 ) -- 0x0035 0x02
    ...
    script_0x04 = function( self )
        opcode3A_VariableBitSet( address=0x0162, bit_num=(vf40)0x000c, flag=0x40 ) -- 0x0046 0x3a
...
Actor[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xfd04, z=(vf40)0xfff9, flag=(flag)0xc0 ) -- 0x00f1 0x19
        -- MISSING OPCODE 0xf8
    end,
