...
Actor[ "0x0a" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=6 ) -- 0x00a5 0x16
        opcodeFE0D_MessageSetFace( char_id=6 ) -- 0x00a8 0xfe
...
Actor[ "0x0d" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=9 ) -- 0x00c6 0x16
        opcodeFE0D_MessageSetFace( char_id=9 ) -- 0x00c9 0xfe
...
Actor[ "0x0e" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=10 ) -- 0x00d1 0x16
        opcodeFE0D_MessageSetFace( char_id=10 ) -- 0x00d4 0xfe
...
Actor[ "0x1b" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x02ef 0xbc
        -- MISSING OPCODE 0xFE1c
    end,
...
Actor[ "0x1f" ] = {
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x039a 0xfe
        opcode74_SoundPlayFixedVolume( sound_id=8 ) -- 0x039c 0x74
        opcode26_Wait( time=30 ) -- 0x039f 0x26
        -- 0x98_MapLoad( field_id=292, value=0 ) -- 0x03a2 0x98
...
Actor[ "0x20" ] = {
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x03c2 0xfe
        opcode74_SoundPlayFixedVolume( sound_id=119 ) -- 0x03c4 0x74
        opcode26_Wait( time=30 ) -- 0x03c7 0x26
        -- 0x98_MapLoad( field_id=304, value=2 ) -- 0x03ca 0x98
...
Actor[ "0x21" ] = {
    ...
    on_update = function( self )
        -- 0xA8_VariableRandom2( address=0x0414, value=3 ) -- 0x03fc 0xa8
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0414 ), value2=(s16)0x0000, condition="value1 == value2", jump_if_false=0x0415 ) -- 0x0401 0x02
        opcode24_ActorEnable( actor_id=(entity)0x22 ) -- 0x0409 0x24
        opcode25_ActorDisable( actor_id=(entity)0x2a ) -- 0x040b 0x25
        -- MISSING OPCODE 0x80
    end,
...
Actor[ "0x25" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x04b7 0xbc
        -- 0x2A() -- 0x04b8 0x2a
        -- 0x23() -- 0x04b9 0x23
...
Actor[ "0x26" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x04bc 0xbc
        -- 0x2A() -- 0x04bd 0x2a
        -- 0x23() -- 0x04be 0x23
...
Actor[ "0x2b" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x04d4 0xbc
        -- 0x2A() -- 0x04d5 0x2a
...
Actor[ "0x2c" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x04d8 0xbc
        -- 0x2A() -- 0x04d9 0x2a
...
Actor[ "0x39" ] = {
    ...
    on_update = function( self )
        opcode69_ActorSetRotation( rot=4 ) -- 0x0527 0x69
...
Actor[ "0x3a" ] = {
    ...
    on_update = function( self )
        opcode69_ActorSetRotation( rot=6 ) -- 0x0553 0x69
        return 0 -- 0x0556 0x00
    end,

    on_talk = function( self )
        opcode6F_ActorRotateToActor( actor_id=(entity)party_1 ) -- 0x0557 0x6f
        -- MISSING OPCODE 0x85
    end,
