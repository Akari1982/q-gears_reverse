...
Actor[ "0x03" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xffd5, z=(vf40)0xff65, flag=(flag)0xc0 ) -- 0x0072 0x19
        -- MISSING OPCODE 0xf8
    end,
    ...
    on_talk = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0000, flags=0 ) -- 0x009b 0xd2
...
Actor[ "0x05" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=2 ) -- 0x00ad 0x16
        opcodeFE0D_MessageSetFace( char_id=2 ) -- 0x00b0 0xfe
...
Actor[ "0x06" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=3 ) -- 0x00b8 0x16
        opcodeFE0D_MessageSetFace( char_id=3 ) -- 0x00bb 0xfe
...
Actor[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=4 ) -- 0x00c3 0x16
        opcodeFE0D_MessageSetFace( char_id=4 ) -- 0x00c6 0xfe
...
Actor[ "0x08" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=5 ) -- 0x00ce 0x16
        opcodeFE0D_MessageSetFace( char_id=5 ) -- 0x00d1 0xfe
...
Actor[ "0x09" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=6 ) -- 0x00d9 0x16
        opcodeFE0D_MessageSetFace( char_id=6 ) -- 0x00dc 0xfe
...
Actor[ "0x0a" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=7 ) -- 0x00e4 0x16
        opcodeFE0D_MessageSetFace( char_id=7 ) -- 0x00e7 0xfe
...
Actor[ "0x0b" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=8 ) -- 0x00ef 0x16
        opcodeFE0D_MessageSetFace( char_id=8 ) -- 0x00f2 0xfe
...
Actor[ "0x0c" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=9 ) -- 0x00fa 0x16
        opcodeFE0D_MessageSetFace( char_id=9 ) -- 0x00fd 0xfe
...
Actor[ "0x0d" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=10 ) -- 0x0105 0x16
...
Actor[ "0x0e" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x008c, z=(vf40)0xff24, flag=(flag)0xc0 ) -- 0x0111 0x19
        opcodeD0_MessageSettings( x=0, y=0, letters=0, rows=0, flags=1 ) -- 0x0117 0xd0
        -- MISSING OPCODE 0xf8
    end,
