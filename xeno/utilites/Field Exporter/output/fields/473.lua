...
Entity[ "0x01" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x0751 0xfe
        -- MISSING OPCODE 0x21
    end,
...
Entity[ "0x02" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x07f7 0xfe
...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x0802 0xfe
...
Entity[ "0x04" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x080d 0xfe
...
Entity[ "0x05" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x0818 0xfe
...
Entity[ "0x06" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x0823 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x082e 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x089d 0xfe
...
Entity[ "0x0a" ] = {
    ...
    script_0x08 = function( self )
        ...
        opcode08_EntityCallScriptSW( entity=0x09, script=0d, priority=03 ) -- 0x0cdf 0x08
        -- 0x35() -- 0x0ce2 0x35
...
Entity[ "0x0d" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x0eaf 0xfe
...
Entity[ "0x0e" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x0eec 0xfe
...
Entity[ "0x0f" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x0f49 0xfe
...
Entity[ "0x10" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x0f86 0xfe
...
Entity[ "0x11" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x0fc3 0xfe
    ...
    script_0x06 = function( self )
        ...
        -- 0x9C() -- 0x1030 0x9c
        opcode09_EntityCallScriptEW( entity=0x08, script=0b, priority=03 ) -- 0x1031 0x09
        -- MISSING OPCODE 0x69
    end,
...
Entity[ "0x19" ] = {
    ...
    on_talk = function( self )
        ...
        opcode08_EntityCallScriptSW( entity=0x1a, script=04, priority=02 ) -- 0x1b5b 0x08
        opcode08_EntityCallScriptSW( entity=0x1b, script=04, priority=03 ) -- 0x1b5e 0x08
...
Entity[ "0x1a" ] = {
    ...
    on_talk = function( self )
        ...
        opcode08_EntityCallScriptSW( entity=0x1b, script=04, priority=03 ) -- 0x1b8d 0x08
...
Entity[ "0x1b" ] = {
    ...
    on_talk = function( self )
        ...
        opcode08_EntityCallScriptSW( entity=0x1a, script=04, priority=03 ) -- 0x1bc2 0x08
