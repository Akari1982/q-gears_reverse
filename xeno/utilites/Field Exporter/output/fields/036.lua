...
Entity[ "0x01" ] = {
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0000, ???=0x00 ) -- 0x0022 0xd2
        -- 0x9C() -- 0x0026 0x9c
    ...
    script_0x07 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0003, ???=0x00 ) -- 0x003c 0xd2
        -- 0x9C() -- 0x0040 0x9c
...
Entity[ "0x02" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x006a 0xfe
...
Entity[ "0x03" ] = {
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0007, ???=0x00 ) -- 0x007d 0xd2
        -- 0x9C() -- 0x0081 0x9c
        return 0 -- 0x0082 0x00
    end,

    script_0x05 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0008, ???=0x00 ) -- 0x0083 0xd2
        -- 0x9C() -- 0x0087 0x9c
...
Entity[ "0x04" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x00ed 0xfe
...
Entity[ "0x05" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x00f8 0xfe
...
Entity[ "0x06" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x0103 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x010e 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x0119 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=10 ) -- 0x0124 0xfe
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x013a 0xfe
...
Entity[ "0x0d" ] = {
    ...
    on_talk = function( self )
        ...
        opcodeD2_MessageShow0( dialog_id=0x0011, ???=0x00 ) -- 0x017c 0xd2
        -- 0x9C() -- 0x0180 0x9c
        -- 0x01_JumpTo( 0x0189 ) -- 0x0181 0x01
        opcodeD2_MessageShow0( dialog_id=0x0012, ???=0x00 ) -- 0x0184 0xd2
        -- 0x9C() -- 0x0188 0x9c
        opcode09_EntityCallScriptEW( entity=0x03, script=06, priority=06 ) -- 0x0189 0x09
        opcodeD2_MessageShow0( dialog_id=0x0013, ???=0x00 ) -- 0x018c 0xd2
        -- 0x9C() -- 0x0190 0x9c
        opcode09_EntityCallScriptEW( entity=0x03, script=07, priority=06 ) -- 0x0191 0x09
        opcode26_Wait( time=2 ) -- 0x0194 0x26
        opcode09_EntityCallScriptEW( entity=0x01, script=08, priority=06 ) -- 0x0197 0x09
        opcode26_Wait( time=3 ) -- 0x019a 0x26
        opcode09_EntityCallScriptEW( entity=0x01, script=09, priority=06 ) -- 0x019d 0x09
...
Entity[ "0x0f" ] = {
    ...
    on_talk = function( self )
        opcodeF5_MessageShow3( dialog_id=0x001e, flag=0x00 ) -- 0x026a 0xf5
        -- 0x9C() -- 0x026e 0x9c
