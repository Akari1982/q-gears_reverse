...
Actor_0x09:on_talk:
0x0082    op6F_ActorRotateToActor( actor_id=(entity)0x01 )
0x0084    op26_Wait( time=10 )
0x0087    -- 0x84_ProgressLessEqualJumpTo( value=8, jump=0x00b4 )
0x008c    opD2_MessageShowDynamic( text_id=0x0000, flags=0 )
0x0090    op9C_MessageSync()
0x0091    op69_ActorSetRotation( rot=2 )
0x0094    op26_Wait( time=10 )
0x0097    opD2_MessageShowDynamic( text_id=0x0001, flags=0 )
0x009b    op9C_MessageSync()
0x009c    op6F_ActorRotateToActor( actor_id=(entity)0x01 )
0x009e    op26_Wait( time=10 )
0x00a1    opD2_MessageShowDynamic( text_id=0x0002, flags=0 )
0x00a5    op9C_MessageSync()
0x00a6    op69_ActorSetRotation( rot=2 )
0x00a9    op26_Wait( time=10 )
0x00ac    opD2_MessageShowDynamic( text_id=0x0003, flags=0 )
0x00b0    op9C_MessageSync()
0x00b1    -- 0x01_JumpTo( 0x00bc )
0x00b4    opD2_MessageShowDynamic( text_id=0x0004, flags=0 )
