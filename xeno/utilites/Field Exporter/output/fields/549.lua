...
Actor[ "0x00" ] = {
    on_start = function( self )
        ...
        opcode35_VariableSet( address=0x0418, value=(vf40)0x0001, flag=0x40 ) -- 0x0011 0x35
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x021c ), value2=(s16)0x0020, condition="value1 & value2", jump_if_false=0x0025 ) -- 0x0017 0x02
        opcode35_VariableSet( address=0x042a, value=(vf40)0x0001, flag=0x40 ) -- 0x001f 0x35
        opcode35_VariableSet( address=0x040c, value=(vf40)0x0001, flag=0x40 ) -- 0x0025 0x35
        opcode35_VariableSet( address=0x040e, value=(vf40)0xffbd, flag=0x40 ) -- 0x002b 0x35
        opcode35_VariableSet( address=0x0410, value=(vf40)0x00f3, flag=0x40 ) -- 0x0031 0x35
        opcode35_VariableSet( address=0x0412, value=(vf40)0x0000, flag=0x40 ) -- 0x0037 0x35
        opcode35_VariableSet( address=0x0414, value=(vf40)0x0005, flag=0x40 ) -- 0x003d 0x35
        opcode35_VariableSet( address=0x0416, value=(vf40)0x0039, flag=0x40 ) -- 0x0043 0x35
        opcode35_VariableSet( address=0x041e, value=(vf40)0x0001, flag=0x40 ) -- 0x0049 0x35
        opcode35_VariableSet( address=0x0420, value=(vf40)0xff01, flag=0x40 ) -- 0x004f 0x35
        opcode35_VariableSet( address=0x0422, value=(vf40)0x0044, flag=0x40 ) -- 0x0055 0x35
        opcode35_VariableSet( address=0x0424, value=(vf40)0x0000, flag=0x40 ) -- 0x005b 0x35
        opcode35_VariableSet( address=0x0426, value=(vf40)0x0005, flag=0x40 ) -- 0x0061 0x35
        opcode35_VariableSet( address=0x0428, value=(vf40)0x003c, flag=0x40 ) -- 0x0067 0x35
        -- 0x2A() -- 0x006d 0x2a
...
Actor[ "0x01" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=GetVar( 0x003e ) ) -- 0x0082 0xfe
    ...
    script_0x05 = function( self )
        ...
        opcode2C_SpritePlayAnim( anim_id=0xff ) -- 0x00a1 0x2c
...
Actor[ "0x02" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=GetVar( 0x0040 ) ) -- 0x00b3 0xfe
...
Actor[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=GetVar( 0x0042 ) ) -- 0x00be 0xfe
...
Actor[ "0x05" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xffa1, z=(vf40)0x0131, flag=(flag)0xc0 ) -- 0x017c 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Actor[ "0x06" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xff10, z=(vf40)0x00f0, flag=(flag)0xc0 ) -- 0x019f 0x19
        -- MISSING OPCODE 0xf8
    end,
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x01b4 0xfe
        opcode09_ActorCallScriptEW( actor_id=0x07, script=04, priority=01 ) -- 0x01b6 0x09
        -- 0x07( actor_id=0x01, script=0x24 ) -- 0x01b9 0x07
...
Actor[ "0x08" ] = {
    ...
    script_0x05 = function( self )
        opcode35_VariableSet( address=0x0400, value=(vf40)0x1000, flag=0x40 ) -- 0x0212 0x35
...
Actor[ "0x09" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x0254 0xbc
        -- 0x23() -- 0x0255 0x23
        -- 0x2A() -- 0x0256 0x2a
    ...
    script_0x05 = function( self )
        opcode35_VariableSet( address=0x0402, value=(vf40)0x1000, flag=0x40 ) -- 0x0296 0x35
...
Actor[ "0x0a" ] = {
    ...
    script_0x05 = function( self )
        opcode35_VariableSet( address=0x0404, value=(vf40)0x1000, flag=0x40 ) -- 0x031a 0x35
...
Actor[ "0x0b" ] = {
    ...
    script_0x05 = function( self )
        opcode35_VariableSet( address=0x0406, value=(vf40)0x1000, flag=0x40 ) -- 0x039e 0x35
...
Actor[ "0x0c" ] = {
    ...
    script_0x05 = function( self )
        opcode35_VariableSet( address=0x0408, value=(vf40)0x1000, flag=0x40 ) -- 0x0422 0x35
...
Actor[ "0x0d" ] = {
    ...
    script_0x05 = function( self )
        opcode35_VariableSet( address=0x040a, value=(vf40)0x1000, flag=0x40 ) -- 0x04a6 0x35
