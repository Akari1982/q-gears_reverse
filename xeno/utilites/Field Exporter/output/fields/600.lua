...
Entity[ "0x01" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 0 ) -- 0x0038 0x16
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x003b 0xfe
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x003f 0xfe
...
Entity[ "0x02" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x004e 0xfe
...
Entity[ "0x03" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 9 ) -- 0x0056 0x16
...
Entity[ "0x05" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x007b 0xfe
...
Entity[ "0x06" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 5 ) -- 0x0083 0x16
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x0086 0xfe
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x008a 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 6 ) -- 0x0092 0x16
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x0095 0xfe
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x0099 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x00a8 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x00b7 0xfe
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x00bf 0xbc
        -- 0x19_SetPosition( x=(vf80)0x0126, z=(vf40)0xfffc, flag=(flag)0xc0 ) -- 0x00c0 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xff55, z=(vf40)0x02fb, flag=(flag)0xc0 ) -- 0x00f0 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xfed2, z=(vf40)0x0000, flag=(flag)0xc0 ) -- 0x0120 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x0d" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x0058, z=(vf40)0xfd6a, flag=(flag)0xc0 ) -- 0x0150 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x0e" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xfe27, z=(vf40)0xfa15, flag=(flag)0xc0 ) -- 0x0180 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x11" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x01f7 0xbc
        -- 0x2A() -- 0x01f8 0x2a
