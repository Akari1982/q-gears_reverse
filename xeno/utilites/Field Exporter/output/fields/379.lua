...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x0224 0xfe
        -- MISSING OPCODE 0xFE07
    end,
...
Entity[ "0x04" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x02d0 0xfe
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x02d4 0xfe
        -- MISSING OPCODE 0xFE07
    end,
...
Entity[ "0x05" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x0391 0xfe
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x0395 0xfe
        -- MISSING OPCODE 0xFE07
    end,
...
Entity[ "0x06" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x0443 0xfe
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x0447 0xfe
        -- MISSING OPCODE 0xFE07
    end,
...
Entity[ "0x07" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x04f0 0xfe
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x04f4 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x04ff 0xfe
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x0503 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x050e 0xfe
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x0512 0xfe
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=10 ) -- 0x051d 0xfe
        opcodeFE0D_SetAvatar( character_id=10 ) -- 0x0521 0xfe
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x052c 0xfe
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x0530 0xfe
...
Entity[ "0x0c" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x053b 0xfe
        -- MISSING OPCODE 0xFE07
    end,
