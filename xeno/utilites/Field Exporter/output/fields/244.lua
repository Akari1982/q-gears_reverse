...
Actor[ "0x10" ] = {
    ...
    on_update = function( self )
        ...
        opcodeD4_MessageShowECopyAvatar( actor_id=(entity)0x01, text_id=0x0000, ???=0x21 ) -- 0x023d 0xfc
        ...
        opcodeD4_MessageShowECopyAvatar( actor_id=(entity)0x02, text_id=0x0001, ???=0x10 ) -- 0x0252 0xfc
        -- MISSING OPCODE 0x67
    end,
