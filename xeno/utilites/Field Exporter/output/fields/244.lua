...
Entity[ "0x02" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xfed2, z=(vf40)0xfc88, flag=(flag)0xc0 ) -- 0x0077 0x19
        -- 0x23() -- 0x007d 0x23
...
Entity[ "0x03" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 5 ) -- 0x00b8 0x16
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x00bb 0xfe
        -- MISSING OPCODE 0x21
    end,
    ...
    script_0x04 = function( self )
        -- 0x19_SetPosition( x=(vf80)0xfe52, z=(vf40)0xf9c0, flag=(flag)0xc0 ) -- 0x00cf 0x19
        -- MISSING OPCODE 0x4a
    end,
