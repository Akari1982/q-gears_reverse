...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x004a 0xfe
...
Entity[ "0x04" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 3 ) -- 0x0052 0x16
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x0055 0xfe
...
Entity[ "0x05" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 4 ) -- 0x005d 0x16
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x0060 0xfe
...
Entity[ "0x06" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 5 ) -- 0x0068 0x16
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x006b 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 6 ) -- 0x0073 0x16
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x0076 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 7 ) -- 0x007e 0x16
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x0081 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 8 ) -- 0x0089 0x16
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x008c 0xfe
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 9 ) -- 0x0094 0x16
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x0097 0xfe
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 10 ) -- 0x009f 0x16
        opcodeFE0D_SetAvatar( character_id=10 ) -- 0x00a2 0xfe
...
Entity[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x01a4, z=(vf40)0xfdcf, flag=(flag)0xc0 ) -- 0x00b0 0x19
        -- 0x2A() -- 0x00b6 0x2a
...
Entity[ "0x0d" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xfd97, z=(vf40)0xfdc4, flag=(flag)0xc0 ) -- 0x00ff 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x0e" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x01b9, z=(vf40)0xfd94, flag=(flag)0xc0 ) -- 0x012e 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x0f" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x002b, z=(vf40)0x0278, flag=(flag)0xc0 ) -- 0x015d 0x19
        -- MISSING OPCODE 0xf8
    end,
