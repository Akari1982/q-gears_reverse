...
Entity[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x0072, z=(vf40)0x00c2, flag=(flag)0xc0 ) -- 0x0093 0x19
        -- MISSING OPCODE 0x69
    end,
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0000, ???=0x00 ) -- 0x00a1 0xd2
        -- 0x9C() -- 0x00a5 0x9c
...
Entity[ "0x0d" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xff59, z=(vf40)0xffb9, flag=(flag)0xc0 ) -- 0x00aa 0x19
        -- MISSING OPCODE 0x69
    end,
