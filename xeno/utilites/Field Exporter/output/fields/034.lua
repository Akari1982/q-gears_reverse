...
Actor[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0072, z=(vf40)0x00c2, flag=(flag)0xc0 ) -- 0x0093 0x19
        opcode69_ActorSetRotation( rot=5 ) -- 0x0099 0x69
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( text_id=0x0000, ???=0x00 ) -- 0x00a1 0xd2
...
Actor[ "0x0d" ] = {
    on_start = function( self )
        -- 0x0B_InitNPC( 1 ) -- 0x00a7 0x0b
        -- 0x19_ActorSetPosition( x=(vf80)0xff59, z=(vf40)0xffb9, flag=(flag)0xc0 ) -- 0x00aa 0x19
        opcode69_ActorSetRotation( rot=6 ) -- 0x00b0 0x69
    ...
    on_talk = function( self )
        opcode6F_ActorRotateToActor( actor_id=(entity)party_1 ) -- 0x00b6 0x6f
        opcodeD2_MessageShow0( text_id=0x0001, ???=0x00 ) -- 0x00b8 0xd2
        opcode9C_MessageSync() -- 0x00bc 0x9c
        opcode69_ActorSetRotation( rot=6 ) -- 0x00bd 0x69
