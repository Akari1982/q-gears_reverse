...
0x009d    op2C_SpritePlayAnim( anim_id=0x02 )
0x009f    -- 0x5B()
0x00a0    op00_Return()

Actor_0x0c:on_talk:
0x00a1    opD2_MessageShowDynamic( text_id=0x0000, flags=0 )
...
Actor_0x0d:on_talk:
0x00b6    op6F_ActorRotateToActor( actor_id=(entity)party_1 )
0x00b8    opD2_MessageShowDynamic( text_id=0x0001, flags=0 )
