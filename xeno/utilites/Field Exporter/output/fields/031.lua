...
Entity[ "12" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x0113, z=(vf40)0xfff3, flag=(flag)0xc0 ) -- 0x0093 0x19
        -- MISSING OPCODE 0x69
    end,
...
Entity[ "13" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xffbc, z=(vf40)0xffeb, flag=(flag)0xc0 ) -- 0x00b5 0x19
        -- MISSING OPCODE 0x69
    end,
...
Entity[ "14" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xff7e, z=(vf40)0x0094, flag=(flag)0xc0 ) -- 0x00ea 0x19
        -- MISSING OPCODE 0x69
    end,
