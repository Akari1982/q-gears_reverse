...
Entity[ "0x01" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 0 ) -- 0x009a 0x16
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x009d 0xfe
...
Entity[ "0x02" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x011b 0xfe
...
Entity[ "0x03" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 1 ) -- 0x0123 0x16
...
Entity[ "0x04" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 3 ) -- 0x012e 0x16
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x0131 0xfe
...
Entity[ "0x05" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 5 ) -- 0x0139 0x16
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x013c 0xfe
...
Entity[ "0x06" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 4 ) -- 0x0144 0x16
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x0147 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 6 ) -- 0x014f 0x16
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x0152 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 7 ) -- 0x015a 0x16
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x015d 0xfe
...
Entity[ "0x0a" ] = {
    ...
    on_talk = function( self )
        ...
        opcodeD2_MessageShow0( dialog_id=0x0005, ???=0x00 ) -- 0x0193 0xd2
        -- 0x9C() -- 0x0197 0x9c
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        ...
        -- 0x23() -- 0x01b5 0x23
        -- 0x20_SpriteSetSolid() -- 0x01b6 0x20
    ...
    on_talk = function( self )
        ...
        opcodeD2_MessageShow0( dialog_id=0x0007, ???=0x00 ) -- 0x01ce 0xd2
        -- 0x9C() -- 0x01d2 0x9c
...
Entity[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x20_SpriteSetSolid() -- 0x01dd 0x20
        -- MISSING OPCODE 0x1c
    end,
...
Entity[ "0x0e" ] = {
    ...
    on_push = function( self )
        ...
        opcode09_EntityCallScriptEW( entity=0x01, script=05, priority=03 ) -- 0x0250 0x09
        ...
        opcodeF5_MessageShow3( dialog_id=0x000b, flag=0x21 ) -- 0x026e 0xf5
        -- 0x9C() -- 0x0272 0x9c
        -- MISSING OPCODE 0x74
    end,
...
Entity[ "0x16" ] = {
    on_start = function( self )
        ...
        -- 0x20_SpriteSetSolid() -- 0x0a02 0x20
        -- MISSING OPCODE 0x21
    end,
...
Entity[ "0x17" ] = {
    on_start = function( self )
        ...
        -- 0x20_SpriteSetSolid() -- 0x0acd 0x20
        -- MISSING OPCODE 0x21
    end,
...
Entity[ "0x18" ] = {
    ...
    on_talk = function( self )
        opcodeFE54() -- 0x0baa 0xfe
        opcodeD2_MessageShow0( dialog_id=0x001a, ???=0x00 ) -- 0x0bac 0xd2
        -- 0x9C() -- 0x0bb0 0x9c
        -- MISSING OPCODE 0x67
    end,
...
Entity[ "0x1b" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x0129, z=(vf40)0x020a, flag=(flag)0xc0 ) -- 0x0d9e 0x19
        -- 0x20_SpriteSetSolid() -- 0x0da4 0x20
        opcodeFE0D_SetAvatar( character_id=16 ) -- 0x0da7 0xfe
        -- MISSING OPCODE 0x17
    end,
    ...
    on_talk = function( self )
        opcodeFE54() -- 0x0dc0 0xfe
        opcode09_EntityCallScriptEW( entity=0x01, script=06, priority=03 ) -- 0x0dc2 0x09
        -- MISSING OPCODE 0x6f
    end,
...
Entity[ "0x21" ] = {
    ...
    on_talk = function( self )
        ...
        opcodeFE54() -- 0x11b1 0xfe
        opcode08_EntityCallScriptSW( entity=0x20, script=04, priority=03 ) -- 0x11b3 0x08
        opcode26_Wait( time=10 ) -- 0x11b6 0x26
        opcodeD2_MessageShow0( dialog_id=0x003c, ???=0x00 ) -- 0x11b9 0xd2
        -- 0x9C() -- 0x11bd 0x9c
        opcode26_Wait( time=10 ) -- 0x11be 0x26
        -- 0x07( entity=0x22, script=0x64 ) -- 0x11c1 0x07
        -- 0x07( entity=0x1f, script=0x64 ) -- 0x11c4 0x07
        opcodeD2_MessageShow0( dialog_id=0x003d, ???=0x00 ) -- 0x11c7 0xd2
        -- 0x9C() -- 0x11cb 0x9c
...
Entity[ "0x22" ] = {
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0040, ???=0x00 ) -- 0x120c 0xd2
        -- 0x9C() -- 0x1210 0x9c
        -- MISSING OPCODE 0x6f
    end,
    ...
    script_0x04 = function( self )
        -- 0x07( entity=0x23, script=0x44 ) -- 0x122b 0x07
        -- MISSING OPCODE 0x37
    end,
...
Entity[ "0x23" ] = {
    ...
    on_push = function( self )
        opcode09_EntityCallScriptEW( entity=0x22, script=05, priority=03 ) -- 0x12a9 0x09
...
Entity[ "0x24" ] = {
    ...
    on_push = function( self )
        opcode09_EntityCallScriptEW( entity=0x22, script=05, priority=04 ) -- 0x12c7 0x09
...
Entity[ "0x28" ] = {
    on_start = function( self )
        ...
        -- 0x20_SpriteSetSolid() -- 0x14b2 0x20
        -- MISSING OPCODE 0x21
    end,
...
Entity[ "0x2d" ] = {
    ...
    script_0x04 = function( self )
        ...
        opcodeD4_MessageShowE( entity=(entity)0x2c, dialog_id=0x0054, ???=0x01 ) -- 0x1733 0xd4
        -- MISSING OPCODE 0x37
    end,
...
Entity[ "0x34" ] = {
    ...
    on_talk = function( self )
        opcodeFE54() -- 0x1869 0xfe
        opcode15() -- 0x186b 0x15
        -- MISSING OPCODE 0xc4
    end,
...
Entity[ "0x35" ] = {
    ...
    on_talk = function( self )
        opcodeFE54() -- 0x1879 0xfe
        opcode15() -- 0x187b 0x15
        -- MISSING OPCODE 0xc4
    end,
...
Entity[ "0x36" ] = {
    ...
    on_talk = function( self )
        opcodeFE54() -- 0x1889 0xfe
        opcode15() -- 0x188b 0x15
        -- MISSING OPCODE 0xc4
    end,
...
Entity[ "0x37" ] = {
    ...
    on_talk = function( self )
        opcodeFE54() -- 0x1899 0xfe
        opcode15() -- 0x189b 0x15
        -- MISSING OPCODE 0xc4
    end,
...
Entity[ "0x38" ] = {
    ...
    on_talk = function( self )
        opcodeFE54() -- 0x18a9 0xfe
        opcode15() -- 0x18ab 0x15
        -- MISSING OPCODE 0xc4
    end,
...
Entity[ "0x39" ] = {
    ...
    on_talk = function( self )
        opcodeFE54() -- 0x18b9 0xfe
        opcode15() -- 0x18bb 0x15
        -- MISSING OPCODE 0xc4
    end,
