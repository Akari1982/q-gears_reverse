...
Actor[ "0x0c" ] = {
    ...
    on_talk = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0000, flags=0 ) -- 0x01ea 0xd2
...
Actor[ "0x0e" ] = {
    ...
    on_talk = function( self )
        ...
        opcodeD2_MessageShowDynamic( text_id=0x0003, flags=0 ) -- 0x0271 0xd2
