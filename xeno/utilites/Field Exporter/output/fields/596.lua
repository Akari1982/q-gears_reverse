...
Entity[ "0x00" ] = {
    ...
    on_update = function( self )
        ...
        opcode09_EntityCallScriptEW( entity=0x0f, script=04, priority=01 ) -- 0x00b9 0x09
        opcode26_Wait( time=24 ) -- 0x00bc 0x26
        opcode09_EntityCallScriptEW( entity=0x0a, script=04, priority=01 ) -- 0x00bf 0x09
        opcode09_EntityCallScriptEW( entity=0x12, script=04, priority=01 ) -- 0x00c2 0x09
        opcode26_Wait( time=32 ) -- 0x00c5 0x26
        opcode09_EntityCallScriptEW( entity=0x0e, script=04, priority=01 ) -- 0x00c8 0x09
        opcode09_EntityCallScriptEW( entity=0x13, script=04, priority=01 ) -- 0x00cb 0x09
        opcode26_Wait( time=40 ) -- 0x00ce 0x26
        opcode09_EntityCallScriptEW( entity=0x12, script=05, priority=01 ) -- 0x00d1 0x09
        opcode09_EntityCallScriptEW( entity=0x0a, script=05, priority=01 ) -- 0x00d4 0x09
        opcode09_EntityCallScriptEW( entity=0x11, script=04, priority=01 ) -- 0x00d7 0x09
        opcode09_EntityCallScriptEW( entity=0x01, script=04, priority=01 ) -- 0x00da 0x09
        opcode09_EntityCallScriptEW( entity=0x0b, script=04, priority=01 ) -- 0x00dd 0x09
        opcode09_EntityCallScriptEW( entity=0x14, script=04, priority=01 ) -- 0x00e0 0x09
        opcode09_EntityCallScriptEW( entity=0x11, script=05, priority=01 ) -- 0x00e3 0x09
        opcode09_EntityCallScriptEW( entity=0x0b, script=05, priority=01 ) -- 0x00e6 0x09
        opcode09_EntityCallScriptEW( entity=0x11, script=06, priority=01 ) -- 0x00e9 0x09
        -- 0x35() -- 0x00ec 0x35
        -- MISSING OPCODE 0x9a
    end,
...
Entity[ "0x02" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x0128 0xfe
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x012c 0xfe
...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x013a 0xfe
...
Entity[ "0x04" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x0149 0xfe
...
Entity[ "0x05" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x0158 0xfe
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x015c 0xfe
...
Entity[ "0x06" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x016a 0xfe
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x016e 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x017c 0xfe
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x0180 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x018b 0xfe
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x018f 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x019a 0xfe
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x019e 0xfe
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x01a9 0xfe
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x0205 0xfe
...
Entity[ "0x0c" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x0272 0xfe
...
Entity[ "0x0d" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x02a0 0xfe
...
Entity[ "0x0e" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x02ce 0xfe
...
Entity[ "0x0f" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x0309 0xfe
...
Entity[ "0x11" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=70 ) -- 0x0373 0xfe
...
Entity[ "0x12" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=71 ) -- 0x03dc 0xfe
...
Entity[ "0x13" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=78 ) -- 0x0417 0xfe
...
Entity[ "0x14" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=29 ) -- 0x047b 0xfe
