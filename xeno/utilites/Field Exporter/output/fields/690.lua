...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=1 ) -- 0x0040 0xfe
...
Entity[ "0x04" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=3 ) -- 0x004b 0xfe
...
Entity[ "0x06" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 4 ) -- 0x005e 0x16
        -- 0xFE0D_SetAvatar( character_id=4 ) -- 0x0061 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 6 ) -- 0x0069 0x16
        -- 0xFE0D_SetAvatar( character_id=6 ) -- 0x006c 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 7 ) -- 0x0074 0x16
        -- 0xFE0D_SetAvatar( character_id=7 ) -- 0x0077 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 8 ) -- 0x007f 0x16
        -- 0xFE0D_SetAvatar( character_id=8 ) -- 0x0082 0xfe
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 10 ) -- 0x0095 0x16
        -- 0xFE0D_SetAvatar( character_id=10 ) -- 0x0098 0xfe
...
Entity[ "0x0c" ] = {
    on_start = function( self )
        -- 0x0B_InitNPC( 1 ) -- 0x00a0 0x0b
        -- 0x19_SetPosition( x=(vf80)0xfece, z=(vf40)0xfbef, flag=(flag)0xc0 ) -- 0x00a3 0x19
        -- MISSING OPCODE 0x69
    end,
    ...
    on_talk = function( self )
        ...
        opcodeD2_MessageShow0( dialog_id=0x0000, ???=0x00 ) -- 0x00b1 0xd2
        -- 0x9C() -- 0x00b5 0x9c
        -- MISSING OPCODE 0x8b
    end,
