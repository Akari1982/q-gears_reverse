...
Entity[ "1" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=0 ) -- 0x00c8 0xfe
        -- MISSING OPCODE 0x1f
    end,
...
Entity[ "4" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=3 ) -- 0x00ef 0xfe
        -- MISSING OPCODE 0x1f
    end,
...
Entity[ "5" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=4 ) -- 0x00fc 0xfe
        -- MISSING OPCODE 0x1f
    end,
...
Entity[ "6" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=5 ) -- 0x0109 0xfe
        -- MISSING OPCODE 0x1f
    end,
...
Entity[ "8" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=7 ) -- 0x0123 0xfe
        -- MISSING OPCODE 0x1f
    end,
...
Entity[ "9" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=8 ) -- 0x0130 0xfe
        -- MISSING OPCODE 0x1f
    end,
