...
Actor[ "0x06" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=6 ) -- 0x004b 0x16
        opcodeFE0D_MessageSetFace( char_id=6 ) -- 0x004e 0xfe
...
Actor[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=7 ) -- 0x0056 0x16
        opcodeFE0D_MessageSetFace( char_id=7 ) -- 0x0059 0xfe
...
Actor[ "0x08" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=8 ) -- 0x0061 0x16
        opcodeFE0D_MessageSetFace( char_id=8 ) -- 0x0064 0xfe
...
Actor[ "0x0b" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x00be, z=(vf40)0x0043, flag=(flag)0xc0 ) -- 0x0085 0x19
        opcode69_ActorSetRotation( rot=5 ) -- 0x008b 0x69
...
Actor[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xffbc, z=(vf40)0xffa2, flag=(flag)0xc0 ) -- 0x00a1 0x19
        opcode69_ActorSetRotation( rot=4 ) -- 0x00a7 0x69
