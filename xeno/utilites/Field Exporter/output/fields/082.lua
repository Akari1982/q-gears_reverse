...
Entity[ "1" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=GetVar( 0x003e ) ) -- 0x0048 0xfe
...
Entity[ "2" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=GetVar( 0x0040 ) ) -- 0x0056 0xfe
...
Entity[ "3" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=GetVar( 0x0042 ) ) -- 0x0064 0xfe
