...
Actor[ "0x02" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=1 ) -- 0x009d 0x16
        opcodeFE0D_MessageSetFace( char_id=1 ) -- 0x00a0 0xfe
...
Actor[ "0x03" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=2 ) -- 0x00ac 0x16
        opcodeFE0D_MessageSetFace( char_id=2 ) -- 0x00af 0xfe
...
Actor[ "0x04" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=9 ) -- 0x00bb 0x16
        opcodeFE0D_MessageSetFace( char_id=9 ) -- 0x00be 0xfe
...
Actor[ "0x05" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=3 ) -- 0x00ca 0x16
        opcodeFE0D_MessageSetFace( char_id=3 ) -- 0x00cd 0xfe
...
Actor[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=5 ) -- 0x00e8 0x16
        opcodeFE0D_MessageSetFace( char_id=5 ) -- 0x00eb 0xfe
...
Actor[ "0x08" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=6 ) -- 0x00f7 0x16
        opcodeFE0D_MessageSetFace( char_id=6 ) -- 0x00fa 0xfe
...
Actor[ "0x09" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=10 ) -- 0x0106 0x16
        opcodeFE0D_MessageSetFace( char_id=10 ) -- 0x0109 0xfe
...
Actor[ "0x0a" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=7 ) -- 0x0115 0x16
        opcodeFE0D_MessageSetFace( char_id=7 ) -- 0x0118 0xfe
...
Actor[ "0x0b" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=8 ) -- 0x0124 0x16
        opcodeFE0D_MessageSetFace( char_id=8 ) -- 0x0127 0xfe
...
Actor[ "0x0e" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x01a1 0xbc
        -- MISSING OPCODE 0xf8
    end,
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x01b4 0xfe
        opcode74_SoundPlayFixedVolume( sound_id=119 ) -- 0x01b6 0x74
        opcode09_ActorCallScriptEW( actor_id=0x14, script=04, priority=06 ) -- 0x01b9 0x09
        -- 0x98_MapLoad( field_id=355, value=0 ) -- 0x01bc 0x98
...
Actor[ "0x14" ] = {
    ...
    script_0x04 = function( self )
        opcode35_VariableSet( address=0x0404, value=(vf40)0x0000, flag=0x40 ) -- 0x01e0 0x35
