...
Entity[ "0x02" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 1 ) -- 0x0040 0x16
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x0043 0xfe
        -- 0x23() -- 0x0047 0x23
...
Entity[ "0x04" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 3 ) -- 0x0058 0x16
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x005b 0xfe
        -- 0x23() -- 0x005f 0x23
...
Entity[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 6 ) -- 0x007c 0x16
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x007f 0xfe
        -- 0x23() -- 0x0083 0x23
...
Entity[ "0x09" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 8 ) -- 0x0094 0x16
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x0097 0xfe
        -- 0x23() -- 0x009b 0x23
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 9 ) -- 0x00a0 0x16
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x00a3 0xfe
        -- 0x23() -- 0x00a7 0x23
