...
Entity[ "0x01" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x0077 0xfe
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x007b 0xfe
...
Entity[ "0x02" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 1 ) -- 0x0083 0x16
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x0086 0xfe
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x008a 0xfe
...
Entity[ "0x03" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 9 ) -- 0x0092 0x16
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x0095 0xfe
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x0099 0xfe
...
Entity[ "0x04" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 3 ) -- 0x00a1 0x16
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x00a4 0xfe
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x00a8 0xfe
...
Entity[ "0x05" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x00b3 0xfe
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x00b7 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 6 ) -- 0x00ce 0x16
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x00d1 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x00e4 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 8 ) -- 0x00ec 0x16
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x00ef 0xfe
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x00f3 0xfe
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x08bd, z=(vf40)0x0035, flag=(flag)0xc0 ) -- 0x00fc 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xf43b, z=(vf40)0xfa53, flag=(flag)0xc0 ) -- 0x0132 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x0179, z=(vf40)0xff0c, flag=(flag)0xc0 ) -- 0x0168 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x0d" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xfb86, z=(vf40)0x020a, flag=(flag)0xc0 ) -- 0x0198 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x0e" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xfb5e, z=(vf40)0xfae5, flag=(flag)0xc0 ) -- 0x01c8 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x0f" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x01fd 0xbc
        -- 0x2A() -- 0x01fe 0x2a
...
Entity[ "0x12" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x0260 0xbc
        -- 0x2A() -- 0x0261 0x2a
...
Entity[ "0x13" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x0281 0xbc
        -- 0x2A() -- 0x0282 0x2a
