...
0x0009    -- 0xA0()
0x0010    op35_VariableSet( address=0x0404, value=(vf40)0x0001, flag=0x40 )
0x0016    op35_VariableSet( address=0x0406, value=(vf40)0x003f, flag=0x40 )
0x001c    op35_VariableSet( address=0x0408, value=(vf40)0x0036, flag=0x40 )
0x0022    op35_VariableSet( address=0x040a, value=(vf40)0x0000, flag=0x40 )
0x0028    op35_VariableSet( address=0x040c, value=(vf40)0x0003, flag=0x40 )
0x002e    op35_VariableSet( address=0x040e, value=(vf40)0x0003, flag=0x40 )
0x0034    -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0162 ), value2=(s16)0x2000, condition="value1 & value2", jump_if_false=0x003f )
0x003c    op36_VariableSetTrue( address=0x0410 )
0x003f    -- 0x2A()
0x0040    -- 0x75( ???=58 )
0x0043    op00_Return()
...
0x0046    op3A_VariableBitSet( address=0x0162, bit_num=(vf40)0x000d, flag=0x40 )
0x004c    op00_Return()
