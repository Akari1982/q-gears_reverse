...
Actor[ "0x00" ] = {
    on_start = function( self )
        ...
        -- 0xA0() -- 0x0009 0xa0
        opcode35_VariableSet( address=0x0404, value=(vf40)0x0001, flag=0x40 ) -- 0x0010 0x35
        opcode35_VariableSet( address=0x0406, value=(vf40)0x003f, flag=0x40 ) -- 0x0016 0x35
        opcode35_VariableSet( address=0x0408, value=(vf40)0x0036, flag=0x40 ) -- 0x001c 0x35
        opcode35_VariableSet( address=0x040a, value=(vf40)0x0000, flag=0x40 ) -- 0x0022 0x35
        opcode35_VariableSet( address=0x040c, value=(vf40)0x0003, flag=0x40 ) -- 0x0028 0x35
        opcode35_VariableSet( address=0x040e, value=(vf40)0x0003, flag=0x40 ) -- 0x002e 0x35
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0162 ), value2=(s16)0x2000, condition="value1 & value2", jump_if_false=0x003f ) -- 0x0034 0x02
        opcode36_VariableSetTrue( address=0x0410 ) -- 0x003c 0x36
        -- 0x2A() -- 0x003f 0x2a
        -- 0x75( ???=58 ) -- 0x0040 0x75
...
Actor[ "0x02" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=1 ) -- 0x005c 0x16
        opcodeFE0D_MessageSetFace( char_id=1 ) -- 0x005f 0xfe
        opcodeFE0D_MessageSetFace( char_id=1 ) -- 0x0063 0xfe
...
Actor[ "0x03" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=9 ) -- 0x006b 0x16
        opcodeFE0D_MessageSetFace( char_id=9 ) -- 0x006e 0xfe
        opcodeFE0D_MessageSetFace( char_id=9 ) -- 0x0072 0xfe
...
Actor[ "0x05" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=4 ) -- 0x0090 0xfe
...
Actor[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=6 ) -- 0x00a7 0x16
        opcodeFE0D_MessageSetFace( char_id=6 ) -- 0x00aa 0xfe
        opcodeFE0D_MessageSetFace( char_id=6 ) -- 0x00ae 0xfe
...
Actor[ "0x08" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=7 ) -- 0x00b6 0x16
        opcodeFE0D_MessageSetFace( char_id=7 ) -- 0x00b9 0xfe
...
Actor[ "0x0b" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xff66, z=(vf40)0x007d, flag=(flag)0xc0 ) -- 0x00da 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Actor[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xfde2, z=(vf40)0xfddc, flag=(flag)0xc0 ) -- 0x00f1 0x19
        -- MISSING OPCODE 0xf8
    end,
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x0109 0xfe
        opcode74_SoundPlayFixedVolume( sound_id=119 ) -- 0x010b 0x74
        opcode09_ActorCallScriptEW( actor_id=0x0d, script=04, priority=01 ) -- 0x010e 0x09
...
Actor[ "0x0d" ] = {
    ...
    script_0x04 = function( self )
        opcode37_VariableSetFalse( address=0x0402 ) -- 0x0125 0x37
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0402 ), value2=(s16)0x000e, condition="value1 < value2", jump_if_false=0x0140 ) -- 0x0128 0x02
        -- 0xC6() -- 0x0130 0xc6
