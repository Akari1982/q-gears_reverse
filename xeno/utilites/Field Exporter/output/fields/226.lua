...
Actor_0x01:on_start:
0x016a    -- 0x16_ActorPCInit( char_id=GetVar( 0x003e ) )
0x016d    opFE0D_MessageSetFace( char_id=GetVar( 0x003e ) )
0x0171    op00_Return()
...
Actor_0x02:on_start:
0x0190    -- 0x16_ActorPCInit( char_id=GetVar( 0x0040 ) )
0x0193    opFE0D_MessageSetFace( char_id=GetVar( 0x0040 ) )
0x0197    op00_Return()
...
Actor_0x03:on_start:
0x019b    -- 0x16_ActorPCInit( char_id=GetVar( 0x0042 ) )
0x019e    opFE0D_MessageSetFace( char_id=GetVar( 0x0042 ) )
0x01a2    op00_Return()
