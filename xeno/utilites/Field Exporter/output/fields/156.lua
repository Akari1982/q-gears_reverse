...
Actor[ "0x01" ] = {
    ...
    on_update = function( self )
        ...
        -- 0x27( actor_id=(entity)0x15 ) -- 0x0046 0x27
        -- 0x98_MapLoad( field_id=157, value=3 ) -- 0x0048 0x98
        -- 0x5B() -- 0x004d 0x5b
        -- 0xCB_TriggerJumpTo( trigger_id=GetVar( 0x6701 ), jump=0x1500 ) -- 0x004e 0xcb
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0400 ), value2=(s16)0x0001, condition="value1 == value2", jump_if_false=0x005f ) -- 0x0053 0x02
        -- 0x5A() -- 0x005b 0x5a
        -- 0x01_JumpTo( 0x0053 ) -- 0x005c 0x01
        -- 0x27( actor_id=(entity)0x15 ) -- 0x005f 0x27
        -- 0x98_MapLoad( field_id=157, value=4 ) -- 0x0061 0x98
        -- 0x5B() -- 0x0066 0x5b
...
Actor[ "0x02" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=0 ) -- 0x0068 0x16
        opcodeFE0D_MessageSetFace( char_id=0 ) -- 0x006b 0xfe
...
Actor[ "0x03" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=1 ) -- 0x0073 0x16
        opcodeFE0D_MessageSetFace( char_id=1 ) -- 0x0076 0xfe
...
Actor[ "0x05" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=3 ) -- 0x0089 0x16
        opcodeFE0D_MessageSetFace( char_id=3 ) -- 0x008c 0xfe
...
Actor[ "0x06" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=4 ) -- 0x0094 0x16
        opcodeFE0D_MessageSetFace( char_id=4 ) -- 0x0097 0xfe
...
Actor[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=5 ) -- 0x009f 0x16
        opcodeFE0D_MessageSetFace( char_id=5 ) -- 0x00a2 0xfe
...
Actor[ "0x08" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=6 ) -- 0x00aa 0x16
        opcodeFE0D_MessageSetFace( char_id=6 ) -- 0x00ad 0xfe
...
Actor[ "0x09" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=7 ) -- 0x00b5 0x16
...
Actor[ "0x0a" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=8 ) -- 0x00c0 0x16
        opcodeFE0D_MessageSetFace( char_id=8 ) -- 0x00c3 0xfe
...
Actor[ "0x0c" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=10 ) -- 0x00d6 0x16
        opcodeFE0D_MessageSetFace( char_id=10 ) -- 0x00d9 0xfe
...
Actor[ "0x10" ] = {
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x0143 0xfe
        -- 0x07( actor_id=0x11, script=0x24 ) -- 0x0145 0x07
        opcode09_ActorCallScriptEW( actor_id=0x12, script=04, priority=01 ) -- 0x0148 0x09
        ...
        -- 0x27( actor_id=(entity)0x15 ) -- 0x0157 0x27
