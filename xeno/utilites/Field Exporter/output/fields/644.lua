...
Entity[ "0x04" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=GetVar( 0x003e ) ) -- 0x4356 0xfe
...
Entity[ "0x05" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=GetVar( 0x0040 ) ) -- 0x4384 0xfe
        -- MISSING OPCODE 0xFE03
    end,
...
Entity[ "0x06" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=GetVar( 0x0042 ) ) -- 0x4397 0xfe
        -- MISSING OPCODE 0xFE03
    end,
...
Entity[ "0x0a" ] = {
    ...
    on_talk = function( self )
        ...
        opcode09_EntityCallScriptEW( entity=0x0c, script=04, priority=01 ) -- 0x4458 0x09
        ...
        opcode09_EntityCallScriptEW( entity=0x0c, script=04, priority=01 ) -- 0x446a 0x09
...
Entity[ "0x0b" ] = {
    ...
    on_talk = function( self )
        ...
        opcode09_EntityCallScriptEW( entity=0x0d, script=04, priority=01 ) -- 0x4494 0x09
