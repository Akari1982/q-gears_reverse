...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x0039 0xfe
...
Entity[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x0000, z=(vf40)0xffa2, flag=(flag)0xc0 ) -- 0x009c 0x19
        -- MISSING OPCODE 0x69
    end,
...
Entity[ "0x0e" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xff3c, z=(vf40)0x0050, flag=(flag)0xc0 ) -- 0x00c6 0x19
        -- MISSING OPCODE 0x69
    end,
