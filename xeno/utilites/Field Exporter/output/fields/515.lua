...
Actor[ "0x00" ] = {
    ...
    on_update = function( self )
        ...
        opcode25_ActorDisable( actor_id=(entity)0x0e ) -- 0x00e3 0x25
        opcode25_ActorDisable( actor_id=(entity)0x0f ) -- 0x00e5 0x25
        -- 0xB3() -- 0x00e7 0xb3
        opcode26_Wait( time=80 ) -- 0x00ea 0x26
        -- 0x07( actor_id=0x14, script=0x24 ) -- 0x00ed 0x07
        opcode09_ActorCallScriptEW( actor_id=0x13, script=07, priority=01 ) -- 0x00f0 0x09
        opcode09_ActorCallScriptEW( actor_id=0x11, script=05, priority=01 ) -- 0x00f3 0x09
        opcode09_ActorCallScriptEW( actor_id=0x11, script=07, priority=01 ) -- 0x00f6 0x09
        opcode09_ActorCallScriptEW( actor_id=0x13, script=0a, priority=01 ) -- 0x00f9 0x09
        opcode09_ActorCallScriptEW( actor_id=0x11, script=08, priority=01 ) -- 0x00fc 0x09
        opcode09_ActorCallScriptEW( actor_id=0x13, script=0b, priority=01 ) -- 0x00ff 0x09
        opcode09_ActorCallScriptEW( actor_id=0x11, script=09, priority=01 ) -- 0x0102 0x09
        opcode09_ActorCallScriptEW( actor_id=0x13, script=0c, priority=01 ) -- 0x0105 0x09
        opcode09_ActorCallScriptEW( actor_id=0x11, script=0a, priority=01 ) -- 0x0108 0x09
        opcode09_ActorCallScriptEW( actor_id=0x13, script=0d, priority=01 ) -- 0x010b 0x09
        opcode09_ActorCallScriptEW( actor_id=0x11, script=0b, priority=01 ) -- 0x010e 0x09
        opcode09_ActorCallScriptEW( actor_id=0x13, script=0e, priority=01 ) -- 0x0111 0x09
        opcode09_ActorCallScriptEW( actor_id=0x11, script=0c, priority=01 ) -- 0x0114 0x09
        opcodeF1_FadeSetUp( steps=2, r=255, g=255, b=255, semi_tr=32 ) -- 0x0117 0xf1
        opcode26_Wait( time=32 ) -- 0x0122 0x26
        opcodeD0_MessageSettings( x=100, y=120, letters=0, rows=0, flags=0 ) -- 0x0125 0xd0
        opcodeF5_MessageShowStatic( text_id=0x0000, flags=CLOSE_OFF_SCREEN|NO_WINDOW ) -- 0x0130 0xf5
...
Actor[ "0x02" ] = {
    on_start = function( self )
        ...
        -- 0x2A() -- 0x0326 0x2a
        opcode35_VariableSet( address=0x0414, value=(vf40)0x007f, flag=0x40 ) -- 0x0327 0x35
        opcode35_VariableSet( address=0x0416, value=(vf40)0x000d, flag=0x40 ) -- 0x032d 0x35
...
Actor[ "0x0c" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=0 ) -- 0x067c 0x16
        opcodeFE0D_MessageSetFace( char_id=0 ) -- 0x067f 0xfe
        -- 0x2A() -- 0x0683 0x2a
        -- MISSING OPCODE 0x29
    end,
...
Actor[ "0x0d" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=26 ) -- 0x068c 0xfe
    ...
    on_update = function( self )
        ...
        opcode2C_SpritePlayAnim( anim_id=0x06 ) -- 0x06ae 0x2c
        opcode36_VariableSetTrue( address=0x0444 ) -- 0x06b0 0x36
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0001, flags=CLOSE_OFF_SCREEN ) -- 0x06b5 0xd2
    ...
    script_0x06 = function( self )
        ...
        opcodeD2_MessageShowDynamic( text_id=0x0002, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x06cc 0xd2
        opcode9C_MessageSync() -- 0x06d0 0x9c
        opcode2C_SpritePlayAnim( anim_id=0x02 ) -- 0x06d1 0x2c
...
Actor[ "0x10" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=31 ) -- 0x06f5 0xfe
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0003, flags=CLOSE_OFF_SCREEN ) -- 0x0711 0xd2
        opcode9C_MessageSync() -- 0x0715 0x9c
        return 0 -- 0x0716 0x00
    end,

    script_0x05 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0004, flags=CLOSE_OFF_SCREEN ) -- 0x0717 0xd2
        opcode9C_MessageSync() -- 0x071b 0x9c
        return 0 -- 0x071c 0x00
    end,

    script_0x06 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0005, flags=CLOSE_OFF_SCREEN ) -- 0x071d 0xd2
...
Actor[ "0x11" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=2 ) -- 0x0735 0xfe
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0007, flags=CLOSE_OFF_SCREEN ) -- 0x074e 0xd2
        opcode9C_MessageSync() -- 0x0752 0x9c
        return 0 -- 0x0753 0x00
    end,

    script_0x05 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0008, flags=CLOSE_OFF_SCREEN ) -- 0x0754 0xd2
        opcode9C_MessageSync() -- 0x0758 0x9c
        return 0 -- 0x0759 0x00
    end,

    script_0x06 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0009, flags=CLOSE_OFF_SCREEN ) -- 0x075a 0xd2
        opcode9C_MessageSync() -- 0x075e 0x9c
        return 0 -- 0x075f 0x00
    end,

    script_0x07 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x000a, flags=CLOSE_OFF_SCREEN ) -- 0x0760 0xd2
        opcode9C_MessageSync() -- 0x0764 0x9c
        return 0 -- 0x0765 0x00
    end,

    script_0x08 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x000b, flags=CLOSE_OFF_SCREEN ) -- 0x0766 0xd2
        opcode9C_MessageSync() -- 0x076a 0x9c
        return 0 -- 0x076b 0x00
    end,

    script_0x09 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x000c, flags=CLOSE_OFF_SCREEN ) -- 0x076c 0xd2
        opcode9C_MessageSync() -- 0x0770 0x9c
        return 0 -- 0x0771 0x00
    end,

    script_0x0a = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x000d, flags=CLOSE_OFF_SCREEN ) -- 0x0772 0xd2
        opcode9C_MessageSync() -- 0x0776 0x9c
        return 0 -- 0x0777 0x00
    end,

    script_0x0b = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x000e, flags=CLOSE_OFF_SCREEN ) -- 0x0778 0xd2
        opcode9C_MessageSync() -- 0x077c 0x9c
        return 0 -- 0x077d 0x00
    end,

    script_0x0c = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x000f, flags=CLOSE_OFF_SCREEN ) -- 0x077e 0xd2
        opcode9C_MessageSync() -- 0x0782 0x9c
        return 0 -- 0x0783 0x00
    end,

    script_0x0d = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0010, flags=CLOSE_OFF_SCREEN|FORCE_BOTTOM ) -- 0x0784 0xd2
        opcode9C_MessageSync() -- 0x0788 0x9c
        return 0 -- 0x0789 0x00
    end,

    script_0x0e = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0011, flags=CLOSE_OFF_SCREEN|FORCE_BOTTOM ) -- 0x078a 0xd2
        opcode9C_MessageSync() -- 0x078e 0x9c
        return 0 -- 0x078f 0x00
    end,

    script_0x0f = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0012, flags=CLOSE_OFF_SCREEN|FORCE_BOTTOM ) -- 0x0790 0xd2
        opcode9C_MessageSync() -- 0x0794 0x9c
...
Actor[ "0x12" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x0796 0xbc
        -- 0x2A() -- 0x0797 0x2a
        -- MISSING OPCODE 0xf9
    end,
...
Actor[ "0x13" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=54 ) -- 0x07aa 0xfe
        -- MISSING OPCODE 0xFE1c
    end,
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0013, flags=CLOSE_OFF_SCREEN ) -- 0x07bc 0xd2
        opcode9C_MessageSync() -- 0x07c0 0x9c
        return 0 -- 0x07c1 0x00
    end,

    script_0x05 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0014, flags=CLOSE_OFF_SCREEN ) -- 0x07c2 0xd2
        opcode9C_MessageSync() -- 0x07c6 0x9c
        return 0 -- 0x07c7 0x00
    end,

    script_0x06 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0015, flags=CLOSE_OFF_SCREEN ) -- 0x07c8 0xd2
        opcode9C_MessageSync() -- 0x07cc 0x9c
        return 0 -- 0x07cd 0x00
    end,

    script_0x07 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0016, flags=CLOSE_OFF_SCREEN ) -- 0x07ce 0xd2
        opcode9C_MessageSync() -- 0x07d2 0x9c
        return 0 -- 0x07d3 0x00
    end,

    script_0x08 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0017, flags=CLOSE_OFF_SCREEN ) -- 0x07d4 0xd2
        opcode9C_MessageSync() -- 0x07d8 0x9c
        return 0 -- 0x07d9 0x00
    end,

    script_0x09 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0018, flags=CLOSE_OFF_SCREEN ) -- 0x07da 0xd2
        opcode9C_MessageSync() -- 0x07de 0x9c
        return 0 -- 0x07df 0x00
    end,

    script_0x0a = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0019, flags=CLOSE_OFF_SCREEN ) -- 0x07e0 0xd2
        opcode9C_MessageSync() -- 0x07e4 0x9c
        return 0 -- 0x07e5 0x00
    end,

    script_0x0b = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x001a, flags=CLOSE_OFF_SCREEN ) -- 0x07e6 0xd2
        opcode9C_MessageSync() -- 0x07ea 0x9c
        return 0 -- 0x07eb 0x00
    end,

    script_0x0c = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x001b, flags=CLOSE_OFF_SCREEN ) -- 0x07ec 0xd2
        opcode9C_MessageSync() -- 0x07f0 0x9c
        return 0 -- 0x07f1 0x00
    end,

    script_0x0d = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x001c, flags=CLOSE_OFF_SCREEN ) -- 0x07f2 0xd2
        opcode9C_MessageSync() -- 0x07f6 0x9c
        opcode26_Wait( time=45 ) -- 0x07f7 0x26
        opcodeD2_MessageShowDynamic( text_id=0x001d, flags=CLOSE_OFF_SCREEN ) -- 0x07fa 0xd2
        opcode9C_MessageSync() -- 0x07fe 0x9c
        return 0 -- 0x07ff 0x00
    end,

    script_0x0e = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x001e, flags=CLOSE_OFF_SCREEN ) -- 0x0800 0xd2
        opcode9C_MessageSync() -- 0x0804 0x9c
        return 0 -- 0x0805 0x00
    end,

    script_0x0f = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x001f, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x0806 0xd2
        opcode9C_MessageSync() -- 0x080a 0x9c
        return 0 -- 0x080b 0x00
    end,

    script_0x10 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0020, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x080c 0xd2
        opcode9C_MessageSync() -- 0x0810 0x9c
        return 0 -- 0x0811 0x00
    end,

    script_0x11 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0021, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x0812 0xd2
        opcode9C_MessageSync() -- 0x0816 0x9c
        return 0 -- 0x0817 0x00
    end,

    script_0x12 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0022, flags=CLOSE_OFF_SCREEN ) -- 0x0818 0xd2
        opcode9C_MessageSync() -- 0x081c 0x9c
        return 0 -- 0x081d 0x00
    end,

    script_0x13 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0023, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x081e 0xd2
        opcode9C_MessageSync() -- 0x0822 0x9c
        return 0 -- 0x0823 0x00
    end,

    script_0x14 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0024, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x0824 0xd2
        opcode9C_MessageSync() -- 0x0828 0x9c
        opcode26_Wait( time=24 ) -- 0x0829 0x26
        opcode09_ActorCallScriptEW( actor_id=0x0d, script=05, priority=01 ) -- 0x082c 0x09
        opcode26_Wait( time=50 ) -- 0x082f 0x26
        -- MISSING OPCODE 0xFE65
    end,

    script_0x15 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0026, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x0841 0xd2
        opcode9C_MessageSync() -- 0x0845 0x9c
        return 0 -- 0x0846 0x00
    end,

    script_0x16 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0027, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x0847 0xd2
        opcode9C_MessageSync() -- 0x084b 0x9c
        return 0 -- 0x084c 0x00
    end,

    script_0x17 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0028, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x084d 0xd2
    ...
    script_0x18 = function( self )
        ...
        opcode26_Wait( time=12 ) -- 0x0855 0x26
        opcode2C_SpritePlayAnim( anim_id=0xff ) -- 0x0858 0x2c
        opcode26_Wait( time=0 ) -- 0x085a 0x26
        opcode2C_SpritePlayAnim( anim_id=0x03 ) -- 0x085d 0x2c
        return 0 -- 0x085f 0x00
    end,

    script_0x19 = function( self )
        -- 0xC6() -- 0x0860 0xc6
        -- 0xFE8F_ParticleSystemInit1( actor_id=(entity)0x13, render_settings=0, rot_x=0, rot_y=0 ) -- 0x0861 0xfe
...
Actor[ "0x14" ] = {
    ...
    script_0x04 = function( self )
        -- 0xFE8F_ParticleSystemInit1( actor_id=(entity)self, render_settings=0, rot_x=0, rot_y=0 ) -- 0x0999 0xfe
