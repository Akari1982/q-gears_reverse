...
0x0054    opFE4D_SpritePlayAddAnim( anim_id=0x00 )
0x0057    opD0_MessageSettings( x=170, y=130, letters=0, rows=0, flags=0 )
0x0062    opD2_MessageShowDynamic( text_id=0x0000, flags=0 )
0x0066    op9C_MessageSync()
0x0067    opF4_MessageClose( type=0x01 )
0x0069    op00_Return()

Actor_0x01:script_0x09:
0x006a    op69_ActorSetRotation( rot=5 )
0x006d    opFE4D_SpritePlayAddAnim( anim_id=0x01 )
0x0070    opD0_MessageSettings( x=170, y=130, letters=0, rows=0, flags=0 )
0x007b    opD2_MessageShowDynamic( text_id=0x0001, flags=0 )
0x007f    op9C_MessageSync()
0x0080    opF4_MessageClose( type=0x01 )
0x0082    op00_Return()

Actor_0x01:script_0x0a:
0x0083    op69_ActorSetRotation( rot=5 )
0x0086    opFE4D_SpritePlayAddAnim( anim_id=0x02 )
0x0089    opD0_MessageSettings( x=170, y=130, letters=0, rows=0, flags=0 )
0x0094    opD2_MessageShowDynamic( text_id=0x0002, flags=0 )
0x0098    op9C_MessageSync()
0x0099    opF4_MessageClose( type=0x01 )
0x009b    op00_Return()

Actor_0x01:script_0x0b:
0x009c    opF4_MessageClose( type=0x00 )
