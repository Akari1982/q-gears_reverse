...
Entity[ "0x01" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x00d5 0xfe
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x00d9 0xfe
...
Entity[ "0x02" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x017f 0xfe
        -- MISSING OPCODE 0xFE8b
    end,
...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x0221 0xfe
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x0225 0xfe
        -- MISSING OPCODE 0xFE8b
    end,
...
Entity[ "0x04" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x02c7 0xfe
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x02cb 0xfe
        -- MISSING OPCODE 0xFE07
    end,
...
Entity[ "0x05" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x041a 0xfe
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x041e 0xfe
        -- MISSING OPCODE 0xFE8b
    end,
...
Entity[ "0x06" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x04c0 0xfe
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x04c4 0xfe
        -- MISSING OPCODE 0xFE8b
    end,
...
Entity[ "0x07" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x0566 0xfe
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x056a 0xfe
        -- MISSING OPCODE 0xFE8b
    end,
...
Entity[ "0x08" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x060c 0xfe
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x0610 0xfe
        -- MISSING OPCODE 0xFE8b
    end,
...
Entity[ "0x09" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x06b2 0xfe
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x06b6 0xfe
        -- MISSING OPCODE 0xFE8b
    end,
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=14 ) -- 0x0758 0xfe
        opcodeFE0D_SetAvatar( character_id=10 ) -- 0x075c 0xfe
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x0780 0xfe
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x0784 0xfe
...
Entity[ "0x0d" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=27 ) -- 0x0880 0xfe
...
Entity[ "0x0e" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x08ca 0xfe
