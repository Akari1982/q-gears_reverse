...
Entity[ "0x00" ] = {
    ...
    script_0x04 = function( self )
        opcode09_EntityCallScriptEW( entity=0x02, script=04, priority=03 ) -- 0x001f 0x09
        -- 0x07( entity=0x1a, script=0x65 ) -- 0x0022 0x07
        opcode09_EntityCallScriptEW( entity=0x1b, script=05, priority=03 ) -- 0x0025 0x09
        opcode26_Wait( time=20 ) -- 0x0028 0x26
        opcode09_EntityCallScriptEW( entity=0x1a, script=06, priority=03 ) -- 0x002b 0x09
        opcode09_EntityCallScriptEW( entity=0x02, script=08, priority=03 ) -- 0x002e 0x09
        opcode26_Wait( time=20 ) -- 0x0031 0x26
        opcode09_EntityCallScriptEW( entity=0x1c, script=05, priority=03 ) -- 0x0034 0x09
    ...
    script_0x05 = function( self )
        ...
        opcode09_EntityCallScriptEW( entity=0x1c, script=04, priority=03 ) -- 0x0044 0x09
...
Entity[ "0x01" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x01c3 0xfe
...
Entity[ "0x02" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x0208 0xfe
...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x0288 0xfe
        -- MISSING OPCODE 0xFE8b
    end,
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0000, ???=0x01 ) -- 0x02c9 0xd2
        -- 0x9C() -- 0x02cd 0x9c
...
Entity[ "0x04" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x02d2 0xfe
        -- MISSING OPCODE 0xFE8b
    end,
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0001, ???=0x01 ) -- 0x0313 0xd2
        -- 0x9C() -- 0x0317 0x9c
...
Entity[ "0x05" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x031c 0xfe
        -- MISSING OPCODE 0xFE8b
    end,
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0002, ???=0x01 ) -- 0x035d 0xd2
        -- 0x9C() -- 0x0361 0x9c
...
Entity[ "0x06" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x0366 0xfe
        -- MISSING OPCODE 0xFE8b
    end,
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0003, ???=0x01 ) -- 0x03a7 0xd2
        -- 0x9C() -- 0x03ab 0x9c
...
Entity[ "0x07" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x03b0 0xfe
        -- MISSING OPCODE 0xFE8b
    end,
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0004, ???=0x01 ) -- 0x03f1 0xd2
        -- 0x9C() -- 0x03f5 0x9c
...
Entity[ "0x08" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x03fa 0xfe
        -- MISSING OPCODE 0xFE8b
    end,
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0005, ???=0x01 ) -- 0x043b 0xd2
        -- 0x9C() -- 0x043f 0x9c
...
Entity[ "0x09" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=31 ) -- 0x0444 0xfe
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=53 ) -- 0x0491 0xfe
        -- MISSING OPCODE 0xFE1c
    end,
