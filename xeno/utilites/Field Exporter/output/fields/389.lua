...
Actor[ "0x00" ] = {
    ...
    on_update = function( self )
        ...
        -- 0x07( actor_id=0x04, script=0x24 ) -- 0x003a 0x07
        opcode09_ActorCallScriptEW( actor_id=0x01, script=04, priority=01 ) -- 0x003d 0x09
        opcode26_Wait( time=40 ) -- 0x0040 0x26
        opcode09_ActorCallScriptEW( actor_id=0x01, script=05, priority=01 ) -- 0x0043 0x09
        opcode09_ActorCallScriptEW( actor_id=0x02, script=04, priority=01 ) -- 0x0046 0x09
        opcode09_ActorCallScriptEW( actor_id=0x04, script=05, priority=01 ) -- 0x0049 0x09
        opcode09_ActorCallScriptEW( actor_id=0x01, script=06, priority=01 ) -- 0x004c 0x09
        opcode09_ActorCallScriptEW( actor_id=0x01, script=07, priority=01 ) -- 0x004f 0x09
        opcode26_Wait( time=41 ) -- 0x0052 0x26
        opcode09_ActorCallScriptEW( actor_id=0x02, script=05, priority=01 ) -- 0x0055 0x09
        -- 0x07( actor_id=0x04, script=0x26 ) -- 0x0058 0x07
...
Actor[ "0x01" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x115d, z=(vf40)0x12e6, flag=(flag)0xc0 ) -- 0x006d 0x19
        -- MISSING OPCODE 0x5f
    end,
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0000, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x007d 0xd2
        opcode9C_MessageSync() -- 0x0081 0x9c
        return 0 -- 0x0082 0x00
    end,

    script_0x05 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0001, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x0083 0xd2
        opcode9C_MessageSync() -- 0x0087 0x9c
        return 0 -- 0x0088 0x00
    end,

    script_0x06 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0002, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x0089 0xd2
        opcode9C_MessageSync() -- 0x008d 0x9c
        return 0 -- 0x008e 0x00
    end,

    script_0x07 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0003, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x008f 0xd2
...
Actor[ "0x02" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x11cf, z=(vf40)0x12c0, flag=(flag)0xc0 ) -- 0x0098 0x19
        -- MISSING OPCODE 0x5f
    end,
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0004, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x00a7 0xd2
        opcode9C_MessageSync() -- 0x00ab 0x9c
        return 0 -- 0x00ac 0x00
    end,

    script_0x05 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0005, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x00ad 0xd2
...
Actor[ "0x07" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x0142 0xbc
        -- 0x2A() -- 0x0143 0x2a
...
Actor[ "0x09" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x014c 0xbc
        -- 0x2A() -- 0x014d 0x2a
...
Actor[ "0x0f" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x016a 0xbc
        -- 0x2A() -- 0x016b 0x2a
...
Actor[ "0x12" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x0179 0xbc
        -- 0x2A() -- 0x017a 0x2a
...
Actor[ "0x16" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x018d 0xbc
        -- 0x2A() -- 0x018e 0x2a
