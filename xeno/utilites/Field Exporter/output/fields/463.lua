...
Actor_0x0c:on_talk:
0x009b    -- 0x02_ConditionalJumpTo( value1=GetVar( 0x040a ), value2=(s16)0x0000, condition="value1 == value2", jump_if_false=0x00be )
0x00a3    op36_VariableSetTrue( address=0x040a )
