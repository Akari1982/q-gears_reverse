...
Entity[ "0x03" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 1 ) -- 0x002c 0x16
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x002f 0xfe
...
Entity[ "0x04" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 2 ) -- 0x0037 0x16
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x003a 0xfe
...
Entity[ "0x06" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 4 ) -- 0x0064 0x16
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x0067 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 5 ) -- 0x006f 0x16
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x0072 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 6 ) -- 0x007a 0x16
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x007d 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 7 ) -- 0x0085 0x16
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x0088 0xfe
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 8 ) -- 0x0090 0x16
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x0093 0xfe
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 14 ) -- 0x009b 0x16
        opcodeFE0D_SetAvatar( character_id=14 ) -- 0x009e 0xfe
...
Entity[ "0x0c" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 9 ) -- 0x00a6 0x16
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x00a9 0xfe
...
Entity[ "0x0d" ] = {
    on_start = function( self )
        ...
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0102 ), value2=(s16)0x0024, condition="value1 >= value2", jump_if_false=0x00c8 ) -- 0x00b4 0x02
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0102 ), value2=(s16)0x0040, condition="value1 <= value2", jump_if_false=0x00c8 ) -- 0x00bc 0x02
        -- 0x23() -- 0x00c4 0x23
        -- MISSING OPCODE 0x27
    end,
    ...
    on_talk = function( self )
        ...
        opcodeD2_MessageShow0( dialog_id=0x0000, ???=0x00 ) -- 0x00de 0xd2
        -- 0x9C() -- 0x00e2 0x9c
        -- 0x01_JumpTo( 0x00eb ) -- 0x00e3 0x01
        opcodeD2_MessageShow0( dialog_id=0x0001, ???=0x00 ) -- 0x00e6 0xd2
        -- 0x9C() -- 0x00ea 0x9c
