...
Actor[ "0x08" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=7 ) -- 0x0086 0x16
        opcodeFE0D_MessageSetFace( char_id=7 ) -- 0x0089 0xfe
...
Actor[ "0x09" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=8 ) -- 0x0091 0x16
        opcodeFE0D_MessageSetFace( char_id=8 ) -- 0x0094 0xfe
...
Actor[ "0x0a" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=9 ) -- 0x009c 0x16
        opcodeFE0D_MessageSetFace( char_id=9 ) -- 0x009f 0xfe
...
Actor[ "0x0b" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=10 ) -- 0x00a7 0x16
        opcodeFE0D_MessageSetFace( char_id=10 ) -- 0x00aa 0xfe
...
Actor[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xffb0, z=(vf40)0xff23, flag=(flag)0xc0 ) -- 0x00b5 0x19
        -- MISSING OPCODE 0x5f
    end,
