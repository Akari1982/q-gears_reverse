...
Entity[ "0x04" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x005d 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x007e 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 7 ) -- 0x0086 0x16
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x0089 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 8 ) -- 0x0091 0x16
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x0094 0xfe
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 9 ) -- 0x009c 0x16
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x009f 0xfe
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 10 ) -- 0x00a7 0x16
        opcodeFE0D_SetAvatar( character_id=10 ) -- 0x00aa 0xfe
...
Entity[ "0x0c" ] = {
    on_start = function( self )
        -- 0x0B_InitNPC( 0 ) -- 0x00b2 0x0b
        -- 0x19_SetPosition( x=(vf80)0xffb0, z=(vf40)0xff23, flag=(flag)0xc0 ) -- 0x00b5 0x19
        -- MISSING OPCODE 0x5f
    end,
