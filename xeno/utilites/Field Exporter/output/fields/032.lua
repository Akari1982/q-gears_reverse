...
0x009a    -- 0xA8_VariableRandom2( address=0x0400, value=1 )
0x009f    -- 0xA8_VariableRandom2( address=0x0402, value=60 )
0x00a4    -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call )
0x00aa    op26_Wait( time=GetVar( 0x0402 ) )
0x00ad    -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0400 ), value2=(s16)0x0000, condition="value1 == value2", jump_if_false=0x00c9 )
0x00b5    -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call )
0x00bb    -- 0xA8_VariableRandom2( address=0x0402, value=60 )
0x00c0    op26_Wait( time=GetVar( 0x0402 ) )
0x00c3    -- 0x01_JumpTo( 0x009a )
0x00c6    -- 0x01_JumpTo( 0x00da )
0x00c9    -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call )
0x00cf    -- 0xA8_VariableRandom2( address=0x0402, value=60 )
0x00d4    op26_Wait( time=GetVar( 0x0402 ) )
0x00d7    -- 0x01_JumpTo( 0x009a )
0x00da    op00_Return()
