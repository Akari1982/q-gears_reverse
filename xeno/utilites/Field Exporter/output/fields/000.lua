...
Entity[ "0x00" ] = {
    ...
    on_update = function( self )
        ...
        opcodeD2_MessageShow0( dialog_id=0x0000, ???=0x01 ) -- 0x0023 0xd2
        -- MISSING OPCODE 0xa9
    end,
...
Entity[ "0x02" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x03cd 0xfe
...
Entity[ "0x04" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x03e3 0xfe
...
Entity[ "0x05" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x03ee 0xfe
...
Entity[ "0x06" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x03f9 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x0404 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x040f 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x041a 0xfe
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x0425 0xfe
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x0430 0xfe
...
Entity[ "0x0c" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=10 ) -- 0x043b 0xfe
...
Entity[ "0x0d" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=11 ) -- 0x0446 0xfe
...
Entity[ "0x0e" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=12 ) -- 0x0450 0xfe
...
Entity[ "0x0f" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=13 ) -- 0x045a 0xfe
...
Entity[ "0x11" ] = {
    ...
    on_talk = function( self )
        ...
        -- 0x35() -- 0x0536 0x35
        -- 0xD0() -- 0x053c 0xd0
        opcodeD2_MessageShow0( dialog_id=0x0020, ???=0x00 ) -- 0x0547 0xd2
        -- MISSING OPCODE 0xa9
    end,
...
Entity[ "0x13" ] = {
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0025, ???=0x00 ) -- 0x0928 0xd2
        -- MISSING OPCODE 0xa9
    end,
...
Entity[ "0x14" ] = {
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0026, ???=0x00 ) -- 0x0955 0xd2
        -- MISSING OPCODE 0xa9
    end,
...
Entity[ "0x15" ] = {
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0027, ???=0x00 ) -- 0x0982 0xd2
        -- MISSING OPCODE 0xa9
    end,
...
Entity[ "0x16" ] = {
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0028, ???=0x00 ) -- 0x09af 0xd2
        -- MISSING OPCODE 0xa9
    end,
...
Entity[ "0x17" ] = {
    ...
    on_talk = function( self )
        ...
        opcodeFE50() -- 0x09f8 0xfe
        -- 0xD0() -- 0x09fa 0xd0
        opcodeD2_MessageShow0( dialog_id=0x0029, ???=0x00 ) -- 0x0a05 0xd2
        -- MISSING OPCODE 0xa9
    end,
...
Entity[ "0x1a" ] = {
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0037, ???=0x00 ) -- 0x121e 0xd2
        -- MISSING OPCODE 0xa9
    end,
