...
Entity[ "0x01" ] = {
    ...
    on_update = function( self )
        ...
        opcodeFE52() -- 0x0105 0xfe
        -- 0x07( entity=0x02, script=0x05 ) -- 0x0107 0x07
        opcode26_Wait( time=50 ) -- 0x010a 0x26
        -- 0x07( entity=0x04, script=0x04 ) -- 0x010d 0x07
        opcode09_EntityCallScriptEW( entity=0x05, script=04, priority=00 ) -- 0x0110 0x09
        opcode09_EntityCallScriptEW( entity=0x06, script=04, priority=00 ) -- 0x0113 0x09
    ...
    script_0x04 = function( self )
        ...
        opcode25_EntityDisable( entity=(entity)0x0b ) -- 0x0141 0x25
        opcode25_EntityDisable( entity=(entity)0x0e ) -- 0x0143 0x25
        opcode25_EntityDisable( entity=(entity)0x0d ) -- 0x0145 0x25
        opcode15() -- 0x0147 0x15
        opcodeFE52() -- 0x0148 0xfe
        -- 0x75() -- 0x014a 0x75
        -- MISSING OPCODE 0xFEa2
    end,
...
Entity[ "0x02" ] = {
    ...
    script_0x04 = function( self )
        ...
        opcode60() -- 0x0175 0x60
        opcode64() -- 0x0176 0x64
        -- MISSING OPCODE 0x62
    end,

    script_0x05 = function( self )
        opcode99() -- 0x01aa 0x99
        opcode63() -- 0x01ab 0x63
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x0540 0xfe
...
Entity[ "0x0c" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x054b 0xfe
...
Entity[ "0x0d" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=2 ) -- 0x0556 0xfe
...
Entity[ "0x0e" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x0561 0xfe
...
Entity[ "0x0f" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x056c 0xfe
...
Entity[ "0x10" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x0577 0xfe
...
Entity[ "0x11" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x0582 0xfe
...
Entity[ "0x12" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x058d 0xfe
...
Entity[ "0x13" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=8 ) -- 0x0598 0xfe
...
Entity[ "0x14" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=10 ) -- 0x05a3 0xfe
