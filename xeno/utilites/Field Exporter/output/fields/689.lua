...
0x012e    -- 0x65( ???=(s)mem[0x424], ???=mem[0x428], ???=mem[0x426] ) -- exp0x1
...
0x0187    -- 0x65( ???=(s)mem[0x424], ???=mem[0x428], ???=mem[0x426] ) -- exp0x1
...
0x01f9    -- 0x63( ???=mem[0x418], ???=mem[0x41a], ???=(s)mem[0x41c] ) -- exp0x1
...
0x0230    -- 0x63( ???=mem[0x418], ???=mem[0x41a], ???=(s)mem[0x41c] ) -- exp0x1
...
0x0346    op0D_Return()
0x0347    -- 0xFE69( actor_id=Actor_0x38, render_settings=(s)mem[0x3e04], rot_x=(s)mem[0x3500], rot_y=mem[0x43a] )
...
0x05ca    op00_Return()
0x05cb    op00_Return()
0x05cc    op07_CallActorEvent( actor_id=Actor_0x5a, event=event_0x09, priority=0x07 )
0x05cf    -- MISSING OPCODE 0x8a
