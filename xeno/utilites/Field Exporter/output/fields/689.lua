...
0x0104    op02_JumpToConditional( val1=(s)mem[0x41e], val2=mem[0x414], condition="val1 < val2", address_if_false=0x142 )
0x010c    -- 0xEC( ???=0x1, ???=(vf80)0x040c, ???=(vf40)0x040e, ???=(vf20)0x0410, flag=0x0, ???=0x424, ???=0x428, ???=0x426 )
0x011b    -- 0xA3()
0x0123    opAC_MoveCamera( control=0x0, steps=mem[0x40a] )
0x0127    opAC_MoveCamera( control=0x1, steps=mem[0x40a] )
0x012b    opEF_MoveCameraSync()
0x012e    -- 0x65( ???=(s)mem[0x424], ???=mem[0x428], ???=(s)mem[0x426] ) -- exp0x1
...
0x015d    op02_JumpToConditional( val1=(s)mem[0x41e], val2=mem[0x414], condition="val1 < val2", address_if_false=0x1a7 )
0x0165    -- 0xEC( ???=0x1, ???=(vf80)0x040c, ???=(vf40)0x040e, ???=(vf20)0x0410, flag=0x0, ???=0x424, ???=0x428, ???=0x426 )
0x0174    -- 0xA3()
0x017c    opAC_MoveCamera( control=0x0, steps=mem[0x40a] )
0x0180    opAC_MoveCamera( control=0x1, steps=mem[0x40a] )
0x0184    opEF_MoveCameraSync()
0x0187    -- 0x65( ???=(s)mem[0x424], ???=mem[0x428], ???=(s)mem[0x426] ) -- exp0x1
...
0x01f9    -- 0x63( ???=(s)mem[0x418], ???=mem[0x41a], ???=mem[0x41c] ) -- exp0x1
...
0x0230    -- 0x63( ???=(s)mem[0x418], ???=mem[0x41a], ???=mem[0x41c] ) -- exp0x1
...
0x0282    -- 0xA3()
0x028a    opAC_MoveCamera( control=0x0, steps=mem[0x40a] )
0x028e    opAC_MoveCamera( control=0x1, steps=mem[0x40a] )
0x0292    opEF_MoveCameraSync()
0x0295    -- 0x65( ???=mem[0x424], ???=mem[0x428], ???=mem[0x426] ) -- exp0x1
...
0x02c7    op0D_Return()
0x02c8    opAC_MoveCamera( control=0x0, steps=mem[0x40a] )
0x02cc    opAC_MoveCamera( control=0x1, steps=mem[0x40a] )
0x02d0    opEF_MoveCameraSync()
0x02d3    op0D_Return()
0x02d4    opAC_MoveCamera( control=0x80, steps=mem[0x40a] )
0x02d8    opAC_MoveCamera( control=0x81, steps=mem[0x40a] )
...
0x0346    op0D_Return()
0x0347    -- 0xFE69( actor_id=Actor_0x38, render_settings=mem[0x3e04], rot_x=mem[0x3500], rot_y=mem[0x43a] )
...
0x035b    op02_JumpToConditional( val1=mem[0x438], val2=51, condition="val1 < val2", address_if_false=0x369 )
0x0363    mem[0x43a] = 0 -- op35
0x0369    op02_JumpToConditional( val1=mem[0x438], val2=101, condition="val1 > val2", address_if_false=0x377 )
0x0371    mem[0x43a] = 2 -- op35
0x0377    op02_JumpToConditional( val1=mem[0x438], val2=156, condition="val1 > val2", address_if_false=0x385 )
...
0x0390    op02_JumpToConditional( val1=mem[0x438], val2=32, condition="val1 < val2", address_if_false=0x39e )
0x0398    mem[0x43a] = 0 -- op35
0x039e    op02_JumpToConditional( val1=mem[0x438], val2=62, condition="val1 > val2", address_if_false=0x3ac )
0x03a6    mem[0x43a] = 2 -- op35
0x03ac    op02_JumpToConditional( val1=mem[0x438], val2=142, condition="val1 > val2", address_if_false=0x3ba )
...
0x03c5    op02_JumpToConditional( val1=mem[0x438], val2=42, condition="val1 < val2", address_if_false=0x3d3 )
0x03cd    mem[0x43a] = 0 -- op35
0x03d3    op02_JumpToConditional( val1=mem[0x438], val2=102, condition="val1 > val2", address_if_false=0x3e1 )
0x03db    mem[0x43a] = 2 -- op35
0x03e1    op02_JumpToConditional( val1=mem[0x438], val2=142, condition="val1 > val2", address_if_false=0x3ef )
...
0x03fa    op02_JumpToConditional( val1=mem[0x438], val2=44, condition="val1 < val2", address_if_false=0x408 )
0x0402    mem[0x43a] = 0 -- op35
0x0408    op02_JumpToConditional( val1=mem[0x438], val2=104, condition="val1 > val2", address_if_false=0x416 )
0x0410    mem[0x43a] = 2 -- op35
0x0416    op02_JumpToConditional( val1=mem[0x438], val2=154, condition="val1 > val2", address_if_false=0x424 )
...
0x042f    op02_JumpToConditional( val1=mem[0x438], val2=63, condition="val1 < val2", address_if_false=0x43d )
0x0437    mem[0x43a] = 0 -- op35
0x043d    op02_JumpToConditional( val1=mem[0x438], val2=153, condition="val1 > val2", address_if_false=0x44b )
0x0445    mem[0x43a] = 2 -- op35
0x044b    op02_JumpToConditional( val1=mem[0x438], val2=193, condition="val1 > val2", address_if_false=0x459 )
...
0x0464    op02_JumpToConditional( val1=mem[0x438], val2=34, condition="val1 < val2", address_if_false=0x472 )
0x046c    mem[0x43a] = 0 -- op35
0x0472    op02_JumpToConditional( val1=mem[0x438], val2=94, condition="val1 > val2", address_if_false=0x480 )
0x047a    mem[0x43a] = 2 -- op35
0x0480    op02_JumpToConditional( val1=mem[0x438], val2=174, condition="val1 > val2", address_if_false=0x48e )
...
0x0499    op02_JumpToConditional( val1=mem[0x438], val2=12, condition="val1 < val2", address_if_false=0x4a7 )
0x04a1    mem[0x43a] = 0 -- op35
0x04a7    op02_JumpToConditional( val1=mem[0x438], val2=82, condition="val1 > val2", address_if_false=0x4b5 )
0x04af    mem[0x43a] = 2 -- op35
0x04b5    op02_JumpToConditional( val1=mem[0x438], val2=182, condition="val1 > val2", address_if_false=0x4c3 )
...
0x04ce    op02_JumpToConditional( val1=mem[0x438], val2=28, condition="val1 < val2", address_if_false=0x4dc )
0x04d6    mem[0x43a] = 0 -- op35
0x04dc    op02_JumpToConditional( val1=mem[0x438], val2=83, condition="val1 > val2", address_if_false=0x4ea )
0x04e4    mem[0x43a] = 2 -- op35
0x04ea    op02_JumpToConditional( val1=mem[0x438], val2=153, condition="val1 > val2", address_if_false=0x4f8 )
...
0x0503    op02_JumpToConditional( val1=mem[0x438], val2=46, condition="val1 < val2", address_if_false=0x511 )
0x050b    mem[0x43a] = 0 -- op35
0x0511    op02_JumpToConditional( val1=mem[0x438], val2=136, condition="val1 > val2", address_if_false=0x51f )
0x0519    mem[0x43a] = 2 -- op35
0x051f    op02_JumpToConditional( val1=mem[0x438], val2=186, condition="val1 > val2", address_if_false=0x52d )
...
0x0538    op02_JumpToConditional( val1=mem[0x438], val2=18, condition="val1 < val2", address_if_false=0x546 )
0x0540    mem[0x43a] = 0 -- op35
0x0546    op02_JumpToConditional( val1=mem[0x438], val2=68, condition="val1 > val2", address_if_false=0x554 )
0x054e    mem[0x43a] = 2 -- op35
0x0554    op02_JumpToConditional( val1=mem[0x438], val2=148, condition="val1 > val2", address_if_false=0x562 )
0x055c    mem[0x43a] = 3 -- op35
0x0562    op01_JumpTo( address=0x565 )
0x0565    op02_JumpToConditional( val1=mem[0x43a], val2=0, condition="val1 == val2", address_if_false=0x578 )
0x056d    -- opFE08( scale_x=3000, scale_y=4096, scale_z=3500 )
0x0575    op01_JumpTo( address=0x5b1 )
0x0578    op02_JumpToConditional( val1=mem[0x43a], val2=1, condition="val1 == val2", address_if_false=0x58b )
0x0580    -- opFE08( scale_x=4096, scale_y=4096, scale_z=3500 )
0x0588    op01_JumpTo( address=0x5b1 )
0x058b    op02_JumpToConditional( val1=mem[0x43a], val2=2, condition="val1 == val2", address_if_false=0x59e )
0x0593    -- opFE08( scale_x=6096, scale_y=4096, scale_z=3500 )
0x059b    op01_JumpTo( address=0x5b1 )
0x059e    op02_JumpToConditional( val1=mem[0x43a], val2=3, condition="val1 == val2", address_if_false=0x5b1 )
...
0x05cc    op00_Return()
0x05cd    op00_Return()
0x05ce    -- 0x65( ???=(s)mem[0x746e], ???=mem[0x305e], ???=-12680 ) -- exp0x1
0x05d6    -- 0xBD()
