...
0x012e    -- 0x65( ???=mem[0x424], ???=mem[0x428], ???=(s)mem[0x426] ) -- exp0x1
0x0136    mem[0x41e] += 1 -- op3c
0x0139    mem[0x410] += mem[0x412] -- op38
...
0x0187    -- 0x65( ???=mem[0x424], ???=mem[0x428], ???=(s)mem[0x426] ) -- exp0x1
0x018f    mem[0x41e] += 1 -- op3c
0x0192    mem[0x40e] += (s)mem[0x416] -- op38
0x0198    mem[0x410] += mem[0x412] -- op38
...
0x0295    -- 0x65( ???=mem[0x424], ???=mem[0x428], ???=(s)mem[0x426] ) -- exp0x1
...
0x0346    op0D_Return()
0x0347    -- 0xFE69( actor_id=Actor_0x38, render_settings=(s)mem[0x3e04], rot_x=mem[0x3500], rot_y=mem[0x43a] )
...
0x05ca    op00_Return()
0x05cb    op00_Return()
0x05cc    op08_CallActorEventStartSync( actor_id=Actor_0x00, event=event_0x1a, priority=0x01 )
0x05cf    -- MISSING OPCODE 0x04
