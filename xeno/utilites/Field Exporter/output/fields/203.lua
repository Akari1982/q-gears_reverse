...
Actor[ "0x03" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xff8c, z=(vf40)0xff77, flag=(flag)0xc0 ) -- 0x002a 0x19
        -- MISSING OPCODE 0x5f
    end,

    on_update = function( self )
        opcode2C_SpritePlayAnim( anim_id=0x02 ) -- 0x0033 0x2c
...
Actor[ "0x06" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=1 ) -- 0x00fe 0x16
        opcodeFE0D_MessageSetFace( char_id=1 ) -- 0x0101 0xfe
...
Actor[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=2 ) -- 0x0109 0x16
        opcodeFE0D_MessageSetFace( char_id=2 ) -- 0x010c 0xfe
...
Actor[ "0x09" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=4 ) -- 0x011f 0x16
        opcodeFE0D_MessageSetFace( char_id=4 ) -- 0x0122 0xfe
...
Actor[ "0x0a" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=5 ) -- 0x012a 0x16
        opcodeFE0D_MessageSetFace( char_id=5 ) -- 0x012d 0xfe
...
Actor[ "0x0b" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=6 ) -- 0x0135 0x16
        opcodeFE0D_MessageSetFace( char_id=6 ) -- 0x0138 0xfe
...
Actor[ "0x0c" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=7 ) -- 0x0140 0x16
        opcodeFE0D_MessageSetFace( char_id=7 ) -- 0x0143 0xfe
...
Actor[ "0x0d" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=8 ) -- 0x014b 0x16
        opcodeFE0D_MessageSetFace( char_id=8 ) -- 0x014e 0xfe
...
Actor[ "0x0e" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=9 ) -- 0x0156 0x16
        opcodeFE0D_MessageSetFace( char_id=9 ) -- 0x0159 0xfe
...
Actor[ "0x0f" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=10 ) -- 0x0161 0x16
        opcodeFE0D_MessageSetFace( char_id=10 ) -- 0x0164 0xfe
