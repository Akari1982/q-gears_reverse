...
Actor[ "0x00" ] = {
    ...
    on_update = function( self )
        ...
        -- 0xFE54() -- 0x00d5 0xfe
        opcode26_Wait( time=32 ) -- 0x00d7 0x26
        opcode26_Wait( time=15 ) -- 0x00da 0x26
        -- MISSING OPCODE 0xf2
    end,
    ...
    script_0x04 = function( self )
        opcode3A_VariableBitSet( address=0x0162, bit_num=(vf40)0x0004, flag=0x40 ) -- 0x0233 0x3a
        return 0 -- 0x0239 0x00
    end,

    script_0x05 = function( self )
        opcode3A_VariableBitSet( address=0x0162, bit_num=(vf40)0x0005, flag=0x40 ) -- 0x023a 0x3a
...
Actor[ "0x02" ] = {
    ...
    script_0x04 = function( self )
        opcodeF1_FadeSetUp( steps=1, r=255, g=255, b=150, semi_tr=3 ) -- 0x029f 0xf1
        opcode26_Wait( time=3 ) -- 0x02aa 0x26
        opcodeF1_FadeSetUp( steps=1, r=0, g=0, b=0, semi_tr=3 ) -- 0x02ad 0xf1
        opcode26_Wait( time=3 ) -- 0x02b8 0x26
        opcodeF1_FadeSetUp( steps=1, r=255, g=255, b=150, semi_tr=3 ) -- 0x02bb 0xf1
        opcode26_Wait( time=180 ) -- 0x02c6 0x26
...
Actor[ "0x04" ] = {
    on_start = function( self )
        ...
        -- 0x2A() -- 0x0337 0x2a
        opcode37_VariableSetFalse( address=0x0422 ) -- 0x0338 0x37
        opcode37_VariableSetFalse( address=0x0432 ) -- 0x033b 0x37
    ...
    on_push = function( self )
        -- 0x07( actor_id=0x20, script=0x64 ) -- 0x039e 0x07
        -- 0x07( actor_id=0x21, script=0x64 ) -- 0x03a1 0x07
        -- 0x07( actor_id=0x22, script=0x64 ) -- 0x03a4 0x07
        -- 0x07( actor_id=0x23, script=0x64 ) -- 0x03a7 0x07
        -- 0x07( actor_id=0x11, script=0x64 ) -- 0x03aa 0x07
        -- 0x07( actor_id=0x13, script=0x64 ) -- 0x03ad 0x07
        -- 0x07( actor_id=0x15, script=0x64 ) -- 0x03b0 0x07
        -- 0x07( actor_id=0x17, script=0x65 ) -- 0x03b3 0x07
        -- 0x07( actor_id=0x19, script=0x64 ) -- 0x03b6 0x07
        -- 0x07( actor_id=0x1b, script=0x65 ) -- 0x03b9 0x07
        -- 0xC6() -- 0x03bc 0xc6
        -- 0x07( actor_id=0x12, script=0x64 ) -- 0x03bd 0x07
        -- 0x07( actor_id=0x14, script=0x64 ) -- 0x03c0 0x07
        -- 0x07( actor_id=0x16, script=0x64 ) -- 0x03c3 0x07
        -- 0x07( actor_id=0x18, script=0x65 ) -- 0x03c6 0x07
        -- 0x07( actor_id=0x1a, script=0x64 ) -- 0x03c9 0x07
        -- 0x07( actor_id=0x1c, script=0x65 ) -- 0x03cc 0x07
        -- 0x07( actor_id=0x24, script=0x64 ) -- 0x03cf 0x07
        -- 0x07( actor_id=0x25, script=0x64 ) -- 0x03d2 0x07
...
Actor[ "0x05" ] = {
    on_start = function( self )
        ...
        -- 0x2A() -- 0x0439 0x2a
        opcode37_VariableSetFalse( address=0x0434 ) -- 0x043a 0x37
        opcode35_VariableSet( address=0x0436, value=(vf40)0x0080, flag=0x40 ) -- 0x043d 0x35
    ...
    script_0x06 = function( self )
        -- 0xFE54() -- 0x04b6 0xfe
        -- 0x60() -- 0x04b8 0x60
        -- 0x63( ???=(vf80)0x005f, ???=(vf40)0xfdbd, ???=(vf20)0xfe8e, flag=0xe0 ) -- 0x04b9 0x63
        -- 0x64() -- 0x04c1 0x64
        opcodeA3() -- 0x04c2 0xa3
        opcodeAC_MoveCamera( control=0x01, steps=16 ) -- 0x04ca 0xac
        opcodeAC_MoveCamera( control=0x00, steps=16 ) -- 0x04ce 0xac
        opcodeEF_MoveCameraSync() -- 0x04d2 0xef
...
Actor[ "0x06" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=0 ) -- 0x04d6 0x16
        opcodeFE0D_MessageSetFace( char_id=0 ) -- 0x04d9 0xfe
        opcodeFE0D_MessageSetFace( char_id=0 ) -- 0x04dd 0xfe
        -- 0x19_ActorSetPosition( x=(vf80)0x00dc, z=(vf40)0xfe5c, flag=(flag)0xc0 ) -- 0x04e1 0x19
        -- MISSING OPCODE 0x5f
    end,
    ...
    script_0x04 = function( self )
        opcode6F_ActorRotateToActor( actor_id=(entity)0x07 ) -- 0x051c 0x6f
        opcodeD2_MessageShowDynamic( text_id=0x0001, flags=FORCE_BOTTOM|0x80 ) -- 0x051e 0xd2
        opcode9C_MessageSync() -- 0x0522 0x9c
        return 0 -- 0x0523 0x00
    end,

    script_0x05 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0002, flags=FORCE_TOP|0x80 ) -- 0x0524 0xd2
        opcode9C_MessageSync() -- 0x0528 0x9c
        opcode26_Wait( time=15 ) -- 0x0529 0x26
        opcode09_ActorCallScriptEW( actor_id=0x04, script=04, priority=01 ) -- 0x052c 0x09
        -- MISSING OPCODE 0x9a
    end,

    script_0x06 = function( self )
        opcode2C_SpritePlayAnim( anim_id=0xff ) -- 0x0533 0x2c
        opcode26_Wait( time=10 ) -- 0x0535 0x26
        opcodeFE4E_SpriteAddAnimUnload() -- 0x0538 0xfe
    ...
    script_0x07 = function( self )
        opcode6F_ActorRotateToActor( actor_id=(entity)0x07 ) -- 0x0547 0x6f
...
Actor[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=2 ) -- 0x054a 0x16
        opcodeFE0D_MessageSetFace( char_id=2 ) -- 0x054d 0xfe
        -- 0x19_ActorSetPosition( x=(vf80)0x0095, z=(vf40)0xfe74, flag=(flag)0xc0 ) -- 0x0551 0x19
        opcodeFE0D_MessageSetFace( char_id=2 ) -- 0x0557 0xfe
        -- MISSING OPCODE 0x5f
    end,
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0003, flags=0x80 ) -- 0x059c 0xd2
        opcode9C_MessageSync() -- 0x05a0 0x9c
    ...
    script_0x06 = function( self )
        -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call ) -- 0x05c6 0x4a
        opcodeD2_MessageShowDynamic( text_id=0x0005, flags=FORCE_BOTTOM|0x80 ) -- 0x05cc 0xd2
        opcode9C_MessageSync() -- 0x05d0 0x9c
        -- 0xF6( ???=0x01 ) -- 0x05d1 0xf6
        -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call ) -- 0x05d3 0x4a
        -- 0xF6( ???=0x00 ) -- 0x05d9 0xf6
        return 0 -- 0x05db 0x00
    end,

    script_0x07 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0006, flags=FORCE_TOP|0x80 ) -- 0x05dc 0xd2
        opcode9C_MessageSync() -- 0x05e0 0x9c
        return 0 -- 0x05e1 0x00
    end,

    script_0x08 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0007, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x05e2 0xd2
        opcode9C_MessageSync() -- 0x05e6 0x9c
        return 0 -- 0x05e7 0x00
    end,

    script_0x09 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0008, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x05e8 0xd2
        opcode9C_MessageSync() -- 0x05ec 0x9c
        return 0 -- 0x05ed 0x00
    end,

    script_0x0a = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x0009, flags=FORCE_TOP|0x80 ) -- 0x05ee 0xd2
        opcode9C_MessageSync() -- 0x05f2 0x9c
...
Actor[ "0x08" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x05f4 0xbc
        opcodeFE0D_MessageSetFace( char_id=2 ) -- 0x05f5 0xfe
        -- 0x2A() -- 0x05f9 0x2a
    ...
    script_0x04 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x000a, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x05fd 0xd2
        opcode9C_MessageSync() -- 0x0601 0x9c
        return 0 -- 0x0602 0x00
    end,

    script_0x05 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x000b, flags=FORCE_TOP|0x80 ) -- 0x0603 0xd2
        opcode9C_MessageSync() -- 0x0607 0x9c
        return 0 -- 0x0608 0x00
    end,

    script_0x06 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x000c, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x0609 0xd2
        opcode9C_MessageSync() -- 0x060d 0x9c
        return 0 -- 0x060e 0x00
    end,

    script_0x07 = function( self )
        opcodeD2_MessageShowDynamic( text_id=0x000d, flags=CLOSE_OFF_SCREEN|FORCE_TOP ) -- 0x060f 0xd2
...
Actor[ "0x09" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xfd17, z=(vf40)0xffbb, flag=(flag)0xc0 ) -- 0x0616 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Actor[ "0x0a" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xfd8a, z=(vf40)0x0040, flag=(flag)0xc0 ) -- 0x065c 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Actor[ "0x0b" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x024c, z=(vf40)0x003c, flag=(flag)0xc0 ) -- 0x069c 0x19
        -- MISSING OPCODE 0xf8
    end,
    ...
    on_talk = function( self )
        ...
        -- 0x07( actor_id=0x08, script=0x26 ) -- 0x06c4 0x07
...
Actor[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x01d6, z=(vf40)0xffb7, flag=(flag)0xc0 ) -- 0x06f0 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Actor[ "0x11" ] = {
    ...
    on_update = function( self )
        ...
        opcode35_VariableSet( address=0x0402, value=(vf40)0x1000, flag=0x40 ) -- 0x0764 0x35
...
Actor[ "0x12" ] = {
    on_start = function( self )
        ...
        -- 0x2A() -- 0x0797 0x2a
        -- 0x23() -- 0x0798 0x23
        opcode35_VariableSet( address=0x0402, value=(vf40)0x0000, flag=0x40 ) -- 0x0799 0x35
...
Actor[ "0x17" ] = {
    ...
    on_update = function( self )
        ...
        opcode35_VariableSet( address=0x0400, value=(vf40)0x0402, flag=0x00 ) -- 0x082b 0x35
        opcode35_VariableSet( address=0x0414, value=(vf40)0x0001, flag=0x40 ) -- 0x0831 0x35
...
Actor[ "0x18" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x087f 0xbc
        -- 0x2A() -- 0x0880 0x2a
        -- 0x23() -- 0x0881 0x23
        opcode37_VariableSetFalse( address=0x0438 ) -- 0x0882 0x37
...
Actor[ "0x1c" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x08fa 0xbc
        -- 0x2A() -- 0x08fb 0x2a
        -- 0x23() -- 0x08fc 0x23
        opcode37_VariableSetFalse( address=0x043a ) -- 0x08fd 0x37
...
Actor[ "0x1d" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x0919 0xbc
        -- 0x2A() -- 0x091a 0x2a
        -- 0x23() -- 0x091b 0x23
...
Actor[ "0x1f" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x0945 0xbc
        -- 0x2A() -- 0x0946 0x2a
    ...
    script_0x04 = function( self )
        -- 0x57( type=0x00, x=(vf80)0x0000, z=(vf40)0xfff6, y=(vf20)0x0005, ???=(vf10)0x0002, flag=0xf0 ) -- 0x0953 0x57
        -- 0x57( type=0x8f ) -- 0x095e 0x57
        opcode26_Wait( time=1 ) -- 0x0960 0x26
        -- 0x57( type=0x0f ) -- 0x0963 0x57
        opcode26_Wait( time=5 ) -- 0x0965 0x26
        -- 0xBF( ???=160 ) -- 0x0968 0xbf
        opcode26_Wait( time=10 ) -- 0x096b 0x26
        -- MISSING OPCODE 0xbd
    end,
...
Actor[ "0x22" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x0990 0xbc
        -- 0x2A() -- 0x0991 0x2a
        -- 0x23() -- 0x0992 0x23
    ...
    on_update = function( self )
        ...
        opcode3A_VariableBitSet( address=0x0080, bit_num=(vf40)0xcb80, flag=0x00 ) -- 0x0999 0x3a
        -- MISSING OPCODE 0xa6
    end,
...
Actor[ "0x23" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x09aa 0xbc
        -- 0x2A() -- 0x09ab 0x2a
        -- 0x23() -- 0x09ac 0x23
...
Actor[ "0x25" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x09ba 0xbc
        -- 0x2A() -- 0x09bb 0x2a
        -- 0x23() -- 0x09bc 0x23
