...
Entity[ "5" ] = {
    ...
    script_0x08 = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0014, ???=0x21 ) -- 0x055c 0xd2
        -- 0x9C() -- 0x0560 0x9c
        opcodeD2_DialogShow0( dialog_id=0x0015, ???=0x21 ) -- 0x0561 0xd2
        -- 0x9C() -- 0x0565 0x9c
        opcodeD2_DialogShow0( dialog_id=0x0016, ???=0x21 ) -- 0x0566 0xd2
        -- 0x9C() -- 0x056a 0x9c
