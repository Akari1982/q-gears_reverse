...
Entity[ "0x01" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=0 ) -- 0x006a 0xfe
...
Entity[ "0x02" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 1 ) -- 0x0072 0x16
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x0075 0xfe
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x0079 0xfe
...
Entity[ "0x03" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x0088 0xfe
...
Entity[ "0x04" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x0093 0xfe
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x0097 0xfe
...
Entity[ "0x05" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 4 ) -- 0x009f 0x16
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x00a2 0xfe
        opcodeFE0D_SetAvatar( character_id=4 ) -- 0x00a6 0xfe
...
Entity[ "0x06" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 5 ) -- 0x00ae 0x16
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x00b1 0xfe
...
Entity[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 6 ) -- 0x00bd 0x16
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x00c0 0xfe
...
Entity[ "0x08" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x00d3 0xfe
...
Entity[ "0x09" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=1 ) -- 0x00de 0xfe
        -- MISSING OPCODE 0x91
    end,
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0000, ???=0x00 ) -- 0x00f8 0xd2
        -- 0x9C() -- 0x00fc 0x9c
...
Entity[ "0x0a" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=9 ) -- 0x0105 0xfe
        -- MISSING OPCODE 0x91
    end,
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0001, ???=0x00 ) -- 0x011c 0xd2
        -- 0x9C() -- 0x0120 0x9c
...
Entity[ "0x0b" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=3 ) -- 0x0126 0xfe
        -- MISSING OPCODE 0x91
    end,
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0002, ???=0x00 ) -- 0x013d 0xd2
        -- 0x9C() -- 0x0141 0x9c
...
Entity[ "0x0c" ] = {
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0003, ???=0x00 ) -- 0x015e 0xd2
        -- 0x9C() -- 0x0162 0x9c
...
Entity[ "0x0d" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=5 ) -- 0x0168 0xfe
        -- MISSING OPCODE 0x91
    end,
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0004, ???=0x00 ) -- 0x017f 0xd2
        -- 0x9C() -- 0x0183 0x9c
        -- MISSING OPCODE 0x6f
    end,
...
Entity[ "0x0e" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=6 ) -- 0x018e 0xfe
        -- MISSING OPCODE 0x91
    end,
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0005, ???=0x00 ) -- 0x01a5 0xd2
        -- 0x9C() -- 0x01a9 0x9c
...
Entity[ "0x0f" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=7 ) -- 0x01af 0xfe
        -- MISSING OPCODE 0x91
    end,
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0006, ???=0x00 ) -- 0x01c6 0xd2
        -- 0x9C() -- 0x01ca 0x9c
...
Entity[ "0x10" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=71 ) -- 0x01d3 0xfe
        -- 0x19_SetPosition( x=(vf80)0x001a, z=(vf40)0x0134, flag=(flag)0xc0 ) -- 0x01d7 0x19
        -- MISSING OPCODE 0x5f
    end,
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0007, ???=0x00 ) -- 0x01e1 0xd2
        -- 0x9C() -- 0x01e5 0x9c
...
Entity[ "0x11" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=78 ) -- 0x01ee 0xfe
        -- 0x19_SetPosition( x=(vf80)0x00dc, z=(vf40)0xffb6, flag=(flag)0xc0 ) -- 0x01f2 0x19
        -- MISSING OPCODE 0x5f
    end,
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0008, ???=0x10 ) -- 0x01fc 0xd2
        -- 0x9C() -- 0x0200 0x9c
...
Entity[ "0x12" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_SetAvatar( character_id=29 ) -- 0x0209 0xfe
        -- 0x19_SetPosition( x=(vf80)0x00b0, z=(vf40)0xff36, flag=(flag)0xc0 ) -- 0x020d 0x19
        -- MISSING OPCODE 0x5f
    end,
    ...
    on_talk = function( self )
        opcodeD2_MessageShow0( dialog_id=0x0009, ???=0x10 ) -- 0x0219 0xd2
        -- 0x9C() -- 0x021d 0x9c
...
Entity[ "0x14" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x015d, z=(vf40)0x0293, flag=(flag)0xc0 ) -- 0x0234 0x19
        -- MISSING OPCODE 0xf8
    end,
...
Entity[ "0x16" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x0404, z=(vf40)0x0406, flag=(flag)0x00 ) -- 0x0286 0x19
...
Entity[ "0x17" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x0414, z=(vf40)0x0416, flag=(flag)0x00 ) -- 0x02e6 0x19
