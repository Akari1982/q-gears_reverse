...
Entity[ "0x0c" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xffa2, z=(vf40)0xffe7, flag=(flag)0xc0 ) -- 0x0093 0x19
        -- MISSING OPCODE 0x69
    end,
...
Entity[ "0x0e" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x0064, z=(vf40)0x0050, flag=(flag)0xc0 ) -- 0x00f4 0x19
        -- MISSING OPCODE 0x69
    end,
