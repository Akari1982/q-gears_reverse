...
Actor[ "0x01" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x003d 0xbc
...
Actor[ "0x03" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=1 ) -- 0x0059 0x16
        opcodeFE0D_MessageSetFace( char_id=1 ) -- 0x005c 0xfe
        opcodeFE0D_MessageSetFace( char_id=1 ) -- 0x0060 0xfe
...
Actor[ "0x05" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=3 ) -- 0x0092 0xfe
...
Actor[ "0x06" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=4 ) -- 0x00a4 0x16
        opcodeFE0D_MessageSetFace( char_id=4 ) -- 0x00a7 0xfe
...
Actor[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=5 ) -- 0x00bd 0x16
        opcodeFE0D_MessageSetFace( char_id=5 ) -- 0x00c0 0xfe
        opcodeFE0D_MessageSetFace( char_id=5 ) -- 0x00c4 0xfe
...
Actor[ "0x08" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=8 ) -- 0x00d6 0x16
        opcodeFE0D_MessageSetFace( char_id=8 ) -- 0x00d9 0xfe
...
Actor[ "0x09" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=7 ) -- 0x00f6 0xfe
...
Actor[ "0x0a" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=6 ) -- 0x010f 0xfe
...
Actor[ "0x0b" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=14 ) -- 0x0121 0x16
        opcodeFE0D_MessageSetFace( char_id=14 ) -- 0x0124 0xfe
        opcodeFE0D_MessageSetFace( char_id=10 ) -- 0x0128 0xfe
...
Actor[ "0x0c" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=2 ) -- 0x0141 0xfe
...
Actor[ "0x0d" ] = {
    on_start = function( self )
        ...
        opcodeFE0D_MessageSetFace( char_id=18 ) -- 0x0156 0xfe
        opcode20_ActorSetFlags0( flags=15 ) -- 0x015a 0x20
        -- 0xFE07( ???=0x01 ) -- 0x015d 0xfe
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x0002 ), value2=(s16)0x0000, condition="value1 == value2", jump_if_false=0x0173 ) -- 0x0160 0x02
        -- 0x19_ActorSetPosition( x=(vf80)0xff4c, z=(vf40)0x0000, flag=(flag)0xc0 ) -- 0x0168 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x0e" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xff16, z=(vf40)0x000c, flag=(flag)0xc0 ) -- 0x01b6 0x19
        -- MISSING OPCODE 0xf8
    end,
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x01c8 0xfe
        -- 0x07( actor_id=0x0f, script=0x24 ) -- 0x01ca 0x07
        opcode09_ActorCallScriptEW( actor_id=0x10, script=04, priority=01 ) -- 0x01cd 0x09
...
Actor[ "0x0f" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x01db 0xbc
        -- 0x2A() -- 0x01dc 0x2a
    ...
    script_0x04 = function( self )
        ...
        -- 0xBF( ???=32 ) -- 0x01e9 0xbf
        opcode3C_VariableInc( address=0x040c ) -- 0x01ec 0x3c
        -- 0x5A() -- 0x01ef 0x5a
        -- 0x01_JumpTo( 0x01e1 ) -- 0x01f0 0x01
...
Actor[ "0x10" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x01f4 0xbc
        -- 0x2A() -- 0x01f5 0x2a
    ...
    script_0x04 = function( self )
        ...
        -- 0xC0( ???=32 ) -- 0x0202 0xc0
        opcode3C_VariableInc( address=0x040e ) -- 0x0205 0x3c
        -- 0x5A() -- 0x0208 0x5a
        -- 0x01_JumpTo( 0x01fa ) -- 0x0209 0x01
