...
0x0048    op02_JumpToConditional( val1=mem[0x400], val2=4, condition="val1 != val2", address_if_false=0x56 )
0x0050    mem[0x400] = 2 -- op35
0x0056    op01_JumpTo( address=0x67 )
0x0059    op02_JumpToConditional( val1=mem[0x400], val2=3, condition="val1 != val2", address_if_false=0x67 )
...
0x0074    op02_JumpToConditional( val1=mem[0x400], val2=1, condition="val1 == val2", address_if_false=0xdd )
...
0x008a    op02_JumpToConditional( val1=mem[0x404], val2=8, condition="val1 < val2", address_if_false=0xbe )
...
0x00dd    op02_JumpToConditional( val1=mem[0x400], val2=2, condition="val1 == val2", address_if_false=0x143 )
...
0x00f3    op02_JumpToConditional( val1=mem[0x404], val2=8, condition="val1 < val2", address_if_false=0x127 )
0x00fb    op02_JumpToConditional( val1=mem[0x402], val2=27, condition="val1 < val2", address_if_false=0x112 )
...
Actor_0x0e:on_talk:
0x01f2    op02_JumpToConditional( val1=mem[0x400], val2=3, condition="val1 == val2", address_if_false=0x215 )
0x01fa    -- 0xFE54()
