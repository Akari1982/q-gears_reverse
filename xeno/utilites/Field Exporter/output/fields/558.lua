...
Actor[ "0x01" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=0 ) -- 0x016b 0x16
        opcodeFE0D_MessageSetFace( char_id=0 ) -- 0x016e 0xfe
...
Actor[ "0x02" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=1 ) -- 0x0188 0x16
...
Actor[ "0x03" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=2 ) -- 0x0193 0x16
        opcodeFE0D_MessageSetFace( char_id=2 ) -- 0x0196 0xfe
...
Actor[ "0x04" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xfed9, z=(vf40)0x0127, flag=(flag)0xc0 ) -- 0x019f 0x19
        -- MISSING OPCODE 0xf8
    end,
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x01b4 0xfe
        opcode09_ActorCallScriptEW( actor_id=0x06, script=04, priority=01 ) -- 0x01b6 0x09
...
Actor[ "0x05" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xfff1, z=(vf40)0xff56, flag=(flag)0xc0 ) -- 0x01c8 0x19
        -- MISSING OPCODE 0xf8
    end,
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x01dd 0xfe
        opcode09_ActorCallScriptEW( actor_id=0x07, script=04, priority=01 ) -- 0x01df 0x09
        -- 0x07( actor_id=0x01, script=0x25 ) -- 0x01e2 0x07
...
Actor[ "0x06" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x01f0 0xbc
        -- 0x2A() -- 0x01f1 0x2a
