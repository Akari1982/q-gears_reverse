...
Actor[ "0x00" ] = {
    on_start = function( self )
        ...
        -- 0xA0() -- 0x0009 0xa0
        opcodeF1_FadeSetUp( steps=2, r=255, g=255, b=255, semi_tr=1 ) -- 0x0010 0xf1
        opcode35_VariableSet( address=0x0400, value=(vf40)0x0000, flag=0x40 ) -- 0x001b 0x35
...
Actor[ "0x02" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=0 ) -- 0x002a 0x16
        opcodeFE0D_MessageSetFace( char_id=0 ) -- 0x002d 0xfe
...
Actor[ "0x03" ] = {
    ...
    script_0x04 = function( self )
        -- 0x19_ActorSetPosition( x=(vf80)0x0076, z=(vf40)0xff17, flag=(flag)0xc0 ) -- 0x0058 0x19
        -- MISSING OPCODE 0x5f
    end,

    script_0x05 = function( self )
        -- 0x21( ???=384 ) -- 0x0061 0x21
        -- 0xFE07( ???=0x01 ) -- 0x0064 0xfe
        -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call ) -- 0x0067 0x4a
        -- MISSING OPCODE 0x5f
    end,

    script_0x06 = function( self )
        opcode5D_SpritePlayAnim2( anim_id=0x05 ) -- 0x008a 0x5d
        -- 0x5E() -- 0x008c 0x5e
        return 0 -- 0x008d 0x00
    end,

    script_0x07 = function( self )
        opcode2C_SpritePlayAnim( anim_id=0x0c ) -- 0x008e 0x2c
        opcode6F_ActorRotateToActor( actor_id=(entity)0x18 ) -- 0x0090 0x6f
        -- 0x5A() -- 0x0092 0x5a
    ...
    script_0x08 = function( self )
        ...
        opcode2C_SpritePlayAnim( anim_id=0x0c ) -- 0x00a0 0x2c
    ...
    script_0x0a = function( self )
        opcode2C_SpritePlayAnim( anim_id=0x02 ) -- 0x00a6 0x2c
...
Actor[ "0x04" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=2 ) -- 0x00b3 0x16
        opcodeFE0D_MessageSetFace( char_id=2 ) -- 0x00b6 0xfe
...
Actor[ "0x06" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=4 ) -- 0x00dd 0x16
        opcodeFE0D_MessageSetFace( char_id=4 ) -- 0x00e0 0xfe
        opcodeFE0D_MessageSetFace( char_id=4 ) -- 0x00e4 0xfe
...
Actor[ "0x07" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=5 ) -- 0x00f6 0x16
        opcodeFE0D_MessageSetFace( char_id=5 ) -- 0x00f9 0xfe
        opcodeFE0D_MessageSetFace( char_id=5 ) -- 0x00fd 0xfe
...
Actor[ "0x08" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=6 ) -- 0x010f 0x16
        opcodeFE0D_MessageSetFace( char_id=6 ) -- 0x0112 0xfe
...
Actor[ "0x09" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=7 ) -- 0x0128 0x16
        opcodeFE0D_MessageSetFace( char_id=7 ) -- 0x012b 0xfe
...
Actor[ "0x0b" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=14 ) -- 0x015a 0x16
        opcodeFE0D_MessageSetFace( char_id=14 ) -- 0x015d 0xfe
        opcodeFE0D_MessageSetFace( char_id=10 ) -- 0x0161 0xfe
...
Actor[ "0x0c" ] = {
    on_start = function( self )
        -- 0x16_ActorPCInit( char_id=9 ) -- 0x0173 0x16
        opcodeFE0D_MessageSetFace( char_id=9 ) -- 0x0176 0xfe
...
Actor[ "0x0d" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xff8a, z=(vf40)0x0053, flag=(flag)0xc0 ) -- 0x018f 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x0e" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xffd1, z=(vf40)0x0092, flag=(flag)0xc0 ) -- 0x019e 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x0f" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xffc3, z=(vf40)0xfff9, flag=(flag)0xc0 ) -- 0x01ad 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x10" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xfff1, z=(vf40)0xffbc, flag=(flag)0xc0 ) -- 0x01bc 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x11" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x001b, z=(vf40)0x0065, flag=(flag)0xc0 ) -- 0x01cb 0x19
        -- MISSING OPCODE 0x5f
    end,

    on_update = function( self )
        opcode6F_ActorRotateToActor( actor_id=(entity)0x0d ) -- 0x01d4 0x6f
        opcode26_Wait( time=60 ) -- 0x01d6 0x26
        -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call ) -- 0x01d9 0x4a
        opcode6F_ActorRotateToActor( actor_id=(entity)0x0e ) -- 0x01df 0x6f
        opcode26_Wait( time=60 ) -- 0x01e1 0x26
        -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call ) -- 0x01e4 0x4a
        -- 0x01_JumpTo( 0x01d4 ) -- 0x01ea 0x01
...
Actor[ "0x12" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xfed5, z=(vf40)0x0045, flag=(flag)0xc0 ) -- 0x01f3 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x13" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xff2c, z=(vf40)0x00fc, flag=(flag)0xc0 ) -- 0x0202 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x14" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xfef2, z=(vf40)0x01ca, flag=(flag)0xc0 ) -- 0x0211 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x15" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0xfe4f, z=(vf40)0x00e2, flag=(flag)0xc0 ) -- 0x0220 0x19
    ...
    script_0x04 = function( self )
        ...
        -- 0x4A_ActorGoToPos( variable arguments based on 0x01800000 in script call ) -- 0x0231 0x4a
        opcode26_Wait( time=10 ) -- 0x0237 0x26
...
Actor[ "0x16" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x009b, z=(vf40)0xfea3, flag=(flag)0xc0 ) -- 0x0248 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x17" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x00da, z=(vf40)0xff05, flag=(flag)0xc0 ) -- 0x0257 0x19
        -- MISSING OPCODE 0x5f
    end,
...
Actor[ "0x18" ] = {
    on_start = function( self )
        ...
        -- 0x19_ActorSetPosition( x=(vf80)0x0025, z=(vf40)0x003f, flag=(flag)0xc0 ) -- 0x0266 0x19
        opcodeFE0D_MessageSetFace( char_id=18 ) -- 0x026c 0xfe
        opcode6F_ActorRotateToActor( actor_id=(entity)0x0f ) -- 0x0270 0x6f
        -- 0xFE07( ???=0x01 ) -- 0x0272 0xfe
...
Actor[ "0x19" ] = {
    ...
    script_0x04 = function( self )
        -- 0x57( type=0x02, x=(vf80)0x07d0, z=(vf40)0x0fa0, y=(vf20)0x0000, ???=(vf10)0xf448, flag=0xf0 ) -- 0x02aa 0x57
        -- 0x57( type=0x8f ) -- 0x02b5 0x57
        opcode26_Wait( time=1 ) -- 0x02b7 0x26
        -- 0x57( type=0x0f ) -- 0x02ba 0x57
...
Actor[ "0x1b" ] = {
    ...
    on_update = function( self )
        -- 0xBF( ???=25 ) -- 0x02e9 0xbf
        -- 0x01_JumpTo( 0x02e9 ) -- 0x02ec 0x01
...
Actor[ "0x1e" ] = {
    ...
    script_0x04 = function( self )
        -- 0xFE8F_ParticleSystemInit1( actor_id=(entity)0x1a, render_settings=2, rot_x=0, rot_y=0 ) -- 0x030d 0xfe
...
Actor[ "0x1f" ] = {
    ...
    on_talk = function( self )
        opcodeD4_MessageShowFromActor( actor_id=(entity)0x03, text_id=0x0000, flags=0 ) -- 0x05b7 0xd4
        -- 0x5A() -- 0x05bd 0x5a
        -- 0x15() -- 0x05be 0x15
        -- MISSING OPCODE 0xc4
    end,
    ...
    script_0x04 = function( self )
        opcode74_SoundPlayFixedVolume( sound_id=8 ) -- 0x05cc 0x74
        -- MISSING OPCODE 0xc4
    end,
...
Actor[ "0x20" ] = {
    on_start = function( self )
        ...
        -- 0x23() -- 0x05d3 0x23
        -- 0x27( actor_id=(entity)0x20 ) -- 0x05d4 0x27
...
Actor[ "0x21" ] = {
    ...
    script_0x0a = function( self )
        -- 0x60() -- 0x070c 0x60
        -- 0x64() -- 0x070d 0x64
        -- 0x63( ???=(vf80)0x027b, ???=(vf40)0x06e9, ???=(vf20)0xffe1, flag=0xe0 ) -- 0x070e 0x63
...
Actor[ "0x23" ] = {
    on_start = function( self )
        -- 0xBC_ActorNoModelInit() -- 0x075a 0xbc
        -- 0x2A() -- 0x075b 0x2a
        opcode35_VariableSet( address=0x0410, value=(vf40)0x0000, flag=0x40 ) -- 0x075c 0x35
        return 0 -- 0x0762 0x00
    end,

    on_update = function( self )
        -- 0xFE54() -- 0x0763 0xfe
        opcodeFE19( char_id=0xff ) -- 0x0765 0xfe
        opcodeFE19( char_id=0xfe ) -- 0x0768 0xfe
        opcodeFE19( char_id=0xfd ) -- 0x076b 0xfe
        -- 0xFE54() -- 0x076e 0xfe
