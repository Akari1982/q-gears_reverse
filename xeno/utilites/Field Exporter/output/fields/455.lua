...
0x001f    op2C_SpritePlayAnim( anim_id=0x07 )
0x0021    op26_Wait( time=10 )
0x0024    -- 0x84_ProgressLessEqualJumpTo( value=179, jump=0x0031 )
0x0029    opD2_MessageShowDynamic( text_id=0x0000, flags=0 )
0x002d    op9C_MessageSync()
0x002e    -- 0x01_JumpTo( 0x0036 )
0x0031    opD2_MessageShowDynamic( text_id=0x0001, flags=0 )
