...
Entity[ "12" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xffd1, z=(vf40)0xffb8, flag=(flag)0xc0 ) -- 0x0093 0x19
        -- MISSING OPCODE 0x69
    end,
...
Entity[ "13" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xffbc, z=(vf40)0xffeb, flag=(flag)0xc0 ) -- 0x00bc 0x19
        -- MISSING OPCODE 0x69
    end,
...
Entity[ "14" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x0060, z=(vf40)0xff9c, flag=(flag)0xc0 ) -- 0x00eb 0x19
        -- MISSING OPCODE 0x69
    end,
...
Entity[ "15" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xff99, z=(vf40)0x0065, flag=(flag)0xc0 ) -- 0x010d 0x19
        -- MISSING OPCODE 0x69
    end,
