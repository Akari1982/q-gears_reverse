...
Entity[ "5" ] = {
    ...
    script_0x05 = function( self )
        -- 0x26_Wait( time=20 ) -- 0x04f5 0x26
        -- MISSING OPCODE 0xFE5e
    end,

    script_0x06 = function( self )
        -- 0x26_Wait( time=20 ) -- 0x051e 0x26
        -- MISSING OPCODE 0x22
    end,
...
Entity[ "6" ] = {
    ...
    script_0x05 = function( self )
        -- 0x26_Wait( time=15 ) -- 0x0573 0x26
        -- MISSING OPCODE 0xFE5e
    end,

    script_0x06 = function( self )
        -- 0x26_Wait( time=30 ) -- 0x059c 0x26
        -- MISSING OPCODE 0x22
    end,
...
Entity[ "7" ] = {
    ...
    script_0x05 = function( self )
        -- 0x26_Wait( time=5 ) -- 0x05f1 0x26
        -- MISSING OPCODE 0xFE5e
    end,

    script_0x06 = function( self )
        -- 0x26_Wait( time=15 ) -- 0x061a 0x26
        -- MISSING OPCODE 0x22
    end,
...
Entity[ "8" ] = {
    ...
    on_update = function( self )
        ...
        -- 0x09_EntityCallScriptEW( entity=0x1e, script=0x24 ) -- 0x0662 0x09
...
Entity[ "9" ] = {
    ...
    script_0x04 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x0e8c 0x26
        -- 0x99() -- 0x0e8f 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x05 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x0ef7 0x26
        -- 0x99() -- 0x0efa 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x06 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x0f1e 0x26
        -- 0x99() -- 0x0f21 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x07 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x0f45 0x26
        -- 0x99() -- 0x0f48 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x08 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x0f6c 0x26
        -- 0x99() -- 0x0f6f 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x09 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x0f93 0x26
        -- 0x99() -- 0x0f96 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x0a = function( self )
        -- 0x26_Wait( time=1 ) -- 0x0fba 0x26
        -- 0x99() -- 0x0fbd 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x0b = function( self )
        -- 0x26_Wait( time=1 ) -- 0x1003 0x26
        -- 0x99() -- 0x1006 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x0c = function( self )
        -- 0x26_Wait( time=1 ) -- 0x102a 0x26
        -- 0x99() -- 0x102d 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x0d = function( self )
        -- 0x26_Wait( time=1 ) -- 0x1051 0x26
        -- 0x99() -- 0x1054 0x99
        -- MISSING OPCODE 0x9b
    end,
...
Entity[ "29" ] = {
    ...
    script_0x04 = function( self )
        -- 0xF5_DialogShow3( dialog_id=0x0000, flag=0x53 ) -- 0x1b8c 0xf5
        -- 0x9C() -- 0x1b90 0x9c
        return 0 -- 0x1b91 0x00
    end,

    script_0x05 = function( self )
        -- 0xF5_DialogShow3( dialog_id=0x0001, flag=0x53 ) -- 0x1b92 0xf5
        -- 0x9C() -- 0x1b96 0x9c
        -- MISSING OPCODE 0xFE77
    end,

    script_0x06 = function( self )
        -- 0xF5_DialogShow3( dialog_id=0x0008, flag=0x53 ) -- 0x1bfe 0xf5
        -- 0x9C() -- 0x1c02 0x9c
        -- 0xF1() -- 0x1c03 0xf1
        -- 0x26_Wait( time=45 ) -- 0x1c0e 0x26
        -- 0x09_EntityCallScriptEW( entity=0x09, script=0x25 ) -- 0x1c11 0x09
        -- 0x09_EntityCallScriptEW( entity=0x1e, script=0x2a ) -- 0x1c14 0x09
        -- MISSING OPCODE 0xFE77
    end,

    script_0x07 = function( self )
        -- 0xF5_DialogShow3( dialog_id=0x000f, flag=0x53 ) -- 0x1c8a 0xf5
        -- 0x9C() -- 0x1c8e 0x9c
        -- 0xF5_DialogShow3( dialog_id=0x0010, flag=0x53 ) -- 0x1c8f 0xf5
        -- 0x9C() -- 0x1c93 0x9c
        return 0 -- 0x1c94 0x00
    end,

    script_0x08 = function( self )
        -- 0xF5_DialogShow3( dialog_id=0x0011, flag=0x53 ) -- 0x1c95 0xf5
        -- 0x9C() -- 0x1c99 0x9c
        return 0 -- 0x1c9a 0x00
    end,

    script_0x09 = function( self )
        -- 0xF5_DialogShow3( dialog_id=0x0012, flag=0x53 ) -- 0x1c9b 0xf5
        -- 0x9C() -- 0x1c9f 0x9c
        -- 0xF5_DialogShow3( dialog_id=0x0013, flag=0x53 ) -- 0x1ca0 0xf5
        -- 0x9C() -- 0x1ca4 0x9c
        -- 0xF5_DialogShow3( dialog_id=0x0014, flag=0x53 ) -- 0x1ca5 0xf5
        -- 0x9C() -- 0x1ca9 0x9c
        return 0 -- 0x1caa 0x00
    end,

    script_0x0a = function( self )
        -- 0xF5_DialogShow3( dialog_id=0x0015, flag=0x53 ) -- 0x1cab 0xf5
        -- 0x9C() -- 0x1caf 0x9c
        -- 0xF5_DialogShow3( dialog_id=0x0016, flag=0x53 ) -- 0x1cb0 0xf5
        -- 0x9C() -- 0x1cb4 0x9c
        -- 0xF5_DialogShow3( dialog_id=0x0017, flag=0x53 ) -- 0x1cb5 0xf5
        -- 0x9C() -- 0x1cb9 0x9c
        return 0 -- 0x1cba 0x00
    end,

    script_0x0b = function( self )
        -- 0xF5_DialogShow3( dialog_id=0x0018, flag=0x53 ) -- 0x1cbb 0xf5
        -- 0x9C() -- 0x1cbf 0x9c
        -- 0xF1() -- 0x1cc0 0xf1
        -- 0x26_Wait( time=90 ) -- 0x1ccb 0x26
        -- 0xC6() -- 0x1cce 0xc6
        -- 0x09_EntityCallScriptEW( entity=0x1e, script=0x2d ) -- 0x1ccf 0x09
        -- 0x09_EntityCallScriptEW( entity=0x01, script=0x28 ) -- 0x1cd2 0x09
        -- 0x35() -- 0x1cd5 0x35
        -- 0x09_EntityCallScriptEW( entity=0x01, script=0x2f ) -- 0x1cdb 0x09
        -- 0x09_EntityCallScriptEW( entity=0x09, script=0x27 ) -- 0x1cde 0x09
        -- 0xF1() -- 0x1ce1 0xf1
        -- 0x26_Wait( time=120 ) -- 0x1cec 0x26
        -- 0x09_EntityCallScriptEW( entity=0x03, script=0x24 ) -- 0x1cef 0x09
        -- 0x09_EntityCallScriptEW( entity=0x03, script=0x29 ) -- 0x1cf2 0x09
        -- 0x26_Wait( time=45 ) -- 0x1cf5 0x26
        -- 0x09_EntityCallScriptEW( entity=0x03, script=0x25 ) -- 0x1cf8 0x09
        -- MISSING OPCODE 0xfc
    end,

    script_0x0c = function( self )
        -- 0x08_EntityCallScriptSW( entity=0x05, script=0x24 ) -- 0x1e05 0x08
        -- 0x08_EntityCallScriptSW( entity=0x06, script=0x24 ) -- 0x1e08 0x08
        -- 0x08_EntityCallScriptSW( entity=0x07, script=0x24 ) -- 0x1e0b 0x08
        -- 0x09_EntityCallScriptEW( entity=0x04, script=0x24 ) -- 0x1e0e 0x09
        -- 0x26_Wait( time=45 ) -- 0x1e11 0x26
        -- 0x08_EntityCallScriptSW( entity=0x05, script=0x26 ) -- 0x1e14 0x08
        -- 0x08_EntityCallScriptSW( entity=0x06, script=0x26 ) -- 0x1e17 0x08
        -- 0x08_EntityCallScriptSW( entity=0x07, script=0x26 ) -- 0x1e1a 0x08
        -- 0x09_EntityCallScriptEW( entity=0x04, script=0x26 ) -- 0x1e1d 0x09
        -- 0x26_Wait( time=120 ) -- 0x1e20 0x26
        -- MISSING OPCODE 0xfc
    end,

    script_0x0d = function( self )
        -- 0xF5_DialogShow3( dialog_id=0x0031, flag=0x53 ) -- 0x1ee1 0xf5
        -- 0x9C() -- 0x1ee5 0x9c
        -- MISSING OPCODE 0xFE77
    end,

    script_0x0e = function( self )
        -- 0xF5_DialogShow3( dialog_id=0x0051, flag=0x53 ) -- 0x21ef 0xf5
        -- 0x9C() -- 0x21f3 0x9c
        -- 0xF5_DialogShow3( dialog_id=0x0052, flag=0x63 ) -- 0x21f4 0xf5
        -- 0x9C() -- 0x21f8 0x9c
        -- 0x26_Wait( time=20 ) -- 0x21f9 0x26
        -- 0x09_EntityCallScriptEW( entity=0x0b, script=0x28 ) -- 0x21fc 0x09
        return 0 -- 0x21ff 0x00
    end,

    script_0x0f = function( self )
        -- 0xF5_DialogShow3( dialog_id=0x0053, flag=0x53 ) -- 0x2200 0xf5
        -- 0x9C() -- 0x2204 0x9c
        return 0 -- 0x2205 0x00
    end,

    script_0x10 = function( self )
        -- 0xF5_DialogShow3( dialog_id=0x0054, flag=0x53 ) -- 0x2206 0xf5
        -- 0x9C() -- 0x220a 0x9c
        -- 0xF5_DialogShow3( dialog_id=0x0055, flag=0x53 ) -- 0x220b 0xf5
        -- 0x9C() -- 0x220f 0x9c
...
Entity[ "31" ] = {
    ...
    on_update = function( self )
        ...
        -- 0xFE54() -- 0x23a6 0xfe
        -- 0x35() -- 0x23a8 0x35
        -- 0x09_EntityCallScriptEW( entity=0x09, script=0x25 ) -- 0x23ae 0x09
        -- 0x5A() -- 0x23b1 0x5a
        -- 0xF1() -- 0x23b2 0xf1
        -- 0x26_Wait( time=15 ) -- 0x23bd 0x26
        -- 0xF5_DialogShow3( dialog_id=0x0056, flag=0x00 ) -- 0x23c0 0xf5
        -- 0x9C() -- 0x23c4 0x9c
        -- MISSING OPCODE 0xFE77
    end,
...
Entity[ "32" ] = {
    ...
    on_talk = function( self )
        -- 0x09_EntityCallScriptEW( entity=0x1e, script=0x27 ) -- 0x24dc 0x09
        -- 0x09_EntityCallScriptEW( entity=0x1e, script=0x28 ) -- 0x24df 0x09
        -- 0x09_EntityCallScriptEW( entity=0x1e, script=0x29 ) -- 0x24e2 0x09
