...
Entity[ "4" ] = {
    ...
    on_talk = function( self )
        ...
        -- 0xFE54() -- 0x0232 0xfe
        -- 0x09_EntityCallScriptEW( entity=0x0f, script=0x24 ) -- 0x0234 0x09
        -- 0x07( entity=0x01, script=0x24 ) -- 0x0237 0x07
        -- 0x26_Wait( time=10 ) -- 0x023a 0x26
...
Entity[ "6" ] = {
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x0280 0xfe
        -- 0x09_EntityCallScriptEW( entity=0x0e, script=0x24 ) -- 0x0282 0x09
        -- 0x07( entity=0x01, script=0x25 ) -- 0x0285 0x07
        -- 0x26_Wait( time=10 ) -- 0x0288 0x26
...
Entity[ "7" ] = {
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x02a9 0xfe
        -- 0x09_EntityCallScriptEW( entity=0x11, script=0x24 ) -- 0x02ab 0x09
        -- 0x07( entity=0x01, script=0x26 ) -- 0x02ae 0x07
        -- 0x26_Wait( time=10 ) -- 0x02b1 0x26
...
Entity[ "8" ] = {
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x02d2 0xfe
        -- 0x09_EntityCallScriptEW( entity=0x13, script=0x24 ) -- 0x02d4 0x09
        -- 0x07( entity=0x01, script=0x27 ) -- 0x02d7 0x07
        -- 0x26_Wait( time=10 ) -- 0x02da 0x26
...
Entity[ "9" ] = {
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x02fb 0xfe
        -- 0x09_EntityCallScriptEW( entity=0x12, script=0x24 ) -- 0x02fd 0x09
        -- 0x07( entity=0x01, script=0x28 ) -- 0x0300 0x07
        -- 0x26_Wait( time=10 ) -- 0x0303 0x26
...
Entity[ "10" ] = {
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x0320 0xfe
        -- 0x09_EntityCallScriptEW( entity=0x14, script=0x24 ) -- 0x0322 0x09
        -- 0x07( entity=0x01, script=0x29 ) -- 0x0325 0x07
        -- 0x26_Wait( time=10 ) -- 0x0328 0x26
...
Entity[ "11" ] = {
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x0349 0xfe
        -- 0x09_EntityCallScriptEW( entity=0x10, script=0x24 ) -- 0x034b 0x09
        -- 0x07( entity=0x01, script=0x2a ) -- 0x034e 0x07
        -- 0x26_Wait( time=10 ) -- 0x0351 0x26
...
Entity[ "12" ] = {
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x036e 0xfe
        -- 0x09_EntityCallScriptEW( entity=0x15, script=0x24 ) -- 0x0370 0x09
        -- MISSING OPCODE 0x36
    end,
...
Entity[ "13" ] = {
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x0392 0xfe
        -- 0x09_EntityCallScriptEW( entity=0x16, script=0x24 ) -- 0x0394 0x09
        -- MISSING OPCODE 0x36
    end,
