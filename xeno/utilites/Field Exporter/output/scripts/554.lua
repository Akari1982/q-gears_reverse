...
Entity[ "2" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=GetVar( 0x0040 ) ) -- 0x007f 0xfe
...
Entity[ "3" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=GetVar( 0x0042 ) ) -- 0x00bc 0xfe
...
Entity[ "4" ] = {
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x010d 0xfe
        -- 0x09_EntityCallScriptEW( entity=0x05, script=0x24 ) -- 0x010f 0x09
        -- 0x07( entity=0x01, script=0x24 ) -- 0x0112 0x07
        -- 0x26_Wait( time=10 ) -- 0x0115 0x26
...
Entity[ "6" ] = {
    ...
    on_update = function( self )
        ...
        -- 0x09_EntityCallScriptEW( entity=0x03, script=0x24 ) -- 0x0159 0x09
        -- MISSING OPCODE 0xFE23
    end,

    on_talk = function( self )
        -- 0x09_EntityCallScriptEW( entity=0x01, script=0x25 ) -- 0x01a1 0x09
        -- MISSING OPCODE 0xd2
    end,
