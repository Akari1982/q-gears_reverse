...
Entity[ "39" ] = {
    ...
    on_talk = function( self )
        ...
        -- 0x09_EntityCallScriptEW( entity=0x28, script=0x64 ) -- 0x15b9 0x09
        -- MISSING OPCODE 0x80
    end,
...
Entity[ "44" ] = {
    ...
    on_talk = function( self )
        ...
        -- 0x09_EntityCallScriptEW( entity=0x29, script=0x64 ) -- 0x16e9 0x09
        -- MISSING OPCODE 0xFE68
    end,
