...
Entity[ "0" ] = {
    ...
    on_update = function( self )
        ...
        -- 0x35() -- 0x025a 0x35
        -- 0x26_Wait( time=32 ) -- 0x0260 0x26
        -- 0x26_Wait( time=20 ) -- 0x0263 0x26
        -- 0x09_EntityCallScriptEW( entity=0x07, script=0x24 ) -- 0x0266 0x09
        -- 0x26_Wait( time=20 ) -- 0x0269 0x26
...
Entity[ "6" ] = {
    ...
    script_0x04 = function( self )
        -- 0xF1() -- 0x0430 0xf1
        -- 0x26_Wait( time=1 ) -- 0x043b 0x26
        -- 0xF1() -- 0x043e 0xf1
        -- 0x07( entity=0x1b, script=0x24 ) -- 0x0449 0x07
        -- 0x26_Wait( time=6 ) -- 0x044c 0x26
        -- 0xF1() -- 0x044f 0xf1
        -- MISSING OPCODE 0xf2
    end,
    ...
    script_0x05 = function( self )
        -- 0xF1() -- 0x0483 0xf1
        -- 0x26_Wait( time=1 ) -- 0x048e 0x26
        -- 0xF1() -- 0x0491 0xf1
        -- 0x07( entity=0x1c, script=0x24 ) -- 0x049c 0x07
        -- 0x26_Wait( time=6 ) -- 0x049f 0x26
        -- 0xF1() -- 0x04a2 0xf1
        -- MISSING OPCODE 0xf2
    end,
