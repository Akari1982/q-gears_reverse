...
Entity[ "2" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 1 ) -- 0x007e 0x16
        -- 0xFE0D_SetAvatar( character_id=1 ) -- 0x0081 0xfe
...
Entity[ "3" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 2 ) -- 0x0089 0x16
        -- 0xFE0D_SetAvatar( character_id=2 ) -- 0x008c 0xfe
...
Entity[ "5" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 3 ) -- 0x009f 0x16
        -- 0xFE0D_SetAvatar( character_id=3 ) -- 0x00a2 0xfe
        return 0 -- 0x00a6 0x00
    end,

    on_update = function( self )
        -- 0x0C_Encounter() -- 0x00a7 0x0c
...
Entity[ "6" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 4 ) -- 0x00aa 0x16
        -- 0xFE0D_SetAvatar( character_id=4 ) -- 0x00ad 0xfe
...
Entity[ "7" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 5 ) -- 0x00b5 0x16
        -- 0xFE0D_SetAvatar( character_id=5 ) -- 0x00b8 0xfe
...
Entity[ "8" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 6 ) -- 0x00c0 0x16
        -- 0xFE0D_SetAvatar( character_id=6 ) -- 0x00c3 0xfe
...
Entity[ "10" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 7 ) -- 0x00d6 0x16
        -- 0xFE0D_SetAvatar( character_id=7 ) -- 0x00d9 0xfe
...
Entity[ "11" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 8 ) -- 0x00e1 0x16
        -- 0xFE0D_SetAvatar( character_id=8 ) -- 0x00e4 0xfe
...
Entity[ "12" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x0000, z=(vf40)0xf7f1, flag=(flag)0xc0 ) -- 0x00f4 0x19
        -- MISSING OPCODE 0x69
    end,
...
Entity[ "24" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x04e6 0xbc
        -- MISSING OPCODE 0xf8
    end,
