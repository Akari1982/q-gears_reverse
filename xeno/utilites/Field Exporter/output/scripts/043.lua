...
Entity[ "12" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xfff6, z=(vf40)0xff73, flag=(flag)0xc0 ) -- 0x0093 0x19
        -- MISSING OPCODE 0x69
    end,
...
Entity[ "13" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xffef, z=(vf40)0xffed, flag=(flag)0xc0 ) -- 0x00b7 0x19
        -- MISSING OPCODE 0x69
    end,
...
Entity[ "14" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit() -- 0x00db 0xbc
        -- MISSING OPCODE 0xf8
    end,
