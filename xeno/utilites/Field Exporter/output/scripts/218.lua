...
Entity[ "1" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=0 ) -- 0x01e5 0xfe
        -- MISSING OPCODE 0x85
    end,
    ...
    script_0x05 = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0000, ???=0x00 ) -- 0x0228 0xd2
        -- 0x9C() -- 0x022c 0x9c
...
Entity[ "4" ] = {
    ...
    script_0x05 = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0002, ???=0x00 ) -- 0x02ce 0xd2
        -- 0x9C() -- 0x02d2 0x9c
...
Entity[ "9" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=1 ) -- 0x0651 0xfe
...
Entity[ "10" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=2 ) -- 0x066c 0xfe
...
Entity[ "11" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=3 ) -- 0x06a2 0xfe
...
Entity[ "12" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=4 ) -- 0x06b5 0xfe
...
Entity[ "13" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=5 ) -- 0x06c8 0xfe
    ...
    script_0x08 = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0008, ???=0x00 ) -- 0x0710 0xd2
        -- 0x9C() -- 0x0714 0x9c
    ...
    script_0x0a = function( self )
        opcodeD2_DialogShow0( dialog_id=0x000a, ???=0x00 ) -- 0x071e 0xd2
        -- 0x9C() -- 0x0722 0x9c
...
Entity[ "14" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=6 ) -- 0x073f 0xfe
...
Entity[ "15" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=7 ) -- 0x0752 0xfe
...
Entity[ "16" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=8 ) -- 0x0765 0xfe
...
Entity[ "17" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=9 ) -- 0x0778 0xfe
...
Entity[ "18" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=10 ) -- 0x078b 0xfe
...
Entity[ "19" ] = {
    ...
    script_0x04 = function( self )
        ...
        opcodeD2_DialogShow0( dialog_id=0x000c, ???=0x00 ) -- 0x07bd 0xd2
        -- 0x9C() -- 0x07c1 0x9c
        -- 0x08_EntityCallScriptSW( entity=0x1a, script=0x2d ) -- 0x07c2 0x08
...
Entity[ "20" ] = {
    ...
    script_0x04 = function( self )
        -- 0x08_EntityCallScriptSW( entity=0x13, script=0x25 ) -- 0x0835 0x08
        -- MISSING OPCODE 0xf6
    end,
...
Entity[ "23" ] = {
    ...
    script_0x04 = function( self )
        opcodeD2_DialogShow0( dialog_id=0x000d, ???=0x13 ) -- 0x08e0 0xd2
        -- 0x9C() -- 0x08e4 0x9c
        -- MISSING OPCODE 0xf6
    end,
...
Entity[ "26" ] = {
    ...
    script_0x05 = function( self )
        -- 0x35() -- 0x097e 0x35
        -- 0x09_EntityCallScriptEW( entity=0x0a, script=0x27 ) -- 0x0984 0x09
        -- MISSING OPCODE 0xfc
    end,
    ...
    script_0x07 = function( self )
        -- 0x35() -- 0x0a26 0x35
        -- 0x09_EntityCallScriptEW( entity=0x01, script=0x29 ) -- 0x0a2c 0x09
        -- MISSING OPCODE 0xfc
    end,

    script_0x08 = function( self )
        -- 0x35() -- 0x0a4e 0x35
        -- 0x09_EntityCallScriptEW( entity=0x01, script=0x29 ) -- 0x0a54 0x09
        -- MISSING OPCODE 0xfc
    end,
    ...
    script_0x0e = function( self )
        -- 0x35() -- 0x0d04 0x35
        -- 0x09_EntityCallScriptEW( entity=0x01, script=0x29 ) -- 0x0d0a 0x09
        -- MISSING OPCODE 0xfc
    end,
...
Entity[ "27" ] = {
    ...
    script_0x05 = function( self )
        opcode25( entity=(entity)0x01 ) -- 0x0dc4 0x25
        -- MISSING OPCODE 0x27
    end,
