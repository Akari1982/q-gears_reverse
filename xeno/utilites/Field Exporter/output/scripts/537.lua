...
Entity[ "12" ] = {
    ...
    on_update = function( self )
        ...
        -- 0x09_EntityCallScriptEW( entity=0x0e, script=0x44 ) -- 0x0363 0x09
        -- 0x09_EntityCallScriptEW( entity=0x0f, script=0x66 ) -- 0x0366 0x09
        -- MISSING OPCODE 0x36
    end,
...
Entity[ "15" ] = {
    ...
    script_0x04 = function( self )
        ...
        opcodeAC() -- 0x0941 0xac
        opcodeEF() -- 0x0945 0xef
    ...
    script_0x09 = function( self )
        ...
        opcodeAC() -- 0x09e7 0xac
        opcodeAC() -- 0x09eb 0xac
        opcodeEF() -- 0x09ef 0xef
