...
Entity[ "12" ] = {
    ...
    on_update = function( self )
        -- 0x19_SetPosition( x=(vf80)0x0090, z=(vf40)0x0041, flag=(flag)0xc0 ) -- 0x0094 0x19
        -- MISSING OPCODE 0xa8
    end,
...
Entity[ "13" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x00b1, z=(vf40)0x005c, flag=(flag)0xc0 ) -- 0x00f3 0x19
