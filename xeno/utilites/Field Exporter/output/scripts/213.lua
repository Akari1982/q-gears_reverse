...
Entity[ "1" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=36 ) -- 0x0351 0xfe
        -- 0x01_JumpTo( 0x035c ) -- 0x0355 0x01
        -- 0xFE0D_SetAvatar( character_id=0 ) -- 0x0358 0xfe
    ...
    script_0x06 = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0000, ???=0x00 ) -- 0x038a 0xd2
        -- MISSING OPCODE 0xa9
    end,

    script_0x07 = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0002, ???=0x00 ) -- 0x03ed 0xd2
        -- MISSING OPCODE 0xa9
    end,
    ...
    script_0x0c = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0008, ???=0x10 ) -- 0x082b 0xd2
        -- 0x9C() -- 0x082f 0x9c
        return 0 -- 0x0830 0x00
    end,

    script_0x0d = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0009, ???=0x00 ) -- 0x0831 0xd2
        -- 0x9C() -- 0x0835 0x9c
...
Entity[ "2" ] = {
    ...
    on_talk = function( self )
        ...
        -- 0x09_EntityCallScriptEW( entity=0x02, script=0x24 ) -- 0x0910 0x09
        -- 0x09_EntityCallScriptEW( entity=0x1d, script=0x29 ) -- 0x0913 0x09
        -- 0x09_EntityCallScriptEW( entity=0x02, script=0x25 ) -- 0x0916 0x09
...
Entity[ "4" ] = {
    ...
    on_talk = function( self )
        ...
        -- 0x09_EntityCallScriptEW( entity=0x1d, script=0x29 ) -- 0x0962 0x09
...
Entity[ "6" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=78 ) -- 0x0a1f 0xfe
        -- 0x01_JumpTo( 0x0a2a ) -- 0x0a23 0x01
        -- 0xFE0D_SetAvatar( character_id=46 ) -- 0x0a26 0xfe
        -- 0xD0() -- 0x0a2a 0xd0
...
Entity[ "7" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=78 ) -- 0x0b55 0xfe
        -- 0x01_JumpTo( 0x0b60 ) -- 0x0b59 0x01
        -- 0xFE0D_SetAvatar( character_id=46 ) -- 0x0b5c 0xfe
        -- 0xD0() -- 0x0b60 0xd0
    ...
    script_0x06 = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0015, ???=0x00 ) -- 0x0bcc 0xd2
        -- 0x9C() -- 0x0bd0 0x9c
        -- MISSING OPCODE 0x21
    end,
...
Entity[ "8" ] = {
    ...
    script_0x04 = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0017, ???=0x00 ) -- 0x0c86 0xd2
        -- 0x9C() -- 0x0c8a 0x9c
...
Entity[ "9" ] = {
    ...
    on_talk = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0019, ???=0x00 ) -- 0x0d01 0xd2
        -- 0x9C() -- 0x0d05 0x9c
...
Entity[ "10" ] = {
    ...
    script_0x05 = function( self )
        -- 0xD0() -- 0x0d20 0xd0
        opcodeD2_DialogShow0( dialog_id=0x001a, ???=0x00 ) -- 0x0d2b 0xd2
        -- 0x9C() -- 0x0d2f 0x9c
        return 0 -- 0x0d30 0x00
    end,

    script_0x06 = function( self )
        opcodeD2_DialogShow0( dialog_id=0x001b, ???=0x00 ) -- 0x0d31 0xd2
        -- 0x9C() -- 0x0d35 0x9c
        return 0 -- 0x0d36 0x00
    end,

    script_0x07 = function( self )
        -- 0x09_EntityCallScriptEW( entity=0x08, script=0x2a ) -- 0x0d37 0x09
        -- 0xF4() -- 0x0d3a 0xf4
        -- 0xD0() -- 0x0d3c 0xd0
        opcodeD2_DialogShow0( dialog_id=0x001c, ???=0x00 ) -- 0x0d47 0xd2
        -- 0x9C() -- 0x0d4b 0x9c
        opcode26_Wait( time=15 ) -- 0x0d4c 0x26
        opcodeD2_DialogShow0( dialog_id=0x001d, ???=0x00 ) -- 0x0d4f 0xd2
        -- 0x9C() -- 0x0d53 0x9c
...
Entity[ "12" ] = {
    ...
    script_0x06 = function( self )
        -- 0xD0() -- 0x0dc7 0xd0
        opcodeD2_DialogShow0( dialog_id=0x0020, ???=0x00 ) -- 0x0dd2 0xd2
        -- 0x9C() -- 0x0dd6 0x9c
...
Entity[ "15" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=1 ) -- 0x13e1 0xfe
...
Entity[ "16" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=2 ) -- 0x13ec 0xfe
    ...
    script_0x05 = function( self )
        -- 0x08_EntityCallScriptSW( entity=0x1e, script=0x2b ) -- 0x1404 0x08
        opcode26_Wait( time=15 ) -- 0x1407 0x26
        -- MISSING OPCODE 0x67
    end,

    script_0x06 = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0022, ???=0x10 ) -- 0x143e 0xd2
        -- 0x9C() -- 0x1442 0x9c
        -- 0x09_EntityCallScriptEW( entity=0x1e, script=0x2d ) -- 0x1443 0x09
    ...
    script_0x14 = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0023, ???=0x10 ) -- 0x14be 0xd2
        -- 0x9C() -- 0x14c2 0x9c
        -- 0x08_EntityCallScriptSW( entity=0x13, script=0x26 ) -- 0x14c3 0x08
        -- 0x09_EntityCallScriptEW( entity=0x01, script=0x32 ) -- 0x14c6 0x09
        -- MISSING OPCODE 0x4a
    end,
...
Entity[ "17" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=3 ) -- 0x14ea 0xfe
...
Entity[ "18" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=4 ) -- 0x14f5 0xfe
...
Entity[ "19" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=5 ) -- 0x1500 0xfe
        -- 0xD0() -- 0x1504 0xd0
...
Entity[ "20" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=6 ) -- 0x1563 0xfe
...
Entity[ "21" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=7 ) -- 0x156e 0xfe
...
Entity[ "22" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=8 ) -- 0x1579 0xfe
...
Entity[ "23" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=9 ) -- 0x1584 0xfe
...
Entity[ "24" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=10 ) -- 0x158f 0xfe
...
Entity[ "27" ] = {
    ...
    on_talk = function( self )
        ...
        -- 0x09_EntityCallScriptEW( entity=0x1d, script=0x28 ) -- 0x1653 0x09
...
Entity[ "29" ] = {
    ...
    script_0x07 = function( self )
        -- 0xF5_DialogShow3( dialog_id=0x002e, flag=0x40 ) -- 0x1758 0xf5
        -- 0x9C() -- 0x175c 0x9c
    ...
    script_0x09 = function( self )
        -- 0x09_EntityCallScriptEW( entity=0x10, script=0x27 ) -- 0x176e 0x09
        -- 0x35() -- 0x1771 0x35
        -- 0x09_EntityCallScriptEW( entity=0x10, script=0x37 ) -- 0x1777 0x09
        -- MISSING OPCODE 0xfc
    end,

    script_0x0a = function( self )
        -- 0x09_EntityCallScriptEW( entity=0x10, script=0x27 ) -- 0x178e 0x09
        -- 0x35() -- 0x1791 0x35
        -- 0x09_EntityCallScriptEW( entity=0x10, script=0x37 ) -- 0x1797 0x09
        -- MISSING OPCODE 0xfc
    end,
    ...
    script_0x0e = function( self )
        -- 0x09_EntityCallScriptEW( entity=0x13, script=0x25 ) -- 0x18a6 0x09
        -- 0x09_EntityCallScriptEW( entity=0x01, script=0x34 ) -- 0x18a9 0x09
        -- MISSING OPCODE 0xfc
    end,
...
Entity[ "30" ] = {
    ...
    script_0x05 = function( self )
        -- 0x35() -- 0x19c6 0x35
        -- 0x09_EntityCallScriptEW( entity=0x10, script=0x36 ) -- 0x19cc 0x09
        -- 0x35() -- 0x19cf 0x35
        -- 0x09_EntityCallScriptEW( entity=0x10, script=0x37 ) -- 0x19d5 0x09
        -- MISSING OPCODE 0xfc
    end,
    ...
    script_0x0d = function( self )
        -- 0x35() -- 0x1f13 0x35
        -- 0x09_EntityCallScriptEW( entity=0x01, script=0x37 ) -- 0x1f19 0x09
        -- MISSING OPCODE 0xfc
    end,

    script_0x0e = function( self )
        -- 0x09_EntityCallScriptEW( entity=0x07, script=0x30 ) -- 0x1fdf 0x09
        -- MISSING OPCODE 0xfc
    end,

    script_0x0f = function( self )
        -- 0x09_EntityCallScriptEW( entity=0x1d, script=0x27 ) -- 0x20af 0x09
        -- 0x35() -- 0x20b2 0x35
        -- 0x09_EntityCallScriptEW( entity=0x10, script=0x37 ) -- 0x20b8 0x09
        -- MISSING OPCODE 0xfc
    end,

    script_0x10 = function( self )
        -- 0x35() -- 0x2128 0x35
        -- 0x09_EntityCallScriptEW( entity=0x10, script=0x37 ) -- 0x212e 0x09
        -- MISSING OPCODE 0xfc
    end,

    script_0x11 = function( self )
        -- 0x09_EntityCallScriptEW( entity=0x07, script=0x31 ) -- 0x2494 0x09
        -- MISSING OPCODE 0xfc
    end,
