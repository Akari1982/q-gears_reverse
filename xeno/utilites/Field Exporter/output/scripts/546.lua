...
Entity[ "6" ] = {
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x01c3 0xfe
        -- 0x09_EntityCallScriptEW( entity=0x04, script=0x24 ) -- 0x01c5 0x09
        -- 0x07( entity=0x01, script=0x24 ) -- 0x01c8 0x07
        -- 0x26_Wait( time=10 ) -- 0x01cb 0x26
...
Entity[ "7" ] = {
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x01ed 0xfe
        -- 0x09_EntityCallScriptEW( entity=0x05, script=0x24 ) -- 0x01ef 0x09
        -- 0x07( entity=0x01, script=0x25 ) -- 0x01f2 0x07
        -- 0x26_Wait( time=10 ) -- 0x01f5 0x26
