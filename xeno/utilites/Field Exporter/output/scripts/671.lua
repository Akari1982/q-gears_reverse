...
Entity[ "14" ] = {
    ...
    script_0x04 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x02cf 0x26
        -- 0x99() -- 0x02d2 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x05 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x0318 0x26
        -- 0x99() -- 0x031b 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x06 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x033f 0x26
        -- 0x99() -- 0x0342 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x07 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x0366 0x26
        -- 0x99() -- 0x0369 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x08 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x038d 0x26
        -- 0x99() -- 0x0390 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x09 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x03b4 0x26
        -- 0x99() -- 0x03b7 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x0a = function( self )
        -- 0x26_Wait( time=1 ) -- 0x03db 0x26
        -- 0x99() -- 0x03de 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x0b = function( self )
        -- 0x26_Wait( time=1 ) -- 0x0402 0x26
        -- 0x99() -- 0x0405 0x99
        -- MISSING OPCODE 0x9b
    end,
