...
Entity[ "12" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x005c, z=(vf40)0xffd0, flag=(flag)0xc0 ) -- 0x0090 0x19
        -- MISSING OPCODE 0x69
    end,
    ...
    on_talk = function( self )
        -- 0x02_ConditionalJumpTo( value1=GetVar( 0x040a ), value2=(s16)0x0000, condition="value1 == value2", jump_if_false=0x00be ) -- 0x009b 0x02
        -- MISSING OPCODE 0x36
    end,
