...
Entity[ "4" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=3 ) -- 0x00a6 0xfe
...
Entity[ "5" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=4 ) -- 0x00b0 0xfe
...
Entity[ "6" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=5 ) -- 0x00ba 0xfe
...
Entity[ "8" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=7 ) -- 0x00ce 0xfe
...
Entity[ "11" ] = {
    ...
    on_talk = function( self )
        -- 0x09_EntityCallScriptEW( entity=0x0d, script=0x64 ) -- 0x0228 0x09
        -- 0x99() -- 0x022b 0x99
        -- 0x35() -- 0x022c 0x35
        -- 0x35() -- 0x0232 0x35
        -- 0x05_CallFunction( 0x03f7 ) -- 0x0238 0x05
        -- 0x26_Wait( time=10 ) -- 0x023b 0x26
