...
Entity[ "6" ] = {
    ...
    script_0x06 = function( self )
        ...
        opcodeAC() -- 0x054f 0xac
        opcodeEF() -- 0x0553 0xef
...
Entity[ "8" ] = {
    ...
    on_update = function( self )
        ...
        -- 0x09_EntityCallScriptEW( entity=0x32, script=0x65 ) -- 0x05bf 0x09
...
Entity[ "30" ] = {
    ...
    on_talk = function( self )
        ...
        opcodeD2_DialogShow0( dialog_id=0x0005, ???=0x00 ) -- 0x09d9 0xd2
        -- 0x9C() -- 0x09dd 0x9c
...
Entity[ "55" ] = {
    ...
    on_talk = function( self )
        opcodeD2_DialogShow0( dialog_id=0x000e, ???=0x00 ) -- 0x0eb6 0xd2
        -- 0x9C() -- 0x0eba 0x9c
