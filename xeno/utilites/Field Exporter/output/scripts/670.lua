...
Entity[ "9" ] = {
    ...
    script_0x04 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x06a1 0x26
        -- 0x99() -- 0x06a4 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x05 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x070c 0x26
        -- 0x99() -- 0x070f 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x06 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x0733 0x26
        -- 0x99() -- 0x0736 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x07 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x075a 0x26
        -- 0x99() -- 0x075d 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x08 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x0781 0x26
        -- 0x99() -- 0x0784 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x09 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x07a8 0x26
        -- 0x99() -- 0x07ab 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x0a = function( self )
        -- 0x26_Wait( time=1 ) -- 0x07cf 0x26
        -- 0x99() -- 0x07d2 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x0b = function( self )
        -- 0x26_Wait( time=1 ) -- 0x07f6 0x26
        -- 0x99() -- 0x07f9 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x0c = function( self )
        -- 0x26_Wait( time=1 ) -- 0x081d 0x26
        -- 0x99() -- 0x0820 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x0d = function( self )
        -- 0x26_Wait( time=1 ) -- 0x0844 0x26
        -- 0x99() -- 0x0847 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x0e = function( self )
        -- 0x26_Wait( time=1 ) -- 0x086b 0x26
        -- 0x99() -- 0x086e 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x0f = function( self )
        -- 0x26_Wait( time=1 ) -- 0x0892 0x26
        -- 0x99() -- 0x0895 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x10 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x08b9 0x26
        -- 0x99() -- 0x08bc 0x99
        -- MISSING OPCODE 0x9b
    end,
...
Entity[ "13" ] = {
    ...
    script_0x04 = function( self )
        -- 0xF5_DialogShow3( dialog_id=0x0000, flag=0x23 ) -- 0x0a60 0xf5
        -- 0x9C() -- 0x0a64 0x9c
        -- 0x09_EntityCallScriptEW( entity=0x0b, script=0x24 ) -- 0x0a65 0x09
        -- 0x26_Wait( time=15 ) -- 0x0a68 0x26
        -- 0xF5_DialogShow3( dialog_id=0x0001, flag=0x23 ) -- 0x0a6b 0xf5
        -- 0x9C() -- 0x0a6f 0x9c
        -- 0x26_Wait( time=30 ) -- 0x0a70 0x26
        -- 0xF5_DialogShow3( dialog_id=0x0002, flag=0x23 ) -- 0x0a73 0xf5
        -- 0x9C() -- 0x0a77 0x9c
        -- 0xF5_DialogShow3( dialog_id=0x0003, flag=0x63 ) -- 0x0a78 0xf5
        -- 0x9C() -- 0x0a7c 0x9c
    ...
    script_0x05 = function( self )
        ...
        -- 0x26_Wait( time=15 ) -- 0x0af1 0x26
        -- 0x35() -- 0x0af4 0x35
        -- 0x09_EntityCallScriptEW( entity=0x01, script=0x2a ) -- 0x0afa 0x09
        -- 0x26_Wait( time=15 ) -- 0x0afd 0x26
        -- 0x35() -- 0x0b00 0x35
        -- 0x09_EntityCallScriptEW( entity=0x01, script=0x2a ) -- 0x0b06 0x09
        -- 0x09_EntityCallScriptEW( entity=0x01, script=0x24 ) -- 0x0b09 0x09
        -- 0x26_Wait( time=10 ) -- 0x0b0c 0x26
        -- MISSING OPCODE 0xfc
    end,

    script_0x06 = function( self )
        -- 0xF5_DialogShow3( dialog_id=0x0013, flag=0x23 ) -- 0x0b83 0xf5
        -- 0x9C() -- 0x0b87 0x9c
        -- 0x09_EntityCallScriptEW( entity=0x0b, script=0x24 ) -- 0x0b88 0x09
        -- 0x26_Wait( time=15 ) -- 0x0b8b 0x26
        -- 0xF5_DialogShow3( dialog_id=0x0014, flag=0x23 ) -- 0x0b8e 0xf5
        -- 0x9C() -- 0x0b92 0x9c
        -- 0x26_Wait( time=30 ) -- 0x0b93 0x26
        -- 0xF5_DialogShow3( dialog_id=0x0015, flag=0x23 ) -- 0x0b96 0xf5
        -- 0x9C() -- 0x0b9a 0x9c
        -- 0xF5_DialogShow3( dialog_id=0x0016, flag=0x63 ) -- 0x0b9b 0xf5
        -- 0x9C() -- 0x0b9f 0x9c
        -- MISSING OPCODE 0xFE9b
    end,
