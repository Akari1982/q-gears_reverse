...
Entity[ "1" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=36 ) -- 0x00b7 0xfe
...
Entity[ "9" ] = {
    ...
    on_talk = function( self )
        ...
        -- 0x09_EntityCallScriptEW( entity=0x19, script=0x25 ) -- 0x03af 0x09
        -- 0x01_JumpTo( 0x03be ) -- 0x03b2 0x01
        -- 0x09_EntityCallScriptEW( entity=0x19, script=0x24 ) -- 0x03b5 0x09
        -- 0x35() -- 0x03b8 0x35
        -- 0x01_JumpTo( 0x03c4 ) -- 0x03be 0x01
        -- 0x09_EntityCallScriptEW( entity=0x19, script=0x26 ) -- 0x03c1 0x09
...
Entity[ "10" ] = {
    ...
    script_0x05 = function( self )
        -- 0x08_EntityCallScriptSW( entity=0x05, script=0x24 ) -- 0x040f 0x08
        -- MISSING OPCODE 0x10
    end,
...
Entity[ "27" ] = {
    ...
    on_talk = function( self )
        ...
        -- 0xF5_DialogShow3( dialog_id=0x0082, flag=0x00 ) -- 0x0fd8 0xf5
        -- 0x9C() -- 0x0fdc 0x9c
        ...
        -- 0xF5_DialogShow3( dialog_id=0x0083, flag=0x00 ) -- 0x0fe8 0xf5
        -- 0x9C() -- 0x0fec 0x9c
...
Entity[ "28" ] = {
    ...
    script_0x04 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x0ff7 0x26
        -- 0x99() -- 0x0ffa 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x05 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x101e 0x26
        -- 0x99() -- 0x1021 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x06 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x1045 0x26
        -- 0x99() -- 0x1048 0x99
        -- MISSING OPCODE 0x9b
    end,
...
Entity[ "29" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=1 ) -- 0x106f 0xfe
...
Entity[ "30" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=2 ) -- 0x107a 0xfe
    ...
    script_0x08 = function( self )
        -- 0x08_EntityCallScriptSW( entity=0x04, script=0x24 ) -- 0x10af 0x08
        -- 0x26_Wait( time=15 ) -- 0x10b2 0x26
        -- 0x08_EntityCallScriptSW( entity=0x29, script=0x25 ) -- 0x10b5 0x08
        -- MISSING OPCODE 0x67
    end,
...
Entity[ "31" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=3 ) -- 0x10e6 0xfe
...
Entity[ "32" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=4 ) -- 0x10f1 0xfe
...
Entity[ "33" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=5 ) -- 0x10fc 0xfe
...
Entity[ "34" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=6 ) -- 0x117b 0xfe
...
Entity[ "35" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=7 ) -- 0x1186 0xfe
...
Entity[ "36" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=8 ) -- 0x1191 0xfe
...
Entity[ "37" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=9 ) -- 0x119c 0xfe
...
Entity[ "38" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=10 ) -- 0x11a7 0xfe
...
Entity[ "41" ] = {
    ...
    script_0x08 = function( self )
        -- 0x08_EntityCallScriptSW( entity=0x01, script=0x25 ) -- 0x1554 0x08
        -- MISSING OPCODE 0xfc
    end,
