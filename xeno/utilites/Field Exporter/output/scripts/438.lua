...
Entity[ "12" ] = {
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x0592 0xfe
        -- 0xF5_DialogShow3( dialog_id=0x000e, flag=0x00 ) -- 0x0594 0xf5
        -- MISSING OPCODE 0xa9
    end,
...
Entity[ "23" ] = {
    ...
    script_0x04 = function( self )
        ...
        -- 0xB3() -- 0x08f2 0xb3
        -- 0x26_Wait( time=180 ) -- 0x08f5 0x26
