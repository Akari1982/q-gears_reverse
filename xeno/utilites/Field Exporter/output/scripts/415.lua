...
Entity[ "4" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=GetVar( 0x003e ) ) -- 0x42d1 0xfe
...
Entity[ "5" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=GetVar( 0x0040 ) ) -- 0x42dc 0xfe
...
Entity[ "6" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=GetVar( 0x0042 ) ) -- 0x42e7 0xfe
