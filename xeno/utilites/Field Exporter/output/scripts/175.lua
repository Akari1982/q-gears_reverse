...
Entity[ "0" ] = {
    ...
    on_update = function( self )
        ...
        -- 0x09_EntityCallScriptEW( entity=0x09, script=0x64 ) -- 0x00de 0x09
        -- MISSING OPCODE 0xd4
    end,
...
Entity[ "4" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=0 ) -- 0x43bf 0xfe
...
Entity[ "5" ] = {
    ...
    script_0x04 = function( self )
        -- 0x26_Wait( time=40 ) -- 0x4414 0x26
        -- MISSING OPCODE 0x4a
    end,

    script_0x05 = function( self )
        -- 0x05_CallFunction( 0x4ef9 ) -- 0x4420 0x05
        -- 0x26_Wait( time=20 ) -- 0x4423 0x26
        -- 0x05_CallFunction( 0x4682 ) -- 0x4426 0x05
        -- 0x26_Wait( time=20 ) -- 0x4429 0x26
        -- MISSING OPCODE 0x4a
    end,
