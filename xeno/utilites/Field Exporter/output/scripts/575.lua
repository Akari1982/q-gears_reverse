...
Entity[ "2" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=1 ) -- 0x00b3 0xfe
...
Entity[ "3" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=2 ) -- 0x00be 0xfe
...
Entity[ "4" ] = {
    ...
    on_talk = function( self )
        -- 0xFE54() -- 0x00dc 0xfe
        -- 0x09_EntityCallScriptEW( entity=0x06, script=0x24 ) -- 0x00de 0x09
        -- 0x07( entity=0x01, script=0x24 ) -- 0x00e1 0x07
        -- 0x26_Wait( time=10 ) -- 0x00e4 0x26
