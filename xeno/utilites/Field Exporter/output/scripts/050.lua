...
Entity[ "20" ] = {
    ...
    script_0x04 = function( self )
        -- 0x26_Wait( time=30 ) -- 0x0e03 0x26
        -- 0x35() -- 0x0e06 0x35
        -- MISSING OPCODE 0x38
    end,

    script_0x05 = function( self )
        -- 0x26_Wait( time=20 ) -- 0x0e3c 0x26
        -- 0xFE63() -- 0x0e3f 0xfe
        -- 0xFE63() -- 0x0e45 0xfe
        -- 0xFE63() -- 0x0e4b 0xfe
        -- 0x35() -- 0x0e51 0x35
