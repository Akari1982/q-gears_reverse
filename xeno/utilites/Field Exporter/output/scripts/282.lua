...
Entity[ "0" ] = {
    ...
    on_update = function( self )
        ...
        -- 0x09_EntityCallScriptEW( entity=0x0c, script=0x26 ) -- 0x00ed 0x09
        -- MISSING OPCODE 0x36
    end,
...
Entity[ "1" ] = {
    ...
    script_0x05 = function( self )
        ...
        opcodeAC() -- 0x028a 0xac
        opcodeAC() -- 0x028e 0xac
        opcodeEF() -- 0x0292 0xef
...
Entity[ "2" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=0 ) -- 0x0299 0xfe
    ...
    script_0x04 = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0001, ???=0x11 ) -- 0x02b5 0xd2
        -- 0x9C() -- 0x02b9 0x9c
    ...
    script_0x05 = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0003, ???=0x10 ) -- 0x02ce 0xd2
        -- 0x9C() -- 0x02d2 0x9c
        -- MISSING OPCODE 0x6f
    end,
...
Entity[ "3" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=1 ) -- 0x0370 0xfe
        -- 0xFE0D_SetAvatar( character_id=1 ) -- 0x0374 0xfe
    ...
    script_0x08 = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0010, ???=0x10 ) -- 0x03b9 0xd2
        -- 0x9C() -- 0x03bd 0x9c
...
Entity[ "4" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=1 ) -- 0x03cc 0xfe
        -- MISSING OPCODE 0x91
    end,
    ...
    script_0x08 = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0017, ???=0x10 ) -- 0x041b 0xd2
        -- 0x9C() -- 0x041f 0x9c
...
Entity[ "5" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=6 ) -- 0x042e 0xfe
    ...
    script_0x0a = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0021, ???=0x11 ) -- 0x055e 0xd2
        -- 0x9C() -- 0x0562 0x9c
...
Entity[ "6" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=2 ) -- 0x05f3 0xfe
        -- 0xFE0D_SetAvatar( character_id=2 ) -- 0x05f7 0xfe
...
Entity[ "7" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=2 ) -- 0x0667 0xfe
        -- MISSING OPCODE 0x91
    end,
...
Entity[ "8" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=3 ) -- 0x06c0 0xfe
        -- 0xFE0D_SetAvatar( character_id=3 ) -- 0x06c4 0xfe
        -- 0x2A() -- 0x06c8 0x2a
...
Entity[ "9" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=4 ) -- 0x071d 0xfe
        -- 0xFE0D_SetAvatar( character_id=4 ) -- 0x0721 0xfe
...
Entity[ "10" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=5 ) -- 0x073e 0xfe
        -- 0xFE0D_SetAvatar( character_id=5 ) -- 0x0742 0xfe
...
Entity[ "11" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=7 ) -- 0x075f 0xfe
        -- 0xFE0D_SetAvatar( character_id=7 ) -- 0x0763 0xfe
...
Entity[ "12" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=19 ) -- 0x0780 0xfe
    ...
    on_talk = function( self )
        opcodeD2_DialogShow0( dialog_id=0x002f, ???=0x11 ) -- 0x07af 0xd2
        -- 0x9C() -- 0x07b3 0x9c
    ...
    script_0x04 = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0030, ???=0x21 ) -- 0x07b6 0xd2
        -- 0x9C() -- 0x07ba 0x9c
        return 0 -- 0x07bb 0x00
    end,

    script_0x05 = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0031, ???=0x21 ) -- 0x07bc 0xd2
        -- 0x9C() -- 0x07c0 0x9c
...
Entity[ "13" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=27 ) -- 0x0815 0xfe
        -- 0x2A() -- 0x0819 0x2a
...
Entity[ "14" ] = {
    ...
    on_talk = function( self )
        ...
        opcodeD2_DialogShow0( dialog_id=0x0035, ???=0x00 ) -- 0x088c 0xd2
        -- 0x9C() -- 0x0890 0x9c
        -- MISSING OPCODE 0x36
    end,
...
Entity[ "15" ] = {
    ...
    on_talk = function( self )
        ...
        opcodeD2_DialogShow0( dialog_id=0x0037, ???=0x00 ) -- 0x08c0 0xd2
        -- 0x9C() -- 0x08c4 0x9c
        -- MISSING OPCODE 0x36
    end,
