...
Entity[ "3" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=2 ) -- 0x0152 0xfe
...
Entity[ "6" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=4 ) -- 0x01d9 0xfe
...
Entity[ "7" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=5 ) -- 0x0206 0xfe
...
Entity[ "8" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=6 ) -- 0x0233 0xfe
...
Entity[ "9" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=10 ) -- 0x0260 0xfe
...
Entity[ "10" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=7 ) -- 0x028d 0xfe
...
Entity[ "11" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=8 ) -- 0x02ba 0xfe
...
Entity[ "15" ] = {
    ...
    on_talk = function( self )
        ...
        -- 0x09_EntityCallScriptEW( entity=0x1a, script=0xc4 ) -- 0x042d 0x09
        -- 0x09_EntityCallScriptEW( entity=0x11, script=0xc4 ) -- 0x0430 0x09
        ...
        -- 0x26_Wait( time=10 ) -- 0x043f 0x26
        -- 0x05_CallFunction( 0x0306 ) -- 0x0442 0x05
        -- 0x05_CallFunction( 0x02f8 ) -- 0x0445 0x05
        -- 0x26_Wait( time=60 ) -- 0x0448 0x26
        -- 0x07( entity=0x18, script=0xc5 ) -- 0x044b 0x07
        -- 0x09_EntityCallScriptEW( entity=0x1a, script=0xc5 ) -- 0x044e 0x09
...
Entity[ "16" ] = {
    ...
    on_talk = function( self )
        ...
        -- 0x09_EntityCallScriptEW( entity=0x1d, script=0xc4 ) -- 0x0486 0x09
        -- 0x09_EntityCallScriptEW( entity=0x13, script=0xc4 ) -- 0x0489 0x09
        ...
        -- 0x26_Wait( time=10 ) -- 0x0498 0x26
        -- 0x05_CallFunction( 0x02ea ) -- 0x049b 0x05
        -- 0x05_CallFunction( 0x0329 ) -- 0x049e 0x05
        -- 0x26_Wait( time=60 ) -- 0x04a1 0x26
        -- 0x07( entity=0x19, script=0xc5 ) -- 0x04a4 0x07
        -- 0x09_EntityCallScriptEW( entity=0x1d, script=0xc5 ) -- 0x04a7 0x09
        -- MISSING OPCODE 0xFE24
    end,
...
Entity[ "17" ] = {
    ...
    on_talk = function( self )
        ...
        -- 0x09_EntityCallScriptEW( entity=0x1a, script=0xc4 ) -- 0x04df 0x09
        -- 0x09_EntityCallScriptEW( entity=0x0f, script=0xc4 ) -- 0x04e2 0x09
        ...
        -- 0x26_Wait( time=10 ) -- 0x04f1 0x26
        -- 0x05_CallFunction( 0x02ea ) -- 0x04f4 0x05
        -- 0x05_CallFunction( 0x030f ) -- 0x04f7 0x05
        -- 0x26_Wait( time=60 ) -- 0x04fa 0x26
        -- 0x07( entity=0x18, script=0xc5 ) -- 0x04fd 0x07
        -- 0x09_EntityCallScriptEW( entity=0x1a, script=0xc5 ) -- 0x0500 0x09
        -- MISSING OPCODE 0xFE24
    end,
...
Entity[ "19" ] = {
    ...
    on_talk = function( self )
        ...
        -- 0x09_EntityCallScriptEW( entity=0x1d, script=0xc4 ) -- 0x055a 0x09
        -- 0x09_EntityCallScriptEW( entity=0x10, script=0xc4 ) -- 0x055d 0x09
        ...
        -- 0x26_Wait( time=10 ) -- 0x056c 0x26
        -- 0x05_CallFunction( 0x0318 ) -- 0x056f 0x05
        -- 0x05_CallFunction( 0x02f8 ) -- 0x0572 0x05
        -- 0x26_Wait( time=60 ) -- 0x0575 0x26
        -- 0x07( entity=0x19, script=0xc5 ) -- 0x0578 0x07
        -- 0x09_EntityCallScriptEW( entity=0x1d, script=0xc5 ) -- 0x057b 0x09
        -- MISSING OPCODE 0xFE24
    end,
