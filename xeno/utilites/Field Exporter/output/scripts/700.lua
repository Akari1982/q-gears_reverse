...
Entity[ "1" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=0 ) -- 0x0149 0xfe
    ...
    script_0x05 = function( self )
        opcodeD2_DialogShow0( dialog_id=0x0005, ???=0x00 ) -- 0x015c 0xd2
        -- 0x9C() -- 0x0160 0x9c
...
Entity[ "2" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=2 ) -- 0x0171 0xfe
...
Entity[ "3" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=1 ) -- 0x017c 0xfe
...
Entity[ "4" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=3 ) -- 0x0187 0xfe
...
Entity[ "5" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=5 ) -- 0x0192 0xfe
...
Entity[ "6" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=4 ) -- 0x019d 0xfe
...
Entity[ "7" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=6 ) -- 0x01a8 0xfe
...
Entity[ "9" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=8 ) -- 0x01be 0xfe
...
Entity[ "11" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=10 ) -- 0x01e0 0xfe
...
Entity[ "12" ] = {
    ...
    on_talk = function( self )
        ...
        -- 0x08_EntityCallScriptSW( entity=0x00, script=0x64 ) -- 0x01fc 0x08
        -- 0xF5_DialogShow3( dialog_id=0x0008, flag=0x11 ) -- 0x01ff 0xf5
        -- 0x9C() -- 0x0203 0x9c
    ...
    script_0x04 = function( self )
        opcodeD2_DialogShow0( dialog_id=0x000a, ???=0x00 ) -- 0x0256 0xd2
        -- 0x9C() -- 0x025a 0x9c
        return 0 -- 0x025b 0x00
    end,

    script_0x05 = function( self )
        opcodeD2_DialogShow0( dialog_id=0x000b, ???=0x00 ) -- 0x025c 0xd2
        -- 0x9C() -- 0x0260 0x9c
