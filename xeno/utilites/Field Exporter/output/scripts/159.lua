...
Entity[ "7" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=5 ) -- 0x00a0 0xfe
...
Entity[ "8" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=6 ) -- 0x00ab 0xfe
...
Entity[ "10" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=8 ) -- 0x00c1 0xfe
...
Entity[ "11" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=10 ) -- 0x00cc 0xfe
