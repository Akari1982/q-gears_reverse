...
Entity[ "0" ] = {
    ...
    on_update = function( self )
        ...
        -- 0xFE54() -- 0x00ba 0xfe
        -- 0x09_EntityCallScriptEW( entity=0x43, script=0x26 ) -- 0x00bc 0x09
...
Entity[ "1" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=0 ) -- 0x020e 0xfe
...
Entity[ "4" ] = {
    ...
    on_update = function( self )
        -- 0x09_EntityCallScriptEW( entity=0x06, script=0x25 ) -- 0x0346 0x09
        -- 0x5A() -- 0x0349 0x5a
        -- 0x09_EntityCallScriptEW( entity=0x06, script=0x24 ) -- 0x034a 0x09
        -- 0x26_Wait( time=15 ) -- 0x034d 0x26
        -- MISSING OPCODE 0x2c
    end,
...
Entity[ "11" ] = {
    ...
    script_0x04 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x05ac 0x26
        -- 0x99() -- 0x05af 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x05 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x0639 0x26
        -- 0x99() -- 0x063c 0x99
        -- MISSING OPCODE 0x9b
    end,
    ...
    script_0x08 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x079c 0x26
        -- 0x99() -- 0x079f 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x09 = function( self )
        -- 0x26_Wait( time=1 ) -- 0x07c3 0x26
        -- 0x99() -- 0x07c6 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x0a = function( self )
        -- 0x26_Wait( time=1 ) -- 0x07ea 0x26
        -- 0x99() -- 0x07ed 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x0b = function( self )
        -- 0x26_Wait( time=1 ) -- 0x0811 0x26
        -- 0x99() -- 0x0814 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x0c = function( self )
        -- 0x26_Wait( time=1 ) -- 0x0838 0x26
        -- 0x99() -- 0x083b 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x0d = function( self )
        -- 0x26_Wait( time=1 ) -- 0x085f 0x26
        -- 0x99() -- 0x0862 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x0e = function( self )
        -- 0x26_Wait( time=1 ) -- 0x0886 0x26
        -- 0x99() -- 0x0889 0x99
        -- MISSING OPCODE 0x9b
    end,

    script_0x0f = function( self )
        -- 0x26_Wait( time=1 ) -- 0x08cf 0x26
        -- 0x99() -- 0x08d2 0x99
        -- MISSING OPCODE 0x9b
    end,
