...
Entity[ "2" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=2 ) -- 0x003c 0xfe
...
Entity[ "5" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=5 ) -- 0x005d 0xfe
...
Entity[ "7" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=6 ) -- 0x0073 0xfe
...
Entity[ "8" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=7 ) -- 0x007e 0xfe
...
Entity[ "9" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=8 ) -- 0x0089 0xfe
...
Entity[ "10" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=9 ) -- 0x0094 0xfe
...
Entity[ "11" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=10 ) -- 0x009f 0xfe
...
Entity[ "14" ] = {
    ...
    on_talk = function( self )
        opcodeFE54() -- 0x00cc 0xfe
        opcode15() -- 0x00ce 0x15
        -- MISSING OPCODE 0xc4
    end,
