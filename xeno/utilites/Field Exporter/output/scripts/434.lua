...
Entity[ "15" ] = {
    ...
    on_update = function( self )
        ...
        -- 0xFE54() -- 0x0374 0xfe
        -- 0x26_Wait( time=40 ) -- 0x0376 0x26
        -- 0x08_EntityCallScriptSW( entity=0x01, script=0x66 ) -- 0x0379 0x08
        -- 0x08_EntityCallScriptSW( entity=0x00, script=0x44 ) -- 0x037c 0x08
