...
Entity[ "2" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=2 ) -- 0x0022 0xfe
...
Entity[ "4" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=3 ) -- 0x0038 0xfe
...
Entity[ "6" ] = {
    on_start = function( self )
        ...
        -- 0xFE0D_SetAvatar( character_id=4 ) -- 0x005d 0xfe
...
Entity[ "7" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 6 ) -- 0x0065 0x16
        -- 0xFE0D_SetAvatar( character_id=6 ) -- 0x0068 0xfe
...
Entity[ "8" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 7 ) -- 0x0070 0x16
        -- 0xFE0D_SetAvatar( character_id=7 ) -- 0x0073 0xfe
...
Entity[ "9" ] = {
    on_start = function( self )
        -- 0x16_EntityPCInit( 8 ) -- 0x007b 0x16
        -- 0xFE0D_SetAvatar( character_id=8 ) -- 0x007e 0xfe
...
Entity[ "12" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x00e8, z=(vf40)0xffa6, flag=(flag)0xc0 ) -- 0x009f 0x19
        -- MISSING OPCODE 0x69
    end,
...
Entity[ "14" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x0011, z=(vf40)0x00f6, flag=(flag)0xc0 ) -- 0x00da 0x19
        -- MISSING OPCODE 0x69
    end,
...
Entity[ "15" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xff1f, z=(vf40)0x006b, flag=(flag)0xc0 ) -- 0x00f6 0x19
        -- MISSING OPCODE 0x69
    end,
...
Entity[ "16" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xff0b, z=(vf40)0xffe1, flag=(flag)0xc0 ) -- 0x011d 0x19
        -- MISSING OPCODE 0x69
    end,
...
Entity[ "17" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xffb8, z=(vf40)0xff12, flag=(flag)0xc0 ) -- 0x0139 0x19
        -- MISSING OPCODE 0x69
    end,
...
Entity[ "19" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x016b, z=(vf40)0x00c1, flag=(flag)0xc0 ) -- 0x0174 0x19
        -- MISSING OPCODE 0x69
    end,
...
Entity[ "20" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0x0026, z=(vf40)0xff89, flag=(flag)0xc0 ) -- 0x0190 0x19
        -- MISSING OPCODE 0x69
    end,
...
Entity[ "21" ] = {
    on_start = function( self )
        ...
        -- 0x19_SetPosition( x=(vf80)0xfe6e, z=(vf40)0x009b, flag=(flag)0xc0 ) -- 0x01b3 0x19
        -- MISSING OPCODE 0x69
    end,
