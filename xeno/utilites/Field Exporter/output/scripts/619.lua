...
Entity[ "7" ] = {
    ...
    on_update = function( self )
        ...
        -- 0x09_EntityCallScriptEW( entity=0x1d, script=0x24 ) -- 0x041d 0x09
...
Entity[ "28" ] = {
    ...
    script_0x04 = function( self )
        -- 0xF5_DialogShow3( dialog_id=0x0000, flag=0x53 ) -- 0x13c2 0xf5
        -- 0x9C() -- 0x13c6 0x9c
        -- 0xF5_DialogShow3( dialog_id=0x0001, flag=0x53 ) -- 0x13c7 0xf5
        -- 0x9C() -- 0x13cb 0x9c
        -- 0xF5_DialogShow3( dialog_id=0x0002, flag=0x53 ) -- 0x13cc 0xf5
        -- 0x9C() -- 0x13d0 0x9c
        return 0 -- 0x13d1 0x00
    end,

    script_0x05 = function( self )
        -- 0xF5_DialogShow3( dialog_id=0x0003, flag=0x53 ) -- 0x13d2 0xf5
        -- 0x9C() -- 0x13d6 0x9c
        return 0 -- 0x13d7 0x00
    end,

    script_0x06 = function( self )
        -- 0xF5_DialogShow3( dialog_id=0x0004, flag=0x53 ) -- 0x13d8 0xf5
        -- 0x9C() -- 0x13dc 0x9c
        -- 0xF5_DialogShow3( dialog_id=0x0005, flag=0x53 ) -- 0x13dd 0xf5
        -- 0x9C() -- 0x13e1 0x9c
        -- 0xF5_DialogShow3( dialog_id=0x0006, flag=0x53 ) -- 0x13e2 0xf5
        -- 0x9C() -- 0x13e6 0x9c
        -- 0xF5_DialogShow3( dialog_id=0x0007, flag=0x53 ) -- 0x13e7 0xf5
        -- 0x9C() -- 0x13eb 0x9c
        -- 0xF5_DialogShow3( dialog_id=0x0008, flag=0x53 ) -- 0x13ec 0xf5
        -- 0x9C() -- 0x13f0 0x9c
        return 0 -- 0x13f1 0x00
    end,

    script_0x07 = function( self )
        -- 0xF5_DialogShow3( dialog_id=0x0009, flag=0x53 ) -- 0x13f2 0xf5
        -- 0x9C() -- 0x13f6 0x9c
        -- MISSING OPCODE 0xfc
    end,
    ...
    script_0x09 = function( self )
        -- 0x35() -- 0x1483 0x35
        -- 0x09_EntityCallScriptEW( entity=0x0a, script=0x2a ) -- 0x1489 0x09
        -- MISSING OPCODE 0xfc
    end,

    script_0x0a = function( self )
        -- 0xC6() -- 0x15a6 0xc6
        -- 0x08_EntityCallScriptSW( entity=0x05, script=0x25 ) -- 0x15a7 0x08
        -- 0x08_EntityCallScriptSW( entity=0x0a, script=0x28 ) -- 0x15aa 0x08
        opcode26_Wait( time=15 ) -- 0x15ad 0x26
        -- 0x09_EntityCallScriptEW( entity=0x01, script=0x28 ) -- 0x15b0 0x09
        opcode26_Wait( time=30 ) -- 0x15b3 0x26
        -- 0x08_EntityCallScriptSW( entity=0x02, script=0x25 ) -- 0x15b6 0x08
...
Entity[ "29" ] = {
    ...
    script_0x06 = function( self )
        opcode25( entity=(entity)0x17 ) -- 0x1771 0x25
        -- MISSING OPCODE 0x27
    end,

    script_0x07 = function( self )
        opcode25( entity=(entity)0x18 ) -- 0x1776 0x25
        -- MISSING OPCODE 0x27
    end,

    script_0x08 = function( self )
        opcode25( entity=(entity)0x1a ) -- 0x177f 0x25
        -- MISSING OPCODE 0x27
    end,

    script_0x09 = function( self )
        opcode24( entity=(entity)0x17 ) -- 0x1788 0x24
        -- MISSING OPCODE 0x28
    end,

    script_0x0a = function( self )
        opcode24( entity=(entity)0x18 ) -- 0x178d 0x24
        -- MISSING OPCODE 0x28
    end,

    script_0x0b = function( self )
        opcode24( entity=(entity)0x1a ) -- 0x1796 0x24
        -- MISSING OPCODE 0x28
    end,

    script_0x0c = function( self )
        opcode25( entity=(entity)0x17 ) -- 0x179f 0x25
        -- MISSING OPCODE 0x27
    end,

    script_0x0d = function( self )
        opcode24( entity=(entity)0x17 ) -- 0x17b4 0x24
        -- MISSING OPCODE 0x28
    end,
...
Entity[ "30" ] = {
    ...
    on_update = function( self )
        ...
        -- 0x35() -- 0x17d6 0x35
        -- 0x09_EntityCallScriptEW( entity=0x08, script=0x25 ) -- 0x17dc 0x09
        -- 0x5A() -- 0x17df 0x5a
        -- 0xF1() -- 0x17e0 0xf1
        opcode26_Wait( time=15 ) -- 0x17eb 0x26
        -- 0xF5_DialogShow3( dialog_id=0x0036, flag=0x00 ) -- 0x17ee 0xf5
        -- 0x9C() -- 0x17f2 0x9c
...
Entity[ "31" ] = {
    ...
    on_talk = function( self )
        -- 0x09_EntityCallScriptEW( entity=0x1d, script=0x26 ) -- 0x1896 0x09
        -- 0x09_EntityCallScriptEW( entity=0x1d, script=0x27 ) -- 0x1899 0x09
        -- 0x09_EntityCallScriptEW( entity=0x1d, script=0x28 ) -- 0x189c 0x09
