...
Entity[ "0" ] = {
    ...
    on_update = function( self )
        ...
        opcodeAC() -- 0x0020 0xac
        opcodeAC() -- 0x0024 0xac
        opcodeEF() -- 0x0028 0xef
        opcode26_Wait( time=60 ) -- 0x002b 0x26
        -- 0xFE0D_SetAvatar( character_id=19 ) -- 0x002e 0xfe
        -- 0xD0() -- 0x0032 0xd0
        opcodeD2_DialogShow0( dialog_id=0x0000, ???=0x21 ) -- 0x003d 0xd2
        -- 0x9C() -- 0x0041 0x9c
        opcode26_Wait( time=60 ) -- 0x0042 0x26
        opcodeFE9B_SlideShow1( steps=30 ) -- 0x0045 0xfe
        opcodeAC() -- 0x0049 0xac
        opcodeAC() -- 0x004d 0xac
        opcodeEF() -- 0x0051 0xef
        opcode25( entity=(entity)0x02 ) -- 0x0054 0x25
        opcode24( entity=(entity)0x03 ) -- 0x0056 0x24
        opcode26_Wait( time=60 ) -- 0x0058 0x26
        -- 0xD0() -- 0x005b 0xd0
        opcodeD2_DialogShow0( dialog_id=0x0001, ???=0x21 ) -- 0x0066 0xd2
        -- 0x9C() -- 0x006a 0x9c
        opcode26_Wait( time=60 ) -- 0x006b 0x26
        opcodeFE9B_SlideShow1( steps=30 ) -- 0x006e 0xfe
        opcodeAC() -- 0x0072 0xac
        opcodeAC() -- 0x0076 0xac
        opcodeEF() -- 0x007a 0xef
        opcode25( entity=(entity)0x03 ) -- 0x007d 0x25
        opcode24( entity=(entity)0x04 ) -- 0x007f 0x24
        opcode26_Wait( time=60 ) -- 0x0081 0x26
        -- 0xD0() -- 0x0084 0xd0
        opcodeD2_DialogShow0( dialog_id=0x0002, ???=0x21 ) -- 0x008f 0xd2
        -- 0x9C() -- 0x0093 0x9c
        -- 0xFE0D_SetAvatar( character_id=2 ) -- 0x0094 0xfe
        -- 0xD0() -- 0x0098 0xd0
        opcodeD2_DialogShow0( dialog_id=0x0003, ???=0x21 ) -- 0x00a3 0xd2
        -- 0x9C() -- 0x00a7 0x9c
