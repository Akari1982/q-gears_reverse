...
Entity[ "1" ] = {
    ...
    on_update = function( self )
        ...
        -- 0xD0() -- 0x0069 0xd0
        opcodeD2_DialogShow0( dialog_id=0x0000, ???=0x00 ) -- 0x0074 0xd2
        -- 0x9C() -- 0x0078 0x9c
        opcodeD2_DialogShow0( dialog_id=0x0001, ???=0x00 ) -- 0x0079 0xd2
        -- 0x9C() -- 0x007d 0x9c
        opcode26_Wait( time=60 ) -- 0x007e 0x26
        opcodeD2_DialogShow0( dialog_id=0x0002, ???=0x00 ) -- 0x0081 0xd2
        -- 0x9C() -- 0x0085 0x9c
        ...
        opcodeD2_DialogShow0( dialog_id=0x0003, ???=0x00 ) -- 0x0092 0xd2
        -- 0x9C() -- 0x0096 0x9c
        -- 0x07( entity=0x03, script=0x05 ) -- 0x0097 0x07
        opcode26_Wait( time=30 ) -- 0x009a 0x26
        opcodeD2_DialogShow0( dialog_id=0x0004, ???=0x00 ) -- 0x009d 0xd2
        -- 0x9C() -- 0x00a1 0x9c
        opcodeD2_DialogShow0( dialog_id=0x0005, ???=0x00 ) -- 0x00a2 0xd2
        -- 0x9C() -- 0x00a6 0x9c
        -- 0x09_EntityCallScriptEW( entity=0x03, script=0x06 ) -- 0x00a7 0x09
        opcodeD2_DialogShow0( dialog_id=0x0006, ???=0x00 ) -- 0x00aa 0xd2
        -- 0x9C() -- 0x00ae 0x9c
        opcodeD2_DialogShow0( dialog_id=0x0007, ???=0x00 ) -- 0x00af 0xd2
        -- 0x9C() -- 0x00b3 0x9c
