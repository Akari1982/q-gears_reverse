...
[SP + 0010] = w(RA);
A0 = h[V0 + 0052];
80091DF0	jal    system_cos [$system_cos]
80091DF4	nop
V1 = V0 << 03;
V1 = V1 + V0;
V0 = w[800af54c];
...
[V0 + 0060] = h(V1);
A0 = h[A0 + 0052];
80091E1C	jal    system_sin [$system_sin]
80091E20	nop
V1 = V0 << 03;
V1 = V1 + V0;
V1 = V1 << 02;
...
80091FA4	jal    system_cos [$system_cos]
A0 = S0;
V1 = w[800af54c];
80091FB4	nop
A1 = h[V1 + 0060];
...
V1 = V1 << 03;
V1 = V1 >> 0c;
80091FD8	jal    system_sin [$system_sin]
S0 = A1 + V1;
V1 = w[800af54c];
80091FE8	nop
A0 = h[V1 + 0064];
