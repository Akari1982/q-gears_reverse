...
for (int i = 0; i < 8; ++i)
{
    if (w[0x8009c778 + A0 * 84 + i * 4] != -1) A2 += 1;
}

for (int i = 0; i < 8; ++i)
{
    if (w[0x8009c798 + A0 * 84 + i * 4] != -1) A2 += 1;
}
...
for (int i = 0; i < 5; ++i)
{
    ...
    V1 = hu[0x8009c6e4 + 54 + i * 84 + 2c]; // current hp
    V1 = V1 * V0;
    A1 = hi(V1 * 80008001);
    V0 = A1 + V1;
    V0 = V0 >> f;
...
{
    if ((hu[0x8009c6e4 + 10a6] >> char_id) & 1)
    {
        for (int i = 0; i < 8; ++i)
        {
            if (w[0x8009c6e4 + 54 + char_id * 84 + 40 + i * 4] == A0)
            {
                [0x8009c6e4 + 54 + char_id * 84 + 40 + i * 4] = w(-1);
                return;
            }
        }
        ...
        for (int i = 0; i < 8; ++i)
        {
            if (w[0x8009c6e4 + 54 + char_id * 84 + 60 + i * 4] == A0)
            {
                [0x8009c6e4 + 54 + char_id * 84 + 60 + i * 4] = w(-1);
                return;
            }
        }
    }
...
for (int i = 0; i < c8; ++i)
{
    if (w[0x8009c6e4 + 77c + i * 4] == A0)
    {
        [0x8009c6e4 + 77c + i * 4] = w(-1);
        return;
    }
}
////////////////////////////////
...
for (int char_id = 0; char_id < 9; ++char_id)
{
    if ((hu[0x8009c6e4 + 10a6] >> char_id) & 1)
    {
        for (int i = 0; i < 8; ++i)
        {
            V0 = w[0x8009c6e4 + 54 + char_id * 84 + 40 + i * 4];
            if ((V0 >> 8) == ffffff)
            {
        ...
        for (int i = 0; i < 8; ++i)
        {
            V0 = w[0x8009c6e4 + 54 + char_id * 84 + 60 + i * 4];
            if ((V0 >> 8) == ffffff)
            {
                if ((V0 & ff) == materia_id) return 1;
            }
...
for (int char_id = 0; char_id < 9; ++char_id)
{
    if ((hu[0x8009c6e4 + 10a6] >> char_id) & 1)
    {
        for (int i = 0; i < 8; ++i)
        {
            if (bu[0x8009c6e4 + 54 + char_id * 84 + 40 + i * 4] == materia_id) return 1;
        }

        for (int i = 0; i < 8; ++i)
        {
            if (bu[0x8009c6e4 + 54 + char_id * 84 + 60 + i * 4] == materia_id) return 1;
        }
    }
}
...
for (int i = 0; i < c8; ++i)
{
    if (bu[0x8009c6e4 + 77c + i * 4] == materia_id) return 1;
}
...
void func1d0704()
{
    if (A0 == 0) // give master magic
    {
        for (int i = 0; i < 0x15; ++i)
        {
            ...
            func1d0324(bu[0x801d082c + i]); // remove mastered materia with given id
        }
        system_menu_add_materia(0x49); // Master Magic
    }
    else if (A0 == 1) // give master summon
    {
        for (int i = 0; i < 0x10; ++i)
        {
            ...
            func1d0324(bu[0x801d0844 + i]); // remove mastered materia with given id
        }
        system_menu_add_materia(0x5a); // Master Summon
    }
    else if (A0 == 0x2) // give master command
    {
        for (int i = 0; i < 0x7; ++i)
        {
            // 801d0854 list of materia for master command
            // 24 25 27 28 29 2A 2B
            func1d0324(bu[0x801d0854 + i]); // remove mastered materia with given id
        }
        system_menu_add_materia(0x30); // Master Command
    }
    else if (A0 == 0x3) // give bahamit zero
    {
        system_menu_add_materia(0x58); // Bahamut ZERO
    }
}
