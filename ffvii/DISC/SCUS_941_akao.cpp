...
int func2df88( CommandData* data )
{
    ...
    else if( V1 == 0x27 )
    {
        [S0 + 0x0] = h(0x23);
        [S0 + 0xc] = w(w[S0 + 0x8] + 0x1);
        [S0 + 0x14] = w(w[S0 + 0x8] + 0x3);
        [S0 + 0x10] = w(w[S0 + 0x8] + 0x2);
    }
    else if( V1 == 0x26 )
    {
        [S0 + 0x0] = h(0x22);
    ...
    V0 = bu[S0 + 0x0];
    A0 = S0;
    8002E188	jalr   w[0x80049548 + V0 * 4] ra
