...
[S0 + 0] = h(hu[0x801518e4 + A0 * b9c + 174 + A1 * 34 + 14] - hu[0x800fa63c + 14]); // translation x
[S0 + 2] = h(hu[0x801518e4 + A0 * b9c + 174 + A1 * 34 + 18] - hu[0x800fa63c + 18]); // translation y
[S0 + 4] = h(hu[0x801518e4 + A0 * b9c + 174 + A1 * 34 + 1c] - hu[0x800fa63c  1c]); // translation z
...
// funcd3a6c
S0 = A1;
[S0 + 0] = h(hu[A0 + 14] - hu[0x800fa63c + 14]);
[S0 + 2] = h(hu[A0 + 18] - hu[0x800fa63c + 18]);
[S0 + 4] = h(hu[A0 + 1c] - hu[0x800fa63c + 1c]);
...
S2 = 801621f0 + h[0x801590d4] * 20;

[SP + 10] = w(w[0x800a0d98 + 0]);
[SP + 14] = w(w[0x800a0d98 + 4]);
[SP + 18] = w(w[0x800a0d98 + 8]);
[SP + 1c] = w(w[0x800a0d98 + c]);
[SP + 20] = w(w[0x800a0d98 + 10]);
[SP + 24] = w(w[0x800a0d98 + 14]);
[SP + 28] = w(w[0x800a0d98 + 18]);
[SP + 2c] = w(w[0x800a0d98 + 1c]);

[0x800f0218 + 4] = b(h[S2 + 2] * 20); // dust frame y tex
...
effect_id = h[0x801590d4];
unit_id = h[0x801621f0 + effect_id * 20 + 0];

bone_id = bu[0x801518e4 + unit_id * b9c + 2b + b + (hu[0x801621f0 + effect_id * 20 + 2] & 1)];
...
if (bone_id != ff)
{
    ...
    [0x801621f0 + new_effect_id * 20 + 6] = h(0);
    [0x801621f0 + new_effect_id * 20 + e] = h(hu[0x801621f0 + effect_id * 20 + e]);
    [0x801621f0 + new_effect_id * 20 + 10] = h(hu[0x801621f0 + effect_id * 20 + 10]);
}

[0x801621f0 + effect_id * 20 + 2] = h(h[0x801621f0 + effect_id * 20 + 2] + 1)

if (h[0x801621f0 + effect_id * 20 + 2] == 4)
{
    [0x801621f0 + effect_id * 20 + 0] = h(-1);
}
////////////////////////////////
...
[0x801621f0 + V0 * 20 + 00] = h(unit_id);
[0x801621f0 + V0 * 20 + 0e] = h(hu[0x801518e4 + unit_id * b9c + 6]);
[0x801621f0 + V0 * 20 + 10] = h(hu[0x801518e4 + unit_id * b9c + 6]);
////////////////////////////////
...
if (collision != 0)
{
    ...
    [0x800f023c] = w(w[0x800f023c] + (collision * w[SP + 10]) >> c);
    [0x800f0240] = w(w[0x800f0240] + (collision * w[SP + 14]) >> c);
    [0x800f0244] = w(w[0x800f0244] + (collision * w[SP + 18]) >> c);
}
...
V1 = S0 & ff00;
S0 = S0 & 00ff;
[0x801621f0 + V0 * 20 + 0] = h(V1);
[0x801621f0 + V0 * 20 + 4] = w(w[S3 + 0]);
[0x801621f0 + V0 * 20 + 8] = w(w[S3 + 4]);
[0x801621f0 + V0 * 20 + c] = w(w[0x800f0f98 + S0 * 4]);
[0x801621f0 + V0 * 20 + 12] = h(S1);
[0x801621f0 + V0 * 20 + 18] = h(S2);
////////////////////////////////
...
////////////////////////////////
// funcd4ff0
if (w[0x800f10d8] != w[0x800f10dc])
{
    V1 = w[0x800f10dc];
    [A0] = w(800f4d2c + V1 * 14);

    [0x800f10dc] = w((w[0x800f10dc] + 1) & f);

    return w[0x800f4cec + V1 * 4];
}
else
{
    [A0] = w(800f4d2c + ((w[0x800f10d8] - 1) & f) * 14);
    return 0;
}
////////////////////////////////
...
[0x80162978 + V0 * 20 + 0] = h(0);
[0x80162978 + V0 * 20 + 4] = h(S0);
[0x80162978 + V0 * 20 + 6] = h(S1);
[0x80162978 + V0 * 20 + 8] = h(S2);
[0x80162978 + V0 * 20 + c] = w(S3);
////////////////////////////////
...
////////////////////////////////
// funcd55a4
collision = h[0x801518e4 + A0 * b9c + 12]; // collision radius
V0 = h[0x801518e4 + A0 * b9c + 106] * 10 * collision;
V0 = V0 >> c;
////////////////////////////////
...
{
    loopd5674:	; 800D5674
        [0x8009a004 + A1 * 4] = w(w[SP + 1c + A1 * 4]);
        A1 = A1 + 1;
        V0 = A2 < A1;
...
if (A0 == 0)
{
    V1 = h[0x80162978 + S0 * 20 + 2];
    A0 = h[0x80162978 + S0 * 20 + 4];
    if (V1 >= A0)
    {
        V1 = V1 - A0
        V0 = h[0x80162978 + S0 * 20 + 6];
        V0 = V1 % V0;
        if (V0 == 0)
        {
            V1 = h[0x80162978 + S0 * 20 + 0];
            A0 = h[0x80162978 + S0 * 20 + 8];
            loopd5858:	; 800D5858
                [0x80162978 + S0 * 20 + 0] = h(V1);
                V0 = A0 >> V1;
                V0 = V0 & 1;
                V1 = V1 + 1;
            ...
            [0x800f4cec + A1 * 4] = w(4);
            [0x800f4d2c + A1 * 14] = h(hu[0x80162978 + S0 * 20 + 0]);

            // remove bit from target mask.
            V1 = h[0x80162978 + S0 * 20 + 0];
            V0 = 1 << V1;
            V1 = hu[0x80162978 + S0 * 20 + 8];
            V0 = 0 NOR V0;
            V1 = V1 & V0;
            [0x80162978 + S0 * 20 + 8] = h(V1);

            if (V1 == 0)
            {
                [0x80162978 + S0 * 20 + 0] = h(-1);
            }
        }
    }

    [0x80162978 + S0 * 20 + 2] = h(hu[0x80162978 + S0 * 20 + 2] + 1);
}
////////////////////////////////
...
[0x80162978 + V0 * 20 + 0] = h(0);
[0x80162978 + V0 * 20 + 4] = h(S2);
[0x80162978 + V0 * 20 + 6] = h(S0);
[0x80162978 + V0 * 20 + 8] = h(S1);
////////////////////////////////
...
[0x801621f0 + V0 * 20 + 4] = w(w[SP + 10 + S0 * 4])
[0x801621f0 + V0 * 20 + 8] = h(S1);
////////////////////////////////
...
system_bios_rand();
[0x800f1956] = h(V0 & 3ff); // random Y rotation

A0 = 800f1954;
A1 = 800f1934;
system_gte_rotation_matrix_from_yxz();

[0x800f1948] = w(h[S1 + 8]); // set X translation
[0x800f1950] = w(h[S1 + c]); // set Z translation
...
if (A0 > 0)
{
    ...
    A0 = w[0x801517c0] + A0 & fffffffc + 70;
    A1 = S0;
    system_psyq_add_prim;

    [0x80163c74] = w(S0 + 28); // add quad
}
...
if (bu[0x80062d98] != 0 || current_frame == 0)
{
    [0x800f1978] = w(-h[S1 + 1a]); // distance from joint
    ...
    if (bu[0x80062d98] == 0)
    {
        ...
        [S0 + 8] = h(hu[SP + 24] - hu[0x800fa650]);
        [S0 + a] = h(hu[SP + 28] - hu[0x800fa654]);
        [S0 + c] = h(hu[SP + 2c] - hu[0x800fa658]);
...
if( bu[0x80062d98] == 0 )
{
    ...
    if( current_frame >= start_frame )
    {
        ...
        if( real_current_frame < final_frame & ff7f )
        {
            ...
            funcbc04c();
            [0x801621f0 + V0 * 20 + 04] = h(hu[S1 + 04]);
            [0x801621f0 + V0 * 20 + 06] = h(hu[S1 + 06]);
            [0x801621f0 + V0 * 20 + 1a] = h(hu[S1 + 1a]);
            [0x801621f0 + V0 * 20 + 1c] = h(hu[S1 + 1c]);
            ...
            if ((final_frame & 0080) == 0) // render shell animation
            {
                ...
                [S2 + 0] = h(0);
                [S2 + 6] = h(hu[S1 + 6]);
                [S2 + 18] = h(hu[0x801518e4 + h[S1 + 6] * b9c + 162]);
...
[0x801621f0 + V0 * 20 + 04] = h(S2);
[0x801621f0 + V0 * 20 + 06] = h(unit_id);
[0x801621f0 + V0 * 20 + 08] = h(w[SP + 10]); // start
[0x801621f0 + V0 * 20 + 0a] = h(w[SP + 14]); // end
[0x801621f0 + V0 * 20 + 1a] = h(distance);
[0x801621f0 + V0 * 20 + 1c] = w(bone_address);
////////////////////////////////
...
unit_id = A1;
bone_id = bu[0x80151915 + unit_id * b9c + 0];

A4 = A2;
A5 = A3;
A2 = 80151a58 + unit_id * b9c + T0 * 34;
A3 = h[0x801518fe + unit_id * b9c + 0];
funcd7a88();
////////////////////////////////
...
unit_id = A1;
bone_id = bu[0x80151916 + unit_id * b9c + 0];

A0 = A0;
A4 = A2;
A5 = A3;
A2 = 80151a58 + unit_id * b9c + bone_id * 34;
A3 = h[0x80151900 + unit_id * b9c + 0];
funcd7a88();
////////////////////////////////
...
result = A0;
// A1
// 800bca84 : SH      00002930 (v1), 8d00 (80160000 (at)) [0x80158d00]
// 800bcaa0 : SH      0000f278 (v1), 8d02 (80160000 (at)) [0x80158d02]
// 800bcabc : SH      0000057d (v1), 8d04 (80160000 (at)) [0x80158d04]
S4 = A1; // end vector
// A2
// 800bcad8 : SH      000004b7 (v1), 31e8 (80100000 (at)) [0x801031e8]
// 800bcaf4 : SH      0000ff45 (v1), 31ea (80100000 (at)) [0x801031ea]
// 800bcb10 : SH      0000fd05 (v0), 31ec (80100000 (at)) [0x801031ec]
A2 = A2; // start vector
...
A0 = 004a;
V0 = V0 << 04;
[0x800f512f + V0 + 0000] = b(V1);
V0 = w[0x800f1994];
V1 = 0060;
V0 = V0 << 04;
[0x800f5133 + V0 + 0000] = b(V1);
V0 = w[0x800f1994];
V1 = 0140;
V0 = V0 << 04;
V0 = V0 + A2;
...
[0x800fb00b] = b(1); // drawing to display area is enabled
[0x800fb00c] = b(1); // clear drawing area when drawing environment is set
...
[0x800faff6] = h(hu[0x800faff6] + 8); // move draw env clip rect x
[0x800faffa] = h(hu[0x800faffa] - 8); // shrink draw env clip rect width
[0x800fb00a] = b(1);
[0x800fb00b] = b(0);
[0x800fb00c] = b(0);
[0x800fb00d] = b(background_r);
[0x800fb00e] = b(background_g);
[0x800fb00f] = b(background_b);
...
[0x800ff0ea] = h(hu[0x800ff0ea] + 8); // move draw env clip rect x
[0x800ff0ee] = h(hu[0x800ff0ee] - 8); // shrink draw env clip rect width
[0x800ff0fe] = b(1); // dithering processing flag (on)
[0x800ff0ff] = b(0); // drawing to display area is blocked
[0x800ff100] = b(0); // not clear drawing area when drawing environment is set
[0x800ff101] = b(background_r);
[0x800ff102] = b(background_g);
[0x800ff103] = b(background_b);
...
if( w[0x800f57cc] == 0 )
{
    ...
    [0x800f90fc + V1 * 240 + 0] = h(0);
    [0x800f90fe + V1 * 240 + 0] = h(0);
}

[0x800f9108 + V1 * 240 + 0] = b(2);
[0x800f9109 + V1 * 240 + 0] = b(3);
[0x800f910c + V1 * 240 + 0] = b(2);
[0x800f9100 + V1 * 240 + 0] = h(2);
[0x800f9102 + V1 * 240 + 0] = h(c);
[0x800f910d + V1 * 240 + 0] = b(0);
[0x800f910a + V1 * 240 + 0] = b(0);
[0x800f910b + V1 * 240 + 0] = b(0);
[0x800f9104 + V1 * 240 + 0] = h(0);
