...
for( int i = 0; i < 18; ++i )
{
    [800f8cf4 + unit_id * 60 + i * 4] = w(w[clut_data + i * 4]);
}
////////////////////////////////
...
[S0 + 0000] = h(S4);
[S0 + 0004] = h(S4);
800C623C	jal    battle_set_load_to_vram [$800d2538]
[S0 + 0006] = h(V0);
...
A1 = 80158d0c;
[800f4b2a] = h(V0);
800C62D8	jal    battle_set_load_to_vram [$800d2538]
800C62DC	nop
RA = w[SP + 0014];
S0 = w[SP + 0010];
SP = SP + 0018;
