            ...
            if (model_id != 0xff)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (step == steps)
                        {
                            g_field_entities[i].pos_i = g_field_entities[i].move_end_i;
                    ...
                    A1 = g_field_entities[i].move_end_x;
