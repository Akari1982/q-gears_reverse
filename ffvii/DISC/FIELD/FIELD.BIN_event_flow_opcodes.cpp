...
int field_event_opcode_30_key()
{
    ...
    {
        A0 = hu[field_struct + 0x78];
    }
    else
    {
        A0 = hu[field_struct + 0x68];
    }

    field_event_key_check();
}
...
int field_event_opcode_31_keyon()
{
    ...
    if( bu[events_data + script_cur + 0x2] & 0x2 )
    {
        A0 = hu[field_struct + 0x80];
    }
    else
    {
        A0 = hu[field_struct + 0x70];
    }
...
int field_event_opcode_32_keyof()
{
    ...
    if( bu[events_data + script_cur + 0x2] & 0x2 )
    {
        A0 = hu[field_struct + 0x84];
    }
    else
    {
        A0 = hu[field_struct + 0x74];
    }
