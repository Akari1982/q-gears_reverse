...
[SP + 0032] = h(V0);
800AE0FC	jal    $system_gte_set_rotation_matrix
A0 = SP + 0010;
A0 = SP + 0010;
S0 = SP + 0038;
800AE10C	jal    $system_copy_vector_to_matrix_translation
A1 = S0;
800AE114	jal    $system_gte_set_translation_vector
A0 = SP + 0010;
T4 = S1;
VXY0 = w[T4 + 0000];
VZ0 = w[T4 + 0004];
...
[T4 + 0004] = w(MAC2);
[T4 + 0008] = w(MAC3);
[S1 + 0020] = h(hu[SP + 0020]);
[S1 + 0022] = h(hu[SP + 0024]);
////////////////////////////////
