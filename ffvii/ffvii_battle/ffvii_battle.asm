...
Lbbe94:	; 800BBE94
800BBE94	jal    system_bios_system_error_boot_or_disk_failure [$800429e0]
800BBE98	nop
...
A0 = w[S0 + 0000];
A1 = w[S0 + 0004];
800D2660	jal    system_psyq_load_image [$80044000]
S0 = S0 + 0014;
...
S1 = S1 + 508c;
A0 = A0 << 04;
800D8E90	jal    system_psyq_clear_o_tag [$8004418c]
A0 = A0 + S1;
A1 = 0040;
...
V0 = V0 + 4e8c;
A0 = A0 << 08;
800D8EB0	jal    system_psyq_clear_o_tag [$8004418c]
A0 = A0 + V0;
